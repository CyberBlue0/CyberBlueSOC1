...
if(description)
{
  ...
  script_name("Microsoft Security Essentials RCE Vulnerability (Jul 2017)");

  script_tag(name:"summary", value:"Security Essentials is prone to a remote code execution (RCE)
  vulnerability.");
