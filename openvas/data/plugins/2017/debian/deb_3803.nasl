...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3803");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/dsa-3803");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'texlive-base' package(s) announced via the DSA-3803 advisory.");
