...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2017-09-10 22:00:00 +0000 (Sun, 10 Sep 2017)");
  ...
  script_name("Debian: Security Advisory (DSA-3968)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3968");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/dsa-3968");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'icedove' package(s) announced via the DSA-3968 advisory.");
