...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4040)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4040");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/dsa-4040");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'imagemagick' package(s) announced via the DSA-4040 advisory.");
...
For the oldstable distribution (jessie), these problems have been fixed in version 8:6.8.9.9-5+deb8u11.
