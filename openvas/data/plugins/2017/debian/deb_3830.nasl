...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2017-04-18 22:00:00 +0000 (Tue, 18 Apr 2017)");
  ...
  script_name("Debian: Security Advisory (DSA-3830)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3830");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/dsa-3830");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'icu' package(s) announced via the DSA-3830 advisory.");
