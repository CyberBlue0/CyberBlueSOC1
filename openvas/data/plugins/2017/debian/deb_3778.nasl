...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2017-02-03 06:41:14 +0000 (Fri, 03 Feb 2017)");
  ...
  script_name("Debian: Security Advisory (DSA-3778)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3778");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/dsa-3778");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ruby-archive-tar-minitar' package(s) announced via the DSA-3778 advisory.");
...
We recommend that you upgrade your ruby-archive-tar-minitar packages.");
  ...
  script_tag(name:"affected", value:"'ruby-archive-tar-minitar' package(s) on Debian 8.");
