...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3960)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3960");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/dsa-3960");
  script_xref(name:"URL", value:"https://eprint.iacr.org/2017/627");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gnupg' package(s) announced via the DSA-3960 advisory.");
