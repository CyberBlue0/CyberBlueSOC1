...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2017-09-21 22:00:00 +0000 (Thu, 21 Sep 2017)");
  ...
  script_name("Debian: Security Advisory (DSA-3983)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3983");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/dsa-3983");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'samba' package(s) announced via the DSA-3983 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Multiple security issues have been discovered in Samba, a SMB/CIFS file, print, and login server for Unix:
