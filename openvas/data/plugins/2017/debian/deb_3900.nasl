...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3900)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3900");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/dsa-3900");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openvpn' package(s) announced via the DSA-3900 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several issues were discovered in openvpn, a virtual private network application.
...
We recommend that you upgrade your openvpn packages.");
  ...
  script_tag(name:"affected", value:"'openvpn' package(s) on Debian 8, Debian 9.");
