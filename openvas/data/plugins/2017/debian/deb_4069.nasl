...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2017-12-19 23:00:00 +0000 (Tue, 19 Dec 2017)");
  ...
  script_name("Debian: Security Advisory (DSA-4069)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4069");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/dsa-4069");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/otrs2");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'otrs2' package(s) announced via the DSA-4069 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Francesco Sirocco discovered a flaw in otrs2, the Open Ticket Request System, which could result in session information disclosure when cookie support is disabled. A remote attacker can take advantage of this flaw to take over an agent's session if the agent is tricked into clicking a link in a specially crafted mail.
