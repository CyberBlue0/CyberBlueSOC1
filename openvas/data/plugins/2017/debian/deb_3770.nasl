...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3770)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3770");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/dsa-3770");
  script_xref(name:"URL", value:"https://mariadb.com/kb/en/mariadb/mariadb-10029-release-notes/");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mariadb-10.0' package(s) announced via the DSA-3770 advisory.");
