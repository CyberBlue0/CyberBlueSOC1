...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4059)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4059");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/dsa-4059");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/libxcursor");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libxcursor' package(s) announced via the DSA-4059 advisory.");
...
For the detailed security status of libxcursor please refer to its security tracker page at: [link moved to references]");

  script_tag(name:"affected", value:"'libxcursor' package(s) on Debian 8, Debian 9.");
