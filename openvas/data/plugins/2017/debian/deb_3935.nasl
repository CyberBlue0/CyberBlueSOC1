...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.703935");
  ...
  script_name("Debian: Security Advisory (DSA-3935)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3935");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/dsa-3935");
  script_xref(name:"URL", value:"https://www.postgresql.org/about/news/1772/");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'postgresql-9.4' package(s) announced via the DSA-3935 advisory.");
