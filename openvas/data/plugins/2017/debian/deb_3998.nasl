...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2017-10-10 22:00:00 +0000 (Tue, 10 Oct 2017)");
  ...
  script_name("Debian: Security Advisory (DSA-3998)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3998");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/dsa-3998");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'nss' package(s) announced via the DSA-3998 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Martin Thomson discovered that nss, the Mozilla Network Security Service library, is prone to a use-after-free vulnerability in the TLS 1.2 implementation when handshake hashes are generated. A remote attacker can take advantage of this flaw to cause an application using the nss library to crash, resulting in a denial of service, or potentially to execute arbitrary code.
...
We recommend that you upgrade your nss packages.");
  ...
  script_tag(name:"affected", value:"'nss' package(s) on Debian 8, Debian 9.");
