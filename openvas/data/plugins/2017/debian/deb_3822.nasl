...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3822)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3822");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/dsa-3822");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gstreamer1.0' package(s) announced via the DSA-3822 advisory.");
...
For the upcoming stable distribution (stretch), this problem has been fixed in version 1.10.3-1.

For the unstable distribution (sid), this problem has been fixed in version 1.10.3-1.

We recommend that you upgrade your gstreamer1.0 packages.");

  script_tag(name:"affected", value:"'gstreamer1.0' package(s) on Debian 8.");
