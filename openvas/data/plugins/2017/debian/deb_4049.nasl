...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2017-11-26 23:00:00 +0000 (Sun, 26 Nov 2017)");
  ...
  script_name("Debian: Security Advisory (DSA-4049)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4049");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/dsa-4049");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/ffmpeg");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ffmpeg' package(s) announced via the DSA-4049 advisory.");
...
For the stable distribution (stretch), these problems have been fixed in version 7:3.2.9-1~deb9u1.
