...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.703805");
  ...
  script_name("Debian: Security Advisory (DSA-3805)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3805");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/dsa-3805");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'firefox-esr' package(s) announced via the DSA-3805 advisory.");
...
For the unstable distribution (sid), these problems have been fixed in version 45.8.0esr-1 of firefox-esr and version 52.0-1 of firefox.
