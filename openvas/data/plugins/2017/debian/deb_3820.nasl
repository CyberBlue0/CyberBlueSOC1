...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3820)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3820");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/dsa-3820");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gst-plugins-good1.0' package(s) announced via the DSA-3820 advisory.");
