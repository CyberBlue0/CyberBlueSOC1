...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2017-11-11 23:00:00 +0000 (Sat, 11 Nov 2017)");
  ...
  script_name("Debian: Security Advisory (DSA-4032)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4032");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/dsa-4032");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'imagemagick' package(s) announced via the DSA-4032 advisory.");
