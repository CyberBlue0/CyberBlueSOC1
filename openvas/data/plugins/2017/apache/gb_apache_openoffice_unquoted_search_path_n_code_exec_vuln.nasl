...
if(description)
{
  ...
  script_name("Apache OpenOffice 'Unquoted Search Path' and RCE Vulnerabilities");

  script_tag(name:"summary", value:"Apache OpenOffice is prone to an unquoted windows search path
