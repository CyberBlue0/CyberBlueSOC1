...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2017-05-10 04:53:55 +0000 (Wed, 10 May 2017)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3279-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3279-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3279-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apache2' package(s) announced via the USN-3279-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that the Apache mod_session_crypto module was encrypting
...
environments. (CVE-2016-8743)");
  ...
  script_tag(name:"affected", value:"'apache2' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 16.10.");
