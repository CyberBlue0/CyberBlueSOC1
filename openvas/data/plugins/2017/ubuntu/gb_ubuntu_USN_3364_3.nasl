...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws, linux-gke, linux-meta-aws, linux-meta-gke' package(s) announced via the USN-3364-3 advisory.");
...
use this to expose sensitive information (kernel memory). (CVE-2017-9605)");
  ...
  script_tag(name:"affected", value:"'linux-aws, linux-gke, linux-meta-aws, linux-meta-gke' package(s) on Ubuntu 16.04.");
