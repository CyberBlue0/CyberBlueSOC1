...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2017-08-16 05:33:21 +0000 (Wed, 16 Aug 2017)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3390-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3390-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3390-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'postgresql-9.3, postgresql-9.5, postgresql-9.6' package(s) announced via the USN-3390-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Ben de Graaff, Jelte Fennema, and Jeroen van der Ham discovered that
...
data in a large object. (CVE-2017-7548)");
  ...
  script_tag(name:"affected", value:"'postgresql-9.3, postgresql-9.5, postgresql-9.6' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 17.04.");
