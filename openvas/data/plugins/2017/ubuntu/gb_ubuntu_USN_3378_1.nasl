...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.843269");
  script_cve_id("CVE-2017-1000365", "CVE-2017-10810", "CVE-2017-7482", "CVE-2017-7533");
  script_tag(name:"creation_date", value:"2017-08-04 05:16:20 +0000 (Fri, 04 Aug 2017)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3378-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3378-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3378-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-aws, linux-gke, linux-meta, linux-meta-aws, linux-meta-gke, linux-meta-raspi2, linux-meta-snapdragon, linux-raspi2, linux-snapdragon' package(s) announced via the USN-3378-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Fan Wu and Shixiong Zhao discovered a race condition between inotify events
