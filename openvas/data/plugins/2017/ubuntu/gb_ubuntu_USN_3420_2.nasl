...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.843308");
  script_cve_id("CVE-2017-1000251", "CVE-2017-10663", "CVE-2017-12762", "CVE-2017-8831");
  script_tag(name:"creation_date", value:"2017-09-19 05:42:06 +0000 (Tue, 19 Sep 2017)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3420-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3420-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3420-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-lts-xenial, linux-meta-lts-xenial' package(s) announced via the USN-3420-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-3420-1 fixed vulnerabilities in the Linux kernel for Ubuntu 16.04
