...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2017-09-14 05:16:21 +0000 (Thu, 14 Sep 2017)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3415-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3415-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3415-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tcpdump' package(s) announced via the USN-3415-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Wilfried Kirsch discovered a buffer overflow in the SLIP decoder
...
CVE-2017-13690, CVE-2017-13725)");
  ...
  script_tag(name:"affected", value:"'tcpdump' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 17.04.");
