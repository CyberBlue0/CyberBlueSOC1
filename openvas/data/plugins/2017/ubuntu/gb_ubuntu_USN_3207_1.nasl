...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.843064");
  script_cve_id("CVE-2016-7910", "CVE-2016-7911", "CVE-2017-6074");
  script_tag(name:"creation_date", value:"2017-02-22 14:15:03 +0000 (Wed, 22 Feb 2017)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3207-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3207-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3207-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-meta' package(s) announced via the USN-3207-1 advisory.");
