...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2017-05-17 04:52:38 +0000 (Wed, 17 May 2017)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3291-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3291-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3291-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-meta' package(s) announced via the USN-3291-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Dmitry Vyukov discovered that the generic SCSI (sg) subsystem in the Linux
