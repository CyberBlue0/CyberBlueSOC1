...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2017-10-12 08:27:28 +0000 (Thu, 12 Oct 2017)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3452-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3452-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3452-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ceph' package(s) announced via the USN-3452-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Ceph incorrectly handled the handle_command
...
cause Ceph to crash, resulting in a denial of service. (CVE-2016-8626)

Yang Liu discovered that Ceph incorrectly handled invalid HTTP Origin
headers. A remote attacker could possibly use this issue to cause Ceph to
crash, resulting in a denial of service. (CVE-2016-9579)");

  script_tag(name:"affected", value:"'ceph' package(s) on Ubuntu 14.04.");
