...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2017-02-04 04:46:29 +0000 (Sat, 04 Feb 2017)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3189-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3189-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3189-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-lts-xenial, linux-meta-lts-xenial' package(s) announced via the USN-3189-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-3189-1 fixed vulnerabilities in the Linux kernel for Ubuntu 16.04
