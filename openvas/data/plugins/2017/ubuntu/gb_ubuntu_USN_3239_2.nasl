...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2017-03-22 04:49:09 +0000 (Wed, 22 Mar 2017)");
  script_version("2024-01-19T05:06:17+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:17 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");

  script_name("Ubuntu: Security Advisory (USN-3239-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3239-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3239-2");
  script_xref(name:"URL", value:"https://bugs.launchpad.net/bugs/1674532");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'eglibc, glibc' package(s) announced via the USN-3239-2 advisory.");
...
Original advisory details:
 ...
 could use this to cause a denial of service. (CVE-2016-6323)");
  ...
  script_tag(name:"affected", value:"'eglibc, glibc' package(s) on Ubuntu 12.04, Ubuntu 14.04, Ubuntu 16.04.");
