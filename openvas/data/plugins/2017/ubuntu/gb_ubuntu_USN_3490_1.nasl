...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2017-12-02 06:28:27 +0000 (Sat, 02 Dec 2017)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3490-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3490-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3490-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird' package(s) announced via the USN-3490-1 advisory.");
...
arbitrary code. (CVE-2017-7826, CVE-2017-7828, CVE-2017-7830)");
  ...
  script_tag(name:"affected", value:"'thunderbird' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 17.04, Ubuntu 17.10.");
