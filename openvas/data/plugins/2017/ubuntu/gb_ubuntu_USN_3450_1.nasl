...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2017-10-12 08:26:42 +0000 (Thu, 12 Oct 2017)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3450-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3450-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3450-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openvswitch' package(s) announced via the USN-3450-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Bhargava Shastry discovered that Open vSwitch incorrectly handled certain
...
vSwitch to crash, resulting in a denial of service. (CVE-2017-9265)");
  ...
  script_tag(name:"affected", value:"'openvswitch' package(s) on Ubuntu 16.04, Ubuntu 17.04.");
