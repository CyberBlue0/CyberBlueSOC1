...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.843067");
  ...
  script_tag(name:"creation_date", value:"2017-02-24 04:52:06 +0000 (Fri, 24 Feb 2017)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3211-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3211-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3211-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php7.0' package(s) announced via the USN-3211-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that PHP incorrectly handled certain invalid objects when
