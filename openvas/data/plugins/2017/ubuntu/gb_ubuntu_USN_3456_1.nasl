...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2017-10-18 14:54:17 +0000 (Wed, 18 Oct 2017)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3456-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3456-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3456-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xorg-server, xorg-server-hwe-16.04, xorg-server-lts-xenial' package(s) announced via the USN-3456-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that the X.Org X server incorrectly handled certain
