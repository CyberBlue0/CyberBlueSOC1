...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2017-05-12 04:50:23 +0000 (Fri, 12 May 2017)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3275-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3275-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3275-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openjdk-8' package(s) announced via the USN-3275-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that OpenJDK improperly re-used cached NTLM
...
control of a Java application's SMTP connections. (CVE-2017-3544)");
  ...
  script_tag(name:"affected", value:"'openjdk-8' package(s) on Ubuntu 16.04, Ubuntu 16.10, Ubuntu 17.04.");
