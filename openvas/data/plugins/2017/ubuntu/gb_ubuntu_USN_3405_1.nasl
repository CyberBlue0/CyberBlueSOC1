...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.843294");
  script_cve_id("CVE-2015-7837", "CVE-2017-11176", "CVE-2017-7495", "CVE-2017-7541");
  script_tag(name:"creation_date", value:"2017-08-29 06:05:05 +0000 (Tue, 29 Aug 2017)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3405-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3405-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3405-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-aws, linux-gke, linux-meta, linux-meta-aws, linux-meta-gke, linux-meta-raspi2, linux-meta-snapdragon, linux-raspi2, linux-snapdragon' package(s) announced via the USN-3405-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that a use-after-free vulnerability existed in the POSIX
