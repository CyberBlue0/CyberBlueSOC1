...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-lts-xenial, linux-meta-lts-xenial' package(s) announced via the USN-3469-2 advisory.");
