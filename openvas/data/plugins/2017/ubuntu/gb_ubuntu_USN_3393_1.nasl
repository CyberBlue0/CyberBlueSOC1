...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2017-08-18 05:33:56 +0000 (Fri, 18 Aug 2017)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3393-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3393-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3393-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'clamav' package(s) announced via the USN-3393-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that ClamAV incorrectly handled parsing certain e-mail
...
cause ClamAV to crash, resulting in a denial of service. (CVE-2017-6420)");
  ...
  script_tag(name:"affected", value:"'clamav' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 17.04.");
