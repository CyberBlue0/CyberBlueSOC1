...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-meta-raspi2, linux-raspi2' package(s) announced via the USN-3325-1 advisory.");
...
arbitrary code and gain administrative privileges");
  ...
  script_tag(name:"affected", value:"'linux-meta-raspi2, linux-raspi2' package(s) on Ubuntu 17.04.");
