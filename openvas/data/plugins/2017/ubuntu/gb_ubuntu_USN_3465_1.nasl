...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2017-10-27 12:32:10 +0000 (Fri, 27 Oct 2017)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3465-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3465-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3465-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'irssi' package(s) announced via the USN-3465-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Brian Carpenter discovered that Irssi incorrectly handled messages with
...
Hanno Bock discovered that Irssi incorrectly handled themes. If a user were
