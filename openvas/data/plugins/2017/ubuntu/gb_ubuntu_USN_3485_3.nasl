...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws, linux-meta-aws' package(s) announced via the USN-3485-3 advisory.");
...
Andrey Konovalov discovered that the USB subsystem in the Linux ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-aws, linux-meta-aws' package(s) on Ubuntu 14.04.");
