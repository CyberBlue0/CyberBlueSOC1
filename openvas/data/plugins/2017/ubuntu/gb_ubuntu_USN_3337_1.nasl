...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2017-06-22 05:12:36 +0000 (Thu, 22 Jun 2017)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3337-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3337-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3337-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'valgrind' package(s) announced via the USN-3337-1 advisory.");
...
CVE-2016-4493, CVE-2016-6131)");
  ...
  script_tag(name:"affected", value:"'valgrind' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 16.10, Ubuntu 17.04.");
