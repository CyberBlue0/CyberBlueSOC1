...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2017-07-27 05:17:24 +0000 (Thu, 27 Jul 2017)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3368-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2017 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3368-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3368-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libiberty' package(s) announced via the USN-3368-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that libiberty incorrectly handled certain string
...
libiberty to crash, resulting in a denial of service. (CVE-2016-4491)");
  ...
  script_tag(name:"affected", value:"'libiberty' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 17.04.");
