...
if(description)
{
  ...
  script_name("PHP 7.x < 7.0.18, 7.1.x < 7.1.4 SSRF Security Bypass Vulnerability - Linux");
  ...
  script_tag(name:"insight", value:"The flaw exists due to the php_wddx_pop_element function in
  ext/wddx/wddx.c via an inapplicable class name in a wddxPacket XML document, leading to
  mishandling in a wddx_deserialize call.");
  ...
  script_tag(name:"affected", value:"PHP versions 7.0.x prior to 7.0.18 and 7.1.x prior to
  7.1.4.");

  script_tag(name:"solution", value:"Update to version 7.0.18, 7.1.4 or later.");

  script_xref(name:"URL", value:"http://www.php.net/ChangeLog-7.php");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/97178");
...
if (version_in_range_exclusive(version: version, test_version_lo: "7.0.0", test_version_up: "7.0.18")) {
