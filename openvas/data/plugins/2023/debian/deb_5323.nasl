...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705323");
  script_cve_id("CVE-2021-43113");
  script_tag(name:"creation_date", value:"2023-01-21 02:00:18 +0000 (Sat, 21 Jan 2023)");
  ...
  script_name("Debian: Security Advisory (DSA-5323)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2023 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5323");
  script_xref(name:"URL", value:"https://www.debian.org/security/2023/dsa-5323");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/libitext5-java");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libitext5-java' package(s) announced via the DSA-5323 advisory.");
...
For the stable distribution (bullseye), this problem has been fixed in version 5.5.13.2-1+deb11u1.
...
For the detailed security status of libitext5-java please refer to its security tracker page at: [link moved to references].");
  ...
  script_tag(name:"affected", value:"'libitext5-java' package(s) on Debian 11.");
