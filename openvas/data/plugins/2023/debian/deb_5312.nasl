...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705312");
  script_cve_id("CVE-2022-40149", "CVE-2022-40150", "CVE-2022-45685", "CVE-2022-45693");
  script_tag(name:"creation_date", value:"2023-01-12 02:00:18 +0000 (Thu, 12 Jan 2023)");
  ...
  script_name("Debian: Security Advisory (DSA-5312)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2023 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5312");
  script_xref(name:"URL", value:"https://www.debian.org/security/2023/dsa-5312");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/libjettison-java");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libjettison-java' package(s) announced via the DSA-5312 advisory.");
...
For the detailed security status of libjettison-java please refer to its security tracker page at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'libjettison-java' package(s) on Debian 11.");
