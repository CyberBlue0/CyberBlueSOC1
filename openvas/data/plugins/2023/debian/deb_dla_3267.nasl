...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.893267");
  script_cve_id("CVE-2022-41966");
  script_tag(name:"creation_date", value:"2023-01-12 02:00:21 +0000 (Thu, 12 Jan 2023)");
