...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-12-01 23:11:00 +0000 (Thu, 01 Dec 2022)");

  script_name("Debian: Security Advisory (DLA-3264)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2023 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-3264");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/dla-3264");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ruby-sinatra' package(s) announced via the DLA-3264 advisory.");
