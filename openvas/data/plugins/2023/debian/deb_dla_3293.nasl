...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-3293)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2023 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-3293");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'modsecurity-crs' package(s) announced via the DLA-3293 advisory.");
...
Kudos to @airween for the support and help while preparing the update.
