...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.893272");
  script_cve_id("CVE-2023-22809");
  script_tag(name:"creation_date", value:"2023-01-19 02:00:04 +0000 (Thu, 19 Jan 2023)");
  ...
  script_name("Debian: Security Advisory (DLA-3272)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2023 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-3272");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/dla-3272");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'sudo' package(s) announced via the DLA-3272 advisory.");
