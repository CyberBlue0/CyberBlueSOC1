...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-01-11 16:07:00 +0000 (Wed, 11 Jan 2023)");

  script_name("Debian: Security Advisory (DLA-3266)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2023 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-3266");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/dla-3266");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'viewvc' package(s) announced via the DLA-3266 advisory.");
