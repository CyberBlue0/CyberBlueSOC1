...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705328");
  script_cve_id("CVE-2023-0471", "CVE-2023-0472", "CVE-2023-0473", "CVE-2023-0474");
  script_tag(name:"creation_date", value:"2023-01-28 02:00:09 +0000 (Sat, 28 Jan 2023)");
  ...
  script_name("Debian: Security Advisory (DSA-5328)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2023 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5328");
  script_xref(name:"URL", value:"https://www.debian.org/security/2023/dsa-5328");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/chromium");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium' package(s) announced via the DSA-5328 advisory.");
...
For the stable distribution (bullseye), these problems have been fixed in version 109.0.5414.119-1~deb11u1.
