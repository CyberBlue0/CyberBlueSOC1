...
if(description)
{
  ...
  script_name("Fedora: Security Advisory for rust-tealdeer (FEDORA-2023-9790b327cb)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2023 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2023-9790b327cb");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XODQFSG6CJJORFK74ZK4EZYL6DHCSWWO");
...
offline client with caching support.");
  ...
  script_tag(name:"affected", value:"'rust-tealdeer' package(s) on Fedora 39.");
