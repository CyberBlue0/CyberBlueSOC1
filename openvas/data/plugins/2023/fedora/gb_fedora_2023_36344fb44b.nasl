...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885285");
  ...
  script_tag(name:"creation_date", value:"2023-11-19 02:16:40 +0000 (Sun, 19 Nov 2023)");
  script_name("Fedora: Security Advisory for tor (FEDORA-2023-36344fb44b)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2023 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2023-36344fb44b");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/WCTWENJMJZ5BG3IUQPP4AOX66622XC5G");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tor'
  package(s) announced via the FEDORA-2023-36344fb44b advisory.
