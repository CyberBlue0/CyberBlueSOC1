...
if(description)
{
  ...
  script_cve_id("CVE-2023-5535", "CVE-2023-5441", "CVE-2023-5344");
  ...
  script_name("Fedora: Security Advisory for vim (FEDORA-2023-1976197889)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2023 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2023-1976197889");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XPT7NMYJRLBPIALGSE24UWTY6F774GZW");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'vim'
  package(s) announced via the FEDORA-2023-1976197889 advisory.
