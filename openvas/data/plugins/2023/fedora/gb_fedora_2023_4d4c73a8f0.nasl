...
if(description)
{
  ...
  script_cve_id("CVE-2023-45129", "CVE-2023-41335", "CVE-2023-42453");
  ...
  script_name("Fedora: Security Advisory for matrix-synapse (FEDORA-2023-4d4c73a8f0)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2023 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2023-4d4c73a8f0");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/N6P4QULVUE254WI7XF2LWWOGHCYVFXFY");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'matrix-synapse'
  package(s) announced via the FEDORA-2023-4d4c73a8f0 advisory.
