...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2023-11-05 02:21:21 +0000 (Sun, 05 Nov 2023)");
  script_name("Fedora: Security Advisory for mingw-freeimage (FEDORA-2023-8e640cb540)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2023 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2023-8e640cb540");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/HFRQ76ZDPSWT7OH6FJDLSFWBXVBE6JDN");
...
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  script_tag(name:"affected", value:"'mingw-freeimage' package(s) on Fedora 39.");
