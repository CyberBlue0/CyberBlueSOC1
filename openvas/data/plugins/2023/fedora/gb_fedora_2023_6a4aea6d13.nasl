...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2023-11-19 02:16:32 +0000 (Sun, 19 Nov 2023)");
  script_name("Fedora: Security Advisory for gstreamer1-plugins-good (FEDORA-2023-6a4aea6d13)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2023 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2023-6a4aea6d13");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6TBQHI5XQ6GC5LM5SZF3BBY5VG4KZ4I5");
...
good quality and under the LGPL license.");
  ...
  script_tag(name:"affected", value:"'gstreamer1-plugins-good' package(s) on Fedora 39.");
