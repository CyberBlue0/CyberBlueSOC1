...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885232");
  ...
  script_tag(name:"creation_date", value:"2023-11-08 02:14:55 +0000 (Wed, 08 Nov 2023)");
  script_name("Fedora: Security Advisory for mlpack (FEDORA-2023-862bb40df5)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2023 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2023-862bb40df5");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/7YQZD3YFUCWQBS3FDC6EFPOZ2LPD2XCA");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mlpack'
  package(s) announced via the FEDORA-2023-862bb40df5 advisory.
...
margins.");
  ...
  script_tag(name:"affected", value:"'mlpack' package(s) on Fedora 39.");
