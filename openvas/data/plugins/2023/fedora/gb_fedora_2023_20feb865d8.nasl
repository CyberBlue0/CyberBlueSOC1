...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885515");
  ...
  script_tag(name:"creation_date", value:"2023-12-29 02:16:15 +0000 (Fri, 29 Dec 2023)");
  script_name("Fedora: Security Advisory for podman-tui (FEDORA-2023-20feb865d8)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2023 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2023-20feb865d8");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/3YQLUQWLIHDB5QCXQEX7HXHAWMOKPP5O");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'podman-tui'
  package(s) announced via the FEDORA-2023-20feb865d8 advisory.
