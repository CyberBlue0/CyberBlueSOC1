...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885027");
  ...
  script_tag(name:"creation_date", value:"2023-10-16 01:17:34 +0000 (Mon, 16 Oct 2023)");
  script_name("Fedora: Security Advisory for ansible-core (FEDORA-2023-389ed7a7e7)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2023 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2023-389ed7a7e7");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/D5PZFOSNSENRW3F4AUJMYJL4ZNFBCJH2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ansible-core'
  package(s) announced via the FEDORA-2023-389ed7a7e7 advisory.
