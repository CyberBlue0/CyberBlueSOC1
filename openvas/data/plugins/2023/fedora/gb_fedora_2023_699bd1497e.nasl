...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885145");
  ...
  script_name("Fedora: Security Advisory for rt (FEDORA-2023-699bd1497e)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2023 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2023-699bd1497e");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6KYOZBLDNMNDKN5SGQGSMROUIZAHVTQ3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rt'
  package(s) announced via the FEDORA-2023-699bd1497e advisory.
...
by a community of users.");
  ...
  script_tag(name:"affected", value:"'rt' package(s) on Fedora 39.");
