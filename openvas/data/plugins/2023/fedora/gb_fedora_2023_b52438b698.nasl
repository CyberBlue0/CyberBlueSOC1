...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885151");
  ...
  script_name("Fedora: Security Advisory for dotnet7.0 (FEDORA-2023-b52438b698)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2023 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2023-b52438b698");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/74OCTWOGC4CU5ULBTM7OOUZDCY3R77EB");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dotnet7.0'
  package(s) announced via the FEDORA-2023-b52438b698 advisory.
