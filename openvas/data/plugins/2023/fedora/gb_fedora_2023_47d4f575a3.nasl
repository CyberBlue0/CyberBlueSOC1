...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885309");
  ...
  script_tag(name:"creation_date", value:"2023-11-22 02:16:35 +0000 (Wed, 22 Nov 2023)");
  script_name("Fedora: Security Advisory for audiofile (FEDORA-2023-47d4f575a3)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2023 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2023-47d4f575a3");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/YZPG27YKICLIWUFOPVUOAFAZGOX4BNHY");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'audiofile'
  package(s) announced via the FEDORA-2023-47d4f575a3 advisory.
...
any of the sound file formats it can handle.");
  ...
  script_tag(name:"affected", value:"'audiofile' package(s) on Fedora 39.");
