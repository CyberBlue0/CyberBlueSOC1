...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884782");
  ...
  script_name("Fedora: Security Advisory for golang (FEDORA-2023-4c35736385)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2023 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2023-4c35736385");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6IYHIWVR3GTHZZJS5GEE2EZDK3AEWRNC");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'golang'
  package(s) announced via the FEDORA-2023-4c35736385 advisory.
