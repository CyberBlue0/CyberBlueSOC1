...
if(description)
{
  ...
  script_cve_id("CVE-2023-44487", "CVE-2023-45143", "CVE-2023-38552", "CVE-2023-39333");
  ...
  script_name("Fedora: Security Advisory for nodejs18 (FEDORA-2023-dbe64661af)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2023 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2023-dbe64661af");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/HT7T2R4MQKLIF4ODV4BDLPARWFPCJ5CZ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nodejs18'
  package(s) announced via the FEDORA-2023-dbe64661af advisory.
