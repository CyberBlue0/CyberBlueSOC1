...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884788");
  ...
  script_name("Fedora: Security Advisory for rubygem-actionmailer (FEDORA-2023-4f0bb4ff5e)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2023 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2023-4f0bb4ff5e");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/AGWBO6X4CG7XF44WE75E7OW2PIPXAWIL");
...
attachments.");
  ...
  script_tag(name:"affected", value:"'rubygem-actionmailer' package(s) on Fedora 39.");
