...
if(description)
{
  ...
  script_cve_id("CVE-2023-44487", "CVE-2023-41752", "CVE-2023-39456");
  ...
  script_name("Fedora: Security Advisory for trafficserver (FEDORA-2023-1caffb88af)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2023 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2023-1caffb88af");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VHUHTSXLXGXS7JYKBXTA3VINUPHTNGVU");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'trafficserver'
  package(s) announced via the FEDORA-2023-1caffb88af advisory.
