...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885505");
  ...
  script_name("Fedora: Security Advisory for filezilla (FEDORA-2023-7141950083)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2023 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2023-7141950083");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/A3FLEA653A7KQORPN346CJKMA6ONAG3I");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'filezilla'
  package(s) announced via the FEDORA-2023-7141950083 advisory.
