...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885499");
  ...
  script_tag(name:"creation_date", value:"2023-12-26 02:26:02 +0000 (Tue, 26 Dec 2023)");
  script_name("Fedora: Security Advisory for python3.11 (FEDORA-2023-87771f4249)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2023 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2023-87771f4249");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/4ZAEFSFZDNBNJPNOUTLG5COISGQDLMGV");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3.11'
  package(s) announced via the FEDORA-2023-87771f4249 advisory.
