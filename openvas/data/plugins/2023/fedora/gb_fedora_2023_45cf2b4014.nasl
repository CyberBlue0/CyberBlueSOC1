...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885314");
  ...
  script_tag(name:"creation_date", value:"2023-11-24 02:13:51 +0000 (Fri, 24 Nov 2023)");
  script_name("Fedora: Security Advisory for vim (FEDORA-2023-45cf2b4014)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2023 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2023-45cf2b4014");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/M3VQF7CL3V6FGSEW37WNDFBRRILR65AK");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'vim'
  package(s) announced via the FEDORA-2023-45cf2b4014 advisory.
