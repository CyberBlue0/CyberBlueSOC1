...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2023-09-23 01:18:17 +0000 (Sat, 23 Sep 2023)");
  script_name("Fedora: Security Advisory for firecracker (FEDORA-2023-8e6ae98f81)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2023 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2023-8e6ae98f81");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/RLIYTQLIX5FAC6EODJHQ6J7ENWZJRO7Z");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firecracker'
  package(s) announced via the FEDORA-2023-8e6ae98f81 advisory.
