...
if(description)
{
  ...
  script_name("Fedora: Security Advisory for rust-rustls-webpki (FEDORA-2023-4ae90bc849)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2023 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2023-4ae90bc849");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/CHFCC7T664BHCNKR2SNYUISUOCMMMPZH");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rust-rustls-webpki'
  package(s) announced via the FEDORA-2023-4ae90bc849 advisory.
