...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826950");
  ...
  script_tag(name:"creation_date", value:"2023-03-23 17:48:27 +0530 (Thu, 23 Mar 2023)");
  script_name("Mozilla Thunderbird Security Advisories (MFSA2023-08, MFSA2023-11) - Mac OS X");
