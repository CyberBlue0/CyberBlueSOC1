...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.826993");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_30-2023-05) - Windows");
