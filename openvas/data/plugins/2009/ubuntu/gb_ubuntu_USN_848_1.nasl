...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.66062");
  ...
  script_name("Ubuntu: Security Advisory (USN-848-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2009 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-848-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-848-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'zope3' package(s) announced via the USN-848-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that the Zope Object Database (ZODB) database server
...
identifier)");
  ...
  script_tag(name:"affected", value:"'zope3' package(s) on Ubuntu 6.06, Ubuntu 8.04, Ubuntu 8.10, Ubuntu 9.04.");
