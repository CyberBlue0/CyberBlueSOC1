...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.840046");
  ...
  script_name("Ubuntu: Security Advisory (USN-454-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2009 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-454-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-454-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'postgresql-8.1, postgresql-8.2' package(s) announced via the USN-454-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"PostgreSQL did not handle the 'search_path' configuration option in a
...
how to write security definer functions in a secure way.");
  ...
  script_tag(name:"affected", value:"'postgresql-8.1, postgresql-8.2' package(s) on Ubuntu 6.06, Ubuntu 6.10, Ubuntu 7.04.");
