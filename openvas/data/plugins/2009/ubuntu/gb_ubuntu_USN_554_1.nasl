...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.840006");
  ...
  script_name("Ubuntu: Security Advisory (USN-554-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2009 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-554-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-554-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tetex-bin, texlive-bin' package(s) announced via the USN-554-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Bastien Roucaries discovered that dvips as included in tetex-bin
...
the user invoking the program. (CVE-2007-5937)");
  ...
  script_tag(name:"affected", value:"'tetex-bin, texlive-bin' package(s) on Ubuntu 6.06, Ubuntu 6.10, Ubuntu 7.04, Ubuntu 7.10.");
