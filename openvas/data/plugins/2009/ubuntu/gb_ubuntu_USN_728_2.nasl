...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63511");
  ...
  script_name("Ubuntu: Security Advisory (USN-728-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2009 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-728-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-728-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox' package(s) announced via the USN-728-2 advisory.");
