...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.840026");
  ...
  script_name("Ubuntu: Security Advisory (USN-473-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2009 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-473-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-473-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libgd2' package(s) announced via the USN-473-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"A buffer overflow was discovered in libgd2's font renderer. By tricking
...
to a remote denial of service. (CVE-2007-2756)");
  ...
  script_tag(name:"affected", value:"'libgd2' package(s) on Ubuntu 6.06, Ubuntu 6.10, Ubuntu 7.04.");
