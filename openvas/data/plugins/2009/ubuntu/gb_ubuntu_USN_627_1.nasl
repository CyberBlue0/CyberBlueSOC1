...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.840230");
  ...
  script_name("Ubuntu: Security Advisory (USN-627-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2009 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-627-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-627-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dnsmasq' package(s) announced via the USN-627-1 advisory.");
...
misdirected email and web traffic.");
  ...
  script_tag(name:"affected", value:"'dnsmasq' package(s) on Ubuntu 8.04.");
