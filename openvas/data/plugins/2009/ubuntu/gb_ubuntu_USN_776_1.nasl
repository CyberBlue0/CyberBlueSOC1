...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-776-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2009 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-776-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-776-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kvm' package(s) announced via the USN-776-1 advisory.");
...
leading to a denial of service. (CVE-2008-5714)");
  ...
  script_tag(name:"affected", value:"'kvm' package(s) on Ubuntu 8.04, Ubuntu 8.10.");
