...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.840035");
  ...
  script_name("Ubuntu: Security Advisory (USN-410-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2009 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-410-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-410-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tetex-bin' package(s) announced via the USN-410-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-410-1 fixed vulnerabilities in the poppler PDF loader library. This
...
Original advisory details:
 ...
 and eventually crash an application that uses this library.");
  ...
  script_tag(name:"affected", value:"'tetex-bin' package(s) on Ubuntu 5.10.");
