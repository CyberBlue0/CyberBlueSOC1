...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.840291");
  ...
  script_name("Ubuntu: Security Advisory (USN-584-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2009 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-584-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-584-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openldap2.2, openldap2.3' package(s) announced via the USN-584-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Jonathan Clarke discovered that the OpenLDAP slapd server did not
...
denial of service via application crash. (CVE-2007-6698)");
  ...
  script_tag(name:"affected", value:"'openldap2.2, openldap2.3' package(s) on Ubuntu 6.06, Ubuntu 6.10, Ubuntu 7.04, Ubuntu 7.10.");
