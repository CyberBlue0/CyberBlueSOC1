...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.840028");
  ...
  script_name("Ubuntu: Security Advisory (USN-489-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2009 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-489-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-489-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-source-2.6.15' package(s) announced via the USN-489-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"A flaw was discovered in dvb ULE decapsulation. A remote attacker could
