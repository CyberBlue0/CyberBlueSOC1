...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.840146");
  ...
  script_name("Ubuntu: Security Advisory (USN-477-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2009 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-477-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-477-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'krb5' package(s) announced via the USN-477-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Wei Wang discovered that the krb5 RPC library did not correctly handle
...
execute arbitrary code with root privileges. (CVE-2007-2798)");
  ...
  script_tag(name:"affected", value:"'krb5' package(s) on Ubuntu 6.06, Ubuntu 6.10, Ubuntu 7.04.");
