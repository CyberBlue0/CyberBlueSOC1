...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.64172");
  ...
  script_name("Ubuntu: Security Advisory (USN-771-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2009 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-771-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-771-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libmodplug' package(s) announced via the USN-771-1 advisory.");
...
Ubuntu 9.04. (CVE-2009-1513)");
  ...
  script_tag(name:"affected", value:"'libmodplug' package(s) on Ubuntu 6.06, Ubuntu 8.04, Ubuntu 8.10, Ubuntu 9.04.");
