...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.64146");
  ...
  script_name("Ubuntu: Security Advisory (USN-777-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2009 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-777-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-777-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ntp' package(s) announced via the USN-777-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"A stack-based buffer overflow was discovered in ntpq. If a user were
...
denial of service, or possibly execute arbitrary code. (CVE-2009-1252)");
  ...
  script_tag(name:"affected", value:"'ntp' package(s) on Ubuntu 6.06, Ubuntu 8.04, Ubuntu 8.10, Ubuntu 9.04.");
