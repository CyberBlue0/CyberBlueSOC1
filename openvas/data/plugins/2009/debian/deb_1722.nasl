...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1722)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2009 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-1722");
  script_xref(name:"URL", value:"https://www.debian.org/security/2009/dsa-1722");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libpam-heimdal' package(s) announced via the DSA-1722 advisory.");
