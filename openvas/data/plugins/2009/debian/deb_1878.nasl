...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.64867");
  ...
  script_name("Debian: Security Advisory (DSA-1878)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2009 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-1878");
  script_xref(name:"URL", value:"https://www.debian.org/security/2009/dsa-1878");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'devscripts' package(s) announced via the DSA-1878 advisory.");
