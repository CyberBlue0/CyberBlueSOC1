...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.66052");
...
We recommend that you upgrade your python-django packages.");
  ...
  script_tag(name:"affected", value:"'python-django' package(s) on Debian 5.");
