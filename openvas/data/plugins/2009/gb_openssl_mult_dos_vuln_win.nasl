...
if(description)
{
  ...
  script_name("OpenSSL DTLS Packets Multiple DoS Vulnerabilities - Windows");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/35001");
  ...
  OpenSSL version 1.0.0 Beta2 and prior.");
