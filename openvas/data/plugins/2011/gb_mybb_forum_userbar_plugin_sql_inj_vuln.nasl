...
if(description)
{
  ...
  script_name("MyBB Userbar Plugin 'userbarsettings.php' SQLi Vulnerability");
  ...
  script_tag(name:"summary", value:"MyBB with Userbar Plugin is prone to an SQL injection (SQLi)
  vulnerability.");
