...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2011-11-11 04:29:23 +0000 (Fri, 11 Nov 2011)");
  ...
  script_name("Ubuntu: Security Advisory (USN-1253-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2011 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1253-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1253-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux' package(s) announced via the USN-1253-1 advisory.");
