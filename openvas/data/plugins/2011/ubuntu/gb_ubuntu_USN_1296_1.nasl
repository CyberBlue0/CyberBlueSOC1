...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2011-12-09 05:24:15 +0000 (Fri, 09 Dec 2011)");
  script_version("2024-01-19T05:06:16+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:16 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"4.6");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:P/I:P/A:P");

  script_name("Ubuntu: Security Advisory (USN-1296-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2011 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1296-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1296-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'acpid' package(s) announced via the USN-1296-1 advisory.");
...
(CVE-2011-4578)");
  ...
  script_tag(name:"affected", value:"'acpid' package(s) on Ubuntu 10.04, Ubuntu 10.10, Ubuntu 11.04, Ubuntu 11.10.");
