...
if(description)
{
  ...
  script_cve_id("CVE-2010-4075", "CVE-2010-4077", "CVE-2010-4158", "CVE-2010-4162", "CVE-2010-4163", "CVE-2010-4242");
  ...
  script_name("Ubuntu: Security Advisory (USN-1092-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2011 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1092-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1092-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-source-2.6.15' package(s) announced via the USN-1092-1 advisory.");
