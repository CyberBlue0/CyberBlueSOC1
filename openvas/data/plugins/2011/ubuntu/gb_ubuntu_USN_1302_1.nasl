...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2011-12-16 05:41:56 +0000 (Fri, 16 Dec 2011)");
  ...
  script_name("Ubuntu: Security Advisory (USN-1302-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2011 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1302-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1302-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-ti-omap4' package(s) announced via the USN-1302-1 advisory.");
