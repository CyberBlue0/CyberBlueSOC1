...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-1045-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2011 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1045-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1045-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'util-linux' package(s) announced via the USN-1045-2 advisory.");
...
Original advisory details:
 ...
 FUSE, could unmount arbitrary locations, leading to a denial of service.");
  ...
  script_tag(name:"affected", value:"'util-linux' package(s) on Ubuntu 8.04, Ubuntu 9.10, Ubuntu 10.04, Ubuntu 10.10.");
