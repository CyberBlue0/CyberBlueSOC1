...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-1197-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2011 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1197-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1197-2");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/838322");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/837557");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird' package(s) announced via the USN-1197-2 advisory.");
