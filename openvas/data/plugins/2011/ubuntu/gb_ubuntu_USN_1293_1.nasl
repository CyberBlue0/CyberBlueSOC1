...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2011-12-09 05:23:48 +0000 (Fri, 09 Dec 2011)");
  ...
  script_name("Ubuntu: Security Advisory (USN-1293-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2011 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1293-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1293-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux' package(s) announced via the USN-1293-1 advisory.");
