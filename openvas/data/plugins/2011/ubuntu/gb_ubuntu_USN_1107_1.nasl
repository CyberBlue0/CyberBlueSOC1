...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-1107-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2011 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1107-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1107-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'x11-xserver-utils' package(s) announced via the USN-1107-1 advisory.");
...
resulting in root privilege escalation.");
  ...
  script_tag(name:"affected", value:"'x11-xserver-utils' package(s) on Ubuntu 8.04, Ubuntu 9.10, Ubuntu 10.04, Ubuntu 10.10.");
