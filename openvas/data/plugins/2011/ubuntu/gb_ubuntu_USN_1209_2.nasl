...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-1209-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2011 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1209-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1209-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libav' package(s) announced via the USN-1209-2 advisory.");
...
the program. (CVE-2011-3362)");
  ...
  script_tag(name:"affected", value:"'libav' package(s) on Ubuntu 11.04.");
