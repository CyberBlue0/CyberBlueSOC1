...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.840743");
  ...
  script_tag(name:"severity_date", value:"2020-08-04 17:52:00 +0000 (Tue, 04 Aug 2020)");

  script_name("Ubuntu: Security Advisory (USN-1208-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2011 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1208-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1208-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-mvl-dove' package(s) announced via the USN-1208-1 advisory.");
