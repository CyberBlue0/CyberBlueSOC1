...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-1233-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2011 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1233-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1233-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'krb5' package(s) announced via the USN-1233-1 advisory.");
...
service. (CVE-2011-1529)");
  ...
  script_tag(name:"affected", value:"'krb5' package(s) on Ubuntu 10.04, Ubuntu 10.10, Ubuntu 11.04, Ubuntu 11.10.");
