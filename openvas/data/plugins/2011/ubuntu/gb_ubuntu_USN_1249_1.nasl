...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-1249-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2011 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1249-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1249-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'backuppc' package(s) announced via the USN-1249-1 advisory.");
...
cross-site scripting (XSS) vulnerabilities.");
  ...
  script_tag(name:"affected", value:"'backuppc' package(s) on Ubuntu 8.04, Ubuntu 10.04, Ubuntu 10.10, Ubuntu 11.04, Ubuntu 11.10.");
