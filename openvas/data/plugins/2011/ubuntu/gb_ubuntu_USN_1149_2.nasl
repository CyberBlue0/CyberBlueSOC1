...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-1149-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2011 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1149-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1149-2");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/801778");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox' package(s) announced via the USN-1149-2 advisory.");
...
Original advisory details:
 ...
 (CVE-2011-2362)");
  ...
  script_tag(name:"affected", value:"'firefox' package(s) on Ubuntu 10.04, Ubuntu 10.10.");
