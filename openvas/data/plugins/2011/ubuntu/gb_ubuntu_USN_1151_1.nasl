...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-1151-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2011 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1151-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1151-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nagios3' package(s) announced via the USN-1151-1 advisory.");
...
confidential data, within the same domain.");
  ...
  script_tag(name:"affected", value:"'nagios3' package(s) on Ubuntu 10.04, Ubuntu 10.10, Ubuntu 11.04.");
