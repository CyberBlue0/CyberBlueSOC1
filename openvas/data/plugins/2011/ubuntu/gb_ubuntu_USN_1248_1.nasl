...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-1248-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2011 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1248-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1248-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kde4libs' package(s) announced via the USN-1248-1 advisory.");
...
modify displaying of the realm and proxy URL.");
  ...
  script_tag(name:"affected", value:"'kde4libs' package(s) on Ubuntu 10.04, Ubuntu 10.10, Ubuntu 11.04.");
