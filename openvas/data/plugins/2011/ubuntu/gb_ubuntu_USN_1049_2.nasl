...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-1049-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2011 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1049-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1049-2");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/728798");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox, firefox-3.0, firefox-3.5, xulrunner-1.9.2' package(s) announced via the USN-1049-2 advisory.");
