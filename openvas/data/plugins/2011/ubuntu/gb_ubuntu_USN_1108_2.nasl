...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-1108-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2011 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1108-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1108-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dhcp3' package(s) announced via the USN-1108-2 advisory.");
...
Original advisory details:
 ...
 server to execute arbitrary code, resulting in root privilege escalation.");
  ...
  script_tag(name:"affected", value:"'dhcp3' package(s) on Ubuntu 9.10, Ubuntu 10.04, Ubuntu 10.10.");
