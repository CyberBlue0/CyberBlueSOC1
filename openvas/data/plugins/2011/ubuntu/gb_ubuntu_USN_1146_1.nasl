...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-08-07 19:28:00 +0000 (Fri, 07 Aug 2020)");

  script_name("Ubuntu: Security Advisory (USN-1146-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2011 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1146-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1146-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux' package(s) announced via the USN-1146-1 advisory.");
