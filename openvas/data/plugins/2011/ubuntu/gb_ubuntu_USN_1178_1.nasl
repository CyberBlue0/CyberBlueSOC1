...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-1178-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2011 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1178-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1178-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'icedtea-web, openjdk-6, openjdk-6b18' package(s) announced via the USN-1178-1 advisory.");
...
11.04. (CVE-2011-2514)");
  ...
  script_tag(name:"affected", value:"'icedtea-web, openjdk-6, openjdk-6b18' package(s) on Ubuntu 10.04, Ubuntu 10.10, Ubuntu 11.04.");
