...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-1109-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2011 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1109-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1109-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gimp' package(s) announced via the USN-1109-1 advisory.");
...
the user's privileges. (CVE-2010-4543)");
  ...
  script_tag(name:"affected", value:"'gimp' package(s) on Ubuntu 8.04, Ubuntu 9.10, Ubuntu 10.04, Ubuntu 10.10.");
