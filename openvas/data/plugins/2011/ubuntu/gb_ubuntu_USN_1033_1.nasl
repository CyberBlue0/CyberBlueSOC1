...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-1033-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2011 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1033-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1033-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'eucalyptus' package(s) announced via the USN-1033-1 advisory.");
...
environment.");
  ...
  script_tag(name:"affected", value:"'eucalyptus' package(s) on Ubuntu 10.10.");
