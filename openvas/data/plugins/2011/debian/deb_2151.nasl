...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2151");
  script_xref(name:"URL", value:"https://www.debian.org/security/2011/dsa-2151");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openoffice.org' package(s) announced via the DSA-2151 advisory.");
