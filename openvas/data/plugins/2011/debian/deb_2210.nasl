...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2210)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2011 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-2210");
  script_xref(name:"URL", value:"https://www.debian.org/security/2011/dsa-2210");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tiff' package(s) announced via the DSA-2210 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several vulnerabilities were discovered in the TIFF manipulation and conversion library:
...
We recommend that you upgrade your tiff packages.");
  ...
  script_tag(name:"affected", value:"'tiff' package(s) on Debian 5, Debian 6.");
