...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2126)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2011 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-2126");
  script_xref(name:"URL", value:"https://www.debian.org/security/2010/dsa-2126");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'linux-2.6' package(s) announced via the DSA-2126 advisory.");
