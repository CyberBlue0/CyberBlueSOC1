...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-03-08 07:07:37 +0000 (Tue, 08 Mar 2016)");
  ...
  script_name("Debian: Security Advisory (DSA-3495)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3495");
  script_xref(name:"URL", value:"https://www.debian.org/security/2016/dsa-3495");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'xymon' package(s) announced via the DSA-3495 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Markus Krell discovered that xymon, a network- and applications-monitoring system, was vulnerable to the following security issues:
