...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3450)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3450");
  script_xref(name:"URL", value:"https://www.debian.org/security/2016/dsa-3450");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ecryptfs-utils' package(s) announced via the DSA-3450 advisory.");
...
We recommend that you upgrade your ecryptfs-utils packages.");
  ...
  script_tag(name:"affected", value:"'ecryptfs-utils' package(s) on Debian 7, Debian 8.");
