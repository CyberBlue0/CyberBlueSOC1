...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-02-07 23:00:00 +0000 (Sun, 07 Feb 2016)");
  ...
  script_name("Debian: Security Advisory (DSA-3472)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3472");
  script_xref(name:"URL", value:"https://www.debian.org/security/2016/dsa-3472");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wordpress' package(s) announced via the DSA-3472 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Two vulnerabilities were discovered in wordpress, a web blogging tool. The Common Vulnerabilities and Exposures project identifies the following problems:
