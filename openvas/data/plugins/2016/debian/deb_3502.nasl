...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-04-20 17:24:00 +0000 (Wed, 20 Apr 2016)");

  script_name("Debian: Security Advisory (DSA-3502)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3502");
  script_xref(name:"URL", value:"https://www.debian.org/security/2016/dsa-3502");
  script_xref(name:"URL", value:"http://www.roundup-tracker.org/docs/upgrading.html#user-data-visibility");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'roundup' package(s) announced via the DSA-3502 advisory.");
