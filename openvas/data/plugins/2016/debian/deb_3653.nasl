...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3653)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3653");
  script_xref(name:"URL", value:"https://www.debian.org/security/2016/dsa-3653");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'flex' package(s) announced via the DSA-3653 advisory.");
