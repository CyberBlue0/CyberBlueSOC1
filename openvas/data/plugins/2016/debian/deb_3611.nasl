...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-07-07 11:22:12 +0000 (Thu, 07 Jul 2016)");
  ...
  script_name("Debian: Security Advisory (DSA-3611)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3611");
  script_xref(name:"URL", value:"https://www.debian.org/security/2016/dsa-3611");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libcommons-fileupload-java' package(s) announced via the DSA-3611 advisory.");
...
We recommend that you upgrade your libcommons-fileupload-java packages.");
  ...
  script_tag(name:"affected", value:"'libcommons-fileupload-java' package(s) on Debian 8.");
