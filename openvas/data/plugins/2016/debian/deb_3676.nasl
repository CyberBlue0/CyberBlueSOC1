...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-09-23 22:00:00 +0000 (Fri, 23 Sep 2016)");
  ...
  script_name("Debian: Security Advisory (DSA-3676)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3676");
  script_xref(name:"URL", value:"https://www.debian.org/security/2016/dsa-3676");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'unadf' package(s) announced via the DSA-3676 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Tuomas Rasanen discovered two vulnerabilities in unADF, a tool to extract files from an Amiga Disk File dump (.adf):
...
We recommend that you upgrade your unadf packages.");
  ...
  script_tag(name:"affected", value:"'unadf' package(s) on Debian 8.");
