...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.703574");
  script_cve_id("CVE-2016-1541");
  script_tag(name:"creation_date", value:"2016-05-09 22:00:00 +0000 (Mon, 09 May 2016)");
