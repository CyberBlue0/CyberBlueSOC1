...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3492)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3492");
  script_xref(name:"URL", value:"https://www.debian.org/security/2016/dsa-3492");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gajim' package(s) announced via the DSA-3492 advisory.");
...
We recommend that you upgrade your gajim packages.");
  ...
  script_tag(name:"affected", value:"'gajim' package(s) on Debian 7.");
