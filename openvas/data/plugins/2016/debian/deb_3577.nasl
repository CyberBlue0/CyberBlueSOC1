...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-05-19 21:21:00 +0000 (Thu, 19 May 2016)");

  script_name("Debian: Security Advisory (DSA-3577)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3577");
  script_xref(name:"URL", value:"https://www.debian.org/security/2016/dsa-3577");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'jansson' package(s) announced via the DSA-3577 advisory.");
