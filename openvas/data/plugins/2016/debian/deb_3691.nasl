...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-10-11 22:00:00 +0000 (Tue, 11 Oct 2016)");
  ...
  script_name("Debian: Security Advisory (DSA-3691)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3691");
  script_xref(name:"URL", value:"https://www.debian.org/security/2016/dsa-3691");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ghostscript' package(s) announced via the DSA-3691 advisory.");
