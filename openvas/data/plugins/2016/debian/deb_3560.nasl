...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.703560");
  script_cve_id("CVE-2015-8865", "CVE-2016-4070", "CVE-2016-4071", "CVE-2016-4072", "CVE-2016-4073");
  ...
  script_name("Debian: Security Advisory (DSA-3560)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3560");
  script_xref(name:"URL", value:"https://www.debian.org/security/2016/dsa-3560");
  script_xref(name:"URL", value:"https://php.net/ChangeLog-5.php#5.6.20");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'php5' package(s) announced via the DSA-3560 advisory.");
