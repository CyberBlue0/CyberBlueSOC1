...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.842805");
  ...
  script_tag(name:"creation_date", value:"2016-06-28 03:24:41 +0000 (Tue, 28 Jun 2016)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3018-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3018-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3018-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-lts-trusty' package(s) announced via the USN-3018-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-3018-1 fixed vulnerabilities in the Linux kernel for Ubuntu
