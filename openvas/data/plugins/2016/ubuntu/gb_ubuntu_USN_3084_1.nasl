...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.842885");
  script_cve_id("CVE-2016-5412", "CVE-2016-6136", "CVE-2016-6156");
  script_tag(name:"creation_date", value:"2016-09-20 03:41:31 +0000 (Tue, 20 Sep 2016)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3084-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3084-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3084-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux' package(s) announced via the USN-3084-1 advisory.");
