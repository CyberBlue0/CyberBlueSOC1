...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.842761");
  script_cve_id("CVE-2016-0758", "CVE-2016-3713");
  script_tag(name:"creation_date", value:"2016-05-17 14:25:20 +0000 (Tue, 17 May 2016)");
  ...
  script_name("Ubuntu: Security Advisory (USN-2979-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2979-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2979-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux' package(s) announced via the USN-2979-1 advisory.");
