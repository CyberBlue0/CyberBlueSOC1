...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-06-07 03:24:55 +0000 (Tue, 07 Jun 2016)");
  ...
  script_name("Ubuntu: Security Advisory (USN-2992-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2992-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2992-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'oxide-qt' package(s) announced via the USN-2992-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"An unspecified security issue was discovered in Blink. If a user were
...
opening a specially crafted website, an attacker could potentially exploit
this to cause a denial of service ... [Please see the references for more information on the vulnerabilities]");
