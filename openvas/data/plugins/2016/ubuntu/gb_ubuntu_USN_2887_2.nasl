...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-02-05 07:44:12 +0000 (Fri, 05 Feb 2016)");
  ...
  script_tag(name:"severity_date", value:"2021-12-10 20:04:00 +0000 (Fri, 10 Dec 2021)");

  script_name("Ubuntu: Security Advisory (USN-2887-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2887-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2887-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-lts-trusty' package(s) announced via the USN-2887-2 advisory.");
