...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.842945");
  script_cve_id("CVE-2016-7042", "CVE-2016-7117");
  script_tag(name:"creation_date", value:"2016-11-11 10:15:32 +0000 (Fri, 11 Nov 2016)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3126-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3126-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3126-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-meta' package(s) announced via the USN-3126-1 advisory.");
