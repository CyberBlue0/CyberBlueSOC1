...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-11-04 04:44:25 +0000 (Fri, 04 Nov 2016)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3123-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3123-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3123-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'curl' package(s) announced via the USN-3123-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that curl incorrectly reused client certificates when
...
Luat Nguyen discovered that curl incorrectly handled parsing globs. A
...
Luat Nguyen discovered that curl incorrectly handled converting dates. A
remote attacker could possibly use this issue to cause curl to crash,
...
Fernando Munoz discovered that curl incorrect parsed certain URLs. A remote
attacker could possibly use this issue to trick curl into connecting to a
different host. (CVE-2016-8624)");

  script_tag(name:"affected", value:"'curl' package(s) on Ubuntu 12.04, Ubuntu 14.04, Ubuntu 16.04, Ubuntu 16.10.");
