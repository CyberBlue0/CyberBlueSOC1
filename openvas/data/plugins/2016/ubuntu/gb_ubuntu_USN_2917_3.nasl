...
if(description)
{
  ...
  script_cve_id("CVE-2016-1950", "CVE-2016-1952", "CVE-2016-1953", "CVE-2016-1954", "CVE-2016-1955", "CVE-2016-1956", "CVE-2016-1957", "CVE-2016-1958", "CVE-2016-1959");
  script_tag(name:"creation_date", value:"2016-04-20 03:18:30 +0000 (Wed, 20 Apr 2016)");
  script_version("2024-01-19T05:06:17+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:17 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");

  script_name("Ubuntu: Security Advisory (USN-2917-3)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2917-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2917-3");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/1572169");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox' package(s) announced via the USN-2917-3 advisory.");
...
Original advisory details:
 ...
 tricked in to ... [Please see the references for more information on the vulnerabilities]");
