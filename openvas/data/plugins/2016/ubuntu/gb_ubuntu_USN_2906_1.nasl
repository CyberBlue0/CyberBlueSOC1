...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.842652");
  script_cve_id("CVE-2015-1197", "CVE-2016-2037");
  script_tag(name:"creation_date", value:"2016-02-23 05:25:53 +0000 (Tue, 23 Feb 2016)");
  ...
  script_name("Ubuntu: Security Advisory (USN-2906-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2906-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2906-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cpio' package(s) announced via the USN-2906-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Alexander Cherepanov discovered that GNU cpio incorrectly handled symbolic
...
possibly execute arbitrary code. (CVE-2016-2037)");
  ...
  script_tag(name:"affected", value:"'cpio' package(s) on Ubuntu 12.04, Ubuntu 14.04, Ubuntu 15.10.");
