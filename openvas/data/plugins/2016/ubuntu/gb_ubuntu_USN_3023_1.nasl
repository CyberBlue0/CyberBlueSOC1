...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.842838");
  script_cve_id("CVE-2016-1951", "CVE-2016-2818");
  script_tag(name:"creation_date", value:"2016-08-02 05:28:42 +0000 (Tue, 02 Aug 2016)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3023-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3023-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3023-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird' package(s) announced via the USN-3023-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that NSPR incorrectly handled memory allocation. If a
