...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-09-07 04:38:43 +0000 (Wed, 07 Sep 2016)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3070-4)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3070-4");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3070-4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-lts-xenial' package(s) announced via the USN-3070-4 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-3070-1 fixed vulnerabilities in the Linux kernel for Ubuntu
