...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.842676");
  script_cve_id("CVE-2016-2512", "CVE-2016-2513");
  script_tag(name:"creation_date", value:"2016-03-08 07:07:35 +0000 (Tue, 08 Mar 2016)");
  script_version("2024-01-19T05:06:17+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:17 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");

  script_name("Ubuntu: Security Advisory (USN-2915-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2915-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2915-2");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/1553251");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-django' package(s) announced via the USN-2915-2 advisory.");
