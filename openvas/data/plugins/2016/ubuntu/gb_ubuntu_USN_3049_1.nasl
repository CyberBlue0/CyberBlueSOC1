...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.842850");
  script_cve_id("CVE-2016-3134", "CVE-2016-3961", "CVE-2016-4470", "CVE-2016-5243");
  script_tag(name:"creation_date", value:"2016-08-11 03:37:15 +0000 (Thu, 11 Aug 2016)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3049-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3049-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3049-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux' package(s) announced via the USN-3049-1 advisory.");
