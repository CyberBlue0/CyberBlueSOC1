...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.842739");
  ...
  script_tag(name:"creation_date", value:"2016-05-10 03:21:10 +0000 (Tue, 10 May 2016)");
  ...
  script_name("Ubuntu: Security Advisory (USN-2970-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2970-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2970-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-lts-vivid' package(s) announced via the USN-2970-1 advisory.");
...
properly validate USB device descriptors. An attacker with physical ... [Please see the references for more information on the vulnerabilities]");
