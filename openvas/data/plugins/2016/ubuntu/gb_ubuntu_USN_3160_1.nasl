...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.843003");
  script_cve_id("CVE-2016-6213", "CVE-2016-7916");
  script_tag(name:"creation_date", value:"2016-12-21 04:45:48 +0000 (Wed, 21 Dec 2016)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3160-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3160-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3160-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-meta' package(s) announced via the USN-3160-1 advisory.");
