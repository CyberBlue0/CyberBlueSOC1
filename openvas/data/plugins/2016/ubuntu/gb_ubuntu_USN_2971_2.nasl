...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-05-10 03:20:35 +0000 (Tue, 10 May 2016)");
  ...
  script_name("Ubuntu: Security Advisory (USN-2971-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2971-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2971-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-lts-wily' package(s) announced via the USN-2971-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-2971-1 fixed vulnerabilities in the Linux kernel for Ubuntu 15.10.
...
It was discovered that the IPv4 ... [Please see the references for more information on the vulnerabilities]");
