...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-03-15 05:37:12 +0000 (Tue, 15 Mar 2016)");
  ...
  script_name("Ubuntu: Security Advisory (USN-2927-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2927-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2927-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'graphite2' package(s) announced via the USN-2927-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that graphite2 incorrectly handled certain malformed
