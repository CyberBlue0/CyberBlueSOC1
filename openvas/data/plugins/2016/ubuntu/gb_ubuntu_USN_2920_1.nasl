...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-03-11 05:01:59 +0000 (Fri, 11 Mar 2016)");
  ...
  script_name("Ubuntu: Security Advisory (USN-2920-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2920-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2920-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'oxide-qt' package(s) announced via the USN-2920-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that the ContainerNode::parserRemoveChild function in
...
opening a specially crafted website, an attacker could potentially ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'oxide-qt' package(s) on Ubuntu 14.04, Ubuntu 15.10.");
