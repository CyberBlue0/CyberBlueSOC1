...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-meta-ti-omap4, linux-ti-omap4' package(s) announced via the USN-3144-2 advisory.");
