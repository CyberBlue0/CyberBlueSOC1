...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.842697");
  script_cve_id("CVE-2013-7041", "CVE-2014-2583", "CVE-2015-3238");
  script_tag(name:"creation_date", value:"2016-03-17 04:11:13 +0000 (Thu, 17 Mar 2016)");
  ...
  script_name("Ubuntu: Security Advisory (USN-2935-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2935-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2935-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pam' package(s) announced via the USN-2935-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that the PAM pam_userdb module incorrectly used a
