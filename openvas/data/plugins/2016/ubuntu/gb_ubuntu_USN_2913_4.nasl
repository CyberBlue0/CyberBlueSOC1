...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-03-01 05:39:03 +0000 (Tue, 01 Mar 2016)");
  script_version("2024-01-19T05:06:17+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:17 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");

  script_name("Ubuntu: Security Advisory (USN-2913-4)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2913-4");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2913-4");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/1528645");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gnutls26' package(s) announced via the USN-2913-4 advisory.");
