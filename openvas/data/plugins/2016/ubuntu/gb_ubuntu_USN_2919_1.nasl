...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-03-08 07:07:57 +0000 (Tue, 08 Mar 2016)");
  ...
  script_name("Ubuntu: Security Advisory (USN-2919-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2919-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2919-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'jasper' package(s) announced via the USN-2919-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Jacob Baines discovered that JasPer incorrectly handled ICC color profiles
...
(CVE-2016-2116)");
  ...
  script_tag(name:"affected", value:"'jasper' package(s) on Ubuntu 12.04, Ubuntu 14.04, Ubuntu 15.10.");
