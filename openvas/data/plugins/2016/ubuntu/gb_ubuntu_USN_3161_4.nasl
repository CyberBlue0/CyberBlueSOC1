...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-12-21 04:45:01 +0000 (Wed, 21 Dec 2016)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3161-4)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3161-4");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3161-4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-meta-snapdragon, linux-snapdragon' package(s) announced via the USN-3161-4 advisory.");
...
gain administrative privileges. (CVE-2016-9644)");
  ...
  script_tag(name:"affected", value:"'linux-meta-snapdragon, linux-snapdragon' package(s) on Ubuntu 16.04.");
