...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.842871");
  script_cve_id("CVE-2016-5244", "CVE-2016-5696", "CVE-2016-5728", "CVE-2016-5828", "CVE-2016-5829");
  script_tag(name:"creation_date", value:"2016-08-30 03:43:23 +0000 (Tue, 30 Aug 2016)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3071-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2016 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3071-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3071-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux' package(s) announced via the USN-3071-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Kangjie Lu discovered an information leak in the Reliable Datagram Sockets
