...
if(description)
{
  ...
  script_name("Panda Small Business Protection  <= 16.1.2 Privilege Escalation Vulnerability");
  ...
  script_tag(name:"summary", value:"Panda Small Business Protection is prone to a privilege
  ...
  script_tag(name:"affected", value:"Panda Small Business Protection version 16.1.2 and prior.");

  script_tag(name:"solution", value:"Install the hotfix for this vulnerability from the referenced
  advisory.");
