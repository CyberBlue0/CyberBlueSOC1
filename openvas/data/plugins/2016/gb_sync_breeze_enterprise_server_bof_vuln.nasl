...
if(description)
{
  ...
  script_name("Sync Breeze Enterprise Server <= 8.9.24 Buffer Overflow Vulnerability - Active Check");

  script_tag(name:"summary", value:"Sync Breeze Enterprise Server is prone to a buffer overflow
  vulnerability.");
  ...
  script_tag(name:"affected", value:"Sync Breeze Enterprise version 8.9.24 and probably prior.");
