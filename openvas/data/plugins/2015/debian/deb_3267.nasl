...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3267)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2015 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3267");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/dsa-3267");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium-browser' package(s) announced via the DSA-3267 advisory.");
