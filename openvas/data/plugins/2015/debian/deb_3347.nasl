...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-01-17 21:28:00 +0000 (Fri, 17 Jan 2020)");

  script_name("Debian: Security Advisory (DSA-3347)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2015 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3347");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/dsa-3347");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'pdns' package(s) announced via the DSA-3347 advisory.");
