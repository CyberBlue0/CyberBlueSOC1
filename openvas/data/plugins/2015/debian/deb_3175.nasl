...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-02-28 16:22:00 +0000 (Fri, 28 Feb 2020)");

  script_name("Debian: Security Advisory (DSA-3175)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2015 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3175");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/dsa-3175");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'kfreebsd-9' package(s) announced via the DSA-3175 advisory.");
