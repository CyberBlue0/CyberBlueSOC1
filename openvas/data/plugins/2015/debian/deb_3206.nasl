...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3206)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2015 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3206");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/dsa-3206");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'dulwich' package(s) announced via the DSA-3206 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Multiple vulnerabilities have been discovered in Dulwich, a Python implementation of the file formats and protocols used by the Git version control system. The Common Vulnerabilities and Exposures project identifies the following problems:
...
We recommend that you upgrade your dulwich packages.");
  ...
  script_tag(name:"affected", value:"'dulwich' package(s) on Debian 7.");
