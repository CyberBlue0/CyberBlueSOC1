...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-08-05 14:31:00 +0000 (Fri, 05 Aug 2022)");

  script_name("Debian: Security Advisory (DSA-3412)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2015 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3412");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/dsa-3412");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'redis' package(s) announced via the DSA-3412 advisory.");
