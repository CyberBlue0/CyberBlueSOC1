...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.703299");
  script_cve_id("CVE-2015-3644");
  script_tag(name:"creation_date", value:"2015-07-01 22:00:00 +0000 (Wed, 01 Jul 2015)");
  script_version("2024-01-19T05:06:16+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:16 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"5.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:N");

  script_name("Debian: Security Advisory (DSA-3299)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2015 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3299");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/dsa-3299");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'stunnel4' package(s) announced via the DSA-3299 advisory.");
...
We recommend that you upgrade your stunnel4 packages.");
  ...
  script_tag(name:"affected", value:"'stunnel4' package(s) on Debian 8.");
