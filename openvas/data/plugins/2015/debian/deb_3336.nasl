...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-08-16 22:00:00 +0000 (Sun, 16 Aug 2015)");
  script_version("2024-01-19T05:06:16+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:16 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:N");

  script_name("Debian: Security Advisory (DSA-3336)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2015 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3336");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/dsa-3336");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'nss' package(s) announced via the DSA-3336 advisory.");
...
We recommend that you upgrade your nss packages.");
  ...
  script_tag(name:"affected", value:"'nss' package(s) on Debian 7, Debian 8.");
