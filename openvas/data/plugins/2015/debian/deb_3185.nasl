...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.703185");
  ...
  script_name("Debian: Security Advisory (DSA-3185)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2015 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3185");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/dsa-3185");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libgcrypt11' package(s) announced via the DSA-3185 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Multiple vulnerabilities were discovered in libgcrypt:
...
For the stable distribution (wheezy), these problems have been fixed in version 1.5.0-5+deb7u3.
