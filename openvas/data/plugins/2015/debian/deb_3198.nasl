...
if(description)
{
  ...
  script_cve_id("CVE-2015-2301", "CVE-2015-2331", "CVE-2015-2348", "CVE-2015-2787", "CVE-2015-3330");
  ...
  script_name("Debian: Security Advisory (DSA-3198)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2015 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3198");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/dsa-3198");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'php5' package(s) announced via the DSA-3198 advisory.");
