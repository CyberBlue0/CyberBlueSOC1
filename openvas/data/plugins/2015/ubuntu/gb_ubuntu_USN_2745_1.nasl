...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-09-25 05:19:18 +0000 (Fri, 25 Sep 2015)");
  ...
  script_name("Ubuntu: Security Advisory (USN-2745-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2015 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2745-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2745-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'qemu, qemu-kvm' package(s) announced via the USN-2745-1 advisory.");
...
process to crash, resulting in a denial of service. (CVE-2015-6855)");
  ...
  script_tag(name:"affected", value:"'qemu, qemu-kvm' package(s) on Ubuntu 12.04, Ubuntu 14.04, Ubuntu 15.04.");
