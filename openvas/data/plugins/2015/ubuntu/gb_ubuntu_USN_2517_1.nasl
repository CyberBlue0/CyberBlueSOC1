...
if(description)
{
  ...
  script_cve_id("CVE-2014-8133", "CVE-2014-8160", "CVE-2014-8559", "CVE-2014-8989", "CVE-2014-9419", "CVE-2014-9420", "CVE-2014-9428", "CVE-2014-9529", "CVE-2014-9584", "CVE-2014-9585", "CVE-2014-9683", "CVE-2014-9728", "CVE-2014-9729", "CVE-2014-9730", "CVE-2014-9731", "CVE-2015-0239");
  script_tag(name:"creation_date", value:"2015-02-27 04:43:29 +0000 (Fri, 27 Feb 2015)");
  ...
  script_name("Ubuntu: Security Advisory (USN-2517-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2015 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2517-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2517-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-lts-utopic' package(s) announced via the USN-2517-1 advisory.");
