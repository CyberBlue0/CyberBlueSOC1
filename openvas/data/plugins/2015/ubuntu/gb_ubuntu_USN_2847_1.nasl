...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.842578");
  script_cve_id("CVE-2015-8550", "CVE-2015-8551", "CVE-2015-8552", "CVE-2015-8709");
  script_tag(name:"creation_date", value:"2015-12-20 04:40:05 +0000 (Sun, 20 Dec 2015)");
  ...
  script_name("Ubuntu: Security Advisory (USN-2847-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2015 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2847-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2847-1");
  script_xref(name:"URL", value:"http://bugs.launchpad.net/bugs/1527374");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-lts-trusty' package(s) announced via the USN-2847-1 advisory.");
