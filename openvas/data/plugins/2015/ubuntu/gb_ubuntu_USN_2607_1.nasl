...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-06-09 09:05:18 +0000 (Tue, 09 Jun 2015)");
  ...
  script_name("Ubuntu: Security Advisory (USN-2607-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2015 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2607-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2607-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libmodule-signature-perl' package(s) announced via the USN-2607-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"John Lightsey discovered that Module::Signature incorrectly handled PGP
...
during signature verification. (CVE-2015-3409)");
  ...
  script_tag(name:"affected", value:"'libmodule-signature-perl' package(s) on Ubuntu 12.04, Ubuntu 14.04, Ubuntu 14.10, Ubuntu 15.04.");
