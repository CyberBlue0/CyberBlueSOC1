...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-12-08 09:56:12 +0000 (Tue, 08 Dec 2015)");
  script_version("2024-01-19T05:06:17+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:17 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"9.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:C/I:C/A:C");

  script_name("Ubuntu: Security Advisory (USN-2832-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2015 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2832-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2832-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libsndfile' package(s) announced via the USN-2832-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that libsndfile incorrectly handled memory when parsing
...
arbitrary code. (CVE-2015-7805)");
  ...
  script_tag(name:"affected", value:"'libsndfile' package(s) on Ubuntu 12.04, Ubuntu 14.04, Ubuntu 15.04, Ubuntu 15.10.");
