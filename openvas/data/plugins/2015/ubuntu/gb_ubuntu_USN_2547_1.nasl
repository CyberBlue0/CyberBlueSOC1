...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-03-25 05:32:27 +0000 (Wed, 25 Mar 2015)");
  ...
  script_name("Ubuntu: Security Advisory (USN-2547-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2015 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2547-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2547-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mono' package(s) announced via the USN-2547-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that the Mono TLS implementation was vulnerable to the
...
(CVE-2012-3543)");
  ...
  script_tag(name:"affected", value:"'mono' package(s) on Ubuntu 12.04, Ubuntu 14.04, Ubuntu 14.10.");
