...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.842456");
  ...
  script_tag(name:"creation_date", value:"2015-09-24 05:26:56 +0000 (Thu, 24 Sep 2015)");
  script_version("2024-01-19T05:06:17+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:17 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"9.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:C/I:C/A:C");

  script_name("Ubuntu: Security Advisory (USN-2743-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2015 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2743-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2743-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox' package(s) announced via the USN-2743-1 advisory.");
...
Jeff Walden ... [Please see the references for more information on the vulnerabilities]");
