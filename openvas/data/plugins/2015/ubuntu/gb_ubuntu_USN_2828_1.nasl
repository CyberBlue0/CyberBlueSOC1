...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-12-04 05:12:52 +0000 (Fri, 04 Dec 2015)");
  ...
  script_name("Ubuntu: Security Advisory (USN-2828-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2015 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2828-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2828-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'qemu, qemu-kvm' package(s) announced via the USN-2828-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Jason Wang discovered that QEMU incorrectly handled the virtio-net device.
...
to a denial of service. (CVE-2015-8345)");
  ...
  script_tag(name:"affected", value:"'qemu, qemu-kvm' package(s) on Ubuntu 12.04, Ubuntu 14.04, Ubuntu 15.04, Ubuntu 15.10.");
