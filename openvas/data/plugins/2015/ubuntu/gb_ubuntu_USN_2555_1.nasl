...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-04-02 05:13:49 +0000 (Thu, 02 Apr 2015)");
  ...
  script_name("Ubuntu: Security Advisory (USN-2555-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2015 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2555-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2555-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libgcrypt11, libgcrypt20' package(s) announced via the USN-2555-1 advisory.");
...
use this attack to possibly recover private keys. (CVE-2015-0837)");
  ...
  script_tag(name:"affected", value:"'libgcrypt11, libgcrypt20' package(s) on Ubuntu 10.04, Ubuntu 12.04, Ubuntu 14.04, Ubuntu 14.10.");
