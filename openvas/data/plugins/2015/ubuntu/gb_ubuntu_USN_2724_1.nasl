...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"USN-2724-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2724-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'qemu, qemu-kvm' package(s) announced via the USN-2724-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that QEMU incorrectly handled a PRDT with zero complete
