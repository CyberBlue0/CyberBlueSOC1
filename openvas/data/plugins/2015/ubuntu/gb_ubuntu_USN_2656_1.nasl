...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-07-10 04:09:51 +0000 (Fri, 10 Jul 2015)");
  ...
  script_name("Ubuntu: Security Advisory (USN-2656-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2015 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2656-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2656-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox' package(s) announced via the USN-2656-1 advisory.");
...
crash, or execute arbitrary code with the privileges of the user ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'firefox' package(s) on Ubuntu 14.04, Ubuntu 14.10, Ubuntu 15.04.");
