...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-03-05 04:43:34 +0000 (Thu, 05 Mar 2015)");
  script_version("2024-01-19T05:06:17+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:17 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");

  script_name("Ubuntu: Security Advisory (USN-2516-3)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2015 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2516-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2516-3");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/1427292");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux' package(s) announced via the USN-2516-3 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-2516-1 fixed vulnerabilities in the Linux kernel, and the fix in
...
the Virtual ... [Please see the references for more information on the vulnerabilities]");
