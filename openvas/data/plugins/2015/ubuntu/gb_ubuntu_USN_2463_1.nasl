...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-01-23 11:58:06 +0000 (Fri, 23 Jan 2015)");
  ...
  script_name("Ubuntu: Security Advisory (USN-2463-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2015 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2463-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2463-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux' package(s) announced via the USN-2463-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"A race condition with MMIO and PIO transactions in the KVM (Kernel Virtual
