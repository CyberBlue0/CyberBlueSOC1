...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.842565");
  script_cve_id("CVE-2015-7799", "CVE-2015-7884", "CVE-2015-7885", "CVE-2015-8104");
  script_tag(name:"creation_date", value:"2015-12-18 04:44:22 +0000 (Fri, 18 Dec 2015)");
  ...
  script_name("Ubuntu: Security Advisory (USN-2842-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2015 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2842-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2842-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux' package(s) announced via the USN-2842-1 advisory.");
