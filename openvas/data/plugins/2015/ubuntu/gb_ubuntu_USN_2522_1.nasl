...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-03-06 05:51:21 +0000 (Fri, 06 Mar 2015)");
  ...
  script_name("Ubuntu: Security Advisory (USN-2522-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2015 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2522-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2522-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'icu' package(s) announced via the USN-2522-1 advisory.");
...
the privileges of the user invoking the program. (CVE-2014-7940)");
  ...
  script_tag(name:"affected", value:"'icu' package(s) on Ubuntu 12.04, Ubuntu 14.04, Ubuntu 14.10.");
