...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-01-27 04:50:43 +0000 (Tue, 27 Jan 2015)");
  script_version("2024-01-19T05:06:17+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:17 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");

  script_name("Ubuntu: Security Advisory (USN-2483-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2015 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2483-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2483-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'jasper' package(s) announced via the USN-2483-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Jose Duart discovered that JasPer incorrectly handled ICC color profiles in
...
or possibly execute arbitrary code with user privileges. (CVE-2014-8158)");
  ...
  script_tag(name:"affected", value:"'jasper' package(s) on Ubuntu 12.04, Ubuntu 14.04, Ubuntu 14.10.");
