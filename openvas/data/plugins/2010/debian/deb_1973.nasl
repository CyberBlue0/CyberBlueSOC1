...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1973");
  script_xref(name:"URL", value:"https://www.debian.org/security/2010/dsa-1973");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'glibc' package(s) announced via the DSA-1973 advisory.");
