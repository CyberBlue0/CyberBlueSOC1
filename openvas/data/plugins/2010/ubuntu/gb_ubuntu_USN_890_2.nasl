...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.840376");
  ...
  script_name("Ubuntu: Security Advisory (USN-890-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2010 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-890-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-890-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python2.5' package(s) announced via the USN-890-2 advisory.");
...
Original advisory details:
 ...
 application crash. (CVE-2009-3560)");
  ...
  script_tag(name:"affected", value:"'python2.5' package(s) on Ubuntu 8.04, Ubuntu 8.10, Ubuntu 9.04, Ubuntu 9.10.");
