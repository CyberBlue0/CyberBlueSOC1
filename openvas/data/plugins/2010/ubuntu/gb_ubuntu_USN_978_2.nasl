...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.840503");
  ...
  script_name("Ubuntu: Security Advisory (USN-978-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2010 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-978-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-978-2");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/640839");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird' package(s) announced via the USN-978-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-978-1 fixed vulnerabilities in Thunderbird. Some users reported
