...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-890-4)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2010 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-890-4");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-890-4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-xml' package(s) announced via the USN-890-4 advisory.");
...
Original advisory details:
 ...
 application crash. (CVE-2009-3560)");
  ...
  script_tag(name:"affected", value:"'python-xml' package(s) on Ubuntu 6.06.");
