...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.840548");
  ...
  script_name("Ubuntu: Security Advisory (USN-1027-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2010 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1027-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1027-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'quagga' package(s) announced via the USN-1027-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Quagga incorrectly handled certain Outbound Route
...
denial of service. (CVE-2010-2949)");
  ...
  script_tag(name:"affected", value:"'quagga' package(s) on Ubuntu 6.06, Ubuntu 8.04, Ubuntu 9.10, Ubuntu 10.04.");
