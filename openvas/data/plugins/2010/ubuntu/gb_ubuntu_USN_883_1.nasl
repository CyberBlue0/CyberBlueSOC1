...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-883-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2010 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-883-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-883-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'network-manager-applet' package(s) announced via the USN-883-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that NetworkManager did not ensure that the Certification
...
users' network connection passwords and pre-shared keys. (CVE-2009-4145)");
  ...
  script_tag(name:"affected", value:"'network-manager-applet' package(s) on Ubuntu 8.10, Ubuntu 9.04.");
