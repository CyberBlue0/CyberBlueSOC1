...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-902-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2010 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-902-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-902-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pidgin' package(s) announced via the USN-902-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Fabian Yamaguchi discovered that Pidgin incorrectly validated all fields of
