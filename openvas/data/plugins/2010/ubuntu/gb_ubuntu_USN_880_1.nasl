...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-880-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2010 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-880-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-880-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gimp' package(s) announced via the USN-880-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Stefan Cornelius discovered that GIMP did not correctly handle certain
...
(CVE-2009-3909)");
  ...
  script_tag(name:"affected", value:"'gimp' package(s) on Ubuntu 8.04, Ubuntu 8.10, Ubuntu 9.04, Ubuntu 9.10.");
