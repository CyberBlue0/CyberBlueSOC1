...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.840394");
  ...
  script_name("Ubuntu: Security Advisory (USN-903-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2010 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-903-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-903-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openoffice.org' package(s) announced via the USN-903-1 advisory.");
...
bypassing security controls. (CVE-2010-0136)");
  ...
  script_tag(name:"affected", value:"'openoffice.org' package(s) on Ubuntu 8.04, Ubuntu 8.10, Ubuntu 9.04, Ubuntu 9.10.");
