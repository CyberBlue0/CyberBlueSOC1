...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-907-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2010 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-907-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-907-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gnome-screensaver' package(s) announced via the USN-907-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that gnome-screensaver did not correctly lock all screens
...
Ubuntu 9.10. (CVE-2010-0422)");
  ...
  script_tag(name:"affected", value:"'gnome-screensaver' package(s) on Ubuntu 8.10, Ubuntu 9.04, Ubuntu 9.10.");
