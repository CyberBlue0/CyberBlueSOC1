...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.840464");
  ...
  script_name("Ubuntu: Security Advisory (USN-930-4)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2010 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-930-4");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-930-4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox-3.0, firefox-3.5' package(s) announced via the USN-930-4 advisory.");
...
Soroush Dalili discovered that Firefox did not properly ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'firefox-3.0, firefox-3.5' package(s) on Ubuntu 9.04, Ubuntu 9.10.");
