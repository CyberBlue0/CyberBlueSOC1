...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-877-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2010 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-877-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-877-1");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/504516");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox-3.0, xulrunner-1.9' package(s) announced via the USN-877-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-873-1 fixed vulnerabilities in Firefox and Xulrunner. The upstream
