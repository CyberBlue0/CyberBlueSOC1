...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.840419");
  ...
  script_name("Ubuntu: Security Advisory (USN-927-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2010 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-927-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-927-2");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/559881");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nss' package(s) announced via the USN-927-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-927-1 fixed vulnerabilities in NSS. Upstream NSS 3.12.6 added an
