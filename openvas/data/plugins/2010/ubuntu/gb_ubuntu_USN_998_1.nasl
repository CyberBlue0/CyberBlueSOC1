...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.840516");
  ...
  script_name("Ubuntu: Security Advisory (USN-998-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2010 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-998-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-998-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird' package(s) announced via the USN-998-1 advisory.");
...
(CVE-2010-3182)");
  ...
  script_tag(name:"affected", value:"'thunderbird' package(s) on Ubuntu 10.04, Ubuntu 10.10.");
