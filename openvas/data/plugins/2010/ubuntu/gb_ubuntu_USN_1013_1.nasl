...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-1013-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2010 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1013-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1013-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'freetype' package(s) announced via the USN-1013-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Marc Schoenefeld discovered that FreeType did not correctly handle certain
...
execute arbitrary code with user privileges. (CVE-2010-3855)");
  ...
  script_tag(name:"affected", value:"'freetype' package(s) on Ubuntu 6.06, Ubuntu 8.04, Ubuntu 9.10, Ubuntu 10.04, Ubuntu 10.10.");
