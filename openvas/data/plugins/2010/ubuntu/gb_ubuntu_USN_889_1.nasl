...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.840374");
  ...
  script_name("Ubuntu: Security Advisory (USN-889-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2010 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-889-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-889-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gzip' package(s) announced via the USN-889-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that gzip incorrectly handled certain malformed
...
with the privileges of the user invoking the program. (CVE-2010-0001)");
  ...
  script_tag(name:"affected", value:"'gzip' package(s) on Ubuntu 6.06, Ubuntu 8.04, Ubuntu 8.10, Ubuntu 9.04, Ubuntu 9.10.");
