...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-992-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2010 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-992-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-992-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'avahi' package(s) announced via the USN-992-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Avahi incorrectly handled certain mDNS query packets
...
cause Avahi to crash, resulting in a denial of service. (CVE-2010-2244)");
  ...
  script_tag(name:"affected", value:"'avahi' package(s) on Ubuntu 8.04, Ubuntu 9.04, Ubuntu 9.10, Ubuntu 10.04.");
