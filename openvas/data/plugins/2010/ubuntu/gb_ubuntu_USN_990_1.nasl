...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-990-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2010 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-990-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-990-1");
  script_xref(name:"URL", value:"http://www.openssl.org/docs/ssl/SSL_CTX_set_options.html#SECURE_RENEGOTIATION");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openssl' package(s) announced via the USN-990-1 advisory.");
...
[link moved to references]");
  ...
  script_tag(name:"affected", value:"'openssl' package(s) on Ubuntu 6.06, Ubuntu 8.04, Ubuntu 9.04, Ubuntu 9.10, Ubuntu 10.04.");
