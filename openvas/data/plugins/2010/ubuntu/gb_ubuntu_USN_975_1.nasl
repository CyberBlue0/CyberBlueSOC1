...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.840495");
  ...
  script_name("Ubuntu: Security Advisory (USN-975-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2010 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-975-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-975-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox, firefox-3.0, firefox-3.5, xulrunner-1.9.1, xulrunner-1.9.2' package(s) announced via the USN-975-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several dangling pointer vulnerabilities were discovered in Firefox. An
