...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-1031-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2010 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1031-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1031-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'clamav' package(s) announced via the USN-1031-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Arkadiusz Miskiewicz and others discovered that the PDF processing
...
clamav AppArmor profile.");
  ...
  script_tag(name:"affected", value:"'clamav' package(s) on Ubuntu 10.04, Ubuntu 10.10.");
