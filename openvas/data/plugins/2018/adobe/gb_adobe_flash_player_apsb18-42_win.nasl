...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.814367");
  ...
  script_tag(name:"severity_date", value:"2025-01-23 17:53:30 +0000 (Thu, 23 Jan 2025)");
  script_tag(name:"creation_date", value:"2018-12-06 12:24:14 +0530 (Thu, 06 Dec 2018)");
  script_name("Adobe Flash Player Security Updates (APSB18-42) - Windows");
  ...
  and escalate privileges on the vulnerable system.");

  script_tag(name:"affected", value:"Adobe Flash Player version before
  32.0.0.101 on Windows.");
