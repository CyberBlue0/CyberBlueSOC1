...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.814371");
  ...
  script_tag(name:"creation_date", value:"2018-12-06 12:26:42 +0530 (Thu, 06 Dec 2018)");
  script_name("Adobe Flash Player Within Google Chrome Security Update (APSB18-42) - Linux");
