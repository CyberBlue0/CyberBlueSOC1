...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-10-27 04:24:24 +0000 (Sat, 27 Oct 2018)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3802-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3802-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3802-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xorg-server, xorg-server-hwe-16.04' package(s) announced via the USN-3802-1 advisory.");
...
privileges.");
  ...
  script_tag(name:"affected", value:"'xorg-server, xorg-server-hwe-16.04' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 18.10.");
