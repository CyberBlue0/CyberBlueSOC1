...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-06-09 03:48:51 +0000 (Sat, 09 Jun 2018)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3673-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3673-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3673-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'unbound' package(s) announced via the USN-3673-1 advisory.");
...
Unbound into accepting a NODATA proof.");
  ...
  script_tag(name:"affected", value:"'unbound' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 17.10, Ubuntu 18.04.");
