...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-11-08 05:01:37 +0000 (Thu, 08 Nov 2018)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3812-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3812-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3812-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nginx' package(s) announced via the USN-3812-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that nginx incorrectly handled the HTTP/2 implementation.
...
arbitrary memory. (CVE-2018-16845)");
  ...
  script_tag(name:"affected", value:"'nginx' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 18.04, Ubuntu 18.10.");
