...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-04-25 06:38:09 +0000 (Wed, 25 Apr 2018)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3631-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3631-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3631-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-aws, linux-kvm, linux-meta, linux-meta-aws, linux-meta-kvm, linux-meta-raspi2, linux-meta-snapdragon, linux-raspi2, linux-snapdragon' package(s) announced via the USN-3631-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that a buffer overread vulnerability existed in the
