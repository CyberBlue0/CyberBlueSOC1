...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-10-26 04:09:09 +0000 (Fri, 26 Oct 2018)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3795-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3795-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3795-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libssh' package(s) announced via the USN-3795-2 advisory.");
...
Original advisory details:
 ...
 this issue to bypass authentication without any credentials.");
  ...
  script_tag(name:"affected", value:"'libssh' package(s) on Ubuntu 18.10.");
