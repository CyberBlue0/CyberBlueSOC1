...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-10-26 04:15:47 +0000 (Fri, 26 Oct 2018)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3543-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3543-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3543-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rsync' package(s) announced via the USN-3543-1 advisory.");
...
(CVE-2018-5764)");
  ...
  script_tag(name:"affected", value:"'rsync' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 17.10.");
