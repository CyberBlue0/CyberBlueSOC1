...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-07-13 03:49:11 +0000 (Fri, 13 Jul 2018)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3714-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3714-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3714-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird' package(s) announced via the USN-3714-1 advisory.");
...
exploit this to obtain sensitive information. (CVE-2018-12374)");
  ...
  script_tag(name:"affected", value:"'thunderbird' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 17.10, Ubuntu 18.04.");
