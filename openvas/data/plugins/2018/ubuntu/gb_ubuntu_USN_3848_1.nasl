...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-12-21 06:23:59 +0000 (Fri, 21 Dec 2018)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3848-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3848-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3848-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-aws, linux-kvm, linux-meta, linux-meta-aws, linux-meta-kvm, linux-meta-raspi2, linux-meta-snapdragon, linux-raspi2, linux-snapdragon' package(s) announced via the USN-3848-1 advisory.");
