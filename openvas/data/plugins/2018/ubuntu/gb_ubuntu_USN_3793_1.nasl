...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-10-16 04:20:47 +0000 (Tue, 16 Oct 2018)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3793-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3793-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3793-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird' package(s) announced via the USN-3793-1 advisory.");
...
(CVE-2018-12385)");
  ...
  script_tag(name:"affected", value:"'thunderbird' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 18.04.");
