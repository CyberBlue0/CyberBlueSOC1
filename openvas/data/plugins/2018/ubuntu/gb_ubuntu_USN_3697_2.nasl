...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-meta-oem, linux-oem' package(s) announced via the USN-3697-2 advisory.");
...
service (memory exhaustion). (CVE-2018-7757)");
  ...
  script_tag(name:"affected", value:"'linux-meta-oem, linux-oem' package(s) on Ubuntu 16.04.");
