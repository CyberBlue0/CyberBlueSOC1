...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-12-04 06:53:44 +0000 (Tue, 04 Dec 2018)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3836-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3836-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3836-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-gcp, linux-kvm, linux-meta, linux-meta-gcp, linux-meta-kvm, linux-meta-raspi2, linux-raspi2' package(s) announced via the USN-3836-1 advisory.");
...
expose sensitive information (protected file names). (CVE-2018-6559)");
  ...
  script_tag(name:"affected", value:"'linux, linux-gcp, linux-kvm, linux-meta, linux-meta-gcp, linux-meta-kvm, linux-meta-raspi2, linux-raspi2' package(s) on Ubuntu 18.04.");
