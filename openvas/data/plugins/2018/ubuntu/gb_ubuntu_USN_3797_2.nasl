...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-10-23 09:56:58 +0000 (Tue, 23 Oct 2018)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3797-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3797-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3797-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws, linux-lts-xenial, linux-meta-aws, linux-meta-lts-xenial' package(s) announced via the USN-3797-2 advisory.");
