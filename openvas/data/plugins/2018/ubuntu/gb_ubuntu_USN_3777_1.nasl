...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-10-02 06:12:15 +0000 (Tue, 02 Oct 2018)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3777-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3777-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3777-1");
  script_xref(name:"URL", value:"https://wiki.ubuntu.com/SecurityTeam/KnowledgeBase/Variant4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-aws, linux-gcp, linux-kvm, linux-meta, linux-meta-aws, linux-meta-gcp, linux-meta-kvm, linux-meta-oem, linux-meta-raspi2, linux-oem, linux-raspi2' package(s) announced via the USN-3777-1 advisory.");
...
may be required.");
  ...
  script_tag(name:"affected", value:"'linux, linux-aws, linux-gcp, linux-kvm, linux-meta, linux-meta-aws, linux-meta-gcp, linux-meta-kvm, linux-meta-oem, linux-meta-raspi2, linux-oem, linux-raspi2' package(s) on Ubuntu 18.04.");
