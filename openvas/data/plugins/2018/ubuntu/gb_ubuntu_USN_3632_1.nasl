...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure, linux-meta-azure' package(s) announced via the USN-3632-1 advisory.");
