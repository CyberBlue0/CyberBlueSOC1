...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-11-09 05:05:26 +0000 (Fri, 09 Nov 2018)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3813-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3813-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3813-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pyopenssl' package(s) announced via the USN-3813-1 advisory.");
...
service. (CVE-2018-1000808)");
  ...
  script_tag(name:"affected", value:"'pyopenssl' package(s) on Ubuntu 16.04.");
