...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-10-23 09:50:44 +0000 (Tue, 23 Oct 2018)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3777-3)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3777-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3777-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure, linux-meta-azure, linux-signed-azure' package(s) announced via the USN-3777-3 advisory.");
...
code. (CVE-2018-6555)");
  ...
  script_tag(name:"affected", value:"'linux-azure, linux-meta-azure, linux-signed-azure' package(s) on Ubuntu 16.04, Ubuntu 18.04.");
