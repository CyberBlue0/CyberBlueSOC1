...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-10-04 06:32:19 +0000 (Thu, 04 Oct 2018)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3783-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3783-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3783-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apache2' package(s) announced via the USN-3783-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Robert Swiecki discovered that the Apache HTTP Server HTTP/2 module
