...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-07-03 03:47:21 +0000 (Tue, 03 Jul 2018)");
  ...
  script_tag(name:"severity_date", value:"2019-03-27 16:17:00 +0000 (Wed, 27 Mar 2019)");

  script_name("Ubuntu: Security Advisory (USN-3697-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3697-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3697-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-meta, linux-meta-raspi2, linux-raspi2' package(s) announced via the USN-3697-1 advisory.");
