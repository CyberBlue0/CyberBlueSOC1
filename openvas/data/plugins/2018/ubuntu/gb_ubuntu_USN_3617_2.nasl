...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-04-04 06:30:51 +0000 (Wed, 04 Apr 2018)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3617-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3617-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3617-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-gcp, linux-hwe, linux-meta-gcp, linux-meta-hwe, linux-meta-oem, linux-oem' package(s) announced via the USN-3617-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-3617-1 fixed vulnerabilities in the Linux kernel for Ubuntu 17.10.
...
properly restrict access to the connection ... [Please see the references for more information on the vulnerabilities]");
