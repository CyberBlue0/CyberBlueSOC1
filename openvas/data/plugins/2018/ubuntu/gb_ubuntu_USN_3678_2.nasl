...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-06-12 03:55:28 +0000 (Tue, 12 Jun 2018)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3678-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3678-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3678-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure, linux-meta-azure' package(s) announced via the USN-3678-2 advisory.");
...
(CVE-2018-10021)");
  ...
  script_tag(name:"affected", value:"'linux-azure, linux-meta-azure' package(s) on Ubuntu 16.04.");
