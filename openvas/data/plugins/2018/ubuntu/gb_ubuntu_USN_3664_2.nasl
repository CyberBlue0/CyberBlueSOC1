...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-06-05 10:56:02 +0000 (Tue, 05 Jun 2018)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3664-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3664-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3664-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apport' package(s) announced via the USN-3664-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-3664-1 fixed a vulnerability in Apport. Sander Bos reported that Ubuntu
