...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws, linux-meta-aws' package(s) announced via the USN-3832-1 advisory.");
...
expose sensitive information (protected file names). (CVE-2018-6559)");
  ...
  script_tag(name:"affected", value:"'linux-aws, linux-meta-aws' package(s) on Ubuntu 18.10.");
