...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-gcp, linux-kvm, linux-meta, linux-meta-gcp, linux-meta-kvm, linux-meta-raspi2, linux-raspi2' package(s) announced via the USN-3835-1 advisory.");
...
expose sensitive information (protected file names). (CVE-2018-6559)");
  ...
  script_tag(name:"affected", value:"'linux, linux-gcp, linux-kvm, linux-meta, linux-meta-gcp, linux-meta-kvm, linux-meta-raspi2, linux-raspi2' package(s) on Ubuntu 18.10.");
