...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.843428");
  script_cve_id("CVE-2017-5715", "CVE-2017-5753");
  script_tag(name:"creation_date", value:"2018-01-23 06:38:26 +0000 (Tue, 23 Jan 2018)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3542-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3542-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3542-1");
  script_xref(name:"URL", value:"https://wiki.ubuntu.com/SecurityTeam/KnowledgeBase/SpectreAndMeltdown");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-meta' package(s) announced via the USN-3542-1 advisory.");
