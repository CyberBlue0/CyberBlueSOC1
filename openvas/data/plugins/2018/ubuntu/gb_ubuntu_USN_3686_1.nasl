...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-06-15 03:47:38 +0000 (Fri, 15 Jun 2018)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3686-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3686-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3686-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'file' package(s) announced via the USN-3686-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Alexander Cherepanov discovered that file incorrectly handled a large
...
(CVE-2018-10360)");
  ...
  script_tag(name:"affected", value:"'file' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 17.10, Ubuntu 18.04.");
