...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws-hwe, linux-azure, linux-gcp, linux-hwe, linux-meta-aws-hwe, linux-meta-azure, linux-meta-gcp, linux-meta-hwe' package(s) announced via the USN-3847-2 advisory.");
...
sensitive information (kernel memory). (CVE-2018-18710)");
  ...
  script_tag(name:"affected", value:"'linux-aws-hwe, linux-azure, linux-gcp, linux-hwe, linux-meta-aws-hwe, linux-meta-azure, linux-meta-gcp, linux-meta-hwe' package(s) on Ubuntu 16.04.");
