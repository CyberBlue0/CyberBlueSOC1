...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-aws, linux-euclid, linux-meta, linux-meta-aws, linux-meta-euclid' package(s) announced via the USN-3540-1 advisory.");
...
advisory details:
 ...
 kernel memory. (CVE-2017-5754)");
  ...
  script_tag(name:"affected", value:"'linux, linux-aws, linux-euclid, linux-meta, linux-meta-aws, linux-meta-euclid' package(s) on Ubuntu 16.04.");
