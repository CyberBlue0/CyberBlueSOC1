...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-11-01 05:05:25 +0000 (Thu, 01 Nov 2018)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3805-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3805-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3805-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'curl' package(s) announced via the USN-3805-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Harry Sintonen discovered that curl incorrectly handled SASL
