...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-07-12 03:57:31 +0000 (Thu, 12 Jul 2018)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3713-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3713-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3713-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cups' package(s) announced via the USN-3713-1 advisory.");
...
confinement. (CVE-2018-6553)");
  ...
  script_tag(name:"affected", value:"'cups' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 17.10, Ubuntu 18.04.");
