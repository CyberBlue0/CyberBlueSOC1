...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-08-28 05:19:45 +0000 (Tue, 28 Aug 2018)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3756-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3756-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3756-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'intel-microcode' package(s) announced via the USN-3756-1 advisory.");
...
sensitive information. (CVE-2018-3640)");
  ...
  script_tag(name:"affected", value:"'intel-microcode' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 18.04.");
