...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure, linux-hwe, linux-meta-azure, linux-meta-hwe' package(s) announced via the USN-3695-2 advisory.");
...
expose sensitive information (kernel memory). (CVE-2018-7755)");
  ...
  script_tag(name:"affected", value:"'linux-azure, linux-hwe, linux-meta-azure, linux-meta-hwe' package(s) on Ubuntu 16.04.");
