...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-08-15 04:20:00 +0000 (Wed, 15 Aug 2018)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3742-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3742-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3742-1");
  script_xref(name:"URL", value:"https://wiki.ubuntu.com/SecurityTeam/KnowledgeBase/L1TF");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-meta' package(s) announced via the USN-3742-1 advisory.");
