...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-06-22 03:50:51 +0000 (Fri, 22 Jun 2018)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3691-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3691-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3691-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openjdk-7' package(s) announced via the USN-3691-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that the Security component of OpenJDK did not correctly
