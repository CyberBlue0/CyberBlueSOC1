...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-10-26 04:11:22 +0000 (Fri, 26 Oct 2018)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3786-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3786-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3786-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libxkbcommon' package(s) announced via the USN-3786-1 advisory.");
...
CVE-2018-15862, CVE-2018-15863, CVE-2018-15864)");
  ...
  script_tag(name:"affected", value:"'libxkbcommon' package(s) on Ubuntu 14.04, Ubuntu 16.04.");
