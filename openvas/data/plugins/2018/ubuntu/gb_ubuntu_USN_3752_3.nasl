...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure, linux-gcp, linux-meta-azure, linux-meta-gcp, linux-meta-oem, linux-oem' package(s) announced via the USN-3752-3 advisory.");
...
A local attacker could use ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-azure, linux-gcp, linux-meta-azure, linux-meta-gcp, linux-meta-oem, linux-oem' package(s) on Ubuntu 16.04, Ubuntu 18.04.");
