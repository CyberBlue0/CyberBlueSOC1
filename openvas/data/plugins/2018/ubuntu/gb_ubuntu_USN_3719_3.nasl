...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-09-28 06:19:24 +0000 (Fri, 28 Sep 2018)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3719-3)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3719-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3719-3");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/1794278");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mutt' package(s) announced via the USN-3719-3 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-3719-1 fixed vulnerabilities in Mutt. Unfortunately, the fixes were
...
Original advisory details:
 ...
 CVE-2018-14362, CVE-2018-14349)");
  ...
  script_tag(name:"affected", value:"'mutt' package(s) on Ubuntu 16.04.");
