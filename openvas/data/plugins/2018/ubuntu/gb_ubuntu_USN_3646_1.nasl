...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-05-15 03:38:29 +0000 (Tue, 15 May 2018)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3646-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3646-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3646-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php5, php7.0, php7.1, php7.2' package(s) announced via the USN-3646-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that PHP incorrectly handled opcache access controls
...
16.04 LTS, Ubuntu 17.10, and Ubuntu 18.04 LTS. (CVE-2018-10549)");
  ...
  script_tag(name:"affected", value:"'php5, php7.0, php7.1, php7.2' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 17.10, Ubuntu 18.04.");
