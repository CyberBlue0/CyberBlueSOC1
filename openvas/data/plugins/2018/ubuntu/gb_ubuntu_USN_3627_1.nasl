...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-04-20 07:13:25 +0000 (Fri, 20 Apr 2018)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3627-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3627-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3627-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apache2' package(s) announced via the USN-3627-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Alex Nichols and Jakob Hirsch discovered that the Apache HTTP Server
...
across a cluster of servers. (CVE-2018-1312)");
  ...
  script_tag(name:"affected", value:"'apache2' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 17.10.");
