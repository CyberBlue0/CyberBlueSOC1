...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-1059)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-1059");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/dla-1059");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'strongswan' package(s) announced via the DLA-1059 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that there was a denial-of-service vulnerability in the Strongswan Virtual Private Network (VPN) software.
