...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4090)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4090");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/dsa-4090");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/wordpress");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wordpress' package(s) announced via the DSA-4090 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several vulnerabilities were discovered in Wordpress, a web blogging tool. They allowed remote attackers to perform SQL injections (SQLi) and various cross-site scripting (XSS) and server-side request forgery (SSRF) attacks, as well as bypass some access restrictions.
