...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4127)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4127");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/dsa-4127");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/simplesamlphp");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'simplesamlphp' package(s) announced via the DSA-4127 advisory.");
