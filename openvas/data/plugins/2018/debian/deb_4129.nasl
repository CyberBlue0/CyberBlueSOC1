...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4129)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4129");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/dsa-4129");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/freexl");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'freexl' package(s) announced via the DSA-4129 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Multiple heap buffer over reads were discovered in freexl, a library to read Microsoft Excel spreadsheets, which could result in denial of service.
...
For the detailed security status of freexl please refer to its security tracker page at: [link moved to references]");
