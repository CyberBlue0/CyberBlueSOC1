...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-874)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-874");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/dla-874");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'jbig2dec' package(s) announced via the DLA-874 advisory.");
...
For Debian 7 Wheezy, these problems have been fixed in version 0.13-4~deb7u1.

For the stable distribution (jessie), this problem has been fixed in version 0.13-4~deb8u1.

For the upcoming stable distribution (stretch) and for the unstable distribution (sid), this problem has been fixed in version 0.13-4.

We recommend that you upgrade your jbig2dec packages.

Further information about Debian LTS security advisories, how to apply these updates to your system and frequently asked questions can be found at: [link moved to references]");

  script_tag(name:"affected", value:"'jbig2dec' package(s) on Debian 7.");
