...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-11-28 23:00:00 +0000 (Wed, 28 Nov 2018)");
  ...
  script_name("Debian: Security Advisory (DSA-4347)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4347");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/dsa-4347");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/perl");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'perl' package(s) announced via the DSA-4347 advisory.");
...
For the detailed security status of perl please refer to its security tracker page at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'perl' package(s) on Debian 9.");
