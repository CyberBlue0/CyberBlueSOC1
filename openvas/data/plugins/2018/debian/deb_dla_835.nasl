...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.890835");
  ...
  script_tag(name:"severity_date", value:"2018-10-23 21:29:00 +0000 (Tue, 23 Oct 2018)");

  script_name("Debian: Security Advisory (DLA-835)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-835");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/dla-835");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'cakephp' package(s) announced via the DLA-835 advisory.");
...
Further information about Debian LTS security advisories, how to apply these updates to your system and frequently asked questions can be found at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'cakephp' package(s) on Debian 7.");
