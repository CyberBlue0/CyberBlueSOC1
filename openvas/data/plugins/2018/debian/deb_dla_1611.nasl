...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-12-20 23:00:00 +0000 (Thu, 20 Dec 2018)");
...
The allocate_buffers function in libavcodec/alac.c did not initialize certain context data, which allowed remote attackers to cause a denial of service (segmentation violation) or possibly have unspecified other impact via crafted Apple Lossless Audio Codec (ALAC) data. This issue has now been addressed by clearing pointers in avcodec/alac.c's allocate_buffers().
