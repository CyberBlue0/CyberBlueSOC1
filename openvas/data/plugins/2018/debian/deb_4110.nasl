...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-02-09 23:00:00 +0000 (Fri, 09 Feb 2018)");
  ...
  script_name("Debian: Security Advisory (DSA-4110)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4110");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/dsa-4110");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/exim4");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'exim4' package(s) announced via the DSA-4110 advisory.");
