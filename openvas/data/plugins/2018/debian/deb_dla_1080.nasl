...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-1080)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-1080");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/dla-1080");
  script_xref(name:"URL", value:"https://eprint.iacr.org/2017/627");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gnupg' package(s) announced via the DLA-1080 advisory.");
...
For Debian 7 Wheezy, these problems have been fixed in version 1.4.12-7+deb7u9.
