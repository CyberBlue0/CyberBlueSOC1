...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-10-22 22:00:00 +0000 (Mon, 22 Oct 2018)");
  ...
  script_name("Debian: Security Advisory (DLA-1552)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-1552");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/dla-1552");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ghostscript' package(s) announced via the DLA-1552 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This is a follow-up update for the recently discovered -dSAFER issues reported by Tavis Ormandy.
...
For Debian 8 Jessie, these problems have been fixed in version 9.06~dfsg-2+deb8u11.
