...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-11-02 23:00:00 +0000 (Fri, 02 Nov 2018)");
  ...
  script_name("Debian: Security Advisory (DSA-4332)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4332");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/dsa-4332");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/ruby2.3");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ruby2.3' package(s) announced via the DSA-4332 advisory.");
