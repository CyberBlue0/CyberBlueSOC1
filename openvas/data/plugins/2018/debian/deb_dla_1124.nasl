...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-1124)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-1124");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/dla-1124");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'dnsmasq' package(s) announced via the DLA-1124 advisory.");
...
For Debian 7 Wheezy, these problems have been fixed in version 2.62-3+deb7u4.

We recommend that you upgrade your dnsmasq packages.

Further information about Debian LTS security advisories, how to apply these updates to your system and frequently asked questions can be found at: [link moved to references]");

  script_tag(name:"affected", value:"'dnsmasq' package(s) on Debian 7.");
