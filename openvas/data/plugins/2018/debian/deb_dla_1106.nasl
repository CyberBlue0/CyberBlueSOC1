...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-1106)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-1106");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/dla-1106");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libgd2' package(s) announced via the DLA-1106 advisory.");
...
For Debian 7 Wheezy, these problems have been fixed in version 2.0.36~rc1~dfsg-6.1+deb7u10.
