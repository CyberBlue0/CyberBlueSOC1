...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-999)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-999");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/dla-999");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openvpn' package(s) announced via the DLA-999 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that there were multiple out-of-bounds memory read vulnerabilities in openvpn, a popular virtual private network (VPN) daemon.
