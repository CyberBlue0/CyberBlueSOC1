...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.891425");
  ...
  script_name("Debian: Security Advisory (DLA-1425)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-1425");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/dla-1425");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'thunderbird' package(s) announced via the DLA-1425 advisory.");
...
For Debian 8 Jessie, these problems have been fixed in version 1:52.9.1-1~deb8u1.
