...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4094)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4094");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/dsa-4094");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/smarty3");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'smarty3' package(s) announced via the DSA-4094 advisory.");
...
For the detailed security status of smarty3 please refer to its security tracker page at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'smarty3' package(s) on Debian 8.");
