...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-03-01 23:33:00 +0000 (Fri, 01 Mar 2019)");

  script_name("Debian: Security Advisory (DLA-1603)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-1603");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/dla-1603");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'suricata' package(s) announced via the DLA-1603 advisory.");
