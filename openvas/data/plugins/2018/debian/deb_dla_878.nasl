...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-878)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-878");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/dla-878");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libytnef' package(s) announced via the DLA-878 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"CVE-2017-6298
...
For Debian 7 Wheezy, these problems have been fixed in version 1.5-4+deb7u1.

We recommend that you upgrade your libytnef packages.

Further information about Debian LTS security advisories, how to apply these updates to your system and frequently asked questions can be found at: [link moved to references]");

  script_tag(name:"affected", value:"'libytnef' package(s) on Debian 7.");
