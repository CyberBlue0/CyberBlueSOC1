...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-937)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-937");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/dla-937");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'rpcbind' package(s) announced via the DLA-937 advisory.");
...
For Debian 7 Wheezy, these problems have been fixed in version 0.2.0-8+deb7u2.

We recommend that you upgrade your rpcbind packages.

Further information about Debian LTS security advisories, how to apply these updates to your system and frequently asked questions can be found at: [link moved to references]");

  script_tag(name:"affected", value:"'rpcbind' package(s) on Debian 7.");
