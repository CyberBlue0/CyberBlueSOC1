...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-07-28 22:00:00 +0000 (Sat, 28 Jul 2018)");
  ...
  script_name("Debian: Security Advisory (DSA-4258)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4258");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/dsa-4258");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/ffmpeg");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ffmpeg' package(s) announced via the DSA-4258 advisory.");
...
For the stable distribution (stretch), this problem has been fixed in version 7:3.2.12-1~deb9u1.
