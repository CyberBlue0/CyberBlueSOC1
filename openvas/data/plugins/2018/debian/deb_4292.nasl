...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4292)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4292");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/dsa-4292");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/kamailio");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'kamailio' package(s) announced via the DSA-4292 advisory.");
