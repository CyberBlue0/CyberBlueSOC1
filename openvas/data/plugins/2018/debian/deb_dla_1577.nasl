...
if(description)
{
  ...
  script_cve_id("CVE-2018-12891", "CVE-2018-12893", "CVE-2018-15469", "CVE-2018-15470", "CVE-2018-19967", "CVE-2018-7540", "CVE-2018-7541", "CVE-2018-8897");
  ...
  script_name("Debian: Security Advisory (DLA-1577)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-1577");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/dla-1577");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'xen' package(s) announced via the DLA-1577 advisory.");
