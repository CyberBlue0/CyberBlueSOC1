...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-1491)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-1491");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/dla-1491");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tomcat8' package(s) announced via the DLA-1491 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Two security issues have been discovered in the Tomcat servlet and JSP engine.
...
For Debian 8 Jessie, these problems have been fixed in version 8.0.14-1+deb8u13.
