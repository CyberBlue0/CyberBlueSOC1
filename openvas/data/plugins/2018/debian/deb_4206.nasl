...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-05-20 22:00:00 +0000 (Sun, 20 May 2018)");
  ...
  script_name("Debian: Security Advisory (DSA-4206)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4206");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gitlab' package(s) announced via the DSA-4206 advisory.");
