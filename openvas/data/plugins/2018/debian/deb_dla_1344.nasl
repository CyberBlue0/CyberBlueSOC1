...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-1344)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-1344");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/dla-1344");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'squirrelmail' package(s) announced via the DLA-1344 advisory.");
...
For Debian 7 Wheezy, these problems have been fixed in version 2:1.4.23~svn20120406-2+deb7u2.

We recommend that you upgrade your squirrelmail packages.

Further information about Debian LTS security advisories, how to apply these updates to your system and frequently asked questions can be found at: [link moved to references]");

  script_tag(name:"affected", value:"'squirrelmail' package(s) on Debian 7.");
