...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4117");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/dsa-4117");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/gcc-4.9");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gcc-4.9' package(s) announced via the DSA-4117 advisory.");
...
For the oldstable distribution (jessie), this problem has been fixed in version 4.9.2-10+deb8u1.

We recommend that you upgrade your gcc-4.9 packages.

For the detailed security status of gcc-4.9 please refer to its security tracker page at: [link moved to references]");
