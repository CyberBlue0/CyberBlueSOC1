...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4189)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4189");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/dsa-4189");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/quassel");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'quassel' package(s) announced via the DSA-4189 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Two vulnerabilities were found in the Quassel IRC client, which could result in the execution of arbitrary code or denial of service.
...
For the detailed security status of quassel please refer to its security tracker page at: [link moved to references]");

  script_tag(name:"affected", value:"'quassel' package(s) on Debian 8, Debian 9.");
