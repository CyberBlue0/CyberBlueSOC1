...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4207)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4207");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/dsa-4207");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/packagekit");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'packagekit' package(s) announced via the DSA-4207 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Matthias Gerstner discovered that PackageKit, a DBus abstraction layer for simple software management tasks, contains an authentication bypass flaw allowing users without privileges to install local packages.
