...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.704287");
  script_cve_id("CVE-2018-12376", "CVE-2018-12377", "CVE-2018-12378", "CVE-2018-18499");
  ...
  script_name("Debian: Security Advisory (DSA-4287)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4287");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/dsa-4287");
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/firefox/60.0esr/releasenotes/");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/firefox-esr");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'firefox-esr' package(s) announced via the DSA-4287 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several security issues have been found in the Mozilla Firefox web browser: Multiple memory safety errors and use-after-frees may lead to the execution of arbitrary code or denial of service.
...
Between 52.x and 60.x, Firefox has undergone significant internal updates, which makes it incompatible with a number of extensions. For more information please refer to [link moved to references]
