...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2018-03-17 23:00:00 +0000 (Sat, 17 Mar 2018)");
  ...
  script_name("Debian: Security Advisory (DSA-4145)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4145");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/dsa-4145");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/gitlab");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gitlab' package(s) announced via the DSA-4145 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several vulnerabilities have been discovered in Gitlab, a software platform to collaborate on code:
...
For the detailed security status of gitlab please refer to its security tracker page at: [link moved to references]");

  script_tag(name:"affected", value:"'gitlab' package(s) on Debian 9.");
