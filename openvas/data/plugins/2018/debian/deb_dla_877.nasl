...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-10-16 21:15:00 +0000 (Fri, 16 Oct 2020)");

  script_name("Debian: Security Advisory (DLA-877)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-877");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/dla-877");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tiff' package(s) announced via the DLA-877 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"libtiff is vulnerable to multiple buffer overflows and integer overflows that can lead to application crashes (denial of service) or worse.
