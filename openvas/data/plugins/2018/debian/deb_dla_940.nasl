...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-940)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-940");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/dla-940");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'sane-backends' package(s) announced via the DLA-940 advisory.");
