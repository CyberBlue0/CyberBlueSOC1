...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4222)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4222");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/dsa-4222");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gnupg2' package(s) announced via the DSA-4222 advisory.");
...
For the detailed security status of gnupg2 please refer to its security tracker page at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'gnupg2' package(s) on Debian 8, Debian 9.");
