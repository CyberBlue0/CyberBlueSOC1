...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.704099");
  script_cve_id("CVE-2017-17081");
  ...
  script_tag(name:"severity_date", value:"2021-01-05 19:15:00 +0000 (Tue, 05 Jan 2021)");

  script_name("Debian: Security Advisory (DSA-4099)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4099");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/dsa-4099");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/ffmpeg");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ffmpeg' package(s) announced via the DSA-4099 advisory.");
...
For the stable distribution (stretch), this problem has been fixed in version 7:3.2.10-1~deb9u1.
