...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-1561)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-1561");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/dla-1561");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'phpldapadmin' package(s) announced via the DLA-1561 advisory.");
...
For Debian 8 Jessie, this problem has been fixed in version 1.2.2-5.2+deb8u1. Note: the package changelog mistakenly refers to the non-existent CVE-2016-11107 identifier. The proper identifier to refer to this issue is CVE-2017-11107. We recommend that you upgrade your phpldapadmin packages. Further information about Debian LTS security advisories, how to apply these updates to your system and frequently asked questions can be found at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'phpldapadmin' package(s) on Debian 8.");
