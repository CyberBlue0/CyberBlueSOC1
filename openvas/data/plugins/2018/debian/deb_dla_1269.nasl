...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-1269)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-1269");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/dla-1269");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'dokuwiki' package(s) announced via the DLA-1269 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that an XHR/AJAX call did not properly encode user input in the dokuwiki wiki platform. This resulted in a reflected file download vulnerability.
