...
if(description)
{
  ...
  script_cve_id("CVE-2018-10001", "CVE-2018-12458", "CVE-2018-13300", "CVE-2018-13302", "CVE-2018-14394", "CVE-2018-1999010", "CVE-2018-1999012", "CVE-2018-1999013", "CVE-2018-6392", "CVE-2018-6621", "CVE-2018-7557");
  ...
  script_tag(name:"severity_date", value:"2019-03-27 19:11:00 +0000 (Wed, 27 Mar 2019)");

  script_name("Debian: Security Advisory (DSA-4249)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4249");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/dsa-4249");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/ffmpeg");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ffmpeg' package(s) announced via the DSA-4249 advisory.");
