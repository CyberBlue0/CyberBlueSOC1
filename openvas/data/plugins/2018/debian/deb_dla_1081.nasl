...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1081");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/dla-1081");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'imagemagick' package(s) announced via the DLA-1081 advisory.");
