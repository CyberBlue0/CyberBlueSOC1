...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-03-03 18:35:00 +0000 (Fri, 03 Mar 2023)");

  script_name("Debian: Security Advisory (DLA-913)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-913");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/dla-913");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'activemq' package(s) announced via the DLA-913 advisory.");
