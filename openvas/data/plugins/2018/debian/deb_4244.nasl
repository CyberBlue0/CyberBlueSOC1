...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.704244");
  ...
  script_tag(name:"creation_date", value:"2018-07-12 22:00:00 +0000 (Thu, 12 Jul 2018)");
  ...
  script_name("Debian: Security Advisory (DSA-4244)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4244");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/dsa-4244");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/thunderbird");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'thunderbird' package(s) announced via the DSA-4244 advisory.");
