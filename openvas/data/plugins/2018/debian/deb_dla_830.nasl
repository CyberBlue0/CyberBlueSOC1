...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.890830");
  ...
  script_name("Debian: Security Advisory (DLA-830)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-830");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/dla-830");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gst-plugins-bad0.10' package(s) announced via the DLA-830 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Some memory management issues were found in the GStreamer bad plugins:
