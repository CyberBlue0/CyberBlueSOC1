...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.891308");
  ...
  script_name("Debian: Security Advisory (DLA-1308)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-1308");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/dla-1308");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'firefox-esr' package(s) announced via the DLA-1308 advisory.");
...
For Debian 7 Wheezy, these problems have been fixed in version 52.7.1esr-1~deb7u1.
