...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-1119)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2018 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-1119");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/dla-1119");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'otrs2' package(s) announced via the DLA-1119 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"An attacker who is logged into OTRS, a Ticket Request System, as an agent with write permissions for statistics can inject arbitrary code into the system. This can lead to serious problems like privilege escalation, data loss, and denial of service. This issue is also known as CVE-2017-14635 and is resolved by upgrading to the latest upstream release of OTRS3.
...
For Debian 7 Wheezy, these problems have been fixed in version 3.3.18-1~deb7u1.
