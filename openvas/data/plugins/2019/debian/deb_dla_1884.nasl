...
if(description)
{
  ...
  script_cve_id("CVE-2017-18509", "CVE-2018-20836", "CVE-2019-10207", "CVE-2019-10638", "CVE-2019-1125", "CVE-2019-13631", "CVE-2019-14283", "CVE-2019-14284", "CVE-2019-15214", "CVE-2019-15216", "CVE-2019-15239", "CVE-2019-3900");
  ...
  script_name("Debian: Security Advisory (DLA-1884)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-1884");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/dla-1884");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'linux' package(s) announced via the DLA-1884 advisory.");
...
Denis Andzakovic reported a possible use-after-free in the TCP sockets implementation. A local user could use this for denial-of-service (memory corruption or crash) or ... [Please see the references for more information on the vulnerabilities]");
