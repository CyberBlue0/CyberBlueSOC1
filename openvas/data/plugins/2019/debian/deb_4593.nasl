...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4593)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4593");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/dsa-4593");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/freeimage");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'freeimage' package(s) announced via the DSA-4593 advisory.");
...
For the detailed security status of freeimage please refer to its security tracker page at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'freeimage' package(s) on Debian 9, Debian 10.");
