...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.891870");
  ...
  script_tag(name:"creation_date", value:"2019-08-03 02:00:16 +0000 (Sat, 03 Aug 2019)");
  ...
  script_name("Debian: Security Advisory (DLA-1870)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-1870");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/dla-1870");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'thunderbird' package(s) announced via the DLA-1870 advisory.");
...
For Debian 8 Jessie, these problems have been fixed in version 1:60.8.0-1~deb8u1.
