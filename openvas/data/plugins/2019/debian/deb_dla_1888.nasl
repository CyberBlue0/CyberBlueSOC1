...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-02-23 15:10:00 +0000 (Thu, 23 Feb 2023)");

  script_name("Debian: Security Advisory (DLA-1888)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-1888");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/dla-1888");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'imagemagick' package(s) announced via the DLA-1888 advisory.");
...
CVE-2019-13295, CVE-2019-13297 Multiple heap buffer over-reads in AdaptiveThresholdImage (magick/threshold.c). These vulnerabilities might be leveraged by remote attackers to cause denial of service or unauthorized disclosure or modification of information via crafted image data.

CVE-2019-13304, CVE-2019-13305, CVE-2019-13306 Multiple stack buffer overflows in WritePNMImage (coders/pnm.c), leading to stack buffer over write up to ten bytes. Remote attackers might leverage these flaws to potentially perform code execution or denial of service.
