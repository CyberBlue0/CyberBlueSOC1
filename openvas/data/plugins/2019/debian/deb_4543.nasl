...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4543)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4543");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/dsa-4543");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'sudo' package(s) announced via the DSA-4543 advisory.");
...
For the detailed security status of sudo please refer to its security tracker page at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'sudo' package(s) on Debian 9, Debian 10.");
