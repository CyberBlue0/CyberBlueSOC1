...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.704432");
  script_cve_id("CVE-2019-3835", "CVE-2019-3838");
  script_tag(name:"creation_date", value:"2019-04-17 02:00:11 +0000 (Wed, 17 Apr 2019)");
  ...
  script_name("Debian: Security Advisory (DSA-4432)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4432");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/dsa-4432");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/ghostscript");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ghostscript' package(s) announced via the DSA-4432 advisory.");
