...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-03-22 16:01:00 +0000 (Mon, 22 Mar 2021)");

  script_name("Debian: Security Advisory (DSA-4551)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4551");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/dsa-4551");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/golang-1.11");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'golang-1.11' package(s) announced via the DSA-4551 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Daniel Mandragona discovered that invalid DSA public keys can cause a panic in dsa.Verify(), resulting in denial of service.
