...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-03-05 17:00:00 +0000 (Tue, 05 Mar 2019)");

  script_name("Debian: Security Advisory (DLA-1654)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-1654");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/dla-1654");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libav' package(s) announced via the DLA-1654 advisory.");
...
libavcodec/utils.c omitted a certain codec ID during enforcement of alignment, which allowed remote attackers to cause a denial of service (out-of-bounds access) or possibly have unspecified other impact via crafted JV data.
