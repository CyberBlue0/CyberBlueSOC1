...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-1989)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-1989");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/dla-1989");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");
  script_xref(name:"URL", value:"https://www.kernel.org/doc/html/latest/admin-guide/hw-vuln/tsx_async_abort.html");
  script_xref(name:"URL", value:"https://software.intel.com/security-software-guidance/insights/deep-dive-intel-transactional-synchronization-extensions-intel-tsx-asynchronous-abort");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'linux' package(s) announced via the DLA-1989 advisory.");
...
The affected chips (gen8) are listed at en.wikipedia.org/wiki/List_of_Intel_graphics_processing_units.
...
Further information on the mitigation can be found at [link moved to references] or in the linux-doc-3.16 package.
