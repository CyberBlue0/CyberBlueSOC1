...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.704411");
  ...
  script_name("Debian: Security Advisory (DSA-4411)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4411");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/dsa-4411");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/firefox-esr");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'firefox-esr' package(s) announced via the DSA-4411 advisory.");
