...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.704400");
  ...
  script_name("Debian: Security Advisory (DSA-4400)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4400");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/dsa-4400");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/openssl1.0");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openssl1.0' package(s) announced via the DSA-4400 advisory.");
