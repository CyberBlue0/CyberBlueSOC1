...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.704580");
  script_cve_id("CVE-2019-17005", "CVE-2019-17008", "CVE-2019-17010", "CVE-2019-17011", "CVE-2019-17012");
  script_tag(name:"creation_date", value:"2019-12-11 03:00:13 +0000 (Wed, 11 Dec 2019)");
  ...
  script_name("Debian: Security Advisory (DSA-4580)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4580");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/dsa-4580");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/firefox-esr");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'firefox-esr' package(s) announced via the DSA-4580 advisory.");
