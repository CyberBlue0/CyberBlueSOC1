...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.892037");
  script_cve_id("CVE-2018-11805", "CVE-2019-12420");
  script_tag(name:"creation_date", value:"2019-12-17 03:00:20 +0000 (Tue, 17 Dec 2019)");
  ...
  script_name("Debian: Security Advisory (DLA-2037)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2037");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/dla-2037");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'spamassassin' package(s) announced via the DLA-2037 advisory.");
