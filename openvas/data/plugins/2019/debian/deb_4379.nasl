...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4379)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4379");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/dsa-4379");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/golang-1.7");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'golang-1.7' package(s) announced via the DSA-4379 advisory.");
...
For the stable distribution (stretch), these problems have been fixed in version 1.7.4-2+deb9u1.
