...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.704542");
  script_cve_id("CVE-2019-14379", "CVE-2019-14439", "CVE-2019-14540", "CVE-2019-16335", "CVE-2019-16942", "CVE-2019-16943");
  script_tag(name:"creation_date", value:"2019-10-07 02:00:11 +0000 (Mon, 07 Oct 2019)");
  ...
  script_name("Debian: Security Advisory (DSA-4542)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4542");
...
For the detailed security status of jackson-databind please refer to its security tracker page at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'jackson-databind' package(s) on Debian 9, Debian 10.");
