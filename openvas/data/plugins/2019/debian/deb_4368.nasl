...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.704368");
  ...
  script_name("Debian: Security Advisory (DSA-4368)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4368");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/dsa-4368");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/zeromq3");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'zeromq3' package(s) announced via the DSA-4368 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Guido Vranken discovered that an incorrect bounds check in ZeroMQ, a lightweight messaging kernel, could result in the execution of arbitrary code.
