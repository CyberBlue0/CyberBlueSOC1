...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-03-02 17:53:00 +0000 (Thu, 02 Mar 2023)");

  script_name("Debian: Security Advisory (DLA-1897)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-1897");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/dla-1897");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tiff' package(s) announced via the DLA-1897 advisory.");
