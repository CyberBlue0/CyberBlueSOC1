...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-1671)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-1671");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/dla-1671");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'coturn' package(s) announced via the DLA-1671 advisory.");
...
For Debian 8 Jessie, these problems have been fixed in version 4.2.1.2-1+deb8u1.

We recommend that you upgrade your coturn packages.

Further information about Debian LTS security advisories, how to apply these updates to your system and frequently asked questions can be found at: [link moved to references]");

  script_tag(name:"affected", value:"'coturn' package(s) on Debian 8.");
