...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.891909");
  script_cve_id("CVE-2015-9381", "CVE-2015-9382", "CVE-2015-9383");
  script_tag(name:"creation_date", value:"2019-09-05 02:00:12 +0000 (Thu, 05 Sep 2019)");
  ...
  script_name("Debian: Security Advisory (DLA-1909)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-1909");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/dla-1909");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'freetype' package(s) announced via the DLA-1909 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several newly-referenced issues have been fixed in the FreeType 2 font engine.
