...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4467)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4467");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/dsa-4467");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/vim");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'vim' package(s) announced via the DSA-4467 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"User Arminius discovered a vulnerability in Vim, an enhanced version of the standard UNIX editor Vi (Vi IMproved). The Common vulnerabilities and exposures project identifies the following problem:
