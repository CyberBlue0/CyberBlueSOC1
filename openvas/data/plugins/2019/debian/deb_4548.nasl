...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4548)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4548");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/dsa-4548");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/openjdk-8");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openjdk-8' package(s) announced via the DSA-4548 advisory.");
...
For the oldstable distribution (stretch), these problems have been fixed in version 8u232-b09-1~deb9u1.
