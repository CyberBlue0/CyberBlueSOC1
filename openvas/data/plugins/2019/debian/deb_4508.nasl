...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4508)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4508");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/dsa-4508");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/h2o");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'h2o' package(s) announced via the DSA-4508 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Three vulnerabilities were discovered in the HTTP/2 code of the H2O HTTP server, which could result in denial of service.
