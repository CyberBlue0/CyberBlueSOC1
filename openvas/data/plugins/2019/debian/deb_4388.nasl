...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2019-02-09 23:00:00 +0000 (Sat, 09 Feb 2019)");
  ...
  script_name("Debian: Security Advisory (DSA-4388)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4388");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/dsa-4388");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mosquitto' package(s) announced via the DSA-4388 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Three vulnerabilities were discovered in the Mosquitto MQTT broker, which could result in authentication bypass. Please refer to [link moved to references] for additional information.
