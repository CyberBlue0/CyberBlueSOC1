...
if(description)
{
  ...
  script_cve_id("CVE-2018-15822", "CVE-2018-1999011", "CVE-2019-11338", "CVE-2019-12730", "CVE-2019-9718");
  ...
  script_name("Debian: Security Advisory (DSA-4449)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4449");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/dsa-4449");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/ffmpeg");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ffmpeg' package(s) announced via the DSA-4449 advisory.");
...
For the stable distribution (stretch), these problems have been fixed in version 7:3.2.14-1~deb9u1.
