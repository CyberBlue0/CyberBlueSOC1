...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-10-11 14:31:00 +0000 (Tue, 11 Oct 2022)");

  script_name("Debian: Security Advisory (DSA-4421)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4421");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/dsa-4421");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/chromium");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium' package(s) announced via the DSA-4421 advisory.");
