...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4492)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4492");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/dsa-4492");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'postgresql-9.6' package(s) announced via the DSA-4492 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"A issue has been discovered in the PostgreSQL database system, which could result in privilege escalation.
