...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-1895)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-1895");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/dla-1895");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libmspack' package(s) announced via the DLA-1895 advisory.");
