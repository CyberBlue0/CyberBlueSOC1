...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4006-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4006-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4006-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-hwe, linux-meta-hwe, linux-signed-hwe' package(s) announced via the USN-4006-2 advisory.");
