...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-3940-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3940-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3940-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'clamav' package(s) announced via the USN-3940-1 advisory.");
...
crash, resulting in a denial of service. (CVE-2019-1789)");
  ...
  script_tag(name:"affected", value:"'clamav' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 18.04, Ubuntu 18.10.");
