...
if(description)
{
  ...
  script_cve_id("CVE-2018-18500", "CVE-2018-18501", "CVE-2018-18502", "CVE-2018-18503", "CVE-2018-18504", "CVE-2018-18505", "CVE-2018-18506");
  script_tag(name:"creation_date", value:"2019-01-31 03:02:48 +0000 (Thu, 31 Jan 2019)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3874-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3874-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3874-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox' package(s) announced via the USN-3874-1 advisory.");
