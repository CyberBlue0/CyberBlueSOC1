...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-3954-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3954-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3954-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'freeradius' package(s) announced via the USN-3954-1 advisory.");
...
(CVE-2019-11234, CVE-2019-11235)");
  ...
  script_tag(name:"affected", value:"'freeradius' package(s) on Ubuntu 18.04, Ubuntu 18.10, Ubuntu 19.04.");
