...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure, linux-gcp, linux-gke-5.0, linux-hwe, linux-meta-azure, linux-meta-gcp, linux-meta-gke-5.0, linux-meta-hwe, linux-signed-azure, linux-signed-gcp, linux-signed-gke-5.0, linux-signed-hwe' package(s) announced via the USN-4157-2 advisory.");
...
attacker could use this to escalate privileges. (CVE-2019-2181)");
  ...
  script_tag(name:"affected", value:"'linux-azure, linux-gcp, linux-gke-5.0, linux-hwe, linux-meta-azure, linux-meta-gcp, linux-meta-gke-5.0, linux-meta-hwe, linux-signed-azure, linux-signed-gcp, linux-signed-gke-5.0, linux-signed-hwe' package(s) on Ubuntu 18.04.");
