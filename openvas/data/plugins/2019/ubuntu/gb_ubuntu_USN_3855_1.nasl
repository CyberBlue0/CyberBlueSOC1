...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2019-01-12 03:00:33 +0000 (Sat, 12 Jan 2019)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3855-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3855-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3855-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'systemd' package(s) announced via the USN-3855-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that systemd-journald allocated variable-length buffers
