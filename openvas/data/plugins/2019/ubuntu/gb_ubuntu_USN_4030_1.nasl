...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4030-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4030-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4030-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'web2py' package(s) announced via the USN-4030-1 advisory.");
...
(CVE-2016-3953, CVE-2016-3954, CVE-2016-3957)");
  ...
  script_tag(name:"affected", value:"'web2py' package(s) on Ubuntu 16.04.");
