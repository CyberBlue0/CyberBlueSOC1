...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2019-03-15 03:09:20 +0000 (Fri, 15 Mar 2019)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3909-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3909-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3909-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libvirt' package(s) announced via the USN-3909-1 advisory.");
...
cause libvirtd to stop responding, resulting in a denial of service.");
  ...
  script_tag(name:"affected", value:"'libvirt' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 18.10.");
