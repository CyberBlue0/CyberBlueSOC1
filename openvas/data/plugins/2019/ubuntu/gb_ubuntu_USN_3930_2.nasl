...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure, linux-hwe, linux-meta-azure, linux-meta-hwe, linux-signed-azure, linux-signed-hwe' package(s) announced via the USN-3930-2 advisory.");
