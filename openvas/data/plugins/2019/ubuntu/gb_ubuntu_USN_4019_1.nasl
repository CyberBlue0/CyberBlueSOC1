...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4019-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4019-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4019-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'sqlite3' package(s) announced via the USN-4019-1 advisory.");
...
(CVE-2017-2519)");
  ...
  script_tag(name:"affected", value:"'sqlite3' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 18.10, Ubuntu 19.04.");
