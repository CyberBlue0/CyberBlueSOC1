...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2019-02-07 03:03:37 +0000 (Thu, 07 Feb 2019)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3882-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3882-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3882-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'curl' package(s) announced via the USN-3882-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Wenxiang Qian discovered that curl incorrectly handled certain NTLM
...
crash, resulting in a denial of service. (CVE-2019-3823)");
  ...
  script_tag(name:"affected", value:"'curl' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 18.04, Ubuntu 18.10.");
