...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2019-02-05 03:02:58 +0000 (Tue, 05 Feb 2019)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3871-3)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3871-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3871-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws, linux-gcp, linux-kvm, linux-meta-aws, linux-meta-gcp, linux-meta-kvm, linux-meta-oem, linux-meta-raspi2, linux-oem, linux-raspi2, linux-signed-gcp, linux-signed-oem' package(s) announced via the USN-3871-3 advisory.");
...
Wei Wu discovered that the KVM ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-aws, linux-gcp, linux-kvm, linux-meta-aws, linux-meta-gcp, linux-meta-kvm, linux-meta-oem, linux-meta-raspi2, linux-oem, linux-raspi2, linux-signed-gcp, linux-signed-oem' package(s) on Ubuntu 18.04.");
