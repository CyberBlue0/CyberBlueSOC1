...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-3998-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3998-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3998-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'evolution-data-server' package(s) announced via the USN-3998-1 advisory.");
...
of encrypted messages as though they were encrypted.");
  ...
  script_tag(name:"affected", value:"'evolution-data-server' package(s) on Ubuntu 16.04, Ubuntu 18.04.");
