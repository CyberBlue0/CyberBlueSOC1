...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-aws, linux-gcp, linux-kvm, linux-meta, linux-meta-aws, linux-meta-gcp, linux-meta-kvm, linux-meta-raspi2, linux-raspi2, linux-signed, linux-signed-gcp' package(s) announced via the USN-3878-1 advisory.");
