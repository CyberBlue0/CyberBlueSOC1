...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-3913-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3913-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3913-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'p7zip' package(s) announced via the USN-3913-1 advisory.");
...
to arbitrary code execution.");
  ...
  script_tag(name:"affected", value:"'p7zip' package(s) on Ubuntu 16.04.");
