...
if(description)
{
  ...
  script_cve_id("CVE-2018-12207", "CVE-2019-0154", "CVE-2019-0155", "CVE-2019-11135", "CVE-2019-15098", "CVE-2019-16746", "CVE-2019-17052", "CVE-2019-17053", "CVE-2019-17054");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-meta, linux-signed' package(s) announced via the USN-4186-3 advisory.");
...
Original advisory details:
 ...
 Ori ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux, linux-meta, linux-signed' package(s) on Ubuntu 16.04.");
