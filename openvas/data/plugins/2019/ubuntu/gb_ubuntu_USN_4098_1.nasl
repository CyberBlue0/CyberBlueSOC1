...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4098-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4098-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4098-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'wpa' package(s) announced via the USN-4098-1 advisory.");
...
issue to recover certain passwords.");
  ...
  script_tag(name:"affected", value:"'wpa' package(s) on Ubuntu 18.04, Ubuntu 19.04.");
