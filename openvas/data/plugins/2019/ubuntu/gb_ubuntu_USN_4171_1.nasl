...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.844217");
  script_cve_id("CVE-2019-11481", "CVE-2019-11482", "CVE-2019-11483", "CVE-2019-11485", "CVE-2019-15790");
  script_tag(name:"creation_date", value:"2019-10-31 03:01:08 +0000 (Thu, 31 Oct 2019)");
  ...
  script_name("Ubuntu: Security Advisory (USN-4171-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4171-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4171-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apport' package(s) announced via the USN-4171-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Kevin Backhouse discovered Apport would read its user-controlled settings
