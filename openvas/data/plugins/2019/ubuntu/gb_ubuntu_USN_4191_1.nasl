...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4191-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4191-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4191-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'qemu' package(s) announced via the USN-4191-1 advisory.");
...
this to cause a denial of service. (CVE-2019-15890)");
  ...
  script_tag(name:"affected", value:"'qemu' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 19.04, Ubuntu 19.10.");
