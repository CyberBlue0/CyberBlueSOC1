...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-hwe, linux-meta, linux-meta-hwe, linux-meta-oem, linux-oem, linux-signed, linux-signed-hwe, linux-signed-oem' package(s) announced via the USN-4185-3 advisory.");
...
Original advisory details:
 ...
 ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux, linux-hwe, linux-meta, linux-meta-hwe, linux-meta-oem, linux-oem, linux-signed, linux-signed-hwe, linux-signed-oem' package(s) on Ubuntu 16.04, Ubuntu 18.04.");
