...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4016-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4016-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4016-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'neovim' package(s) announced via the USN-4016-2 advisory.");
...
could possibly use this issue to execute arbitrary code. (CVE-2019-12735)");
  ...
  script_tag(name:"affected", value:"'neovim' package(s) on Ubuntu 18.10, Ubuntu 19.04.");
