...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-3979-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3979-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3979-1");
  script_xref(name:"URL", value:"https://wiki.ubuntu.com/SecurityTeam/KnowledgeBase/MDS");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-aws, linux-azure, linux-gcp, linux-kvm, linux-meta, linux-meta-aws, linux-meta-azure, linux-meta-gcp, linux-meta-kvm, linux-meta-raspi2, linux-raspi2, linux-signed, linux-signed-azure, linux-signed-gcp' package(s) announced via the USN-3979-1 advisory.");
...
Marc Orr discovered that the KVM hypervisor ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'linux, linux-aws, linux-azure, linux-gcp, linux-kvm, linux-meta, linux-meta-aws, linux-meta-azure, linux-meta-gcp, linux-meta-kvm, linux-meta-raspi2, linux-raspi2, linux-signed, linux-signed-azure, linux-signed-gcp' package(s) on Ubuntu 19.04.");
