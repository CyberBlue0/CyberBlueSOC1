...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2019-01-31 03:02:39 +0000 (Thu, 31 Jan 2019)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3873-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3873-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3873-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openvswitch' package(s) announced via the USN-3873-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Open vSwitch incorrectly decoded certain packets. A
...
vSwitch to crash, resulting in a denial of service. (CVE-2018-17206)");
  ...
  script_tag(name:"affected", value:"'openvswitch' package(s) on Ubuntu 16.04, Ubuntu 18.04.");
