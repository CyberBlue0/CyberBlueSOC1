...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.843978");
  ...
  script_tag(name:"creation_date", value:"2019-04-17 02:00:46 +0000 (Wed, 17 Apr 2019)");
  script_version("2024-01-19T05:06:17+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:17 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");

  script_name("Ubuntu: Security Advisory (USN-3918-4)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3918-4");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3918-4");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/1825051");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox' package(s) announced via the USN-3918-4 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-3918-1 fixed vulnerabilities in Firefox. The update caused web
...
Original advisory details:
 ...
 conduct machine-in-the-middle (MITM) attacks. (CVE-2019-9803)");
  ...
  script_tag(name:"affected", value:"'firefox' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 18.04, Ubuntu 18.10.");
