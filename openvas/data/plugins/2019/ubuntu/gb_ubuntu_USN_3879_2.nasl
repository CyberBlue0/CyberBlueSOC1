...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2019-02-05 03:04:20 +0000 (Tue, 05 Feb 2019)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3879-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3879-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3879-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws, linux-lts-xenial, linux-meta-aws, linux-meta-lts-xenial, linux-signed-lts-xenial' package(s) announced via the USN-3879-2 advisory.");
...
denial of service (system crash). (CVE-2018-20169)");
  ...
  script_tag(name:"affected", value:"'linux-aws, linux-lts-xenial, linux-meta-aws, linux-meta-lts-xenial, linux-signed-lts-xenial' package(s) on Ubuntu 14.04.");
