...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4079-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4079-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4079-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'sox' package(s) announced via the USN-4079-2 advisory.");
...
Original advisory details:
 ...
 CVE-2019-8355, CVE-2019-8356, CVE-2019-8357)");
  ...
  script_tag(name:"affected", value:"'sox' package(s) on Ubuntu 18.04, Ubuntu 19.04.");
