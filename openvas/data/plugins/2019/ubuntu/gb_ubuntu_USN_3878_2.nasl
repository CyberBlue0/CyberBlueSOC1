...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2019-02-08 03:05:08 +0000 (Fri, 08 Feb 2019)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3878-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3878-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3878-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure, linux-meta-azure, linux-signed-azure' package(s) announced via the USN-3878-2 advisory.");
...
(CVE-2018-19854)");
  ...
  script_tag(name:"affected", value:"'linux-azure, linux-meta-azure, linux-signed-azure' package(s) on Ubuntu 18.10.");
