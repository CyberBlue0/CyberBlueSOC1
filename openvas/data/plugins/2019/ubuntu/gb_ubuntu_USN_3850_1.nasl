...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.843863");
  script_cve_id("CVE-2018-0495", "CVE-2018-12384", "CVE-2018-12404");
  script_tag(name:"creation_date", value:"2019-01-10 03:00:29 +0000 (Thu, 10 Jan 2019)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3850-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3850-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3850-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nss' package(s) announced via the USN-3850-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Keegan Ryan discovered that NSS incorrectly handled ECDSA key generation.
...
Bleichenbacher attack. (CVE-2018-12404)");
  ...
  script_tag(name:"affected", value:"'nss' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 18.04, Ubuntu 18.10.");
