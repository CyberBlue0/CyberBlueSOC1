...
if(description)
{
  ...
  script_cve_id("CVE-2018-12207", "CVE-2019-0154", "CVE-2019-0155", "CVE-2019-11135", "CVE-2019-15098", "CVE-2019-15791", "CVE-2019-15792", "CVE-2019-15793");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-hwe, linux-meta, linux-meta-hwe, linux-meta-oem-osp1, linux-oem-osp1, linux-signed, linux-signed-hwe, linux-signed-oem-osp1' package(s) announced via the USN-4184-2 advisory.");
...
Original advisory details:
 ...
 Ori Nimron ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux, linux-hwe, linux-meta, linux-meta-hwe, linux-meta-oem-osp1, linux-oem-osp1, linux-signed, linux-signed-hwe, linux-signed-oem-osp1' package(s) on Ubuntu 18.04, Ubuntu 19.04.");
