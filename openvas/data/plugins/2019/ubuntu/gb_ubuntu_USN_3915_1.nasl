...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.843945");
  script_cve_id("CVE-2019-3835", "CVE-2019-3838");
  script_tag(name:"creation_date", value:"2019-03-28 13:46:39 +0000 (Thu, 28 Mar 2019)");
  ...
  script_name("Ubuntu: Security Advisory (USN-3915-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3915-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3915-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ghostscript' package(s) announced via the USN-3915-1 advisory.");
