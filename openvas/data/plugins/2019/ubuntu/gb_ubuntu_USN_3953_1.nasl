...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-10-02 13:13:00 +0000 (Fri, 02 Oct 2020)");

  script_name("Ubuntu: Security Advisory (USN-3953-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3953-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3953-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php7.0, php7.2' package(s) announced via the USN-3953-1 advisory.");
