...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4082-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4082-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4082-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'subversion' package(s) announced via the USN-4082-1 advisory.");
...
cause svnserver to crash, resulting in a denial of service. (CVE-2019-0203)");
  ...
  script_tag(name:"affected", value:"'subversion' package(s) on Ubuntu 16.04.");
