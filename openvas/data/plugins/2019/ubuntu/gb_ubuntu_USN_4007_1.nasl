...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4007-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4007-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4007-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-aws, linux-gcp, linux-kvm, linux-meta, linux-meta-aws, linux-meta-gcp, linux-meta-kvm, linux-meta-oem, linux-meta-oracle, linux-meta-raspi2, linux-meta-snapdragon, linux-oem, linux-oracle, linux-raspi2, linux-signed, linux-signed-gcp, linux-signed-oem, linux-signed-oracle, linux-snapdragon' package(s) announced via the USN-4007-1 advisory.");
...
As a hardening measure, this update disables a.out support.");
  ...
  script_tag(name:"affected", value:"'linux, linux-aws, linux-gcp, linux-kvm, linux-meta, linux-meta-aws, linux-meta-gcp, linux-meta-kvm, linux-meta-oem, linux-meta-oracle, linux-meta-raspi2, linux-meta-snapdragon, linux-oem, linux-oracle, linux-raspi2, linux-signed, linux-signed-gcp, linux-signed-oem, linux-signed-oracle, linux-snapdragon' package(s) on Ubuntu 18.04.");
