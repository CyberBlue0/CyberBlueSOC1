...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-3971-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3971-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3971-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'monit' package(s) announced via the USN-3971-1 advisory.");
...
(CVE-2019-11455)");
  ...
  script_tag(name:"affected", value:"'monit' package(s) on Ubuntu 18.10, Ubuntu 19.04.");
