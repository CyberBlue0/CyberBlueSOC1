...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4062-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4062-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4062-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'wavpack' package(s) announced via the USN-4062-1 advisory.");
...
(CVE-2019-1010315, CVE-2019-1010317, CVE-2019-1010318, CVE-2019-1010319)");
  ...
  script_tag(name:"affected", value:"'wavpack' package(s) on Ubuntu 18.04, Ubuntu 19.04.");
