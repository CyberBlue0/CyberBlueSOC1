...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4114-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4114-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4114-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-azure, linux-gcp, linux-gke-5.0, linux-hwe, linux-kvm, linux-meta, linux-meta-azure, linux-meta-gcp, linux-meta-gke-5.0, linux-meta-hwe, linux-meta-kvm, linux-meta-raspi2, linux-meta-snapdragon, linux-raspi2, linux-signed, linux-signed-azure, linux-signed-gcp, linux-signed-gke-5.0, linux-signed-hwe, linux-snapdragon' package(s) announced via the USN-4114-1 advisory.");
...
(CVE-2019-3900)");
  ...
  script_tag(name:"affected", value:"'linux, linux-azure, linux-gcp, linux-gke-5.0, linux-hwe, linux-kvm, linux-meta, linux-meta-azure, linux-meta-gcp, linux-meta-gke-5.0, linux-meta-hwe, linux-meta-kvm, linux-meta-raspi2, linux-meta-snapdragon, linux-raspi2, linux-signed, linux-signed-azure, linux-signed-gcp, linux-signed-gke-5.0, linux-signed-hwe, linux-snapdragon' package(s) on Ubuntu 18.04, Ubuntu 19.04.");
