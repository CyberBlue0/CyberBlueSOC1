...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.844097");
  script_cve_id("CVE-2019-9848", "CVE-2019-9849");
  script_tag(name:"creation_date", value:"2019-07-18 02:00:48 +0000 (Thu, 18 Jul 2019)");
  ...
  script_name("Ubuntu: Security Advisory (USN-4063-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4063-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4063-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libreoffice' package(s) announced via the USN-4063-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Nils Emmerich discovered that LibreOffice incorrectly handled LibreLogo
