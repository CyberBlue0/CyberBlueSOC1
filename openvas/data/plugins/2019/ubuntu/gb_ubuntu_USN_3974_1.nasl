...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-3974-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3974-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3974-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'vcftools' package(s) announced via the USN-3974-1 advisory.");
...
(CVE-2018-11099, CVE-2018-11129, CVE-2018-11130)");
  ...
  script_tag(name:"affected", value:"'vcftools' package(s) on Ubuntu 16.04.");
