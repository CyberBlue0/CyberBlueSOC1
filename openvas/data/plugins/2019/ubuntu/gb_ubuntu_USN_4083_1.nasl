...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4083-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4083-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4083-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openjdk-lts' package(s) announced via the USN-4083-1 advisory.");
...
execute arbitrary code. (CVE-2019-7317)");
  ...
  script_tag(name:"affected", value:"'openjdk-lts' package(s) on Ubuntu 18.04, Ubuntu 19.04.");
