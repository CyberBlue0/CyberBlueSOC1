...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws, linux-aws-hwe, linux-meta-aws, linux-meta-aws-hwe' package(s) announced via the USN-4118-1 advisory.");
...
Diffie-Hellman key exchange in some ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-aws, linux-aws-hwe, linux-meta-aws, linux-meta-aws-hwe' package(s) on Ubuntu 16.04, Ubuntu 18.04.");
