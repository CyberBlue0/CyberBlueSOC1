...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-3981-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2019 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3981-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3981-2");
  script_xref(name:"URL", value:"https://wiki.ubuntu.com/SecurityTeam/KnowledgeBase/MDS");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure, linux-gcp, linux-hwe, linux-meta-azure, linux-meta-gcp, linux-meta-hwe, linux-meta-oracle, linux-oracle, linux-signed-azure, linux-signed-gcp, linux-signed-hwe, linux-signed-oracle' package(s) announced via the USN-3981-2 advisory.");
...
not properly limit DMA mappings. A local attacker could use this to cause ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'linux-azure, linux-gcp, linux-hwe, linux-meta-azure, linux-meta-gcp, linux-meta-hwe, linux-meta-oracle, linux-oracle, linux-signed-azure, linux-signed-gcp, linux-signed-hwe, linux-signed-oracle' package(s) on Ubuntu 14.04, Ubuntu 16.04.");
