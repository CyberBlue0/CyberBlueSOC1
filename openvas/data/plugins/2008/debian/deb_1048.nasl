...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56668");
  ...
  script_name("Debian: Security Advisory (DSA-1048)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-1048");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/dsa-1048");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'asterisk' package(s) announced via the DSA-1048 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several problems have been discovered in Asterisk, an Open Source Private Branch Exchange (telephone control center). The Common Vulnerabilities and Exposures project identifies the following problems:
...
We recommend that you upgrade your asterisk package.");
  ...
  script_tag(name:"affected", value:"'asterisk' package(s) on Debian 3.0, Debian 3.1.");
