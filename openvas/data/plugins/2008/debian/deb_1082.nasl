...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56836");
  ...
  script_name("Debian: Security Advisory (DSA-1082)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-1082");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/dsa-1082");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'kernel-source-2.4.17' package(s) announced via the DSA-1082 advisory.");
...
Crafted ELF binaries may lead to privilege escalation, due to insufficient checking of overlapping memory ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'kernel-source-2.4.17' package(s) on Debian 3.0.");
