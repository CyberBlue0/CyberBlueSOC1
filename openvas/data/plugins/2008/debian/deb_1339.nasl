...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1339)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-1339");
  script_xref(name:"URL", value:"https://www.debian.org/security/2007/dsa-1339");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'iceape' package(s) announced via the DSA-1339 advisory.");
