...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-910)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-910");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/dsa-910");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'zope2.7' package(s) announced via the DSA-910 advisory.");
