...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56215");
  ...
  script_name("Debian: Security Advisory (DSA-951)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-951");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/dsa-951");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'trac' package(s) announced via the DSA-951 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This update corrects the search feature in trac, an enhanced wiki and issue tracking system for software development projects, which broke with the last security update. For completeness please find below the original advisory text:
...
We recommend that you upgrade your trac package.");
  ...
  script_tag(name:"affected", value:"'trac' package(s) on Debian 3.1.");
