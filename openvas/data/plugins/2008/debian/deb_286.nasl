...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53355");
  ...
  script_name("Debian: Security Advisory (DSA-286)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-286");
  script_xref(name:"URL", value:"https://www.debian.org/security/2003/dsa-286");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gs-common' package(s) announced via the DSA-286 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Paul Szabo discovered insecure creation of a temporary file in ps2epsi, a script that is distributed as part of gs-common which contains common files for different Ghostscript releases. ps2epsi uses a temporary file in the process of invoking ghostscript. This file was created in an insecure fashion, which could allow a local attacker to overwrite files owned by a user who invokes ps2epsi.
...
We recommend that you upgrade your gs-common package.");
  ...
  script_tag(name:"affected", value:"'gs-common' package(s) on Debian 3.0.");
