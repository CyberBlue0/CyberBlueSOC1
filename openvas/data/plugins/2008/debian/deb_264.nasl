...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53335");
  ...
  script_name("Debian: Security Advisory (DSA-264)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-264");
  script_xref(name:"URL", value:"https://www.debian.org/security/2003/dsa-264");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'lxr' package(s) announced via the DSA-264 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Upstream developers of lxr, a general hypertext cross-referencing tool, have been alerted of a vulnerability that allows a remote attacker to read arbitrary files on the host system as user www-data. This could disclose local files that were not meant to be shared with the public.
...
We recommend that you upgrade your lxr package.");
  ...
  script_tag(name:"affected", value:"'lxr' package(s) on Debian 3.0.");
