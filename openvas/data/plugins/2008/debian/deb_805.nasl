...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-805)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-805");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/dsa-805");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'apache2' package(s) announced via the DSA-805 advisory.");
