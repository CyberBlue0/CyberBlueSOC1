...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-437)");
  ...
  script_tag(name:"insight", value:"A vulnerability was discovered in cgiemail, a CGI program used to email the contents of an HTML form, whereby it could be used to send email to arbitrary addresses. This type of vulnerability is commonly exploited to send unsolicited commercial email (spam).

For the current stable distribution (woody) this problem has been fixed in version 1.6-14woody1.

For the unstable distribution (sid), this problem has been fixed in version 1.6-20.

We recommend that you update your cgiemail package.");

  script_tag(name:"affected", value:"'cgiemail' package(s) on Debian 3.0.");
