...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53857");
  ...
  script_name("Debian: Security Advisory (DSA-209)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-209");
  script_xref(name:"URL", value:"https://www.debian.org/security/2002/dsa-209");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wget' package(s) announced via the DSA-209 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Two problems have been found in the wget package as distributed in Debian GNU/Linux:
...
Both problems have been fixed in version 1.5.3-3.1 for Debian GNU/Linux 2.2/potato and version 1.8.1-6.1 for Debian GNU/Linux 3.0/woody.");
  ...
  script_tag(name:"affected", value:"'wget' package(s) on Debian 3.0.");
