...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61023");
  ...
  script_name("Debian: Security Advisory (DSA-1573)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-1573");
  script_xref(name:"URL", value:"https://www.debian.org/security/2008/dsa-1573");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'rdesktop' package(s) announced via the DSA-1573 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several remote vulnerabilities have been discovered in rdesktop, a Remote Desktop Protocol client. The Common Vulnerabilities and Exposures project identifies the following problems:
...
We recommend that you upgrade your rdesktop package.");
  ...
  script_tag(name:"affected", value:"'rdesktop' package(s) on Debian 4.");
