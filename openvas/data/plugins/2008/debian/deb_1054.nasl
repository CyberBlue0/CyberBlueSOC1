...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56718");
  ...
  script_name("Debian: Security Advisory (DSA-1054)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-1054");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/dsa-1054");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tiff' package(s) announced via the DSA-1054 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Tavis Ormandy discovered several vulnerabilities in the TIFF library that can lead to a denial of service or the execution of arbitrary code. The Common Vulnerabilities and Exposures project identifies the following problems:
...
We recommend that you upgrade your libtiff packages.");
  ...
  script_tag(name:"affected", value:"'tiff' package(s) on Debian 3.0, Debian 3.1.");
