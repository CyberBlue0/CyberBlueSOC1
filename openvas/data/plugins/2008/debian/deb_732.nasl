...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53561");
  ...
  script_name("Debian: Security Advisory (DSA-732)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-732");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/dsa-732");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mailutils' package(s) announced via the DSA-732 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"'infamous41md' discovered several vulnerabilities in the GNU mailutils package which contains utilities for handling mail. These problems can lead to a denial of service or the execution of arbitrary code. The Common Vulnerabilities and Exposures project identifies the following vulnerabilities.
...
We recommend that you upgrade your mailutils packages.");
  ...
  script_tag(name:"affected", value:"'mailutils' package(s) on Debian 3.0.");
