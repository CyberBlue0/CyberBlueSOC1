...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53299");
  ...
  script_name("Debian: Security Advisory (DSA-615)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-615");
  script_xref(name:"URL", value:"https://www.debian.org/security/2004/dsa-615");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'debmake' package(s) announced via the DSA-615 advisory.");
...
We recommend that you upgrade your debmake package.");
  ...
  script_tag(name:"affected", value:"'debmake' package(s) on Debian 3.0.");
