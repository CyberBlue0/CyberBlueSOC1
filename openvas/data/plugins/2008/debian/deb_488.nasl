...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53182");
...
We recommend that you update your logcheck package.");
  ...
  script_tag(name:"affected", value:"'logcheck' package(s) on Debian 3.0.");
