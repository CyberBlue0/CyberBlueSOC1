...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56114");
  ...
  script_name("Debian: Security Advisory (DSA-930)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-930");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/dsa-930");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'smstools' package(s) announced via the DSA-930 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Ulf Harnhammar from the Debian Security Audit project discovered a format string attack in the logging code of smstools, which may be exploited to execute arbitrary code with root privileges.
...
We recommend that you upgrade your smstools package.");
  ...
  script_tag(name:"affected", value:"'smstools' package(s) on Debian 3.0, Debian 3.1.");
