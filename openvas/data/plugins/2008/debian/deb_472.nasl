...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53169");
  ...
  script_name("Debian: Security Advisory (DSA-472)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-472");
  script_xref(name:"URL", value:"https://www.debian.org/security/2004/dsa-472");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'fte' package(s) announced via the DSA-472 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Steve Kemp and Jaguar discovered a number of buffer overflow vulnerabilities in vfte, a version of the fte editor which runs on the Linux console, found in the package fte-console. This program is setuid root in order to perform certain types of low-level operations on the console.
...
We recommend that you update your fte package.");
  ...
  script_tag(name:"affected", value:"'fte' package(s) on Debian 3.0.");
