...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1504)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-1504");
  script_xref(name:"URL", value:"https://www.debian.org/security/2008/dsa-1504");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'fai-kernels, kernel-image-2.6.8-alpha, kernel-image-2.6.8-amd64, kernel-image-2.6.8-hppa, kernel-image-2.6.8-i386, kernel-image-2.6.8-ia64, kernel-image-2.6.8-m68k, kernel-image-2.6.8-s390, kernel-image-2.6.8-sparc, kernel-patch-powerpc-2.6.8, kernel-source-2.6.8' package(s) announced via the DSA-1504 advisory.");
