...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53310");
...
We recommend that you upgrade your libmcrypt packages.");
  ...
  script_tag(name:"affected", value:"'libmcrypt' package(s) on Debian 3.0.");
