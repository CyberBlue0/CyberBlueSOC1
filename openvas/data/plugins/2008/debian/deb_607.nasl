...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"DSA-607");
  script_xref(name:"URL", value:"https://www.debian.org/security/2004/dsa-607");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'xfree86' package(s) announced via the DSA-607 advisory.");
