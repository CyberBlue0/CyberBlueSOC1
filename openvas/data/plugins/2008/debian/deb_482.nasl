...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53685");
  ...
  script_name("Debian: Security Advisory (DSA-482)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-482");
  script_xref(name:"URL", value:"https://www.debian.org/security/2004/dsa-482");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'kernel-image-2.4.17-s390, kernel-patch-2.4.17-apus, kernel-patch-2.4.17-s390, kernel-source-2.4.17' package(s) announced via the DSA-482 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several serious problems have been discovered in the Linux kernel. This update takes care of Linux 2.4.17 for the PowerPC/apus and S/390 architectures. The Common Vulnerabilities and Exposures project identifies the following problems that will be fixed with this update:
...
Vulnerability matrix for CAN-2004-0109");
  ...
  script_tag(name:"affected", value:"'kernel-image-2.4.17-s390, kernel-patch-2.4.17-apus, kernel-patch-2.4.17-s390, kernel-source-2.4.17' package(s) on Debian 3.0.");
