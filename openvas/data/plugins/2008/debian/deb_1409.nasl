...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.59917");
  ...
  script_name("Debian: Security Advisory (DSA-1409)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-1409");
  script_xref(name:"URL", value:"https://www.debian.org/security/2007/dsa-1409");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'samba' package(s) announced via the DSA-1409 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This update fixes all currently known regressions introduced with the previous two revisions of DSA-1409. The original text is reproduced below:
