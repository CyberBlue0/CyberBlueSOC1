...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.55792");
  script_cve_id("CVE-2005-2869", "CVE-2005-3300", "CVE-2005-3301", "CVE-2005-3787");
  ...
  script_name("Debian: Security Advisory (DSA-880)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-880");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/dsa-880");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'phpmyadmin' package(s) announced via the DSA-880 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several cross-site scripting vulnerabilities have been discovered in phpmyadmin, a set of PHP-scripts to administrate MySQL over the WWW. The Common Vulnerabilities and Exposures project identifies the following problems:
...
We recommend that you upgrade your phpmyadmin package.");
  ...
  script_tag(name:"affected", value:"'phpmyadmin' package(s) on Debian 3.1.");
