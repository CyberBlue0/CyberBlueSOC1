...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61783");
  ...
  script_name("Debian: Security Advisory (DSA-1661)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-1661");
  script_xref(name:"URL", value:"https://www.debian.org/security/2008/dsa-1661");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openoffice.org' package(s) announced via the DSA-1661 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several vulnerabilities have been discovered in the OpenOffice.org office suite:
...
We recommend that you upgrade your OpenOffice.org package.");
  ...
  script_tag(name:"affected", value:"'openoffice.org' package(s) on Debian 4.");
