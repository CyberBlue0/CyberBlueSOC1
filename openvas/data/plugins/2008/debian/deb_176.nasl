...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53733");
  ...
  script_name("Debian: Security Advisory (DSA-176)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-176");
  script_xref(name:"URL", value:"https://www.debian.org/security/2002/dsa-176");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gv' package(s) announced via the DSA-176 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Zen-parse discovered a buffer overflow in gv, a PostScript and PDF viewer for X11. This problem is triggered by scanning the PostScript file and can be exploited by an attacker sending a malformed PostScript or PDF file. The attacker is able to cause arbitrary code to be run with the privileges of the victim.
...
We recommend that you upgrade your gv package.");
  ...
  script_tag(name:"affected", value:"'gv' package(s) on Debian 3.0.");
