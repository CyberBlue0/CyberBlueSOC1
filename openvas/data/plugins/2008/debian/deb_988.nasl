...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56394");
  ...
  script_name("Debian: Security Advisory (DSA-988)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-988");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/dsa-988");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'squirrelmail' package(s) announced via the DSA-988 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several vulnerabilities have been discovered in Squirrelmail, a commonly used webmail system. The Common Vulnerabilities and Exposures project identifies the following problems:
...
We recommend that you upgrade your squirrelmail package.");
  ...
  script_tag(name:"affected", value:"'squirrelmail' package(s) on Debian 3.0, Debian 3.1.");
