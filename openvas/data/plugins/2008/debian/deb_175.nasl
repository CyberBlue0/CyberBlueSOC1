...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53430");
...
We recommend that you upgrade your syslog-ng package immediately.");
  ...
  script_tag(name:"affected", value:"'syslog-ng' package(s) on Debian 3.0.");
