...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.55207");
  ...
  script_name("Debian: Security Advisory (DSA-800)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-800");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/dsa-800");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'pcre3' package(s) announced via the DSA-800 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"An integer overflow with subsequent buffer overflow has been detected in PCRE, the Perl Compatible Regular Expressions library, which allows an attacker to execute arbitrary code.
...
We recommend that you upgrade your libpcre3 package.");
  ...
  script_tag(name:"affected", value:"'pcre3' package(s) on Debian 3.0, Debian 3.1.");
