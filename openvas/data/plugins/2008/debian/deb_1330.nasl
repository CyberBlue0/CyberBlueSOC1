...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58451");
  ...
  script_name("Debian: Security Advisory (DSA-1330)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-1330");
  script_xref(name:"URL", value:"https://www.debian.org/security/2007/dsa-1330");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'php5' package(s) announced via the DSA-1330 advisory.");
...
For the stable distribution (etch) these problems have been fixed in version 5.2.0-8+etch7.

For the unstable distribution (sid) these problems have been fixed in version 5.2.2-1.

We recommend that you upgrade your PHP packages. Packages for the littleendian Mips architecture are not yet available, due to problems on the build host. They will be provided later.");
