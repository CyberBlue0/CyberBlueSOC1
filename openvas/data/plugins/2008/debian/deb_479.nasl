...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53176");
  ...
  script_name("Debian: Security Advisory (DSA-479)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-479");
  script_xref(name:"URL", value:"https://www.debian.org/security/2004/dsa-479");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'kernel-image-2.4.18-1-alpha, kernel-image-2.4.18-1-i386, kernel-image-2.4.18-i386bf, kernel-patch-2.4.18-powerpc, kernel-source-2.4.18' package(s) announced via the DSA-479 advisory.");
...
Vulnerability matrix for CAN-2004-0109");
  ...
  script_tag(name:"affected", value:"'kernel-image-2.4.18-1-alpha, kernel-image-2.4.18-1-i386, kernel-image-2.4.18-i386bf, kernel-patch-2.4.18-powerpc, kernel-source-2.4.18' package(s) on Debian 3.0.");
