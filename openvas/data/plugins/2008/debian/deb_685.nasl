...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53514");
  ...
  script_name("Debian: Security Advisory (DSA-685)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-685");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/dsa-685");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'emacs21' package(s) announced via the DSA-685 advisory.");
...
We recommend that you upgrade your emacs packages.");
  ...
  script_tag(name:"affected", value:"'emacs21' package(s) on Debian 3.0.");
