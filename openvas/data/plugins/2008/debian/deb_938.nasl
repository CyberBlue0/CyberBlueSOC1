...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56141");
  script_cve_id("CVE-2005-3191", "CVE-2005-3624", "CVE-2005-3625", "CVE-2005-3626", "CVE-2005-3627", "CVE-2005-3628");
  ...
  script_name("Debian: Security Advisory (DSA-938)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-938");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/dsa-938");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'koffice' package(s) announced via the DSA-938 advisory.");
