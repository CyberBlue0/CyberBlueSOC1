...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53184");
...
We recommend that you update your iproute package.");
  ...
  script_tag(name:"affected", value:"'iproute' package(s) on Debian 3.0.");
