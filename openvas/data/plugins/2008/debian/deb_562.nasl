...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53251");
  ...
  script_name("Debian: Security Advisory (DSA-562)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-562");
  script_xref(name:"URL", value:"https://www.debian.org/security/2004/dsa-562");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mysql' package(s) announced via the DSA-562 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several problems have been discovered in MySQL, a commonly used SQL database on Unix servers. The following problems have been identified by the Common Vulnerabilities and Exposures Project:
