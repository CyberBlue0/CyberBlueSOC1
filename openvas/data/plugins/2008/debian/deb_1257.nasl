...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58012");
  ...
  script_name("Debian: Security Advisory (DSA-1257)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-1257");
  script_xref(name:"URL", value:"https://www.debian.org/security/2007/dsa-1257");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'samba' package(s) announced via the DSA-1257 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several remote vulnerabilities have been discovered in samba, a free implementation of the SMB/CIFS protocol, which may lead to the execution of arbitrary code or denial of service. The Common Vulnerabilities and Exposures project identifies the following problems:
...
We recommend that you upgrade your samba package.");
  ...
  script_tag(name:"affected", value:"'samba' package(s) on Debian 3.1.");
