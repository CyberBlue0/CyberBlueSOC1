...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58522");
  ...
  script_name("Debian: Security Advisory (DSA-1350)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-1350");
  script_xref(name:"URL", value:"https://www.debian.org/security/2007/dsa-1350");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tetex-bin' package(s) announced via the DSA-1350 advisory.");
...
For the oldstable distribution (sarge) this problem has been fixed in version 2.0.2-30sarge5.
...
We recommend that you upgrade your tetex-bin packages.");
  ...
  script_tag(name:"affected", value:"'tetex-bin' package(s) on Debian 3.1.");
