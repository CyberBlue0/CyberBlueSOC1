...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.59636");
  ...
  script_name("Debian: Security Advisory (DSA-1411)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-1411");
  script_xref(name:"URL", value:"https://www.debian.org/security/2007/dsa-1411");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libopenssl-ruby' package(s) announced via the DSA-1411 advisory.");
...
We recommend that you upgrade your libopenssl-ruby packages.");
  ...
  script_tag(name:"affected", value:"'libopenssl-ruby' package(s) on Debian 3.1.");
