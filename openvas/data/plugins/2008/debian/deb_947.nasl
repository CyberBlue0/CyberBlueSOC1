...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56207");
  script_cve_id("CVE-2005-3587", "CVE-2006-0162");
  ...
  script_name("Debian: Security Advisory (DSA-947)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-947");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/dsa-947");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'clamav' package(s) announced via the DSA-947 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"A heap overflow has been discovered in ClamAV, a virus scanner, which could allow an attacker to execute arbitrary code by sending a carefully crafted UPX-encoded executable to a system running ClamAV. In addition, other potential overflows have been corrected.
