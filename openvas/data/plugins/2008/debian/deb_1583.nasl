...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1583)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-1583");
  script_xref(name:"URL", value:"https://www.debian.org/security/2008/dsa-1583");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gnome-peercast' package(s) announced via the DSA-1583 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several remote vulnerabilities have been discovered in GNOME PeerCast, the GNOME interface to PeerCast, a P2P audio and video streaming server. The Common Vulnerabilities and Exposures project identifies the following problems:
...
We recommend that you upgrade your gnome-peercast package.");
  ...
  script_tag(name:"affected", value:"'gnome-peercast' package(s) on Debian 4.");
