...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53154");
  ...
  script_name("Debian: Security Advisory (DSA-456)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-456");
  script_xref(name:"URL", value:"https://www.debian.org/security/2004/dsa-456");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'kernel-image-2.2.19-netwinder, kernel-image-2.2.19-riscpc, kernel-patch-2.2.19-arm, kernel-source-2.2.19' package(s) announced via the DSA-456 advisory.");
...
Vulnerability matrix for CAN-2004-0077");
  ...
  script_tag(name:"affected", value:"'kernel-image-2.2.19-netwinder, kernel-image-2.2.19-riscpc, kernel-patch-2.2.19-arm, kernel-source-2.2.19' package(s) on Debian 3.0.");
