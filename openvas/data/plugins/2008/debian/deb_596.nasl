...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53283");
...
We recommend that you upgrade your sudo package.");
  ...
  script_tag(name:"affected", value:"'sudo' package(s) on Debian 3.0.");
