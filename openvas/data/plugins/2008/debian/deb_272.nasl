...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53343");
...
We recommend that you upgrade your dietlibc packages.");
  ...
  script_tag(name:"affected", value:"'dietlibc' package(s) on Debian 3.0.");
