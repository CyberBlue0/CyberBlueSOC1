...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53163");
  ...
  script_name("Debian: Security Advisory (DSA-466)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-466");
  script_xref(name:"URL", value:"https://www.debian.org/security/2004/dsa-466");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'kernel-image-2.2.10-powerpc-apus, kernel-source-2.2.10' package(s) announced via the DSA-466 advisory.");
...
Vulnerability matrix for CAN-2004-0077");
  ...
  script_tag(name:"affected", value:"'kernel-image-2.2.10-powerpc-apus, kernel-source-2.2.10' package(s) on Debian 3.0.");
