...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57153");
  ...
  script_name("Debian: Security Advisory (DSA-1118)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-1118");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/dsa-1118");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mozilla' package(s) announced via the DSA-1118 advisory.");
...
Kazuho Oku discovered that Mozilla's lenient handling of HTTP header syntax may allow remote attackers to trick the browser to interpret certain ... [Please see the references for more information on the vulnerabilities]");
