...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53178");
  ...
  script_name("Debian: Security Advisory (DSA-491)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-491");
  script_xref(name:"URL", value:"https://www.debian.org/security/2004/dsa-491");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'kernel-patch-2.4.19-mips, kernel-source-2.4.19' package(s) announced via the DSA-491 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several serious problems have been discovered in the Linux kernel. This update takes care of Linux 2.4.19 for the MIPS architecture. The Common Vulnerabilities and Exposures project identifies the following problems that will be fixed with this update:
...
Vulnerability matrix for CAN-2004-0109");
  ...
  script_tag(name:"affected", value:"'kernel-patch-2.4.19-mips, kernel-source-2.4.19' package(s) on Debian 3.0.");
