...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53213");
  ...
  script_name("Debian: Security Advisory (DSA-521)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-521");
  script_xref(name:"URL", value:"https://www.debian.org/security/2004/dsa-521");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'sup' package(s) announced via the DSA-521 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"discovered a format string vulnerability in sup, a set of programs to synchronize collections of files across a number of machines, whereby a remote attacker could potentially cause arbitrary code to be executed with the privileges of the supfilesrv process (this process does not run automatically by default).
...
We recommend that you update your sup package.");
  ...
  script_tag(name:"affected", value:"'sup' package(s) on Debian 3.0.");
