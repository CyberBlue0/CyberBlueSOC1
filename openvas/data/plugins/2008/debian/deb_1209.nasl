...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57582");
  ...
  script_name("Debian: Security Advisory (DSA-1209)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-1209");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/dsa-1209");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'trac' package(s) announced via the DSA-1209 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Trac, a wiki and issue tracking system for software development projects, performs insufficient validation against cross-site request forgery, which might lead to an attacker being able to perform manipulation of a Trac site with the privileges of the attacked Trac user.
