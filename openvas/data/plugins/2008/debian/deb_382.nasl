...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53699");
  ...
  script_name("Debian: Security Advisory (DSA-382)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-382");
  script_xref(name:"URL", value:"https://www.debian.org/security/2003/dsa-382");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openssh' package(s) announced via the DSA-382 advisory.");
...
For the Debian stable distribution (woody) these bugs have been fixed in version 1:3.4p1-1.woody.3.");
  ...
  script_tag(name:"affected", value:"'openssh' package(s) on Debian 3.0.");
