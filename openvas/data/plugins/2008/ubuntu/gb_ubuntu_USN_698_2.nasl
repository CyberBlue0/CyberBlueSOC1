...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-698-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2008 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-698-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-698-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nagios3' package(s) announced via the USN-698-2 advisory.");
...
(CVE-2008-5027)");
  ...
  script_tag(name:"affected", value:"'nagios3' package(s) on Ubuntu 8.10.");
