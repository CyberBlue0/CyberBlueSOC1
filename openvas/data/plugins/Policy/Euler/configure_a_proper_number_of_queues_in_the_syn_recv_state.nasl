...
expected_value = 'The output should be equal to "net.ipv4.tcp_max_syn_backlog = 256"';
...
# ------------------------------------------------------------------
# CHECK :  Verify command `sysctl net.ipv4.tcp_max_syn_backlog`
# ------------------------------------------------------------------

step_cmd = 'sysctl net.ipv4.tcp_max_syn_backlog';
actual_value = ssh_cmd(socket:sock, cmd:step_cmd, return_errors:TRUE, return_linux_errors_only:TRUE);

if(actual_value == 'net.ipv4.tcp_max_syn_backlog = 256'){
  compliant = "yes";
