...
if(description)
{
  ...
  script_name("AVM FRITZ!Box / FRITZ!OS Detection Consolidation");

  script_category(ACT_GATHER_INFO);

  script_copyright("Copyright (C) 2014 Greenbone AG");
  script_family("Product detection");
  script_dependencies("gb_avm_fritz_box_http_detect.nasl", "gb_avm_fritz_box_detect_sip.nasl",
                      "gb_avm_fritz_box_detect_upnp.nasl", "gb_avm_fritz_box_detect_ftp.nasl");
  script_mandatory_keys("avm_fritz_box/detected");

  script_tag(name:"summary", value:"Consolidation of AVM FRITZ!Box and FRITZ!OS detections.");
...
SCRIPT_DESC       = "AVM FRITZ!Box / FRITZ!OS Detection Consolidation";
