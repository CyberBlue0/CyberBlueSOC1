...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4659-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4659-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4659-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-aws, linux-azure, linux-gcp, linux-kvm, linux-meta, linux-meta-aws, linux-meta-azure, linux-meta-gcp, linux-meta-kvm, linux-meta-oracle, linux-meta-raspi, linux-oracle, linux-raspi, linux-signed, linux-signed-azure, linux-signed-gcp, linux-signed-kvm, linux-signed-oracle' package(s) announced via the USN-4659-1 advisory.");
