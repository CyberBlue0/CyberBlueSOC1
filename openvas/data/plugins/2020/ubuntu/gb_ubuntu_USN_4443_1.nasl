...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.844517");
  ...
  script_tag(name:"creation_date", value:"2020-07-30 03:00:44 +0000 (Thu, 30 Jul 2020)");
  ...
  script_name("Ubuntu: Security Advisory (USN-4443-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4443-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4443-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox' package(s) announced via the USN-4443-1 advisory.");
