...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4134-3)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4134-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4134-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ibus' package(s) announced via the USN-4134-3 advisory.");
...
Original advisory details:
 ...
 capture the key strokes of the other user.");
  ...
  script_tag(name:"affected", value:"'ibus' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 19.10.");
