...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.844367");
  ...
  script_name("Ubuntu: Security Advisory (USN-4171-5)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4171-5");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4171-5");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/1851806");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/1854237");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apport' package(s) announced via the USN-4171-5 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-4171-1 fixed vulnerabilities in Apport. This caused a regression in
...
Original advisory details:
 ...
 that is readable by an unprivileged user. (CVE-2019-15790)");
  ...
  script_tag(name:"affected", value:"'apport' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 19.10.");
