...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.844650");
  script_cve_id("CVE-2018-10322", "CVE-2020-14314", "CVE-2020-16119", "CVE-2020-25285");
  script_tag(name:"creation_date", value:"2020-10-14 03:00:33 +0000 (Wed, 14 Oct 2020)");
  ...
  script_name("Ubuntu: Security Advisory (USN-4579-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4579-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4579-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-aws, linux-kvm, linux-lts-xenial, linux-meta, linux-meta-aws, linux-meta-kvm, linux-meta-raspi2, linux-meta-snapdragon, linux-raspi2, linux-signed, linux-snapdragon' package(s) announced via the USN-4579-1 advisory.");
