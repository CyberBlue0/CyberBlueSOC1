...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4600-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4600-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4600-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'netty-3.9' package(s) announced via the USN-4600-1 advisory.");
...
CVE-2019-20444, CVE-2019-20445, CVE-2020-7238)");
  ...
  script_tag(name:"affected", value:"'netty-3.9' package(s) on Ubuntu 16.04.");
