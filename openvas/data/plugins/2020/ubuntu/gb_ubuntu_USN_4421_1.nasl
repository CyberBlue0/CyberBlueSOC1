...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.844495");
  ...
  script_tag(name:"creation_date", value:"2020-07-09 03:00:24 +0000 (Thu, 09 Jul 2020)");
  ...
  script_name("Ubuntu: Security Advisory (USN-4421-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4421-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4421-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird' package(s) announced via the USN-4421-1 advisory.");
...
result in add-ons becoming outdated. (CVE-2020-12421)");
  ...
  script_tag(name:"affected", value:"'thunderbird' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 19.10, Ubuntu 20.04.");
