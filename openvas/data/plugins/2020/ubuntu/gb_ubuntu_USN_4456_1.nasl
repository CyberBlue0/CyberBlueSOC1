...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.844535");
  script_cve_id("CVE-2020-12100", "CVE-2020-12673", "CVE-2020-12674");
  script_tag(name:"creation_date", value:"2020-08-13 03:00:24 +0000 (Thu, 13 Aug 2020)");
  ...
  script_name("Ubuntu: Security Advisory (USN-4456-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4456-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4456-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dovecot' package(s) announced via the USN-4456-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Dovecot incorrectly handled deeply nested MIME
...
cause Dovecot to crash, resulting in a denial of service. (CVE-2020-12674)");
  ...
  script_tag(name:"affected", value:"'dovecot' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04.");
