...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-3911-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3911-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3911-2");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/1835596");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'file' package(s) announced via the USN-3911-2 advisory.");
...
Original advisory details:
 ...
 possibly execute arbitrary code.");
  ...
  script_tag(name:"affected", value:"'file' package(s) on Ubuntu 16.04, Ubuntu 18.04.");
