...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.844712");
  ...
  script_tag(name:"creation_date", value:"2020-11-13 04:00:26 +0000 (Fri, 13 Nov 2020)");
  ...
  script_name("Ubuntu: Security Advisory (USN-4607-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4607-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4607-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openjdk-8, openjdk-lts' package(s) announced via the USN-4607-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-4607-1 fixed vulnerabilities and added features in OpenJDK.
