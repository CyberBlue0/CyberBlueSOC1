...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.844338");
  script_cve_id("CVE-2016-6328", "CVE-2017-7544", "CVE-2019-9278");
  script_tag(name:"creation_date", value:"2020-02-12 04:00:25 +0000 (Wed, 12 Feb 2020)");
  ...
  script_name("Ubuntu: Security Advisory (USN-4277-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4277-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4277-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libexif' package(s) announced via the USN-4277-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Liu Bingchang discovered that libexif incorrectly handled certain files.
...
possibly use this issue to execute arbitrary code. (CVE-2019-9278)");
  ...
  script_tag(name:"affected", value:"'libexif' package(s) on Ubuntu 12.04, Ubuntu 14.04, Ubuntu 16.04, Ubuntu 18.04, Ubuntu 19.10.");
