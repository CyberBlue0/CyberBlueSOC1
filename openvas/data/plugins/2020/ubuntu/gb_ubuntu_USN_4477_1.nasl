...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.844554");
  script_cve_id("CVE-2020-15810", "CVE-2020-15811", "CVE-2020-24606");
  script_tag(name:"creation_date", value:"2020-09-02 06:22:01 +0000 (Wed, 02 Sep 2020)");
  ...
  script_name("Ubuntu: Security Advisory (USN-4477-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4477-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4477-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'squid' package(s) announced via the USN-4477-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Amit Klein discovered that Squid incorrectly validated certain data. A
