...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.844709");
  script_cve_id("CVE-2020-8695", "CVE-2020-8696", "CVE-2020-8698");
  script_tag(name:"creation_date", value:"2020-11-12 04:00:33 +0000 (Thu, 12 Nov 2020)");
  ...
  script_name("Ubuntu: Security Advisory (USN-4628-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4628-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4628-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'intel-microcode' package(s) announced via the USN-4628-1 advisory.");
...
information. (CVE-2020-8698)");
  ...
  script_tag(name:"affected", value:"'intel-microcode' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 20.10.");
