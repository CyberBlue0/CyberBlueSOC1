...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws-5.0, linux-azure, linux-gcp, linux-gke-5.0, linux-meta-aws-5.0, linux-meta-azure, linux-meta-gcp, linux-meta-gke-5.0, linux-meta-oracle-5.0, linux-oracle-5.0, linux-signed-azure, linux-signed-gcp, linux-signed-gke-5.0, linux-signed-oracle-5.0' package(s) announced via the USN-4285-1 advisory.");
...
destroying GEM contexts in the i915 driver for the Linux kernel. ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-aws-5.0, linux-azure, linux-gcp, linux-gke-5.0, linux-meta-aws-5.0, linux-meta-azure, linux-meta-gcp, linux-meta-gke-5.0, linux-meta-oracle-5.0, linux-oracle-5.0, linux-signed-azure, linux-signed-gcp, linux-signed-gke-5.0, linux-signed-oracle-5.0' package(s) on Ubuntu 18.04.");
