...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-12-20 00:15:00 +0000 (Fri, 20 Dec 2019)");

  script_name("Ubuntu: Security Advisory (USN-4262-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4262-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4262-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'keystone' package(s) announced via the USN-4262-1 advisory.");
