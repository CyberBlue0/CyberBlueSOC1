...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-12-11 17:44:00 +0000 (Fri, 11 Dec 2020)");

  script_name("Ubuntu: Security Advisory (USN-4664-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4664-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4664-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'aptdaemon' package(s) announced via the USN-4664-1 advisory.");
...
service. (CVE-2020-27349)");
  ...
  script_tag(name:"affected", value:"'aptdaemon' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 20.10.");
