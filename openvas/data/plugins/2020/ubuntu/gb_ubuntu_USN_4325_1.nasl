...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure, linux-gcp, linux-gke-5.0, linux-meta-azure, linux-meta-gcp, linux-meta-gke-5.0, linux-meta-oem-osp1, linux-meta-oracle-5.0, linux-oem-osp1, linux-oracle-5.0, linux-signed-azure, linux-signed-gcp, linux-signed-gke-5.0, linux-signed-oem-osp1, linux-signed-oracle-5.0' package(s) announced via the USN-4325-1 advisory.");
...
memory). (CVE-2020-8428)");
  ...
  script_tag(name:"affected", value:"'linux-azure, linux-gcp, linux-gke-5.0, linux-meta-azure, linux-meta-gcp, linux-meta-gke-5.0, linux-meta-oem-osp1, linux-meta-oracle-5.0, linux-oem-osp1, linux-oracle-5.0, linux-signed-azure, linux-signed-gcp, linux-signed-gke-5.0, linux-signed-oem-osp1, linux-signed-oracle-5.0' package(s) on Ubuntu 18.04.");
