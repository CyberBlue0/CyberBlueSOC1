...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure-5.3, linux-gcp-5.3, linux-gke-5.3, linux-hwe, linux-meta-azure-5.3, linux-meta-gcp-5.3, linux-meta-gke-5.3, linux-meta-hwe, linux-meta-oracle-5.3, linux-oracle-5.3, linux-signed-azure-5.3, linux-signed-gcp-5.3, linux-signed-gke-5.3, linux-signed-hwe, linux-signed-oracle-5.3' package(s) announced via the USN-4440-1 advisory.");
...
restrictions and execute arbitrary code in the kernel. (CVE-2020-15780)");
  ...
  script_tag(name:"affected", value:"'linux-azure-5.3, linux-gcp-5.3, linux-gke-5.3, linux-hwe, linux-meta-azure-5.3, linux-meta-gcp-5.3, linux-meta-gke-5.3, linux-meta-hwe, linux-meta-oracle-5.3, linux-oracle-5.3, linux-signed-azure-5.3, linux-signed-gcp-5.3, linux-signed-gke-5.3, linux-signed-hwe, linux-signed-oracle-5.3' package(s) on Ubuntu 18.04.");
