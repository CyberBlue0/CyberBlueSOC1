...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4301-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4301-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4301-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws-5.0, linux-gcp, linux-gke-5.0, linux-meta-aws-5.0, linux-meta-gcp, linux-meta-gke-5.0, linux-meta-oracle-5.0, linux-oracle-5.0, linux-signed-gcp, linux-signed-gke-5.0, linux-signed-oracle-5.0' package(s) announced via the USN-4301-1 advisory.");
