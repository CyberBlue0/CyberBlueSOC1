...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.844488");
  script_cve_id("CVE-2020-12415", "CVE-2020-12416", "CVE-2020-12417", "CVE-2020-12418", "CVE-2020-12419", "CVE-2020-12420", "CVE-2020-12421", "CVE-2020-12422", "CVE-2020-12424", "CVE-2020-12425", "CVE-2020-12426");
  script_tag(name:"creation_date", value:"2020-07-03 03:01:52 +0000 (Fri, 03 Jul 2020)");
  ...
  script_name("Ubuntu: Security Advisory (USN-4408-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4408-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4408-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox' package(s) announced via the USN-4408-1 advisory.");
