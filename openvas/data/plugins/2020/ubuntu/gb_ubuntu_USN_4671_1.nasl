...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.844761");
  script_cve_id("CVE-2020-16042", "CVE-2020-26793", "CVE-2020-26971", "CVE-2020-26972", "CVE-2020-26973", "CVE-2020-26974", "CVE-2020-26976", "CVE-2020-26978", "CVE-2020-26979", "CVE-2020-35111", "CVE-2020-35113", "CVE-2020-35114");
  script_tag(name:"creation_date", value:"2020-12-16 04:00:56 +0000 (Wed, 16 Dec 2020)");
  ...
  script_name("Ubuntu: Security Advisory (USN-4671-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4671-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4671-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox' package(s) announced via the USN-4671-1 advisory.");
