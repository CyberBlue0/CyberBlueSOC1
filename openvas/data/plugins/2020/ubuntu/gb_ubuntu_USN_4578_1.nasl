...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.844647");
  script_cve_id("CVE-2018-10322", "CVE-2019-19448", "CVE-2020-14314", "CVE-2020-16119", "CVE-2020-16120", "CVE-2020-25212", "CVE-2020-26088");
  script_tag(name:"creation_date", value:"2020-10-14 03:00:23 +0000 (Wed, 14 Oct 2020)");
  ...
  script_name("Ubuntu: Security Advisory (USN-4578-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4578-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4578-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-aws, linux-aws-hwe, linux-azure, linux-azure-4.15, linux-gcp, linux-gcp-4.15, linux-gke-4.15, linux-hwe, linux-kvm, linux-meta, linux-meta-aws, linux-meta-aws-hwe, linux-meta-azure, linux-meta-azure-4.15, linux-meta-gcp, linux-meta-gcp-4.15, linux-meta-gke-4.15, linux-meta-hwe, linux-meta-kvm, linux-meta-oem, linux-meta-oracle, linux-meta-raspi2, linux-meta-snapdragon, linux-oem, linux-oracle, linux-raspi2, linux-signed, linux-signed-azure, linux-signed-azure-4.15, linux-signed-gcp, linux-signed-gcp-4.15, linux-signed-gke-4.15, linux-signed-hwe, linux-signed-oem, linux-signed-oracle, linux-snapdragon' package(s) announced via the USN-4578-1 advisory.");
