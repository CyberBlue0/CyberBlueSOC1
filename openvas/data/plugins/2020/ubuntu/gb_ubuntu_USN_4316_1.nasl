...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.844380");
  script_cve_id("CVE-2018-14553", "CVE-2019-11038");
  script_tag(name:"creation_date", value:"2020-04-03 03:00:33 +0000 (Fri, 03 Apr 2020)");
  ...
  script_name("Ubuntu: Security Advisory (USN-4316-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4316-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4316-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libgd2' package(s) announced via the USN-4316-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that GD Graphics Library incorrectly handled cloning an
...
only affected Ubuntu 18.04 LTS and Ubuntu 16.04 LTS. (CVE-2019-11038)");
  ...
  script_tag(name:"affected", value:"'libgd2' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 19.10.");
