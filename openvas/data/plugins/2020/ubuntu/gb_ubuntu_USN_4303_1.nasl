...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.844363");
  ...
  script_name("Ubuntu: Security Advisory (USN-4303-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4303-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4303-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-aws, linux-kvm, linux-meta, linux-meta-aws, linux-meta-kvm, linux-meta-raspi2, linux-meta-snapdragon, linux-raspi2, linux-signed, linux-snapdragon' package(s) announced via the USN-4303-1 advisory.");
