...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.844760");
  script_cve_id("CVE-2019-19948", "CVE-2019-19949", "CVE-2020-27560");
  script_tag(name:"creation_date", value:"2020-12-16 04:00:54 +0000 (Wed, 16 Dec 2020)");
  ...
  script_name("Ubuntu: Security Advisory (USN-4670-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4670-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4670-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'imagemagick' package(s) announced via the USN-4670-1 advisory.");
...
this to cause a denial of service. (CVE-2020-27560)");
  ...
  script_tag(name:"affected", value:"'imagemagick' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 20.10.");
