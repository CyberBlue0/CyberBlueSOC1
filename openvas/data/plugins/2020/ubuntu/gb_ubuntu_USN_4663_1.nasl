...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4663-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4663-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4663-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gdk-pixbuf' package(s) announced via the USN-4663-1 advisory.");
...
to cause GDK-PixBuf to hang, resulting in a denial of service.");
  ...
  script_tag(name:"affected", value:"'gdk-pixbuf' package(s) on Ubuntu 20.04, Ubuntu 20.10.");
