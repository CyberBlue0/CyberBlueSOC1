...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4505-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4505-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4505-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libphp-phpmailer' package(s) announced via the USN-4505-1 advisory.");
...
matching filename extensions. (CVE-2020-13625)");
  ...
  script_tag(name:"affected", value:"'libphp-phpmailer' package(s) on Ubuntu 18.04.");
