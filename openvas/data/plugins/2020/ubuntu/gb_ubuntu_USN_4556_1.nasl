...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4556-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4556-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4556-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'netqmail' package(s) announced via the USN-4556-1 advisory.");
...
cause netqmail to disclose sensitive information. (CVE-2020-3812)");
  ...
  script_tag(name:"affected", value:"'netqmail' package(s) on Ubuntu 20.04.");
