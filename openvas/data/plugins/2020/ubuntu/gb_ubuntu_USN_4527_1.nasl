...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4527-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4527-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4527-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-aws, linux-lts-xenial, linux-meta, linux-meta-aws, linux-meta-raspi2, linux-meta-snapdragon, linux-raspi2, linux-signed, linux-snapdragon' package(s) announced via the USN-4527-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that the Conexant 23885 TV card device driver for the
...
service (system crash) or possibly execute arbitrary code. (CVE-2020-25212)");
  ...
  script_tag(name:"affected", value:"'linux, linux-aws, linux-lts-xenial, linux-meta, linux-meta-aws, linux-meta-raspi2, linux-meta-snapdragon, linux-raspi2, linux-signed, linux-snapdragon' package(s) on Ubuntu 14.04, Ubuntu 16.04.");
