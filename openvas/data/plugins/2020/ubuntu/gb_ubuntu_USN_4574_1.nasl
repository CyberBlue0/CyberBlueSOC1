...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4574-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4574-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4574-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'golang-github-seccomp-libseccomp-golang' package(s) announced via the USN-4574-1 advisory.");
...
intended restrictions put in place by seccomp.");
  ...
  script_tag(name:"affected", value:"'golang-github-seccomp-libseccomp-golang' package(s) on Ubuntu 16.04.");
