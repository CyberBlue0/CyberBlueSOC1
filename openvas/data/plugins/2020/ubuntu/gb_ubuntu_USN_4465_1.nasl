...
if(description)
{
  ...
  script_cve_id("CVE-2020-12655", "CVE-2020-12771", "CVE-2020-15393", "CVE-2020-24394");
  ...
  script_name("Ubuntu: Security Advisory (USN-4465-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4465-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4465-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure-5.3, linux-gke-5.3, linux-hwe, linux-meta-azure-5.3, linux-meta-gke-5.3, linux-meta-hwe, linux-signed-azure-5.3, linux-signed-gke-5.3, linux-signed-hwe' package(s) announced via the USN-4465-1 advisory.");
...
(CVE-2020-15393)");
  ...
  script_tag(name:"affected", value:"'linux-azure-5.3, linux-gke-5.3, linux-hwe, linux-meta-azure-5.3, linux-meta-gke-5.3, linux-meta-hwe, linux-signed-azure-5.3, linux-signed-gke-5.3, linux-signed-hwe' package(s) on Ubuntu 18.04.");
