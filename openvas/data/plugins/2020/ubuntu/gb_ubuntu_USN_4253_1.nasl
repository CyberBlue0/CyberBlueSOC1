...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-aws, linux-meta, linux-meta-aws, linux-signed' package(s) announced via the USN-4253-1 advisory.");
...
local attacker could use this to expose sensitive information.");
  ...
  script_tag(name:"affected", value:"'linux, linux-aws, linux-meta, linux-meta-aws, linux-signed' package(s) on Ubuntu 19.10.");
