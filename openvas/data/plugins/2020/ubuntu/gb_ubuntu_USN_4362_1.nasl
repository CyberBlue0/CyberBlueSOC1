...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4362-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4362-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4362-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dpdk' package(s) announced via the USN-4362-1 advisory.");
...
CVE-2020-10724, CVE-2020-10725, CVE-2020-10726)");
  ...
  script_tag(name:"affected", value:"'dpdk' package(s) on Ubuntu 18.04, Ubuntu 19.10, Ubuntu 20.04.");
