...
if(description)
{
  ...
  script_cve_id("CVE-2019-1547", "CVE-2019-1551", "CVE-2019-1563", "CVE-2020-1968");
  ...
  script_name("Ubuntu: Security Advisory (USN-4504-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4504-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4504-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openssl, openssl1.0' package(s) announced via the USN-4504-1 advisory.");
...
traffic. This issue only affected Ubuntu 18.04 LTS. (CVE-2019-1563)");
  ...
  script_tag(name:"affected", value:"'openssl, openssl1.0' package(s) on Ubuntu 16.04, Ubuntu 18.04.");
