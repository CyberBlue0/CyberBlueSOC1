...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.844620");
  script_cve_id("CVE-2020-15673", "CVE-2020-15674", "CVE-2020-15675", "CVE-2020-15676", "CVE-2020-15677", "CVE-2020-15678");
  script_tag(name:"creation_date", value:"2020-09-29 03:01:21 +0000 (Tue, 29 Sep 2020)");
  ...
  script_name("Ubuntu: Security Advisory (USN-4546-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4546-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4546-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox' package(s) announced via the USN-4546-1 advisory.");
