...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4250-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4250-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4250-2");
  script_xref(name:"URL", value:"https://mariadb.com/kb/en/mariadb-10322-release-notes/");
  script_xref(name:"URL", value:"https://mariadb.com/kb/en/mariadb-10144-release-notes/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mariadb-10.1, mariadb-10.3' package(s) announced via the USN-4250-2 advisory.");
...
new features, and possibly incompatible changes.");
  ...
  script_tag(name:"affected", value:"'mariadb-10.1, mariadb-10.3' package(s) on Ubuntu 18.04, Ubuntu 19.10.");
