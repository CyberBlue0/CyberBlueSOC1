...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2020-09-02 06:21:50 +0000 (Wed, 02 Sep 2020)");
  ...
  script_name("Ubuntu: Security Advisory (USN-4482-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4482-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4482-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ark' package(s) announced via the USN-4482-1 advisory.");
...
directory.");
  ...
  script_tag(name:"affected", value:"'ark' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04.");
