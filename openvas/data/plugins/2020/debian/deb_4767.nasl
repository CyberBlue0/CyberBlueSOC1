...
if(description)
{
  ...
  script_cve_id("CVE-2020-15005", "CVE-2020-17367", "CVE-2020-17368", "CVE-2020-25812", "CVE-2020-25813", "CVE-2020-25814", "CVE-2020-25827", "CVE-2020-25828");
  ...
  script_name("Debian: Security Advisory (DSA-4767)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4767");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mediawiki' package(s) announced via the DSA-4767 advisory.");
