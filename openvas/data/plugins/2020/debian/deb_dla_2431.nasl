...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2431)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2431");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/dla-2431-2");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/libonig");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libonig' package(s) announced via the DLA-2431 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that CVE-2020-26159 in the Oniguruma regular expressions library, notably used in PHP mbstring, was a false-positive. In consequence the patch for CVE-2020-26159 was reverted. For reference, the original advisory text follows.
