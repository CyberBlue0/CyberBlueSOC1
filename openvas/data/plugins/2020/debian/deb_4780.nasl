...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.704780");
  script_cve_id("CVE-2020-15683", "CVE-2020-15969");
  script_tag(name:"creation_date", value:"2020-10-26 04:00:07 +0000 (Mon, 26 Oct 2020)");
  ...
  script_name("Debian: Security Advisory (DSA-4780)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4780");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4780");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/thunderbird");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'thunderbird' package(s) announced via the DSA-4780 advisory.");
...
For the stable distribution (buster), these problems have been fixed in version 1:78.4.0-1~deb10u1.
