...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4601)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4601");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4601");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/ldm");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ldm' package(s) announced via the DSA-4601 advisory.");
...
For the detailed security status of ldm please refer to its security tracker page at: [link moved to references]");

  script_tag(name:"affected", value:"'ldm' package(s) on Debian 9, Debian 10.");
