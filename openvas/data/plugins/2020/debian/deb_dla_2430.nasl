...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.892430");
  script_cve_id("CVE-2020-15238");
  script_tag(name:"creation_date", value:"2020-11-04 04:00:16 +0000 (Wed, 04 Nov 2020)");
  ...
  script_name("Debian: Security Advisory (DLA-2430)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2430");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/dla-2430");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/blueman");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'blueman' package(s) announced via the DLA-2430 advisory.");
...
For Debian 9 stretch, this problem has been fixed in version 2.0.4-1+deb9u1.
...
Further information about Debian LTS security advisories, how to apply these updates to your system and frequently asked questions can be found at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'blueman' package(s) on Debian 9.");
