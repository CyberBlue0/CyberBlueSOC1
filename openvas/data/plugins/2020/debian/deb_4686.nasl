...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.704686");
  script_cve_id("CVE-2019-17571");
  script_tag(name:"creation_date", value:"2020-05-17 03:00:11 +0000 (Sun, 17 May 2020)");
...
For the detailed security status of apache-log4j1.2 please refer to its security tracker page at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'apache-log4j1.2' package(s) on Debian 9, Debian 10.");
