...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2467)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2467");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/dla-2467-2");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/lxml");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'lxml' package(s) announced via the DLA-2467 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"The fix for CVE-2020-27783, released as DLA 2467-1, was incomplete as the <math/svg> component was still affected by the vulnerability. This update includes an additional patch that completes the fix. Note that a package with version 3.7.1-1+deb9u2 was uploaded, but before the publication of the advisory a regression was discovered, which was immediately corrected prior to publication of this advisory.
