...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.704806");
  script_cve_id("CVE-2020-12695", "CVE-2020-28926");
  script_tag(name:"creation_date", value:"2020-12-08 10:02:36 +0000 (Tue, 08 Dec 2020)");
  ...
  script_name("Debian: Security Advisory (DSA-4806)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4806");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'minidlna' package(s) announced via the DSA-4806 advisory.");
