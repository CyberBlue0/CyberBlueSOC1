...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4725)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4725");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'evolution-data-server' package(s) announced via the DSA-4725 advisory.");
...
For the detailed security status of evolution-data-server please refer to its security tracker page at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'evolution-data-server' package(s) on Debian 10.");
