...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.704687");
  script_cve_id("CVE-2020-12783");
  script_tag(name:"creation_date", value:"2020-05-17 03:00:08 +0000 (Sun, 17 May 2020)");
  ...
  script_name("Debian: Security Advisory (DSA-4687)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4687");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4687");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/exim4");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'exim4' package(s) announced via the DSA-4687 advisory.");
