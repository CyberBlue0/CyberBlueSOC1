...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.704656");
  script_xref(name:"CISA", value:"Known Exploited Vulnerability (KEV) catalog");
  script_xref(name:"URL", value:"https://www.cisa.gov/known-exploited-vulnerabilities-catalog");
  script_cve_id("CVE-2020-6819", "CVE-2020-6820", "CVE-2020-6821", "CVE-2020-6822", "CVE-2020-6825");
  script_tag(name:"creation_date", value:"2020-04-14 03:00:11 +0000 (Tue, 14 Apr 2020)");
  ...
  script_name("Debian: Security Advisory (DSA-4656)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4656");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4656");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/thunderbird");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'thunderbird' package(s) announced via the DSA-4656 advisory.");
