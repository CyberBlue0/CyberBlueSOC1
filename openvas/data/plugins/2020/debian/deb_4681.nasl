...
if(description)
{
  ...
  script_cve_id("CVE-2020-3885", "CVE-2020-3894", "CVE-2020-3895", "CVE-2020-3897", "CVE-2020-3899", "CVE-2020-3900", "CVE-2020-3901", "CVE-2020-3902", "CVE-2021-30762");
  ...
  script_tag(name:"severity_date", value:"2021-09-14 19:29:00 +0000 (Tue, 14 Sep 2021)");

  script_name("Debian: Security Advisory (DSA-4681)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4681");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4681");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/webkit2gtk");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'webkit2gtk' package(s) announced via the DSA-4681 advisory.");
