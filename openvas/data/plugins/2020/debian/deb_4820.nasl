...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4820)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4820");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4820");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/horizon");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'horizon' package(s) announced via the DSA-4820 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Pritam Singh discovered an open redirect in the workflow forms of OpenStack Horizon.
