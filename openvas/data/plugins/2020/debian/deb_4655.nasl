...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.704655");
  script_cve_id("CVE-2020-6821", "CVE-2020-6822", "CVE-2020-6825");
  script_tag(name:"creation_date", value:"2020-04-09 03:00:15 +0000 (Thu, 09 Apr 2020)");
  ...
  script_name("Debian: Security Advisory (DSA-4655)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4655");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4655");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/firefox-esr");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'firefox-esr' package(s) announced via the DSA-4655 advisory.");
