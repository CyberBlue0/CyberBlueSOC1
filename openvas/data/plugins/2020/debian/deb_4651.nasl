...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-04-06 13:41:00 +0000 (Mon, 06 Apr 2020)");

  script_name("Debian: Security Advisory (DSA-4651)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4651");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4651");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/mediawiki");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mediawiki' package(s) announced via the DSA-4651 advisory.");
