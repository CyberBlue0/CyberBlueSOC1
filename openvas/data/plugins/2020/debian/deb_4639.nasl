...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.704639");
  script_cve_id("CVE-2019-20503", "CVE-2020-6805", "CVE-2020-6806", "CVE-2020-6807", "CVE-2020-6811", "CVE-2020-6812", "CVE-2020-6814");
  script_tag(name:"creation_date", value:"2020-03-18 10:45:23 +0000 (Wed, 18 Mar 2020)");
  ...
  script_name("Debian: Security Advisory (DSA-4639)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4639");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4639");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/firefox-esr");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'firefox-esr' package(s) announced via the DSA-4639 advisory.");
