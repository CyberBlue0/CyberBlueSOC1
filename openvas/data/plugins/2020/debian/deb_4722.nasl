...
if(description)
{
  ...
  script_cve_id("CVE-2019-13390", "CVE-2019-17539", "CVE-2019-17542", "CVE-2020-12284", "CVE-2020-13904", "CVE-2020-20448", "CVE-2020-20902");
  ...
  script_name("Debian: Security Advisory (DSA-4722)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4722");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4722");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/ffmpeg");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ffmpeg' package(s) announced via the DSA-4722 advisory.");
