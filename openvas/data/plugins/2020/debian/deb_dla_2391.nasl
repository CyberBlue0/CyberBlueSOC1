...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.892391");
  script_cve_id("CVE-2020-25613");
  script_tag(name:"creation_date", value:"2020-10-02 03:00:11 +0000 (Fri, 02 Oct 2020)");
  ...
  script_name("Debian: Security Advisory (DLA-2391)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2391");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/dla-2391");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/ruby2.3");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ruby2.3' package(s) announced via the DLA-2391 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"A potential HTTP request smuggling vulnerability in WEBrick was reported.
