...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4638)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4638");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4638");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/chromium");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium' package(s) announced via the DSA-4638 advisory.");
...
Michal Bentkowski discovered that untrusted input was insufficiently validated.
