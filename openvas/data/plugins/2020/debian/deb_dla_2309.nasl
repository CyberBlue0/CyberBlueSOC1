...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-08-11 17:29:00 +0000 (Tue, 11 Aug 2020)");

  script_name("Debian: Security Advisory (DLA-2309)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2309");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'evolution-data-server' package(s) announced via the DLA-2309 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"A vulnerability was discovered that allowed a malicious server to crash the mail client.

For Debian 9 stretch, this problem has been fixed in version 3.22.7-1+deb9u2.
