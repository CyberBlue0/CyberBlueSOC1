...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2312)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2312");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/dla-2312");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/libx11");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libx11' package(s) announced via the DLA-2312 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Todd Carson discovered some integer overflows in libX11, which could lead to heap corruption when processing crafted messages from an input method.
