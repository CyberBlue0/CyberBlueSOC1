...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.892343");
  script_cve_id("CVE-2020-24368");
  script_tag(name:"creation_date", value:"2020-08-25 03:00:13 +0000 (Tue, 25 Aug 2020)");
  ...
  script_name("Debian: Security Advisory (DLA-2343)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2343");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/dla-2343");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/icingaweb2");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'icingaweb2' package(s) announced via the DLA-2343 advisory.");
...
Further information about Debian LTS security advisories, how to apply these updates to your system and frequently asked questions can be found at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'icingaweb2' package(s) on Debian 9.");
