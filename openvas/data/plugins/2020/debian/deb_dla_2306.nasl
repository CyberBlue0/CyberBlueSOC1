...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.892306");
  script_cve_id("CVE-2020-13625");
  script_tag(name:"creation_date", value:"2020-08-03 03:00:06 +0000 (Mon, 03 Aug 2020)");
  ...
  script_name("Debian: Security Advisory (DLA-2306)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2306");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/dla-2306");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/libphp-phpmailer");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libphp-phpmailer' package(s) announced via the DLA-2306 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that there was an escaping issue in libphp-phpmailer, an email generation utility class for the PHP programming language.
