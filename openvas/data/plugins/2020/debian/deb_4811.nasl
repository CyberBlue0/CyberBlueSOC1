...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4811)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4811");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4811");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libxstream-java' package(s) announced via the DSA-4811 advisory.");
