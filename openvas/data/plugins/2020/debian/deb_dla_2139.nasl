...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.892139");
  script_cve_id("CVE-2020-5258", "CVE-2020-5259");
  script_tag(name:"creation_date", value:"2020-03-18 10:44:43 +0000 (Wed, 18 Mar 2020)");
  ...
  script_tag(name:"severity_date", value:"2020-03-11 21:15:00 +0000 (Wed, 11 Mar 2020)");

  script_name("Debian: Security Advisory (DLA-2139)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2139");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/dla-2139");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'dojo' package(s) announced via the DLA-2139 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"The following CVEs were reported against dojo:
...
Further information about Debian LTS security advisories, how to apply these updates to your system and frequently asked questions can be found at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'dojo' package(s) on Debian 8.");
