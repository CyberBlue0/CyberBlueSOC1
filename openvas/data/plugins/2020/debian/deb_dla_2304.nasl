...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2304)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2304");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/dla-2304");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/libpam-radius-auth");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libpam-radius-auth' package(s) announced via the DLA-2304 advisory.");
