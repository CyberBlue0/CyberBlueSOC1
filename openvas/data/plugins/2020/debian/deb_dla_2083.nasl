...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-01-29 17:15:00 +0000 (Wed, 29 Jan 2020)");

  script_name("Debian: Security Advisory (DLA-2083)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2083");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/dla-2083");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'hiredis' package(s) announced via the DLA-2083 advisory.");
