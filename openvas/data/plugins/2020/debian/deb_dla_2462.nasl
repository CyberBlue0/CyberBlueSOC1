...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2462)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2462");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/dla-2462");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/cimg");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'cimg' package(s) announced via the DLA-2462 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Multiple heap buffer overflows have been fixed in CImg, a C++ toolkit to load, save, process and display images.

For Debian 9 stretch, this problem has been fixed in version 1.7.9+dfsg-1+deb9u2.
