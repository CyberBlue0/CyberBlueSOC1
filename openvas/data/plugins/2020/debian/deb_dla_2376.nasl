...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2376)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2376");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/dla-2376");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/qtbase-opensource-src");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'qtbase-opensource-src' package(s) announced via the DLA-2376 advisory.");
...
For Debian 9 stretch, these problems have been fixed in version 5.7.1+dfsg-3+deb9u3.
