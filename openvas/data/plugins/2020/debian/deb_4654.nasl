...
if(description)
{
  ...
  script_cve_id("CVE-2020-6450", "CVE-2020-6451", "CVE-2020-6452", "CVE-2020-6453");
  ...
  script_tag(name:"severity_date", value:"2020-06-04 16:47:00 +0000 (Thu, 04 Jun 2020)");

  script_name("Debian: Security Advisory (DSA-4654)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4654");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4654");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/chromium");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium' package(s) announced via the DSA-4654 advisory.");
