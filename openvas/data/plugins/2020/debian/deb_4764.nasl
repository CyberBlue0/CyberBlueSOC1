...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4764)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4764");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4764");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/inspircd");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'inspircd' package(s) announced via the DSA-4764 advisory.");
