...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4799)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4799");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4799");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/x11vnc");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'x11vnc' package(s) announced via the DSA-4799 advisory.");
...
For the detailed security status of x11vnc please refer to its security tracker page at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'x11vnc' package(s) on Debian 10.");
