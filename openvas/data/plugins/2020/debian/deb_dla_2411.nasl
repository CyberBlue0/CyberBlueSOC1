...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.892411");
  script_cve_id("CVE-2020-15683", "CVE-2020-15969");
  script_tag(name:"creation_date", value:"2020-10-22 03:00:11 +0000 (Thu, 22 Oct 2020)");
  ...
  script_name("Debian: Security Advisory (DLA-2411)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2411");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/dla-2411");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/firefox-esr");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'firefox-esr' package(s) announced via the DLA-2411 advisory.");
...
For Debian 9 stretch, these problems have been fixed in version 78.4.0esr-1~deb9u1.
