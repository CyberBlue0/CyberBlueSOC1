...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.704642");
  script_cve_id("CVE-2019-20503", "CVE-2020-6805", "CVE-2020-6806", "CVE-2020-6807", "CVE-2020-6811", "CVE-2020-6812", "CVE-2020-6814");
  script_tag(name:"creation_date", value:"2020-03-21 04:00:29 +0000 (Sat, 21 Mar 2020)");
  ...
  script_name("Debian: Security Advisory (DSA-4642)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4642");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4642");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/thunderbird");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'thunderbird' package(s) announced via the DSA-4642 advisory.");
