...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-07-23 20:06:00 +0000 (Thu, 23 Jul 2020)");

  script_name("Debian: Security Advisory (DSA-4700)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4700");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4700");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/roundcube");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'roundcube' package(s) announced via the DSA-4700 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Matei Badanoiu and LoRexxar@knownsec discovered that roundcube, a skinnable AJAX based webmail solution for IMAP servers, did not correctly process and sanitize requests. This would allow a remote attacker to perform a cross-site scripting (XSS) attack leading to the execution of arbitrary code.
