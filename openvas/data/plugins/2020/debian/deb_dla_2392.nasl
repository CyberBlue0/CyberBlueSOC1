...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.892392");
  script_cve_id("CVE-2020-25613");
  script_tag(name:"creation_date", value:"2020-10-02 03:00:13 +0000 (Fri, 02 Oct 2020)");
  ...
  script_name("Debian: Security Advisory (DLA-2392)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2392");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'jruby' package(s) announced via the DLA-2392 advisory.");
