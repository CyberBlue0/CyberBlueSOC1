...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-12-03 14:43:00 +0000 (Thu, 03 Dec 2020)");

  script_name("Debian: Security Advisory (DLA-2092)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2092");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/dla-2092");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'qtbase-opensource-src' package(s) announced via the DLA-2092 advisory.");
