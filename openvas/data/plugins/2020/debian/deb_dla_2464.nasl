...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.892464");
  ...
  script_tag(name:"creation_date", value:"2020-11-24 04:00:16 +0000 (Tue, 24 Nov 2020)");
  ...
  script_name("Debian: Security Advisory (DLA-2464)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2464");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/dla-2464");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/thunderbird");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'thunderbird' package(s) announced via the DLA-2464 advisory.");
...
For Debian 9 stretch, these problems have been fixed in version 1:78.5.0-1~deb9u1.
