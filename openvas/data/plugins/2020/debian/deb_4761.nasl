...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4761)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4761");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/dsa-4761");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/zeromq3");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'zeromq3' package(s) announced via the DSA-4761 advisory.");
...
For the detailed security status of zeromq3 please refer to its security tracker page at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'zeromq3' package(s) on Debian 10.");
