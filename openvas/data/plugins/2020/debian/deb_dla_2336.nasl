...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.892336");
  script_cve_id("CVE-2020-17367", "CVE-2020-17368");
  script_tag(name:"creation_date", value:"2020-08-23 03:00:07 +0000 (Sun, 23 Aug 2020)");
  ...
  script_name("Debian: Security Advisory (DLA-2336)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2020 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2336");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/dla-2336");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/firejail");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'firejail' package(s) announced via the DLA-2336 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Tim Starling discovered two vulnerabilities in firejail, a sandbox program to restrict the running environment of untrusted applications.
