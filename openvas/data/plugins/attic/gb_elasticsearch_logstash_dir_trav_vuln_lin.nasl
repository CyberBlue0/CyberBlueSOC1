...
if(description)
{
  ...
  This VT has been deprecated and merged into the VT VT 'Elastic Logstash 'CVE-2015-4152' Directory Traversal Vulnerability' (OID: 1.3.6.1.4.1.25623.1.0.808094)");
