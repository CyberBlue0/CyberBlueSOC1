...
if(description)
{
  ...
  This VT has been deprecated and merged into the VT 'Elastic Logstash 'CVE-2014-4326' Remote Code Execution Vulnerability' (OID: 1.3.6.1.4.1.25623.1.0.808095)");
