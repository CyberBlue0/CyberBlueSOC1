...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.887425");
  ...
  script_tag(name:"creation_date", value:"2024-08-26 04:04:21 +0000 (Mon, 26 Aug 2024)");
  script_name("Fedora: Security Advisory for nginx (FEDORA-2024-8ba5080dfa)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-8ba5080dfa");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/NRCTPPABRILGFLVZMK2W4EDZRMZ3QH75");
