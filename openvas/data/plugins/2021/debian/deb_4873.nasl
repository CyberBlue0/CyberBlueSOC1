...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4873)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4873");
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4873");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/squid");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'squid' package(s) announced via the DSA-4873 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Jianjun Chen discovered that the Squid proxy caching server was susceptible to HTTP request smuggling.
