...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-04-18 17:58:00 +0000 (Mon, 18 Apr 2022)");

  script_name("Debian: Security Advisory (DLA-2765)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2765");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/dla-2765");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/mupdf");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mupdf' package(s) announced via the DLA-2765 advisory.");
