...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-03-26 21:04:00 +0000 (Fri, 26 Mar 2021)");

  script_name("Debian: Security Advisory (DLA-2553)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2553");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/dla-2553-2");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/xcftools");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'xcftools' package(s) announced via the DLA-2553 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"The patch to address CVE-2019-5086 and CVE-2019-5087 was not portable and did not work on 32 bit processor architectures. This update fixes the problem. For reference, the original advisory text follows.
