...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2525)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2525");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/dla-2525");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/wavpack");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wavpack' package(s) announced via the DLA-2525 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Multiple vulnerabilities in wavpack were found, like OOB read (which could potentially lead to a DOS attack), unexpected control flow, crashes, integer overflow, and segfaults.
