...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.892575");
  script_cve_id("CVE-2021-23968", "CVE-2021-23969", "CVE-2021-23973", "CVE-2021-23978");
  script_tag(name:"creation_date", value:"2021-02-26 04:00:07 +0000 (Fri, 26 Feb 2021)");
  ...
  script_name("Debian: Security Advisory (DLA-2575)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2575");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/dla-2575");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/firefox-esr");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'firefox-esr' package(s) announced via the DLA-2575 advisory.");
