...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2021-03-19 04:00:06 +0000 (Fri, 19 Mar 2021)");
  ...
  script_name("Debian: Security Advisory (DLA-2598)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2598");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/dla-2598");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/squid3");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'squid3' package(s) announced via the DLA-2598 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Due to improper input validation, Squid is vulnerable to an HTTP Request Smuggling attack.
...
For Debian 9 stretch, this problem has been fixed in version 3.5.23-5+deb9u6.
