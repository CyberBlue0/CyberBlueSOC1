...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.704951");
  script_cve_id("CVE-2020-26558", "CVE-2020-27153", "CVE-2021-0129");
  script_tag(name:"creation_date", value:"2021-08-08 03:00:09 +0000 (Sun, 08 Aug 2021)");
  ...
  script_name("Debian: Security Advisory (DSA-4951)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4951");
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4951");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/bluez");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'bluez' package(s) announced via the DSA-4951 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several vulnerabilities were discovered in Bluez, the Linux Bluetooth protocol stack.
