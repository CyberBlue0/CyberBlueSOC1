...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-10-19 17:41:00 +0000 (Tue, 19 Oct 2021)");

  script_name("Debian: Security Advisory (DSA-4979)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4979");
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4979");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/mediawiki");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mediawiki' package(s) announced via the DSA-4979 advisory.");
