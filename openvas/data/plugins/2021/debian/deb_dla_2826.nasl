...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-08-28 01:13:00 +0000 (Sat, 28 Aug 2021)");

  script_name("Debian: Security Advisory (DLA-2826)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2826");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/dla-2826");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/mbedtls");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mbedtls' package(s) announced via the DLA-2826 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several vulnerabilities were discovered in mbed TLS, a lightweight crypto and SSL/TLS library, which could result in denial of service, information disclosure or side-channel attacks.
