...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.112893");
  script_cve_id("CVE-2021-29967");
  script_tag(name:"creation_date", value:"2021-06-04 03:00:06 +0000 (Fri, 04 Jun 2021)");
  ...
  script_name("Debian: Security Advisory (DLA-2673)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2673");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/dla-2673");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/firefox-esr");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'firefox-esr' package(s) announced via the DLA-2673 advisory.");
...
For Debian 9 stretch, this problem has been fixed in version 78.11.0esr-1~deb9u1.
