...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2513)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2513");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/dla-2513");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/p11-kit");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'p11-kit' package(s) announced via the DLA-2513 advisory.");
