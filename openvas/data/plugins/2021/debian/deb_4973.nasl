...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.704973");
  script_cve_id("CVE-2021-38493");
  script_tag(name:"creation_date", value:"2021-09-12 01:00:07 +0000 (Sun, 12 Sep 2021)");
  ...
  script_name("Debian: Security Advisory (DSA-4973)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4973");
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4973");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/thunderbird");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'thunderbird' package(s) announced via the DSA-4973 advisory.");
