...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2524)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2524");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/dla-2524");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/spice-vdagent");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'spice-vdagent' package(s) announced via the DLA-2524 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several vulnerabilities were discovered in spice-vdagent, a spice guest agent for enhancing SPICE integration and experience.
