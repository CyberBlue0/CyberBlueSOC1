...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2021-09-14 01:00:07 +0000 (Tue, 14 Sep 2021)");
  ...
  script_name("Debian: Security Advisory (DLA-2757)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2757");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/dla-2757");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/thunderbird");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'thunderbird' package(s) announced via the DLA-2757 advisory.");
...
For Debian 9 stretch, this problem has been fixed in version 1:78.14.0-1~deb9u1.
