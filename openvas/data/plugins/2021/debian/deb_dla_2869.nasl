...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.892869");
  script_cve_id("CVE-2021-4008", "CVE-2021-4009", "CVE-2021-4011");
  script_tag(name:"creation_date", value:"2021-12-30 02:00:33 +0000 (Thu, 30 Dec 2021)");
  ...
  script_name("Debian: Security Advisory (DLA-2869)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2869");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/dla-2869");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/xorg-server");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'xorg-server' package(s) announced via the DLA-2869 advisory.");
...
For Debian 9 stretch, these problems have been fixed in version 2:1.19.2-1+deb9u9.
