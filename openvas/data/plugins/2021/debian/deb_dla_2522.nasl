...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.892522");
  script_cve_id("CVE-2020-26262");
  script_tag(name:"creation_date", value:"2021-01-13 04:00:31 +0000 (Wed, 13 Jan 2021)");
  ...
  script_name("Debian: Security Advisory (DLA-2522)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2522");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/dla-2522");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/coturn");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'coturn' package(s) announced via the DLA-2522 advisory.");
...
For Debian 9 stretch, this problem has been fixed in version 4.5.0.5-1+deb9u3.
