...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.704998");
  script_cve_id("CVE-2020-20445", "CVE-2020-20446", "CVE-2020-20450", "CVE-2020-20453", "CVE-2020-21688", "CVE-2020-21697", "CVE-2020-22037", "CVE-2020-22042", "CVE-2021-38114", "CVE-2021-38171", "CVE-2021-38291");
  script_tag(name:"creation_date", value:"2021-11-02 02:00:31 +0000 (Tue, 02 Nov 2021)");
  ...
  script_name("Debian: Security Advisory (DSA-4998)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4998");
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4998");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/ffmpeg");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ffmpeg' package(s) announced via the DSA-4998 advisory.");
