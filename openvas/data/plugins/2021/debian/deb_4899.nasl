...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4899)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4899");
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4899");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/openjdk-11");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openjdk-11' package(s) announced via the DSA-4899 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that the OpenJDK Java platform incompletely enforced configuration settings used in Jar signing verifications.

For the stable distribution (buster), this problem has been fixed in version 11.0.11+9-1~deb10u1.
