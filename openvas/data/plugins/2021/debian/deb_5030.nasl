...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705030");
  script_cve_id("CVE-2021-30887", "CVE-2021-30890");
  script_tag(name:"creation_date", value:"2021-12-25 02:00:10 +0000 (Sat, 25 Dec 2021)");
  ...
  script_name("Debian: Security Advisory (DSA-5030)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5030");
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-5030");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/webkit2gtk");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'webkit2gtk' package(s) announced via the DSA-5030 advisory.");
...
Narendra Bhati discovered that processing maliciously crafted web content may lead to unexpectedly unenforced Content Security Policy.
