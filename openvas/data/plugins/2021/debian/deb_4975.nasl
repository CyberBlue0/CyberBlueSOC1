...
if(description)
{
  ...
  script_cve_id("CVE-2021-30809", "CVE-2021-30836", "CVE-2021-30848", "CVE-2021-30849", "CVE-2021-30858", "CVE-2021-45482");
  ...
  script_name("Debian: Security Advisory (DSA-4975)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4975");
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4975");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/webkit2gtk");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'webkit2gtk' package(s) announced via the DSA-4975 advisory.");
