...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5019)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5019");
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-5019");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/wireshark");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wireshark' package(s) announced via the DSA-5019 advisory.");
...
For the oldstable distribution (buster), CVE-2021-39925 has been fixed in version 2.6.20-0+deb10u2.
