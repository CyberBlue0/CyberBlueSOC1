...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.704959");
  script_cve_id("CVE-2021-29980", "CVE-2021-29984", "CVE-2021-29985", "CVE-2021-29986", "CVE-2021-29988", "CVE-2021-29989");
  script_tag(name:"creation_date", value:"2021-08-16 03:00:23 +0000 (Mon, 16 Aug 2021)");
  ...
  script_name("Debian: Security Advisory (DSA-4959)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4959");
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4959");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/thunderbird");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'thunderbird' package(s) announced via the DSA-4959 advisory.");
