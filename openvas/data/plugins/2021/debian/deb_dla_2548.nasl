...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2548)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2548");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/dla-2548");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/privoxy");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'privoxy' package(s) announced via the DLA-2548 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Multiple vulnerabilities were discovered in privoxy, a privacy enhancing HTTP proxy, like memory leaks, dereference of a NULL-pointer, et al.
