...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.704862");
  script_cve_id("CVE-2021-23968", "CVE-2021-23969", "CVE-2021-23973", "CVE-2021-23978");
  script_tag(name:"creation_date", value:"2021-02-26 04:00:15 +0000 (Fri, 26 Feb 2021)");
  ...
  script_name("Debian: Security Advisory (DSA-4862)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4862");
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4862");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/firefox-esr");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'firefox-esr' package(s) announced via the DSA-4862 advisory.");
...
For the stable distribution (buster), these problems have been fixed in version 78.8.0esr-1~deb10u1.
