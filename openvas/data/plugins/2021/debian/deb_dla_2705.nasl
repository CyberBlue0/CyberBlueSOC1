...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2705)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2705");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'scilab' package(s) announced via the DLA-2705 advisory.");
