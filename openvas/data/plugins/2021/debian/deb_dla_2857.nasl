...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2857)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2857");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/dla-2857-2");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/postgis");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'postgis' package(s) announced via the DLA-2857 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"The regression of postgresql-9.6-postgis-2.3-scripts being empty in 2.3.1+dfsg-2+deb9u1 has been fixed.

For Debian 9 stretch, this problem has been fixed in version 2.3.1+dfsg-2+deb9u2.
