...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.892632");
  ...
  script_tag(name:"creation_date", value:"2021-04-23 03:00:13 +0000 (Fri, 23 Apr 2021)");
  ...
  script_name("Debian: Security Advisory (DLA-2632)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2632");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/dla-2632");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/thunderbird");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'thunderbird' package(s) announced via the DLA-2632 advisory.");
