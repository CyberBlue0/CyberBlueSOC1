...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4916)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4916");
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4916");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/prosody");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'prosody' package(s) announced via the DSA-4916 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Multiple security issues were found in Prosody, a lightweight Jabber/XMPP server, which could result in denial of service or information disclosure.
...
For the detailed security status of prosody please refer to its security tracker page at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'prosody' package(s) on Debian 10.");
