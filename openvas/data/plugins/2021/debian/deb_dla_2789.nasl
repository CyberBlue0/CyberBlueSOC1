...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2021-10-21 01:00:08 +0000 (Thu, 21 Oct 2021)");
  ...
  script_name("Debian: Security Advisory (DLA-2789)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2789");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/dla-2789");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/squashfs-tools");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'squashfs-tools' package(s) announced via the DLA-2789 advisory.");
...
For Debian 9 stretch, this problem has been fixed in version 1:4.3-3+deb9u3.
