...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.704986");
  script_cve_id("CVE-2021-41079");
  script_tag(name:"creation_date", value:"2021-10-16 01:00:42 +0000 (Sat, 16 Oct 2021)");
  ...
  script_name("Debian: Security Advisory (DSA-4986)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4986");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tomcat9' package(s) announced via the DSA-4986 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Two vulnerabilities were discovered in the Tomcat servlet and JSP engine, which could result in denial of service.
...
For the detailed security status of tomcat9 please refer to its security tracker page at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'tomcat9' package(s) on Debian 10, Debian 11.");
