...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.704981");
  script_cve_id("CVE-2021-38496", "CVE-2021-38500");
  script_tag(name:"creation_date", value:"2021-10-08 01:00:06 +0000 (Fri, 08 Oct 2021)");
  ...
  script_name("Debian: Security Advisory (DSA-4981)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4981");
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4981");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/firefox-esr");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'firefox-esr' package(s) announced via the DSA-4981 advisory.");
