...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4933)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4933");
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4933");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/nettle");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'nettle' package(s) announced via the DSA-4933 advisory.");
...
For the detailed security status of nettle please refer to its security tracker page at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'nettle' package(s) on Debian 10.");
