...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-04-06 19:37:00 +0000 (Wed, 06 Apr 2022)");

  script_name("Debian: Security Advisory (DLA-2635)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2635");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/dla-2635");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/libspring-java");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libspring-java' package(s) announced via the DLA-2635 advisory.");
