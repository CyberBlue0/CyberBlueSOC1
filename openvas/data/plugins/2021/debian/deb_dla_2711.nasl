...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2021-07-20 03:00:13 +0000 (Tue, 20 Jul 2021)");
  ...
  script_name("Debian: Security Advisory (DLA-2711)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2711");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/dla-2711");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/thunderbird");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'thunderbird' package(s) announced via the DLA-2711 advisory.");
...
For Debian 9 stretch, these problems have been fixed in version 1:78.12.0-1~deb9u1.
