...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-06-02 16:57:00 +0000 (Wed, 02 Jun 2021)");

  script_name("Debian: Security Advisory (DSA-4911)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4911");
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4911");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/chromium");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium' package(s) announced via the DSA-4911 advisory.");
