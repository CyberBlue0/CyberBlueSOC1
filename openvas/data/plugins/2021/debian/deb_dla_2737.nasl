...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2737)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2737");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/dla-2737");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/openjdk-8");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openjdk-8' package(s) announced via the DLA-2737 advisory.");
...
For Debian 9 stretch, these problems have been fixed in version 8u302-b08-1~deb9u1.
