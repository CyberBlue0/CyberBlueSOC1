...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2567)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2567");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/dla-2567");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/unrar-free");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'unrar-free' package(s) announced via the DLA-2567 advisory.");
...
For the detailed security status of unrar-free please refer to its security tracker page at: [link moved to references]

Further information about Debian LTS security advisories, how to apply these updates to your system and frequently asked questions can be found at: [link moved to references]");

  script_tag(name:"affected", value:"'unrar-free' package(s) on Debian 9.");
