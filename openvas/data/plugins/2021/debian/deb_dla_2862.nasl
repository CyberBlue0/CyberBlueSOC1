...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.892862");
  script_cve_id("CVE-2018-12020", "CVE-2019-6690");
  script_tag(name:"creation_date", value:"2021-12-29 02:00:22 +0000 (Wed, 29 Dec 2021)");
  ...
  script_name("Debian: Security Advisory (DLA-2862)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2862");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/dla-2862");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/python-gnupg");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'python-gnupg' package(s) announced via the DLA-2862 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"A couple of vulnerabilities were found in python-gnupg, a Python wrapper for the GNU Privacy Guard.
...
Further information about Debian LTS security advisories, how to apply these updates to your system and frequently asked questions can be found at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'python-gnupg' package(s) on Debian 9.");
