...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5007)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5007");
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-5007");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/postgresql-13");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'postgresql-13' package(s) announced via the DSA-5007 advisory.");
