...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-03-09 19:45:00 +0000 (Wed, 09 Mar 2022)");

  script_name("Debian: Security Advisory (DSA-5025)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5025");
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-5025");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/tang");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tang' package(s) announced via the DSA-5025 advisory.");
