...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2021-08-13 09:50:33 +0000 (Fri, 13 Aug 2021)");
  ...
  script_tag(name:"severity_date", value:"2021-08-25 16:57:00 +0000 (Wed, 25 Aug 2021)");

  script_name("Debian: Security Advisory (DLA-2740)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2740");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/dla-2740");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/firefox-esr");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'firefox-esr' package(s) announced via the DLA-2740 advisory.");
...
For Debian 9 stretch, these problems have been fixed in version 78.13.0esr-1~deb9u1.
