...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4904)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4904");
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4904");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/gst-plugins-ugly1.0");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gst-plugins-ugly1.0' package(s) announced via the DSA-4904 advisory.");
...
For the stable distribution (buster), this problem has been fixed in version 1.14.4-1+deb10u1.
