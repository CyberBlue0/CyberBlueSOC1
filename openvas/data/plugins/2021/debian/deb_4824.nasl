...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-01-27 20:51:00 +0000 (Wed, 27 Jan 2021)");

  script_name("Debian: Security Advisory (DSA-4824)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4824");
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4824");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/chromium");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium' package(s) announced via the DSA-4824 advisory.");
...
For the stable distribution (buster), these problems have been fixed in version 87.0.4280.88-0.4~deb10u1.
