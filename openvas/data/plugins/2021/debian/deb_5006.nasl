...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705006");
  script_cve_id("CVE-2021-23214", "CVE-2021-23222");
  script_tag(name:"creation_date", value:"2021-11-14 02:00:13 +0000 (Sun, 14 Nov 2021)");
  ...
  script_name("Debian: Security Advisory (DSA-5006)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5006");
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-5006");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/postgresql-11");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'postgresql-11' package(s) announced via the DSA-5006 advisory.");
