...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4822)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4822");
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4822");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/p11-kit");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'p11-kit' package(s) announced via the DSA-4822 advisory.");
