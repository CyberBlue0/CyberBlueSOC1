...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.892838");
  script_cve_id("CVE-2021-21898", "CVE-2021-21899", "CVE-2021-21900");
  script_tag(name:"creation_date", value:"2021-12-04 02:00:09 +0000 (Sat, 04 Dec 2021)");
  ...
  script_name("Debian: Security Advisory (DLA-2838)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2838");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'librecad' package(s) announced via the DLA-2838 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several vulnerabilities were discovered in LibreCAD, an application for computer aided design (CAD) in two dimensions. An attacker could trigger code execution through malicious .dwg and .dxf files.
