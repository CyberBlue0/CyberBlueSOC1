...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.704956");
  script_cve_id("CVE-2021-29980", "CVE-2021-29984", "CVE-2021-29985", "CVE-2021-29986", "CVE-2021-29988", "CVE-2021-29989");
  script_tag(name:"creation_date", value:"2021-08-13 09:50:43 +0000 (Fri, 13 Aug 2021)");
  ...
  script_name("Debian: Security Advisory (DSA-4956)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-4956");
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-4956");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/firefox-esr");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'firefox-esr' package(s) announced via the DSA-4956 advisory.");
