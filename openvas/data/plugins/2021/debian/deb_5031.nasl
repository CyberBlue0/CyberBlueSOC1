...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705031");
  script_cve_id("CVE-2021-30887", "CVE-2021-30890");
  script_tag(name:"creation_date", value:"2021-12-25 02:00:09 +0000 (Sat, 25 Dec 2021)");
  ...
  script_name("Debian: Security Advisory (DSA-5031)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5031");
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/dsa-5031");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/wpewebkit");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wpewebkit' package(s) announced via the DSA-5031 advisory.");
