...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818817");
  ...
  script_tag(name:"creation_date", value:"2021-10-14 15:31:53 +0530 (Thu, 14 Oct 2021)");
  script_name("Adobe Acrobat 2017 Security Update (APSB21-104) - Windows");
