...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.818824");
  ...
  script_tag(name:"severity_date", value:"2021-10-15 15:15:09 +0000 (Fri, 15 Oct 2021)");
  script_tag(name:"creation_date", value:"2021-10-14 17:50:12 +0530 (Thu, 14 Oct 2021)");
  script_name("Adobe Acrobat Classic 2020 Security Update (APSB21-104) - Mac OS X");
