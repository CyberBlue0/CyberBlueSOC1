...
if(description)
{
  ...
  script_name("Microsoft Windows Defender Antimalware Platform RCE Vulnerability (Jan 2021)");
...
if(version_is_less(version:mpe_version, test_version:"1.1.17600.5")){
  report = report_fixed_ver(installed_version:exempe_versionVer, fixed_version: "1.1.17600.5");
