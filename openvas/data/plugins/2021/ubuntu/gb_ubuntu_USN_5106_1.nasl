...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845094");
  script_cve_id("CVE-2020-26541", "CVE-2021-22543", "CVE-2021-3612", "CVE-2021-38160", "CVE-2021-38199", "CVE-2021-41073");
  script_tag(name:"creation_date", value:"2021-10-07 01:00:24 +0000 (Thu, 07 Oct 2021)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5106-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5106-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5106-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-meta-oem-5.10, linux-oem-5.10, linux-signed-oem-5.10' package(s) announced via the USN-5106-1 advisory.");
