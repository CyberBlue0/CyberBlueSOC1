...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4900-1)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'openexr' package(s) announced via the USN-4900-1 advisory.");
...
arbitrary code.");
  ...
  script_tag(name:"affected", value:"'openexr' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 20.10.");
