...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-5030-1)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libdbi-perl' package(s) announced via the USN-5030-1 advisory.");
...
Ubuntu 18.04 LTS. (CVE-2020-14393)");
  ...
  script_tag(name:"affected", value:"'libdbi-perl' package(s) on Ubuntu 18.04, Ubuntu 20.04.");
