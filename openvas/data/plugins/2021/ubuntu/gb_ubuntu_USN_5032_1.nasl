...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-5032-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5032-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5032-1");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/1938908");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'docker.io' package(s) announced via the USN-5032-1 advisory.");
  ...
  script_tag(name:"affected", value:"'docker.io' package(s) on Ubuntu 18.04, Ubuntu 20.04.");
