...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.844788");
  script_cve_id("CVE-2020-35653", "CVE-2020-35654", "CVE-2020-35655");
  script_tag(name:"creation_date", value:"2021-01-19 04:00:19 +0000 (Tue, 19 Jan 2021)");
  ...
  script_name("Ubuntu: Security Advisory (USN-4697-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4697-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4697-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pillow' package(s) announced via the USN-4697-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Pillow incorrectly handled certain PCX image files.
