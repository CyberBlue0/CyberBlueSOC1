...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-5170-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5170-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5170-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mariadb-10.3, mariadb-10.5' package(s) announced via the USN-5170-1 advisory.");
...
new features, and possibly incompatible changes.");
  ...
  script_tag(name:"affected", value:"'mariadb-10.3, mariadb-10.5' package(s) on Ubuntu 20.04, Ubuntu 21.04, Ubuntu 21.10.");
