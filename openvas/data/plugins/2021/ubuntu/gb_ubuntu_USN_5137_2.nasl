...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-5137-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5137-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5137-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-bluefield, linux-gke-5.4, linux-meta-bluefield, linux-meta-gke-5.4, linux-meta-oracle, linux-meta-oracle-5.4, linux-meta-raspi, linux-meta-raspi-5.4, linux-oracle, linux-oracle-5.4, linux-raspi, linux-raspi-5.4, linux-signed-bluefield, linux-signed-gke-5.4, linux-signed-oracle, linux-signed-oracle-5.4' package(s) announced via the USN-5137-2 advisory.");
...
cause a denial of service (memory exhaustion). (CVE-2021-3759)");
  ...
  script_tag(name:"affected", value:"'linux-bluefield, linux-gke-5.4, linux-meta-bluefield, linux-meta-gke-5.4, linux-meta-oracle, linux-meta-oracle-5.4, linux-meta-raspi, linux-meta-raspi-5.4, linux-oracle, linux-oracle-5.4, linux-raspi, linux-raspi-5.4, linux-signed-bluefield, linux-signed-gke-5.4, linux-signed-oracle, linux-signed-oracle-5.4' package(s) on Ubuntu 18.04, Ubuntu 20.04.");
