...
if(description)
{
  ...
  script_cve_id("CVE-2021-20239", "CVE-2021-20268", "CVE-2021-3178", "CVE-2021-3347", "CVE-2021-3348");
  ...
  script_name("Ubuntu: Security Advisory (USN-4910-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4910-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4910-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-aws, linux-azure, linux-gcp, linux-hwe-5.8, linux-kvm, linux-meta, linux-meta-aws, linux-meta-azure, linux-meta-gcp, linux-meta-hwe-5.8, linux-meta-kvm, linux-meta-oracle, linux-meta-raspi, linux-oracle, linux-raspi, linux-signed, linux-signed-azure, linux-signed-gcp, linux-signed-hwe-5.8, linux-signed-kvm, linux-signed-oracle' package(s) announced via the USN-4910-1 advisory.");
