...
if(description)
{
  ...
  script_cve_id("CVE-2019-17514", "CVE-2019-20907", "CVE-2019-9674", "CVE-2020-26116", "CVE-2020-27619", "CVE-2020-8492", "CVE-2021-3177");
  ...
  script_name("Ubuntu: Security Advisory (USN-4754-3)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4754-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4754-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python2.7, python3.7, python3.8' package(s) announced via the USN-4754-3 advisory.");
...
Original advisory details:
 ...
 or cause a denial of service. (CVE-2020-27619, CVE-2021-3177)");
  ...
  script_tag(name:"affected", value:"'python2.7, python3.7, python3.8' package(s) on Ubuntu 18.04, Ubuntu 20.04.");
