...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845120");
  script_cve_id("CVE-2021-38503", "CVE-2021-38504", "CVE-2021-38506", "CVE-2021-38507", "CVE-2021-38508", "CVE-2021-38509");
  script_tag(name:"creation_date", value:"2021-11-04 02:00:31 +0000 (Thu, 04 Nov 2021)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5131-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5131-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5131-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox' package(s) announced via the USN-5131-1 advisory.");
