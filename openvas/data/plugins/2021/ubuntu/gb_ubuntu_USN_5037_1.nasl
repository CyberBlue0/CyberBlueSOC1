...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-08-25 16:59:00 +0000 (Wed, 25 Aug 2021)");

  script_name("Ubuntu: Security Advisory (USN-5037-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5037-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5037-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox' package(s) announced via the USN-5037-1 advisory.");
