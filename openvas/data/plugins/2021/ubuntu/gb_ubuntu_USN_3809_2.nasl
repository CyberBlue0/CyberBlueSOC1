...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-3809-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-3809-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-3809-2");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/1934501");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openssh' package(s) announced via the USN-3809-2 advisory.");
...
Original advisory details:
 ...
 (CVE-2018-15473)");
  ...
  script_tag(name:"affected", value:"'openssh' package(s) on Ubuntu 18.04.");
