...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.844932");
  script_cve_id("CVE-2020-35519", "CVE-2021-28375", "CVE-2021-29646", "CVE-2021-29650", "CVE-2021-30002");
  script_tag(name:"creation_date", value:"2021-05-12 03:01:16 +0000 (Wed, 12 May 2021)");
  ...
  script_name("Ubuntu: Security Advisory (USN-4947-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4947-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4947-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-meta-oem-5.6, linux-oem-5.6, linux-signed-oem-5.6' package(s) announced via the USN-4947-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Kiyin (Yin Liang ) discovered that the x25 implementation in the Linux kernel
