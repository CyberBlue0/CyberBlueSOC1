...
if(description)
{
  ...
  script_cve_id("CVE-2017-1000501", "CVE-2020-29600", "CVE-2020-35176");
  ...
  script_name("Ubuntu: Security Advisory (USN-4953-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4953-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4953-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'awstats' package(s) announced via the USN-4953-1 advisory.");
...
information. (CVE-2020-35176)");
  ...
  script_tag(name:"affected", value:"'awstats' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 20.10.");
