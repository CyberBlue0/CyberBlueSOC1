...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4932-1)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-django' package(s) announced via the USN-4932-1 advisory.");
