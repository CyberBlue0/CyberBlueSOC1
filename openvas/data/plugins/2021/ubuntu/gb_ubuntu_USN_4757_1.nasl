...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.844855");
  script_cve_id("CVE-2021-27803");
  script_tag(name:"creation_date", value:"2021-03-04 04:00:22 +0000 (Thu, 04 Mar 2021)");
  ...
  script_name("Ubuntu: Security Advisory (USN-4757-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4757-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4757-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'wpa' package(s) announced via the USN-4757-1 advisory.");
