...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.844774");
  ...
  script_name("Ubuntu: Security Advisory (USN-4682-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4682-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4682-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'wavpack' package(s) announced via the USN-4682-1 advisory.");
...
cause a crash.");
  ...
  script_tag(name:"affected", value:"'wavpack' package(s) on Ubuntu 18.04, Ubuntu 20.04, Ubuntu 20.10.");
