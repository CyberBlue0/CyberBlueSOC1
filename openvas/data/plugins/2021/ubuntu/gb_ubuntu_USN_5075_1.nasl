...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-02-28 19:52:00 +0000 (Mon, 28 Feb 2022)");

  script_name("Ubuntu: Security Advisory (USN-5075-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5075-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5075-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ghostscript' package(s) announced via the USN-5075-1 advisory.");
...
service.");
  ...
  script_tag(name:"affected", value:"'ghostscript' package(s) on Ubuntu 20.04, Ubuntu 21.04.");
