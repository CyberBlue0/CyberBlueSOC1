...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845130");
  ...
  script_tag(name:"creation_date", value:"2021-11-12 02:00:39 +0000 (Fri, 12 Nov 2021)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5142-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5142-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'samba' package(s) announced via the USN-5142-1 advisory.");
