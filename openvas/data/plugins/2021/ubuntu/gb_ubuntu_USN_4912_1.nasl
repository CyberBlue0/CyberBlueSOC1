...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-meta-oem-5.6, linux-oem-5.6, linux-signed-oem-5.6' package(s) announced via the USN-4912-1 advisory.");
