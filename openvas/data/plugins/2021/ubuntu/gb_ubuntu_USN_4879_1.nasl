...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.844867");
  script_cve_id("CVE-2020-36158", "CVE-2021-20194");
  script_tag(name:"creation_date", value:"2021-03-17 04:00:45 +0000 (Wed, 17 Mar 2021)");
  ...
  script_tag(name:"severity_date", value:"2021-03-31 12:29:00 +0000 (Wed, 31 Mar 2021)");

  script_name("Ubuntu: Security Advisory (USN-4879-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4879-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4879-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-aws, linux-azure, linux-gcp, linux-hwe-5.8, linux-kvm, linux-meta, linux-meta-aws, linux-meta-azure, linux-meta-gcp, linux-meta-hwe-5.8, linux-meta-kvm, linux-meta-oracle, linux-meta-raspi, linux-oracle, linux-raspi, linux-signed, linux-signed-azure, linux-signed-gcp, linux-signed-hwe-5.8, linux-signed-kvm, linux-signed-oracle' package(s) announced via the USN-4879-1 advisory.");
