...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.844820");
  ...
  script_tag(name:"creation_date", value:"2021-02-09 04:00:48 +0000 (Tue, 09 Feb 2021)");
  ...
  script_name("Ubuntu: Security Advisory (USN-4724-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4724-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4724-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openldap' package(s) announced via the USN-4724-1 advisory.");
