...
if(description)
{
  ...
  script_cve_id("CVE-2021-23239", "CVE-2021-3156");
  ...
  script_name("Ubuntu: Security Advisory (USN-4705-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4705-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4705-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'sudo' package(s) announced via the USN-4705-1 advisory.");
...
not. (CVE-2021-23239)");
  ...
  script_tag(name:"affected", value:"'sudo' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 20.10.");
