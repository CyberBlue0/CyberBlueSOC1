...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845098");
  script_cve_id("CVE-2021-41072");
  script_tag(name:"creation_date", value:"2021-10-14 01:00:28 +0000 (Thu, 14 Oct 2021)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5078-3)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5078-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5078-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'squashfs-tools' package(s) announced via the USN-5078-3 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-5078-1 fixed a vulnerability in Squashfs-Tools. That update was
...
Original advisory details:
 ...
 write arbitrary files to the filesystem.");
  ...
  script_tag(name:"affected", value:"'squashfs-tools' package(s) on Ubuntu 20.04, Ubuntu 21.04.");
