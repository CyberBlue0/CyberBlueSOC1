...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845140");
  script_cve_id("CVE-2021-3658", "CVE-2021-41229", "CVE-2021-43400");
  script_tag(name:"creation_date", value:"2021-11-24 02:00:39 +0000 (Wed, 24 Nov 2021)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5155-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5155-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5155-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'bluez' package(s) announced via the USN-5155-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that BlueZ incorrectly handled the Discoverable status
...
BlueZ to crash, leading to a denial of service. (CVE-2021-43400)");
  ...
  script_tag(name:"affected", value:"'bluez' package(s) on Ubuntu 18.04, Ubuntu 20.04, Ubuntu 21.04, Ubuntu 21.10.");
