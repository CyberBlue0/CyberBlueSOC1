...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-hwe-5.4, linux-meta-hwe-5.4, linux-signed-hwe-5.4' package(s) announced via the USN-5071-2 advisory.");
...
registered. (CVE-2021-3612)");
  ...
  script_tag(name:"affected", value:"'linux-hwe-5.4, linux-meta-hwe-5.4, linux-signed-hwe-5.4' package(s) on Ubuntu 18.04.");
