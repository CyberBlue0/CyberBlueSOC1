...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.844890");
  script_cve_id("CVE-2020-8161", "CVE-2020-8184");
  script_tag(name:"creation_date", value:"2021-04-07 03:00:38 +0000 (Wed, 07 Apr 2021)");
  ...
  script_name("Ubuntu: Security Advisory (USN-4561-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4561-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4561-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ruby-rack' package(s) announced via the USN-4561-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-4561-1 fixed vulnerabilities in Rack. This update provides the
...
Original advisory details:
 ...
 could possibly use this issue to forge a secure cookie. (CVE-2020-8184)");
  ...
  script_tag(name:"affected", value:"'ruby-rack' package(s) on Ubuntu 16.04, Ubuntu 20.04, Ubuntu 20.10.");
