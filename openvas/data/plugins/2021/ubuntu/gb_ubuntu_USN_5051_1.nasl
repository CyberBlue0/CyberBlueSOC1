...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-5051-1)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'openssl' package(s) announced via the USN-5051-1 advisory.");
...
(CVE-2021-3712)");
  ...
  script_tag(name:"affected", value:"'openssl' package(s) on Ubuntu 18.04, Ubuntu 20.04, Ubuntu 21.04.");
