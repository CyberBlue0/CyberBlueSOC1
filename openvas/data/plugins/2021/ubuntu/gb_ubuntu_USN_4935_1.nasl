...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.844923");
  script_cve_id("CVE-2021-1076", "CVE-2021-1077");
  script_tag(name:"creation_date", value:"2021-05-05 03:01:14 +0000 (Wed, 05 May 2021)");
...
issue to cause a denial of service. (CVE-2021-1077)");
  ...
  script_tag(name:"affected", value:"'nvidia-graphics-drivers-390, nvidia-graphics-drivers-418-server, nvidia-graphics-drivers-450, nvidia-graphics-drivers-450-server, nvidia-graphics-drivers-460, nvidia-graphics-drivers-460-server' package(s) on Ubuntu 18.04, Ubuntu 20.04, Ubuntu 20.10, Ubuntu 21.04.");
