...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-meta-raspi2, linux-raspi2' package(s) announced via the USN-5094-2 advisory.");
