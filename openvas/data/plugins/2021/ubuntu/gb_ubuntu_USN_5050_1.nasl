...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845034");
  script_cve_id("CVE-2020-26558", "CVE-2021-0129", "CVE-2021-28691", "CVE-2021-3564", "CVE-2021-3573", "CVE-2021-38208");
  script_tag(name:"creation_date", value:"2021-08-25 03:00:37 +0000 (Wed, 25 Aug 2021)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5050-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5050-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5050-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws-5.8, linux-azure-5.8, linux-gcp-5.8, linux-meta-aws-5.8, linux-meta-azure-5.8, linux-meta-gcp-5.8, linux-meta-oracle-5.8, linux-oracle-5.8, linux-signed-azure-5.8, linux-signed-gcp-5.8, linux-signed-oracle-5.8' package(s) announced via the USN-5050-1 advisory.");
...
(CVE-2021-38208)");
  ...
  script_tag(name:"affected", value:"'linux-aws-5.8, linux-azure-5.8, linux-gcp-5.8, linux-meta-aws-5.8, linux-meta-azure-5.8, linux-meta-gcp-5.8, linux-meta-oracle-5.8, linux-oracle-5.8, linux-signed-azure-5.8, linux-signed-gcp-5.8, linux-signed-oracle-5.8' package(s) on Ubuntu 20.04.");
