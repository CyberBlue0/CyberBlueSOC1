...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845086");
  script_cve_id("CVE-2021-41103");
  script_tag(name:"creation_date", value:"2021-10-05 01:00:45 +0000 (Tue, 05 Oct 2021)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5100-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5100-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5100-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'containerd' package(s) announced via the USN-5100-1 advisory.");
...
programs on the host filesystem, possibly leading to privilege escalation.");
  ...
  script_tag(name:"affected", value:"'containerd' package(s) on Ubuntu 18.04, Ubuntu 20.04, Ubuntu 21.04.");
