...
if(description)
{
  ...
  script_cve_id("CVE-2021-3492", "CVE-2021-3493");
  ...
  script_name("Ubuntu: Security Advisory (USN-4915-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4915-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4915-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-meta-oem-5.6, linux-oem-5.6, linux-signed-oem-5.6' package(s) announced via the USN-4915-1 advisory.");
