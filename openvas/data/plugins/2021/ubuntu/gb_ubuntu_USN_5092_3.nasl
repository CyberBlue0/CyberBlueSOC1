...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure, linux-azure-5.11, linux-meta-azure, linux-meta-azure-5.11, linux-signed-azure, linux-signed-azure-5.11' package(s) announced via the USN-5092-3 advisory.");
...
It was discovered that the MAX-3421 ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-azure, linux-azure-5.11, linux-meta-azure, linux-meta-azure-5.11, linux-signed-azure, linux-signed-azure-5.11' package(s) on Ubuntu 20.04, Ubuntu 21.04.");
