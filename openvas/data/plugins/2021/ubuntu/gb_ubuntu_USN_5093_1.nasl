...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845076");
  script_cve_id("CVE-2021-3770", "CVE-2021-3778", "CVE-2021-3796");
  script_tag(name:"creation_date", value:"2021-09-29 01:00:31 +0000 (Wed, 29 Sep 2021)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5093-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5093-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5093-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'vim' package(s) announced via the USN-5093-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Brian Carpenter discovered that vim incorrectly handled memory
...
arbitrary code with user privileges. (CVE-2021-3796)");
  ...
  script_tag(name:"affected", value:"'vim' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 21.04.");
