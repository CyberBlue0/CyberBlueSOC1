...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845064");
  script_cve_id("CVE-2020-17507", "CVE-2021-38593");
  script_tag(name:"creation_date", value:"2021-09-17 01:00:30 +0000 (Fri, 17 Sep 2021)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5081-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5081-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5081-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'qtbase-opensource-src' package(s) announced via the USN-5081-1 advisory.");
...
denial of service. (CVE-2021-38593)");
  ...
  script_tag(name:"affected", value:"'qtbase-opensource-src' package(s) on Ubuntu 18.04.");
