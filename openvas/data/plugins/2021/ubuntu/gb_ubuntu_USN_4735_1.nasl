...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4735-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4735-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4735-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'postgresql-12' package(s) announced via the USN-4735-1 advisory.");
...
possibly use this issue to obtain sensitive information.");
  ...
  script_tag(name:"affected", value:"'postgresql-12' package(s) on Ubuntu 20.04, Ubuntu 20.10.");
