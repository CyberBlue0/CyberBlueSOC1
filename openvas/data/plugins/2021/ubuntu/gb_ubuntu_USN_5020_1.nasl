...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-5020-1)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'ruby2.3, ruby2.5, ruby2.7' package(s) announced via the USN-5020-1 advisory.");
...
(CVE-2021-32066)");
  ...
  script_tag(name:"affected", value:"'ruby2.3, ruby2.5, ruby2.7' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 20.10, Ubuntu 21.04.");
