...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.844897");
  script_cve_id("CVE-2020-25639", "CVE-2021-28038", "CVE-2021-28375", "CVE-2021-28950");
  script_tag(name:"creation_date", value:"2021-04-14 03:00:40 +0000 (Wed, 14 Apr 2021)");
  ...
  script_name("Ubuntu: Security Advisory (USN-4911-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4911-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4911-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-meta-oem-5.10, linux-oem-5.10, linux-signed-oem-5.10' package(s) announced via the USN-4911-1 advisory.");
