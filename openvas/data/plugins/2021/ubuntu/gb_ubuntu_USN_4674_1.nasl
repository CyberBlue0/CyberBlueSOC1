...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.844778");
  script_cve_id("CVE-2020-24386", "CVE-2020-25275");
  script_tag(name:"creation_date", value:"2021-01-11 10:57:46 +0000 (Mon, 11 Jan 2021)");
  ...
  script_name("Ubuntu: Security Advisory (USN-4674-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4674-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4674-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dovecot' package(s) announced via the USN-4674-1 advisory.");
...
to crash, resulting in a denial of service. (CVE-2020-25275)");
  ...
  script_tag(name:"affected", value:"'dovecot' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 20.10.");
