...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-hwe-5.4, linux-meta, linux-signed' package(s) announced via the USN-4712-1 advisory.");
...
Original vulnerability details:
 ...
 gain read access to restricted files.");
  ...
  script_tag(name:"affected", value:"'linux, linux-hwe-5.4, linux-meta, linux-signed' package(s) on Ubuntu 18.04, Ubuntu 20.04, Ubuntu 20.10.");
