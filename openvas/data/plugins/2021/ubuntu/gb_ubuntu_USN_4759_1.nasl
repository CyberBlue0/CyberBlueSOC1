...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.844860");
  script_cve_id("CVE-2021-27218", "CVE-2021-27219");
  script_tag(name:"creation_date", value:"2021-03-09 04:00:23 +0000 (Tue, 09 Mar 2021)");
  ...
  script_name("Ubuntu: Security Advisory (USN-4759-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4759-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4759-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'glib2.0' package(s) announced via the USN-4759-1 advisory.");
...
execute arbitrary code. (CVE-2021-27219)");
  ...
  script_tag(name:"affected", value:"'glib2.0' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 20.10.");
