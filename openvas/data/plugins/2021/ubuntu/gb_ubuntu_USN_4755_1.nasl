...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4755-1)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'tiff' package(s) announced via the USN-4755-1 advisory.");
...
denial of service, or possibly execute arbitrary code with user privileges.");
  ...
  script_tag(name:"affected", value:"'tiff' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 20.10.");
