...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-5053-1)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libssh' package(s) announced via the USN-5053-1 advisory.");
...
denial of service, or possibly execute arbitrary code.");
  ...
  script_tag(name:"affected", value:"'libssh' package(s) on Ubuntu 20.04, Ubuntu 21.04.");
