...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845024");
  script_cve_id("CVE-2021-3449", "CVE-2021-3677");
  script_tag(name:"creation_date", value:"2021-08-13 03:00:22 +0000 (Fri, 13 Aug 2021)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5038-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5038-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5038-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'postgresql-10, postgresql-12, postgresql-13' package(s) announced via the USN-5038-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that the PostgresQL planner could create incorrect plans
...
of service. (CVE-2021-3449)");
  ...
  script_tag(name:"affected", value:"'postgresql-10, postgresql-12, postgresql-13' package(s) on Ubuntu 18.04, Ubuntu 20.04, Ubuntu 21.04.");
