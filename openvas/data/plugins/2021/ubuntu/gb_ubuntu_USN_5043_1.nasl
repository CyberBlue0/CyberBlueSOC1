...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-5043-1)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'exiv2' package(s) announced via the USN-5043-1 advisory.");
...
CVE-2021-37619, CVE-2021-37621, CVE-2021-37623)");
  ...
  script_tag(name:"affected", value:"'exiv2' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 21.04.");
