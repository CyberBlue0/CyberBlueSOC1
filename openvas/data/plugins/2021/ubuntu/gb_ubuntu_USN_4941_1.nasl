...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.817722");
  script_cve_id("CVE-2021-29457", "CVE-2021-29458", "CVE-2021-29470", "CVE-2021-3482");
  script_tag(name:"creation_date", value:"2021-05-11 03:00:23 +0000 (Tue, 11 May 2021)");
  ...
  script_name("Ubuntu: Security Advisory (USN-4941-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4941-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4941-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'exiv2' package(s) announced via the USN-4941-1 advisory.");
