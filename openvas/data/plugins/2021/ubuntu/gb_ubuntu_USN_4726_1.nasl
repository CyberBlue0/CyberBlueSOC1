...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4726-1");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/1914824");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openjdk-8, openjdk-lts' package(s) announced via the USN-4726-1 advisory.");
