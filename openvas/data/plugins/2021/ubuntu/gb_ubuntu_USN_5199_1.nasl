...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845170");
  script_cve_id("CVE-2021-3733", "CVE-2021-3737");
  script_tag(name:"creation_date", value:"2021-12-18 02:00:27 +0000 (Sat, 18 Dec 2021)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5199-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5199-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5199-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3.6' package(s) announced via the USN-5199-1 advisory.");
...
(CVE-2021-3737)");
  ...
  script_tag(name:"affected", value:"'python3.6' package(s) on Ubuntu 18.04.");
