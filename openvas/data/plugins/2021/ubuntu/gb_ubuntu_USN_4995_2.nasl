...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4995-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4995-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4995-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird' package(s) announced via the USN-4995-2 advisory.");
...
Original advisory details:
 ...
 (CVE-2021-29957)");
  ...
  script_tag(name:"affected", value:"'thunderbird' package(s) on Ubuntu 18.04.");
