...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845133");
  ...
  script_name("Ubuntu: Security Advisory (USN-5140-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5140-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5140-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-meta-oem-5.14, linux-oem-5.14, linux-signed-oem-5.14' package(s) announced via the USN-5140-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that the AMD Cryptographic Coprocessor (CCP) driver in
