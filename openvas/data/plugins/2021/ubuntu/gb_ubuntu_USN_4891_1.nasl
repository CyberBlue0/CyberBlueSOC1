...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4891-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4891-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4891-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openssl' package(s) announced via the USN-4891-1 advisory.");
...
OpenSSL to crash, resulting in a denial of service.");
  ...
  script_tag(name:"affected", value:"'openssl' package(s) on Ubuntu 18.04, Ubuntu 20.04, Ubuntu 20.10.");
