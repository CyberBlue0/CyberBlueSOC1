...
if(description)
{
  ...
  script_cve_id("CVE-2018-1128", "CVE-2020-10736", "CVE-2020-10753", "CVE-2020-25660");
  ...
  script_name("Ubuntu: Security Advisory (USN-4706-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4706-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4706-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ceph' package(s) announced via the USN-4706-1 advisory.");
