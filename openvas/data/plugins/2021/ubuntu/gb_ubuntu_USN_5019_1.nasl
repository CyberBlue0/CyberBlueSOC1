...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-5019-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5019-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5019-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nvidia-graphics-drivers-390, nvidia-graphics-drivers-418-server, nvidia-graphics-drivers-450-server, nvidia-graphics-drivers-460, nvidia-graphics-drivers-460-server' package(s) announced via the USN-5019-1 advisory.");
...
attacker could use this to cause a denial of service. (CVE-2021-1095)");
  ...
  script_tag(name:"affected", value:"'nvidia-graphics-drivers-390, nvidia-graphics-drivers-418-server, nvidia-graphics-drivers-450-server, nvidia-graphics-drivers-460, nvidia-graphics-drivers-460-server' package(s) on Ubuntu 18.04, Ubuntu 20.04, Ubuntu 20.10, Ubuntu 21.04.");
