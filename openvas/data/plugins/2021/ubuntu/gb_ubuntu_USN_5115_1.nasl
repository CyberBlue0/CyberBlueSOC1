...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-meta-oem-5.10, linux-oem-5.10, linux-signed-oem-5.10' package(s) announced via the USN-5115-1 advisory.");
