...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4927-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2021 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-4927-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4927-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'file-roller' package(s) announced via the USN-4927-1 advisory.");
...
An attacker could possibly use this issue to expose sensitive information.");
  ...
  script_tag(name:"affected", value:"'file-roller' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 20.10.");
