...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-kvm, linux-meta-kvm, linux-signed-kvm' package(s) announced via the USN-5000-2 advisory.");
...
use this issue to cause a denial of service (system crash) or ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-kvm, linux-meta-kvm, linux-signed-kvm' package(s) on Ubuntu 20.04.");
