...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.117850");
  ...
  script_name("Elastic Logstash Multiple Log4j Vulnerabilities (Dec 2021)");
  ...
  script_tag(name:"summary", value:"Elastic Logstash is prone to multiple vulnerabilities in the
