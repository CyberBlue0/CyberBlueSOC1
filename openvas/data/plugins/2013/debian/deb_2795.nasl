...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-02-26 15:14:00 +0000 (Fri, 26 Feb 2021)");

  script_name("Debian: Security Advisory (DSA-2795)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2013 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-2795");
  script_xref(name:"URL", value:"https://www.debian.org/security/2013/dsa-2795");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'lighttpd' package(s) announced via the DSA-2795 advisory.");
