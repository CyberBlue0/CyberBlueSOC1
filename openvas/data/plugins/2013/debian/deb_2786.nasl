...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.702786");
  ...
  script_name("Debian: Security Advisory (DSA-2786)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2013 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-2786");
  script_xref(name:"URL", value:"https://www.debian.org/security/2013/dsa-2786");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'icu' package(s) announced via the DSA-2786 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"The Google Chrome Security Team discovered two issues (a race condition and a use-after-free issue) in the International Components for Unicode (ICU) library.
...
We recommend that you upgrade your icu packages.");
  ...
  script_tag(name:"affected", value:"'icu' package(s) on Debian 6, Debian 7.");
