...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.702680");
  ...
  script_name("Debian: Security Advisory (DSA-2680)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2013 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-2680");
  script_xref(name:"URL", value:"https://www.debian.org/security/2013/dsa-2680");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libxt' package(s) announced via the DSA-2680 advisory.");
...
We recommend that you upgrade your libxt packages.");
  ...
  script_tag(name:"affected", value:"'libxt' package(s) on Debian 6, Debian 7.");
