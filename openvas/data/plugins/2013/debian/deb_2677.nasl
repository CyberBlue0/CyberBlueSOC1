...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.702677");
  ...
  script_name("Debian: Security Advisory (DSA-2677)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2013 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-2677");
  script_xref(name:"URL", value:"https://www.debian.org/security/2013/dsa-2677");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libxrender' package(s) announced via the DSA-2677 advisory.");
...
We recommend that you upgrade your libxrender packages.");
  ...
  script_tag(name:"affected", value:"'libxrender' package(s) on Debian 6, Debian 7.");
