...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2615)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2013 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-2615");
  script_xref(name:"URL", value:"https://www.debian.org/security/2013/dsa-2615");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libupnp4' package(s) announced via the DSA-2615 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Multiple stack-based buffer overflows were discovered in libupnp4, a library used for handling the Universal Plug and Play protocol. HD Moore from Rapid7 discovered that SSDP queries where not correctly handled by the unique_service_name() function.
...
We recommend that you upgrade your libupnp4 packages.");
  ...
  script_tag(name:"affected", value:"'libupnp4' package(s) on Debian 6.");
