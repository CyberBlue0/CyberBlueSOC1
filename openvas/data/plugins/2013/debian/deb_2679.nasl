...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.702679");
  ...
  script_name("Debian: Security Advisory (DSA-2679)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2013 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-2679");
  script_xref(name:"URL", value:"https://www.debian.org/security/2013/dsa-2679");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'xserver-xorg-video-openchrome' package(s) announced via the DSA-2679 advisory.");
...
For the unstable distribution (sid), this problem has been fixed in version 1:0.2.906-2+deb7u1.

We recommend that you upgrade your xserver-xorg-video-openchrome packages.");

  script_tag(name:"affected", value:"'xserver-xorg-video-openchrome' package(s) on Debian 6, Debian 7.");
