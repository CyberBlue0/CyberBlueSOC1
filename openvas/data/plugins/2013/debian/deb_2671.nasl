...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.702671");
  script_cve_id("CVE-2012-4733", "CVE-2013-3368", "CVE-2013-3369", "CVE-2013-3370", "CVE-2013-3371", "CVE-2013-3372", "CVE-2013-3373", "CVE-2013-3374", "CVE-2013-5587");
  ...
  script_name("Debian: Security Advisory (DSA-2671)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2013 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-2671");
  script_xref(name:"URL", value:"https://www.debian.org/security/2013/dsa-2671");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'request-tracker4' package(s) announced via the DSA-2671 advisory.");
...
A user with the ModifyTicket right can bypass the DeleteTicket right or any custom lifecycle transition rights and thus modify ticket data without authorization.
...
For the stable distribution (wheezy), these problems have been fixed in version 4.0.7-5+deb7u2.

For the testing distribution (jessie), these problems will be fixed soon.

For the unstable distribution (sid), these problems have been fixed in version 4.0.12-2.
