...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2651)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2013 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-2651");
  script_xref(name:"URL", value:"https://www.debian.org/security/2013/dsa-2651");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'smokeping' package(s) announced via the DSA-2651 advisory.");
...
For the stable distribution (squeeze), this problem has been fixed in version 2.3.6-5+squeeze1.
...
We recommend that you upgrade your smokeping packages.");
  ...
  script_tag(name:"affected", value:"'smokeping' package(s) on Debian 6.");
