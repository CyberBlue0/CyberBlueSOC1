...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.702678");
  ...
  script_name("Debian: Security Advisory (DSA-2678)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2013 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-2678");
  script_xref(name:"URL", value:"https://www.debian.org/security/2013/dsa-2678");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mesa' package(s) announced via the DSA-2678 advisory.");
...
For the oldstable distribution (squeeze), this problem has been fixed in version 7.7.1-6.

For the stable distribution (wheezy), this problem has been fixed in version 8.0.5-4+deb7u1.
...
We recommend that you upgrade your mesa packages.");
  ...
  script_tag(name:"affected", value:"'mesa' package(s) on Debian 6, Debian 7.");
