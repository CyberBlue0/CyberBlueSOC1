...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2752)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2013 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-2752");
  script_xref(name:"URL", value:"https://www.debian.org/security/2013/dsa-2752");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'phpbb3' package(s) announced via the DSA-2752 advisory.");
