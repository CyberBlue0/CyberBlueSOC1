...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.841445");
  ...
  script_name("Ubuntu: Security Advisory (USN-1844-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2013 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1844-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1844-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux' package(s) announced via the USN-1844-1 advisory.");
