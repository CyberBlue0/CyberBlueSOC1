...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.841637");
  script_cve_id("CVE-2013-1741", "CVE-2013-2566", "CVE-2013-5605", "CVE-2013-5607");
  script_tag(name:"creation_date", value:"2013-11-26 06:55:39 +0000 (Tue, 26 Nov 2013)");
  ...
  script_name("Ubuntu: Security Advisory (USN-2032-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2013 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2032-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2032-1");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/1253027");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird' package(s) announced via the USN-2032-1 advisory.");
