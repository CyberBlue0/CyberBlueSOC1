...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.841645");
  script_cve_id("CVE-2013-4299", "CVE-2013-4350", "CVE-2013-4387", "CVE-2013-6431");
  script_tag(name:"creation_date", value:"2013-12-04 04:56:30 +0000 (Wed, 04 Dec 2013)");
  script_version("2024-01-19T05:06:16+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:16 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"6.1");
  script_tag(name:"cvss_base_vector", value:"AV:A/AC:L/Au:N/C:N/I:N/A:C");

  script_name("Ubuntu: Security Advisory (USN-2041-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2013 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2041-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2041-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-lts-raring' package(s) announced via the USN-2041-1 advisory.");
