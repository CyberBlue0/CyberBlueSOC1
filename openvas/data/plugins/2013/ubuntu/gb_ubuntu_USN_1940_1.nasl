...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2013-09-12 06:15:59 +0000 (Thu, 12 Sep 2013)");
  ...
  script_name("Ubuntu: Security Advisory (USN-1940-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2013 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1940-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1940-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-ec2' package(s) announced via the USN-1940-1 advisory.");
