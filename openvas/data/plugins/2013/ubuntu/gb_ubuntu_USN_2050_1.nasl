...
if(description)
{
  ...
  script_cve_id("CVE-2013-0343", "CVE-2013-2147", "CVE-2013-2888", "CVE-2013-2889", "CVE-2013-2892", "CVE-2013-2893", "CVE-2013-2895", "CVE-2013-2896", "CVE-2013-2897", "CVE-2013-2899", "CVE-2013-4299", "CVE-2013-4350", "CVE-2013-4387", "CVE-2013-4470", "CVE-2014-1444", "CVE-2014-1445");
  script_tag(name:"creation_date", value:"2013-12-17 06:39:12 +0000 (Tue, 17 Dec 2013)");
  script_version("2024-01-19T05:06:16+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:16 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"6.9");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:M/Au:N/C:C/I:C/A:C");

  script_name("Ubuntu: Security Advisory (USN-2050-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2013 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2050-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2050-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-ti-omap4' package(s) announced via the USN-2050-1 advisory.");
...
A flaw was discovered in the Linux kernel's dm snapshot facility. A ... [Please see the references for more information on the vulnerabilities]");
