...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2013-10-03 04:50:45 +0000 (Thu, 03 Oct 2013)");
  script_version("2024-01-19T05:06:16+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:16 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:N");

  script_name("Ubuntu: Security Advisory (USN-1985-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2013 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1985-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1985-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3.3' package(s) announced via the USN-1985-1 advisory.");
...
information or alter encrypted communications. (CVE-2013-4238)");
  ...
  script_tag(name:"affected", value:"'python3.3' package(s) on Ubuntu 12.10, Ubuntu 13.04.");
