...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2013-08-01 13:42:51 +0000 (Thu, 01 Aug 2013)");
  script_version("2024-01-19T05:06:16+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:16 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");

  script_name("Ubuntu: Security Advisory (USN-1907-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2013 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1907-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1907-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openjdk-7' package(s) announced via the USN-1907-1 advisory.");
...
integrity. (CVE-2013-2453, CVE-2013-2455, CVE-2013-2457)");
  ...
  script_tag(name:"affected", value:"'openjdk-7' package(s) on Ubuntu 12.10, Ubuntu 13.04.");
