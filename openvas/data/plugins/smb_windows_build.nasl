...
# nb:
# - Does not work for systems older than Windows Server 2016 / Windows 10 per default as PS5.1 is
#   required
...
set_kb_item(name:"MS_VT/Windows/Arch", value:os_arch);
set_kb_item(name:"MS_VT/Windows/FullBuild", value:full_build);
...
if (os_type == "2" || os_type == "3") {
  ...
  set_kb_item(name:"MS_VT/Windows/InstallType", value:install_type);
