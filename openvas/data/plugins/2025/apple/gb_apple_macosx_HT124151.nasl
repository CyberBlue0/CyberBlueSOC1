...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836555");
  ...
  script_cve_id("CVE-2025-43191", "CVE-2025-43186", "CVE-2025-43244", "CVE-2025-31243",
                ...
                "CVE-2025-43259", "CVE-2025-43238", "CVE-2025-43252");
  ...
  script_name("Apple MacOSX Security Update (HT124151)");
  ...
  script_tag(name:"solution", value:"Update macOS Ventura to version 13.7.7 or
  later.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"package");
  script_xref(name:"URL", value:"https://support.apple.com/en-us/124151");
...
if(version_is_less(version:osVer, test_version:"13.7.7")) {
  report = report_fixed_ver(installed_version:osVer, fixed_version:"13.7.7");
