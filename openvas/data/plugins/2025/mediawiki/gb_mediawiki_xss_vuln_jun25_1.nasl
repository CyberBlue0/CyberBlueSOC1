...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.128158");
  ...
  script_cve_id("CVE-2025-49577");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("MediaWiki >= 2.13.0 < 3.3.1 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"Citizen is a MediaWiki skin that makes extensions part of the
  cohesive experience. Various preferences messages are inserted into raw HTML, allowing anybody
  who can edit those messages to insert arbitrary HTML into the DOM");

  script_tag(name:"affected", value:"MediaWiki version through 2.13.0 prior to 3.3.1.");

  script_tag(name:"solution", value:"Update to version 3.3.1 or later.");

  script_xref(name:"URL", value:"https://github.com/StarCitizenTools/mediawiki-skins-Citizen/security/advisories/GHSA-jwr7-992g-68mh");
...
if (version_in_range(version: version, test_version: "2.13.0", test_version2: "3.3.1")) {
