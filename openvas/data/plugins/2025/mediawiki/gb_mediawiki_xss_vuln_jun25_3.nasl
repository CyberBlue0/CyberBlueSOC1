...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.128160");
  ...
  script_cve_id("CVE-2025-49578");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("MediaWiki >= 3.3.0 < 3.3.1 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"Various date messages returned by Language::userDate are
  inserted into raw HTML, allowing anybody who can edit those messages to insert arbitrary HTML
  into the DOM.");

  script_tag(name:"affected", value:"MediaWiki version through 3.3.0 prior to 3.3.1.");

  script_tag(name:"solution", value:"Update to version 3.3.1 or later.");

  script_xref(name:"URL", value:"https://github.com/advisories/GHSA-2v3v-3whp-953h");
