...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836376");
  ...
  script_name("Mozilla Thunderbird ESR Security Update (mfsa_2025-46) - Mac OS X");
  ...
  script_xref(name:"URL", value:"https://www.mozilla.org/en-US/security/advisories/mfsa2025-46/");
...
if(version_is_less(version:vers, test_version:"128.11")) {
