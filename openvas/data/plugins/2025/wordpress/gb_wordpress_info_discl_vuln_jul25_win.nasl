...
if(description)
{
  ...
  script_name("WordPress Information Disclosure Vulnerability (July 2025) - Windows");
  ...
  script_tag(name:"summary", value:"WordPress is prone to an information disclosure vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"WordPress allows remote attackers to guess titles of private and
  draft posts via pingback.ping XML-RPC requests. NOTE: the Supplier is not changing this behavior.");
