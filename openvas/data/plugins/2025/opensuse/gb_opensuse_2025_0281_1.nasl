...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.857017");
  ...
  script_name("openSUSE: Security Advisory for go1.22 (SUSE-SU-2025:0281-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2025 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0281-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/7XTI4KUOONR5HJF44MSTEKVTUVIZ6IS6");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'go1.22'
  package(s) announced via the SUSE-SU-2025:0281-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  script_tag(name:"affected", value:"'go1.22' package(s) on openSUSE Leap 15.6.");
