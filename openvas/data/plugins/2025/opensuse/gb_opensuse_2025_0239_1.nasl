...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856992");
  script_version("2025-08-07T05:44:51+0000");
  script_xref(name:"CISA", value:"Known Exploited Vulnerability (KEV) catalog");
  script_xref(name:"URL", value:"https://www.cisa.gov/known-exploited-vulnerabilities-catalog");
  script_cve_id("CVE-2021-47291", "CVE-2021-47598", "CVE-2022-48956", "CVE-2023-52752", "CVE-2024-26923", "CVE-2024-35861", "CVE-2024-35862", "CVE-2024-35864", "CVE-2024-35950", "CVE-2024-36904", "CVE-2024-36964", "CVE-2024-36971", "CVE-2024-41059", "CVE-2024-43861", "CVE-2024-50264");
  ...
  script_tag(name:"creation_date", value:"2025-01-28 05:02:42 +0000 (Tue, 28 Jan 2025)");
  script_name("openSUSE: Security Advisory for the Linux Kernel (Live Patch 45 for SLE 15 SP3) (SUSE-SU-2025:0239-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2025 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0239-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/VBKJOKHJGUZRHPVCGSRZVBF6ZMI7KJY7");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'the Linux Kernel (Live Patch 45 for SLE 15 SP3)'
  package(s) announced via the SUSE-SU-2025:0239-1 advisory.
