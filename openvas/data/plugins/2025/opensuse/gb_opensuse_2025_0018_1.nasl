...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for dpdk (SUSE-SU-2025:0018-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2025 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0018-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/AGTGYRLZAB3VTHQDY2AHVWHLGD4DIL4D");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dpdk'
  package(s) announced via the SUSE-SU-2025:0018-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  * CVE-2024-11614: Fixed Denial Of Service from malicious guest on hypervisors
      using DPDK Vhost library (bsc#1234718)");
