...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856947");
  ...
  script_tag(name:"creation_date", value:"2025-01-17 05:00:23 +0000 (Fri, 17 Jan 2025)");
  script_name("openSUSE: Security Advisory for the Linux Kernel (Live Patch 13 for SLE 15 SP5) (SUSE-SU-2025:0146-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2025 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0146-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/C6ANXHEO54VUUFEWI6QYB2M3L2SS7OOW");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'the Linux Kernel (Live Patch 13 for SLE 15 SP5)'
  package(s) announced via the SUSE-SU-2025:0146-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This update for the Linux Kernel 5.14.21-150500_55_62 fixes several issues.
  ...
  * CVE-2024-26828: Fixed underflow in parse_server_interfaces() (bsc#1223363).");
  ...
  script_tag(name:"affected", value:"'the Linux Kernel (Live Patch 13 for SLE 15 SP5)' package(s) on openSUSE Leap 15.5.");
