...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856935");
  ...
  script_tag(name:"creation_date", value:"2025-01-16 05:02:38 +0000 (Thu, 16 Jan 2025)");
  script_name("openSUSE: Security Advisory for rsync (SUSE-SU-2025:0122-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2025 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0122-2");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/FDJSS5UVGBZXCNVBX4FQ77W4TUNRVECV");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rsync'
  package(s) announced via the SUSE-SU-2025:0122-2 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  NOTE: This update was retracted as one of the fixes was broken. A new update
  will be issued.
  ...
  * CVE-2024-12088: bypass of the --safe-links flag may allow the placement of
  ...
  script_tag(name:"affected", value:"'rsync' package(s) on openSUSE Leap 15.4, openSUSE Leap 15.5.");
