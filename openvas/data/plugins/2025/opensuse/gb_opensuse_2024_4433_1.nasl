...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2025-01-08 12:21:12 +0530 (Wed, 08 Jan 2025)");
  script_name("openSUSE: Security Advisory for govulncheck (SUSE-SU-2024:4433-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2025 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:4433-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/JWEVRKKYW3XAKTAG4ZZPVOGHRS3G2CTH");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'govulncheck'
  package(s) announced via the SUSE-SU-2024:4433-1 advisory.
