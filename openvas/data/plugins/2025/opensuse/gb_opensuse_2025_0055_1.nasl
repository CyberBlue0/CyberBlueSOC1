...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856905");
  ...
  script_tag(name:"creation_date", value:"2025-01-10 05:00:28 +0000 (Fri, 10 Jan 2025)");
  script_name("openSUSE: Security Advisory for gstreamer (SUSE-SU-2025:0055-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2025 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0055-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/ZR4JWLTM5UGIYENGQ4DPVYNAVYUZGQ2S");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gstreamer'
  package(s) announced via the SUSE-SU-2025:0055-1 advisory.
