...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856924");
  ...
  script_tag(name:"creation_date", value:"2025-01-15 05:01:11 +0000 (Wed, 15 Jan 2025)");
  script_name("openSUSE: Security Advisory for the Linux Kernel (Live Patch 22 for SLE 15 SP4) (SUSE-SU-2025:0108-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2025 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0108-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/PSSR42U6R2R4DCGBQVMQRZ4BUEZ47QGX");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'the Linux Kernel (Live Patch 22 for SLE 15 SP4)'
  package(s) announced via the SUSE-SU-2025:0108-1 advisory.
