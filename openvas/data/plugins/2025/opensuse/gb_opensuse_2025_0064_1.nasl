...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856912");
  ...
  script_tag(name:"creation_date", value:"2025-01-11 05:00:32 +0000 (Sat, 11 Jan 2025)");
  script_name("openSUSE: Security Advisory for gstreamer (SUSE-SU-2025:0064-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2025 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0064-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/7W7QOMEYC4R74XEEEPFRHKF4KPKXOAZK");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gstreamer'
  package(s) announced via the SUSE-SU-2025:0064-1 advisory.
