...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856984");
  ...
  script_tag(name:"creation_date", value:"2025-01-28 05:00:08 +0000 (Tue, 28 Jan 2025)");
  script_name("openSUSE: Security Advisory for the Linux Kernel (Live Patch 12 for SLE 15 SP5) (SUSE-SU-2025:0253-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2025 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0253-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/N5UIXAE5EZXVQRTRSHX65GPBNLWOM3HZ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'the Linux Kernel (Live Patch 12 for SLE 15 SP5)'
  package(s) announced via the SUSE-SU-2025:0253-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  The following security issues were fixed:
    ...
    * CVE-2024-35950: drm/client: Fully protect modes with dev->mode_config.mutex
      (bsc#1225310).
    * CVE-2024-26923: Fixed false-positive lockdep splat for spin_ ...
