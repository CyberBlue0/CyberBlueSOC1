...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856980");
  script_version("2025-02-20T08:47:14+0000");
  script_cve_id("CVE-2025-22150", "CVE-2025-23083", "CVE-2025-23085");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2025-02-20 08:47:14 +0000 (Thu, 20 Feb 2025)");
  script_tag(name:"creation_date", value:"2025-01-25 05:00:05 +0000 (Sat, 25 Jan 2025)");
  script_name("openSUSE: Security Advisory for nodejs20 (SUSE-SU-2025:0237-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2025 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0237-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/4GHLFJIFCCY7T6727ECCVQVUTXPGIN56");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nodejs20'
  package(s) announced via the SUSE-SU-2025:0237-1 advisory.
