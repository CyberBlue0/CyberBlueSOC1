...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for govulncheck (SUSE-SU-2025:0297-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2025 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0297-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/SJZPZE7XC24OQL4RE3HZGEDJBGXUVL5C");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'govulncheck'
  package(s) announced via the SUSE-SU-2025:0297-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  script_tag(name:"insight", value:"This update for govulncheck-vulndb fixes the following issues:
    ...
    * Update to version 0.0.20250128T150132 2025-01-28T15:01:32Z. Refs
    ...
    * Update to version 0.0.20250128T004730 2025-01-28T00:47:30Z. Refs
      jsc#PED-11136 Go CVE Numbering Authority IDs added or updated with aliases:
    ...
    * Update to version 0.0.20250117T214834 2025-01-17T21:48:34Z. Refs
      jsc#PED-11136 Go CVE Numbering Authority IDs added or updated with aliases:
    ...
    * Update to version 0.0.20250115T172141 2025-01-15T17:21:41Z. Refs
      jsc#PED-11136 Go CVE Numbering Authority IDs added or updated with aliases:
    ...
    * Update to version 0.0.20250109T194159 2025-01-09T19:41:59Z. Refs
      jsc#PED-11136 Go CVE Numbering Authority IDs added or updated with aliases:
  ...
  script_tag(name:"affected", value:"'govulncheck' package(s) on openSUSE Leap 15.6.");
