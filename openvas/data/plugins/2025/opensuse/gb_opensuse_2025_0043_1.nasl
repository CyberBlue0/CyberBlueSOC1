...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856903");
  ...
  script_tag(name:"creation_date", value:"2025-01-10 05:00:18 +0000 (Fri, 10 Jan 2025)");
  script_name("openSUSE: Security Advisory for webkit2gtk3 (SUSE-SU-2025:0043-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2025 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0043-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/GHKR3MZPJPBPNRT7Q5XDKGIK3LKPHWSM");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'webkit2gtk3'
  package(s) announced via the SUSE-SU-2025:0043-1 advisory.
