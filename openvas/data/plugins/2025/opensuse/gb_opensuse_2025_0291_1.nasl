...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for iperf (SUSE-SU-2025:0291-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2025 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0291-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/FFROPYDPJFJQOHFRTULDQK7V66SQQ7QZ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'iperf'
  package(s) announced via the SUSE-SU-2025:0291-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  script_tag(name:"insight", value:"This update for iperf fixes the following issues:
    ...
    * CVE-2024-53580: Fixed a segmentation violation via the
      iperf_exchange_parameters() function. (bsc#1234705)");
