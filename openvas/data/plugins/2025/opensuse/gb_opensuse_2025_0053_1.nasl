...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856906");
  ...
  script_tag(name:"creation_date", value:"2025-01-10 05:00:45 +0000 (Fri, 10 Jan 2025)");
  script_name("openSUSE: Security Advisory for gstreamer (SUSE-SU-2025:0053-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2025 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0053-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/UWQ66UIR5WRSR2SWK4O4RDXEV5TAXHWR");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gstreamer'
  package(s) announced via the SUSE-SU-2025:0053-1 advisory.
