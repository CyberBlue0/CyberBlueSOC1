...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856930");
  script_version("2025-02-20T08:47:14+0000");
  script_cve_id("CVE-2024-12084", "CVE-2024-12085", "CVE-2024-12086", "CVE-2024-12087", "CVE-2024-12088");
  ...
  script_tag(name:"creation_date", value:"2025-01-16 05:00:42 +0000 (Thu, 16 Jan 2025)");
  script_name("openSUSE: Security Advisory for rsync (SUSE-SU-2025:0118-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2025 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0118-2");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/4BRNRPJ3VCRVJMGFGC5EPYWUJTTXNY57");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rsync'
  package(s) announced via the SUSE-SU-2025:0118-2 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  NOTE: this update is broken and was retracted. New update will be published as
  followup update.
  ...
  * CVE-2024-12088: bypass of the --safe-links flag may allow the placement of
  ...
  script_tag(name:"affected", value:"'rsync' package(s) on openSUSE Leap 15.6.");
