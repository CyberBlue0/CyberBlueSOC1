...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856994");
  ...
  script_tag(name:"creation_date", value:"2025-01-28 05:03:20 +0000 (Tue, 28 Jan 2025)");
  script_name("openSUSE: Security Advisory for the Linux Kernel (Live Patch 11 for SLE 15 SP5) (SUSE-SU-2025:0252-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2025 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0252-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/LEEQ7D3EJ6CXFAUUFH4RVHIPRAIS6DUT");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'the Linux Kernel (Live Patch 11 for SLE 15 SP5)'
  package(s) announced via the SUSE-SU-2025:0252-1 advisory.
