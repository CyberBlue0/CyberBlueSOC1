...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856950");
  script_version("2025-02-20T08:47:14+0000");
  script_cve_id("CVE-2021-47517", "CVE-2021-47598", "CVE-2022-48956", "CVE-2023-52752", "CVE-2023-52846", "CVE-2024-26923", "CVE-2024-35949", "CVE-2024-36899", "CVE-2024-36904", "CVE-2024-40909", "CVE-2024-40954", "CVE-2024-41059", "CVE-2024-43861", "CVE-2024-50264");
  ...
  script_tag(name:"creation_date", value:"2025-01-17 05:01:02 +0000 (Fri, 17 Jan 2025)");
  script_name("openSUSE: Security Advisory for the Linux Kernel (Live Patch 15 for SLE 15 SP5) (SUSE-SU-2025:0138-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2025 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0138-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/ET3TDUWYDTZV554NRC7LB5HGM4TCIIGZ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'the Linux Kernel (Live Patch 15 for SLE 15 SP5)'
  package(s) announced via the SUSE-SU-2025:0138-1 advisory.
