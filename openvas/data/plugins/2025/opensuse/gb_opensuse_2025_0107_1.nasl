...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856925");
  script_version("2025-02-20T08:47:14+0000");
  script_cve_id("CVE-2021-47598", "CVE-2022-48651", "CVE-2022-48662", "CVE-2022-48956", "CVE-2023-52340", "CVE-2023-52502", "CVE-2023-52752", "CVE-2023-52846", "CVE-2023-6546", "CVE-2024-23307", "CVE-2024-26585", "CVE-2024-26610", "CVE-2024-26622", "CVE-2024-26766", "CVE-2024-26828", "CVE-2024-26852", "CVE-2024-26923", "CVE-2024-26930", "CVE-2024-27398", "CVE-2024-35817", "CVE-2024-35861", "CVE-2024-35862", "CVE-2024-35863", "CVE-2024-35864", "CVE-2024-35867", "CVE-2024-35950", "CVE-2024-36899", "CVE-2024-36904", "CVE-2024-36964", "CVE-2024-40954", "CVE-2024-41059", "CVE-2024-43861", "CVE-2024-50264");
  ...
  script_tag(name:"creation_date", value:"2025-01-15 05:01:12 +0000 (Wed, 15 Jan 2025)");
  script_name("openSUSE: Security Advisory for the Linux Kernel (Live Patch 23 for SLE 15 SP4) (SUSE-SU-2025:0107-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2025 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0107-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/WBQRAHBBLBMV634E2RCPJNX4BWRSTU2J");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'the Linux Kernel (Live Patch 23 for SLE 15 SP4)'
  package(s) announced via the SUSE-SU-2025:0107-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This update for the Linux Kernel 5.14.21-150400_24_108 fixes several issues.
  ...
  * CVE-2024-26852: Fixed use-after-free ...

  Description truncated. Please see the references for more information.");

  script_tag(name:"affected", value:"'the Linux Kernel (Live Patch 23 for SLE 15 SP4)' package(s) on openSUSE Leap 15.4.");
