...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for nvidia (SUSE-SU-2025:0207-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2025 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0207-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/YPRCWB3A5EJFJXM4LJOOCSKH667ZDOU5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nvidia'
  package(s) announced via the SUSE-SU-2025:0207-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  * fixes CVE-2024-0131, CVE-2024-0147, CVE-2024-0149, CVE-2024-0150,
  ...
  script_tag(name:"affected", value:"'nvidia' package(s) on openSUSE Leap 15.6.");
