...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for python310 (SUSE-SU-2025:0049-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2025 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2025:0049-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/LWXPVE6AKWHEV6LBAVR6EUVO2QMG6E3P");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python310'
  package(s) announced via the SUSE-SU-2025:0049-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  * Update to 3.10.16");
  ...
  script_tag(name:"affected", value:"'python310' package(s) on openSUSE Leap 15.4, openSUSE Leap 15.6.");
