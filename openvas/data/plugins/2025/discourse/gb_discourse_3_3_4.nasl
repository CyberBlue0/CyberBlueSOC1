...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.153937");
  script_version("2025-04-11T15:45:04+0000");
  script_tag(name:"last_modification", value:"2025-04-11 15:45:04 +0000 (Fri, 11 Apr 2025)");
  script_tag(name:"creation_date", value:"2025-02-05 03:21:02 +0000 (Wed, 05 Feb 2025)");
  script_tag(name:"cvss_base", value:"6.4");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:P");

  script_cve_id("CVE-2024-56197", "CVE-2024-56328", "CVE-2025-22602", "CVE-2025-24808",
                "CVE-2025-24972");
  ...
  script_name("Discourse < 3.3.4 Multiple Vulnerabilities");
  ...
  script_tag(name:"affected", value:"Discourse prior to version 3.3.4.");

  script_tag(name:"solution", value:"Update to version 3.3.4 or later.");
...
if (version_is_less(version: version, test_version: "3.3.4")) {
