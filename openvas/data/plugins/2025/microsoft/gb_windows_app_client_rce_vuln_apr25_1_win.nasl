...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.836131");
  ...
  script_tag(name:"creation_date", value:"2025-04-10 17:47:05 +0530 (Thu, 10 Apr 2025)");
  script_name("Windows App Client < 2.0.379.0 RCE Vulnerability (Apr 2025) - Windows");
  ...
  script_tag(name:"affected", value:"Microsoft Windows App Client prior to version  2.0.379.0 on Microsoft Windows .");

  script_tag(name:"solution", value:"Update to version 2.0.379.0 or later.");
...
if(version_is_less(version:version, test_version:"2.0.379.0")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "2.0.379.0", install_path: location);
