...
if (description)
{
  ...
  script_cve_id("CVE-2025-53023");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL Server 8.0.0 - 8.0.42 Security Update (cpujul2025) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server version 8.0.0 through 8.0.42.");

  script_tag(name:"solution", value:"Update to version 8.0.43 or later.");
