...
if (description)
{
  ...
  script_cve_id("CVE-2025-21492");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL Server 8.0 - 8.0.36, 8.4.0 Security Update (cpujan2025) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server version 8.0 through 8.0.36 and 8.4.0.");

  script_tag(name:"solution", value:"Update to version 8.0.37, 8.4.1 or later.");
