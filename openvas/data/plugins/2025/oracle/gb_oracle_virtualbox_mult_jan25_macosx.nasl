...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834907");
  ...
  script_tag(name:"creation_date", value:"2025-01-22 12:02:14 +0530 (Wed, 22 Jan 2025)");
  script_name("Oracle VirtualBox Security Update (Jan 2025) - Mac OS X");
  ...
  - CVE-2025-21533: An error in the Core component of Oracle VM VirtualBox.

  - CVE-2025-21571: An error in the Core component of Oracle VM VirtualBox.");

  script_tag(name:"impact", value:"Successful exploitation allows an attacker
  to perform limited unauthorized modifications to data, disclose information
  and cause denial of service attacks.");

  script_tag(name:"affected", value:"Oracle VM VirtualBox version 7.0.x prior
  to 7.0.24 and 7.1.x prior to 7.1.6 on Mac OS X.");

  script_tag(name:"solution", value:"Update to version 7.0.24 or 7.1.6 or
  later.");
...
if(vers =~ "^7\.0\." && version_is_less(version:vers, test_version:"7.0.24")) {
  fix = "7.0.24";
}

if(vers =~ "^7\.1\." && version_is_less(version:vers, test_version:"7.1.6")) {
  fix = "7.1.6";
}
