...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.154946");
  script_version("2025-07-17T05:43:33+0000");
  script_tag(name:"last_modification", value:"2025-07-17 05:43:33 +0000 (Thu, 17 Jul 2025)");
  script_tag(name:"creation_date", value:"2025-07-16 03:56:54 +0000 (Wed, 16 Jul 2025)");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:N/I:N/A:C");
  script_tag(name:"severity_vector", value:"CVSS:3.1/AV:N/AC:L/PR:L/UI:N/S:U/C:N/I:N/A:H");
  script_tag(name:"severity_origin", value:"NVD");
  script_tag(name:"severity_date", value:"2025-07-15 20:15:43 +0000 (Tue, 15 Jul 2025)");

  script_cve_id("CVE-2025-50076");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL Server 8.0.0 - 8.0.25 Security Update (cpujul2025) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server version 8.0.0 through 8.0.25.");
...
if (version_in_range(version: version, test_version: "8.0.0", test_version2: "8.0.25")) {
