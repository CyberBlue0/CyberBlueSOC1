...
if (description)
{
  ...
  script_cve_id("CVE-2025-50095", "CVE-2025-50103");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Oracle MySQL Server 9.0.0 - 9.3.0 Security Update (cpujul2025) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle MySQL Server version 9.0.0 through 9.3.0.");

  script_tag(name:"solution", value:"Update to version 9.3.1 or later.");
