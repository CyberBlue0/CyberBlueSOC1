...
if( ret = product_reached_eol( cpe:CPE, version:ver ) ) {
  report = eol_build_message( name:"VMware Spring Framework",
                              cpe:CPE,
                              version:ver,
