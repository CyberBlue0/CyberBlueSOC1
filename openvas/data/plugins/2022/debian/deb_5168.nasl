...
if(description)
{
  ...
  script_cve_id("CVE-2022-2156", "CVE-2022-2157", "CVE-2022-2158", "CVE-2022-2160", "CVE-2022-2161", "CVE-2022-2162", "CVE-2022-2163", "CVE-2022-2164", "CVE-2022-2165", "CVE-2022-2415");
  ...
  script_tag(name:"severity_date", value:"2022-08-02 21:06:00 +0000 (Tue, 02 Aug 2022)");

  script_name("Debian: Security Advisory (DSA-5168)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5168");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5168");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/chromium");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium' package(s) announced via the DSA-5168 advisory.");
