...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-3121)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-3121");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-3121");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/firefox-esr");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'firefox-esr' package(s) announced via the DLA-3121 advisory.");
...
This update brings back support for the i386 and arm64 architectures. Support for the armhf architecture is still missing, pending some changes to the buildd network.

For Debian 10 buster, these problems have been fixed in version 102.3.0esr-1~deb10u2.
