...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.892881");
  ...
  script_tag(name:"creation_date", value:"2022-01-17 02:00:22 +0000 (Mon, 17 Jan 2022)");
  ...
  script_name("Debian: Security Advisory (DLA-2881)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2881");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-2881");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/thunderbird");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'thunderbird' package(s) announced via the DLA-2881 advisory.");
...
For Debian 9 stretch, these problems have been fixed in version 1:91.5.0-1~deb9u1.
