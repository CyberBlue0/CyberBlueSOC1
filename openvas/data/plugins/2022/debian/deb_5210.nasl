...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705210");
  script_cve_id("CVE-2022-32792", "CVE-2022-32816", "CVE-2022-32891");
  script_tag(name:"creation_date", value:"2022-08-18 01:00:07 +0000 (Thu, 18 Aug 2022)");
  ...
  script_name("Debian: Security Advisory (DSA-5210)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5210");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5210");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/webkit2gtk");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'webkit2gtk' package(s) announced via the DSA-5210 advisory.");
