...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-3174)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-3174");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-3174");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/pysha3");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'pysha3' package(s) announced via the DLA-3174 advisory.");
...
For Debian 10 buster, this problem has been fixed in version 1.0.2-2+deb10u1.
...
Further information about Debian LTS security advisories, how to apply these updates to your system and frequently asked questions can be found at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'pysha3' package(s) on Debian 10.");
