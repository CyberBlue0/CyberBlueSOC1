...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5053)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5053");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'pillow' package(s) announced via the DSA-5053 advisory.");
...
For the detailed security status of pillow please refer to its security tracker page at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'pillow' package(s) on Debian 10, Debian 11.");
