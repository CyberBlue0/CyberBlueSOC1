...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705045");
  ...
  script_tag(name:"creation_date", value:"2022-01-16 02:01:32 +0000 (Sun, 16 Jan 2022)");
  ...
  script_name("Debian: Security Advisory (DSA-5045)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5045");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5045");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/thunderbird");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'thunderbird' package(s) announced via the DSA-5045 advisory.");
