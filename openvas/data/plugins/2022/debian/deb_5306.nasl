...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5306)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5306");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5306");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/gerbv");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gerbv' package(s) announced via the DSA-5306 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several vulnerabilities were discovered in gerbv, a Gerber file viewer, which could result in the execution of arbitrary code, denial of service or information disclosure if a specially crafted file is processed.
...
For the detailed security status of gerbv please refer to its security tracker page at: [link moved to references].");
  ...
  script_tag(name:"affected", value:"'gerbv' package(s) on Debian 11.");
