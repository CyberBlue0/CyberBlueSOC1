...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.893086");
  script_cve_id("CVE-2022-29599");
  script_tag(name:"creation_date", value:"2022-08-30 01:00:07 +0000 (Tue, 30 Aug 2022)");
  ...
  script_name("Debian: Security Advisory (DLA-3086)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-3086");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-3086");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/maven-shared-utils");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'maven-shared-utils' package(s) announced via the DLA-3086 advisory.");
...
Further information about Debian LTS security advisories, how to apply these updates to your system and frequently asked questions can be found at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'maven-shared-utils' package(s) on Debian 10.");
