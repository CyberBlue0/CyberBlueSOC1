...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.892879");
  script_cve_id("CVE-2021-45944", "CVE-2021-45949");
  script_tag(name:"creation_date", value:"2022-01-15 02:00:15 +0000 (Sat, 15 Jan 2022)");
  ...
  script_name("Debian: Security Advisory (DLA-2879)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2879");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-2879");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/ghostscript");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ghostscript' package(s) announced via the DLA-2879 advisory.");
