...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.892952");
  script_cve_id("CVE-2019-1551", "CVE-2022-0778");
  script_tag(name:"creation_date", value:"2022-03-18 02:00:05 +0000 (Fri, 18 Mar 2022)");
  ...
  script_name("Debian: Security Advisory (DLA-2952)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2952");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-2952");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/openssl");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openssl' package(s) announced via the DLA-2952 advisory.");
