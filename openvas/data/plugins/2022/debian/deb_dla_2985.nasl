...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.892985");
  script_cve_id("CVE-2022-23772", "CVE-2022-23806", "CVE-2022-24921");
  script_tag(name:"creation_date", value:"2022-04-29 01:00:08 +0000 (Fri, 29 Apr 2022)");
  ...
  script_name("Debian: Security Advisory (DLA-2985)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2985");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-2985");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/golang-1.7");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'golang-1.7' package(s) announced via the DLA-2985 advisory.");
