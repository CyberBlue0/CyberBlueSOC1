...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-01-19 14:49:00 +0000 (Wed, 19 Jan 2022)");

  script_name("Debian: Security Advisory (DLA-3240)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-3240");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libde265' package(s) announced via the DLA-3240 advisory.");
