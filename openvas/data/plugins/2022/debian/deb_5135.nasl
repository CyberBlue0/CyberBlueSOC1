...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705135");
  script_cve_id("CVE-2022-1552");
  script_tag(name:"creation_date", value:"2022-05-13 01:00:14 +0000 (Fri, 13 May 2022)");
  ...
  script_name("Debian: Security Advisory (DSA-5135)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5135");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5135");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'postgresql-11' package(s) announced via the DSA-5135 advisory.");
