...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-04-13 13:27:00 +0000 (Wed, 13 Apr 2022)");

  script_name("Debian: Security Advisory (DSA-5068)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5068");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5068");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/chromium");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium' package(s) announced via the DSA-5068 advisory.");
