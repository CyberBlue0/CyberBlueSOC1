...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705203");
  script_cve_id("CVE-2022-2509");
  script_tag(name:"creation_date", value:"2022-08-09 06:50:41 +0000 (Tue, 09 Aug 2022)");
  ...
  script_name("Debian: Security Advisory (DSA-5203)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5203");
