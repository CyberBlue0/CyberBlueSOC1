...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705097");
  script_cve_id("CVE-2022-26381", "CVE-2022-26383", "CVE-2022-26384", "CVE-2022-26386", "CVE-2022-26387");
  script_tag(name:"creation_date", value:"2022-03-11 02:00:21 +0000 (Fri, 11 Mar 2022)");
  ...
  script_name("Debian: Security Advisory (DSA-5097)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5097");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5097");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/firefox-esr");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'firefox-esr' package(s) announced via the DSA-5097 advisory.");
