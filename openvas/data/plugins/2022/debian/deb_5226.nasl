...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5226)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5226");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5226");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/pcs");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'pcs' package(s) announced via the DSA-5226 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Two security issues were discovered in pcs, a corosync and pacemaker configuration tool:
...
For the detailed security status of pcs please refer to its security tracker page at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'pcs' package(s) on Debian 11.");
