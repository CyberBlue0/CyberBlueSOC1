...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2915)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2915");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-2915");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/connman");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'connman' package(s) announced via the DLA-2915 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several issues were found in ConnMan, a connection manager for embedded devices, that could cause denial of service via service crash or excessive CPU usage.
