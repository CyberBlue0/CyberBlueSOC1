...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.893170");
  script_cve_id("CVE-2022-42927", "CVE-2022-42928", "CVE-2022-42929", "CVE-2022-42932");
  script_tag(name:"creation_date", value:"2022-10-31 02:00:09 +0000 (Mon, 31 Oct 2022)");
  ...
  script_name("Debian: Security Advisory (DLA-3170)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-3170");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-3170");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/thunderbird");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'thunderbird' package(s) announced via the DLA-3170 advisory.");
...
For Debian 10 buster, these problems have been fixed in version 1:102.4.0-1~deb10u1.
