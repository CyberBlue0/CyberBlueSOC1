...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705302");
  script_cve_id("CVE-2022-4436", "CVE-2022-4437", "CVE-2022-4438", "CVE-2022-4439", "CVE-2022-4440");
  script_tag(name:"creation_date", value:"2022-12-18 02:00:16 +0000 (Sun, 18 Dec 2022)");
  ...
  script_name("Debian: Security Advisory (DSA-5302)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5302");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5302");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/chromium");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium' package(s) announced via the DSA-5302 advisory.");
