...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705073");
  ...
  script_tag(name:"creation_date", value:"2022-02-13 02:00:12 +0000 (Sun, 13 Feb 2022)");
  ...
  script_name("Debian: Security Advisory (DSA-5073)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5073");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5073");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/expat");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'expat' package(s) announced via the DSA-5073 advisory.");
