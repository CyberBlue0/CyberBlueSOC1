...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5076)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5076");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5076");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/h2database");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'h2database' package(s) announced via the DSA-5076 advisory.");
...
For the detailed security status of h2database please refer to its security tracker page at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'h2database' package(s) on Debian 10, Debian 11.");
