...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.893064");
  ...
  script_tag(name:"creation_date", value:"2022-07-01 01:00:13 +0000 (Fri, 01 Jul 2022)");
  ...
  script_name("Debian: Security Advisory (DLA-3064)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-3064");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-3064");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/firefox-esr");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'firefox-esr' package(s) announced via the DLA-3064 advisory.");
...
For Debian 9 stretch, these problems have been fixed in version 91.11.0esr-1~deb9u1.
