...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705259");
  script_cve_id("CVE-2022-42927", "CVE-2022-42928", "CVE-2022-42929", "CVE-2022-42932");
  script_tag(name:"creation_date", value:"2022-10-21 01:00:13 +0000 (Fri, 21 Oct 2022)");
  ...
  script_name("Debian: Security Advisory (DSA-5259)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5259");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5259");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/firefox-esr");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'firefox-esr' package(s) announced via the DSA-5259 advisory.");
