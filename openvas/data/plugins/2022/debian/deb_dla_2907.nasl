...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.892907");
  script_cve_id("CVE-2021-44224", "CVE-2021-44790");
  script_tag(name:"creation_date", value:"2022-02-02 02:00:12 +0000 (Wed, 02 Feb 2022)");
  ...
  script_name("Debian: Security Advisory (DLA-2907)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2907");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-2907");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/apache2");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'apache2' package(s) announced via the DLA-2907 advisory.");
