...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2885)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2885");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-2885");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/qtsvg-opensource-src");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'qtsvg-opensource-src' package(s) announced via the DLA-2885 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Multiple out-of-bounds errors were discovered in qtsvg-opensource-src. The highest threat from CVE-2021-3481 (at least) is to data confidentiality the application availability.
