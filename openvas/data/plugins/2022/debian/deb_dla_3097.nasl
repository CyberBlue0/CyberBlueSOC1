...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.893097");
  script_cve_id("CVE-2022-38472", "CVE-2022-38473", "CVE-2022-38478");
  script_tag(name:"creation_date", value:"2022-09-05 01:00:11 +0000 (Mon, 05 Sep 2022)");
  ...
  script_name("Debian: Security Advisory (DLA-3097)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-3097");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-3097");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/thunderbird");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'thunderbird' package(s) announced via the DLA-3097 advisory.");
...
For Debian 10 buster, these problems have been fixed in version 1:91.13.0-1~deb10u1.
