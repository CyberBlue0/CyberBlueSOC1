...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.892989");
  script_cve_id("CVE-2019-25059");
  script_tag(name:"creation_date", value:"2022-05-02 01:00:06 +0000 (Mon, 02 May 2022)");
  ...
  script_name("Debian: Security Advisory (DLA-2989)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2989");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-2989");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/ghostscript");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ghostscript' package(s) announced via the DLA-2989 advisory.");
