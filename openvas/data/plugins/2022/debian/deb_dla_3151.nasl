...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.893151");
  script_cve_id("CVE-2022-41317", "CVE-2022-41318");
  script_tag(name:"creation_date", value:"2022-10-13 01:00:12 +0000 (Thu, 13 Oct 2022)");
  ...
  script_tag(name:"severity_date", value:"2023-01-05 02:17:00 +0000 (Thu, 05 Jan 2023)");

  script_name("Debian: Security Advisory (DLA-3151)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-3151");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-3151");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/squid");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'squid' package(s) announced via the DLA-3151 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Multiple vulnerabilities were discovered in squid, a Web Proxy cache
