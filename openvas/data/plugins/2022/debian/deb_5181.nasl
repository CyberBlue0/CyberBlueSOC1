...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-07-20 10:41:00 +0000 (Wed, 20 Jul 2022)");

  script_name("Debian: Security Advisory (DSA-5181)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5181");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5181");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/request-tracker4");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'request-tracker4' package(s) announced via the DSA-5181 advisory.");
