...
if(description)
{
  ...
  script_cve_id("CVE-2021-21408", "CVE-2021-29454", "CVE-2022-29221");
  ...
  script_name("Debian: Security Advisory (DSA-5151)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5151");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5151");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/smarty3");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'smarty3' package(s) announced via the DSA-5151 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several security vulnerabilities have been discovered in smarty3, the compiling PHP template engine. Template authors are able to run restricted static php methods or even arbitrary PHP code by crafting a malicious math string or by choosing an invalid {block} or {include} file name. If a math string was passed through as user provided data to the math function, remote users were able to run arbitrary PHP code as well.
...
For the detailed security status of smarty3 please refer to its security tracker page at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'smarty3' package(s) on Debian 10, Debian 11.");
