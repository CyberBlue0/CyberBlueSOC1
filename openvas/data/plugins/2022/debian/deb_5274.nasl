...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705274");
  script_cve_id("CVE-2022-42799", "CVE-2022-42823", "CVE-2022-42824", "CVE-2022-46691");
  script_tag(name:"creation_date", value:"2022-11-10 02:00:12 +0000 (Thu, 10 Nov 2022)");
  ...
  script_name("Debian: Security Advisory (DSA-5274)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5274");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5274");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/wpewebkit");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wpewebkit' package(s) announced via the DSA-5274 advisory.");
