...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5049)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5049");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5049");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/flatpak");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'flatpak' package(s) announced via the DSA-5049 advisory.");
