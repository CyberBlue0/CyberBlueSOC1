...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.892945");
  script_cve_id("CVE-2022-26661", "CVE-2022-26662");
  script_tag(name:"creation_date", value:"2022-03-11 02:00:17 +0000 (Fri, 11 Mar 2022)");
  ...
  script_name("Debian: Security Advisory (DLA-2945)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2945");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-2945");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/tryton-server");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tryton-server' package(s) announced via the DLA-2945 advisory.");
...
For Debian 9 stretch, these problems have been fixed in version 4.2.1-2+deb9u2.
