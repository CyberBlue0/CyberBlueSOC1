...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705061");
  script_cve_id("CVE-2021-30934", "CVE-2021-30936", "CVE-2021-30951", "CVE-2021-30952", "CVE-2021-30953", "CVE-2021-30954", "CVE-2021-30984", "CVE-2022-22594", "CVE-2022-22637");
  script_tag(name:"creation_date", value:"2022-01-27 02:00:14 +0000 (Thu, 27 Jan 2022)");
  ...
  script_name("Debian: Security Advisory (DSA-5061)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5061");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5061");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/wpewebkit");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wpewebkit' package(s) announced via the DSA-5061 advisory.");
