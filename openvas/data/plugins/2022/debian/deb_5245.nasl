...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705245");
  script_cve_id("CVE-2022-3370", "CVE-2022-3373");
  script_tag(name:"creation_date", value:"2022-10-05 07:22:14 +0000 (Wed, 05 Oct 2022)");
  ...
  script_name("Debian: Security Advisory (DSA-5245)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5245");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5245");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/chromium");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium' package(s) announced via the DSA-5245 advisory.");
