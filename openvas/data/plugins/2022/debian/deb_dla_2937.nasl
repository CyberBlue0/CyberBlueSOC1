...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-01-06 20:05:00 +0000 (Thu, 06 Jan 2022)");

  script_name("Debian: Security Advisory (DLA-2937)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2937");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-2937");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/gif2apng");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gif2apng' package(s) announced via the DLA-2937 advisory.");
