...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-3109)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-3109");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-3109");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/nova");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'nova' package(s) announced via the DLA-3109 advisory.");
