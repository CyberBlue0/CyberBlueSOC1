...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-05-13 04:20:00 +0000 (Fri, 13 May 2022)");

  script_name("Debian: Security Advisory (DSA-5166)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5166");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5166");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/slurm-wlm");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'slurm-wlm' package(s) announced via the DSA-5166 advisory.");
