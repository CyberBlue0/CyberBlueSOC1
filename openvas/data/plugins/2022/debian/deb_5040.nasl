...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-01-13 20:52:00 +0000 (Thu, 13 Jan 2022)");

  script_name("Debian: Security Advisory (DSA-5040)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5040");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'lighttpd' package(s) announced via the DSA-5040 advisory.");
