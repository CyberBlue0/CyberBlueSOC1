...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-3230)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-3230");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-3230");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/jqueryui");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'jqueryui' package(s) announced via the DLA-3230 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"jQuery-UI, the official jQuery user interface library, is a curated set of user interface interactions, effects, widgets, and themes built on top of jQuery were reported to have the following vulnerabilities.
...
For the detailed security status of jqueryui please refer to its security tracker page at: [link moved to references]

Further information about Debian LTS security advisories, how to apply these updates to your system and frequently asked questions can be found at: [link moved to references]");

  script_tag(name:"affected", value:"'jqueryui' package(s) on Debian 10.");
