...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.893059");
  script_cve_id("CVE-2022-29599");
  script_tag(name:"creation_date", value:"2022-06-30 13:53:27 +0000 (Thu, 30 Jun 2022)");
  ...
  script_name("Debian: Security Advisory (DLA-3059)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-3059");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-3059");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/maven-shared-utils");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'maven-shared-utils' package(s) announced via the DLA-3059 advisory.");
...
For Debian 9 stretch, this problem has been fixed in version 3.0.0-1+deb9u1.
...
Further information about Debian LTS security advisories, how to apply these updates to your system and frequently asked questions can be found at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'maven-shared-utils' package(s) on Debian 9.");
