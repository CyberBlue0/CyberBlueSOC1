...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.892926");
  script_cve_id("CVE-2021-45444");
  script_tag(name:"creation_date", value:"2022-02-19 02:00:11 +0000 (Sat, 19 Feb 2022)");
  ...
  script_name("Debian: Security Advisory (DLA-2926)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2926");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-2926");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/zsh");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'zsh' package(s) announced via the DLA-2926 advisory.");
...
For Debian 9 stretch, this problem has been fixed in version 5.3.1-4+deb9u5.
...
Further information about Debian LTS security advisories, how to apply these updates to your system and frequently asked questions can be found at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'zsh' package(s) on Debian 9.");
