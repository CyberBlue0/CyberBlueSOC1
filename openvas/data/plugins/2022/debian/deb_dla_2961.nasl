...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.892961");
  script_cve_id("CVE-2022-26381", "CVE-2022-26383", "CVE-2022-26384", "CVE-2022-26386", "CVE-2022-26387");
  script_tag(name:"creation_date", value:"2022-03-23 02:00:16 +0000 (Wed, 23 Mar 2022)");
  ...
  script_name("Debian: Security Advisory (DLA-2961)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2961");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-2961");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/thunderbird");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'thunderbird' package(s) announced via the DLA-2961 advisory.");
...
For Debian 9 stretch, these problems have been fixed in version 1:91.7.0-2~deb9u1.
