...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.893129");
  script_cve_id("CVE-2019-17545", "CVE-2021-45943");
  script_tag(name:"creation_date", value:"2022-10-01 01:00:09 +0000 (Sat, 01 Oct 2022)");
  ...
  script_name("Debian: Security Advisory (DLA-3129)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-3129");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-3129");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/gdal");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gdal' package(s) announced via the DLA-3129 advisory.");
...
Further information about Debian LTS security advisories, how to apply these updates to your system and frequently asked questions can be found at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'gdal' package(s) on Debian 10.");
