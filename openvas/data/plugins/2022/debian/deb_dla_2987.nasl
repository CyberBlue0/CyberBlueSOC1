...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.892987");
  script_cve_id("CVE-2019-19221", "CVE-2021-23177", "CVE-2021-31566");
  script_tag(name:"creation_date", value:"2022-05-01 01:00:08 +0000 (Sun, 01 May 2022)");
  ...
  script_tag(name:"severity_date", value:"2022-08-26 16:09:00 +0000 (Fri, 26 Aug 2022)");

  script_name("Debian: Security Advisory (DLA-2987)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2987");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-2987");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/libarchive");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libarchive' package(s) announced via the DLA-2987 advisory.");
...
Further information about Debian LTS security advisories, how to apply these updates to your system and frequently asked questions can be found at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'libarchive' package(s) on Debian 9.");
