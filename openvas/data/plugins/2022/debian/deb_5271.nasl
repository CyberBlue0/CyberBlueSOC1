...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705271");
  script_cve_id("CVE-2022-40303", "CVE-2022-40304");
  script_tag(name:"creation_date", value:"2022-11-07 02:00:05 +0000 (Mon, 07 Nov 2022)");
  ...
  script_name("Debian: Security Advisory (DSA-5271)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5271");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5271");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/libxml2");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libxml2' package(s) announced via the DSA-5271 advisory.");
