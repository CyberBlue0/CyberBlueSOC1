...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.893073");
  script_cve_id("CVE-2022-32792", "CVE-2022-32816", "CVE-2022-32891");
  script_tag(name:"creation_date", value:"2022-08-18 01:00:18 +0000 (Thu, 18 Aug 2022)");
  ...
  script_name("Debian: Security Advisory (DLA-3073)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-3073");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-3073");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/webkit2gtk");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'webkit2gtk' package(s) announced via the DLA-3073 advisory.");
...
For Debian 10 buster, these problems have been fixed in version 2.36.6-1~deb10u1.
