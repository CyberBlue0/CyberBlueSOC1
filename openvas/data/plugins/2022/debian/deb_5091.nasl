...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5091)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5091");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5091");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/containerd");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'containerd' package(s) announced via the DSA-5091 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Felix Wilhelm discovered that the containerd container runtime was susceptible to information disclosure via malformed container images.
