...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705301");
  script_cve_id("CVE-2022-46872", "CVE-2022-46874", "CVE-2022-46878", "CVE-2022-46880", "CVE-2022-46881", "CVE-2022-46882");
  script_tag(name:"creation_date", value:"2022-12-16 02:00:09 +0000 (Fri, 16 Dec 2022)");
  ...
  script_name("Debian: Security Advisory (DSA-5301)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5301");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5301");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/firefox-esr");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'firefox-esr' package(s) announced via the DSA-5301 advisory.");
