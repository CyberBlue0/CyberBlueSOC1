...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705120");
  script_cve_id("CVE-2022-1305", "CVE-2022-1306", "CVE-2022-1307", "CVE-2022-1308", "CVE-2022-1309", "CVE-2022-1310", "CVE-2022-1311", "CVE-2022-1312", "CVE-2022-1313", "CVE-2022-1314", "CVE-2022-2399");
  script_tag(name:"creation_date", value:"2022-04-20 01:00:20 +0000 (Wed, 20 Apr 2022)");
  ...
  script_name("Debian: Security Advisory (DSA-5120)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5120");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5120");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/chromium");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium' package(s) announced via the DSA-5120 advisory.");
