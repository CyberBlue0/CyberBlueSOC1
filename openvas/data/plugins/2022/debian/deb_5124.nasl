...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-05-10 14:00:00 +0000 (Tue, 10 May 2022)");

  script_name("Debian: Security Advisory (DSA-5124)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5124");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5124");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/ffmpeg");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ffmpeg' package(s) announced via the DSA-5124 advisory.");
