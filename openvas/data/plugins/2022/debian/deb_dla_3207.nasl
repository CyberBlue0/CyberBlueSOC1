...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.893207");
  script_cve_id("CVE-2020-36518", "CVE-2022-42003", "CVE-2022-42004");
  script_tag(name:"creation_date", value:"2022-11-28 02:00:10 +0000 (Mon, 28 Nov 2022)");
  ...
  script_name("Debian: Security Advisory (DLA-3207)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-3207");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'jackson-databind' package(s) announced via the DLA-3207 advisory.");
...
Further information about Debian LTS security advisories, how to apply these updates to your system and frequently asked questions can be found at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'jackson-databind' package(s) on Debian 10.");
