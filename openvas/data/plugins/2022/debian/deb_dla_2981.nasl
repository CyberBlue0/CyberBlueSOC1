...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-04-05 15:07:00 +0000 (Tue, 05 Apr 2022)");

  script_name("Debian: Security Advisory (DLA-2981)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2981");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-2981");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/lrzip");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'lrzip' package(s) announced via the DLA-2981 advisory.");
