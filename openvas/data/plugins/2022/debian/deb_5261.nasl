...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705261");
  script_cve_id("CVE-2022-3652", "CVE-2022-3653", "CVE-2022-3654", "CVE-2022-3655", "CVE-2022-3656", "CVE-2022-3657", "CVE-2022-3658", "CVE-2022-3659", "CVE-2022-3660", "CVE-2022-3661");
  script_tag(name:"creation_date", value:"2022-10-28 01:00:13 +0000 (Fri, 28 Oct 2022)");
  ...
  script_name("Debian: Security Advisory (DSA-5261)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5261");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5261");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/chromium");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium' package(s) announced via the DSA-5261 advisory.");
