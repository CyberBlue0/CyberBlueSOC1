...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705193");
  script_cve_id("CVE-2022-36318", "CVE-2022-36319");
  script_tag(name:"creation_date", value:"2022-07-28 01:00:08 +0000 (Thu, 28 Jul 2022)");
  ...
  script_name("Debian: Security Advisory (DSA-5193)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5193");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5193");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/firefox-esr");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'firefox-esr' package(s) announced via the DSA-5193 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Multiple security issues have been found in the Mozilla Firefox web browser, which could result in spoofing.
