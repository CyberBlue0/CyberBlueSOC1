...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.892906");
  script_cve_id("CVE-2022-22818", "CVE-2022-23833");
  script_tag(name:"creation_date", value:"2022-02-02 02:00:09 +0000 (Wed, 02 Feb 2022)");
  ...
  script_name("Debian: Security Advisory (DLA-2906)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2906");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-2906");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'python-django' package(s) announced via the DLA-2906 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that there were two vulnerabilities in Django, a popular Python-based web development framework:
...
For Debian 9 Stretch, these problems have been fixed in version 1:1.10.7-2+deb9u15.
