...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-3137)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-3137");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-3137");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/nodejs");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'nodejs' package(s) announced via the DLA-3137 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Multiple vulnerabilities were discovered in Node.js, a JavaScript runtime environment, which could result in memory corruption, invalid certificate validation, prototype pollution or command injection.

CVE-2021-22930, CVE-2021-22940 Use after free attack where an attacker might be able to exploit the memory corruption, to change process behavior.
