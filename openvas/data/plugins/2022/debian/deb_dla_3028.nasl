...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-3028)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-3028");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-3028");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/atftp");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'atftp' package(s) announced via the DLA-3028 advisory.");
...
Due to missing bound checks, data could be read behind a buffer so that sensible information might be disclosed to a remote client.

For Debian 9 stretch, this problem has been fixed in version 0.7.git20120829-3.1~deb9u3.
