...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.892884");
  script_cve_id("CVE-2022-21661", "CVE-2022-21662", "CVE-2022-21663", "CVE-2022-21664");
  script_tag(name:"creation_date", value:"2022-01-24 02:00:10 +0000 (Mon, 24 Jan 2022)");
  ...
  script_name("Debian: Security Advisory (DLA-2884)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2884");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-2884");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/wordpress");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wordpress' package(s) announced via the DLA-2884 advisory.");
