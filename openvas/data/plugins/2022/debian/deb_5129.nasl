...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705129");
  script_cve_id("CVE-2022-29909", "CVE-2022-29911", "CVE-2022-29912", "CVE-2022-29914", "CVE-2022-29916", "CVE-2022-29917");
  script_tag(name:"creation_date", value:"2022-05-06 01:00:24 +0000 (Fri, 06 May 2022)");
  ...
  script_name("Debian: Security Advisory (DSA-5129)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5129");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5129");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/firefox-esr");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'firefox-esr' package(s) announced via the DSA-5129 advisory.");
