...
For the detailed security status of condor please refer to its security tracker page at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'condor' package(s) on Debian 10.");
