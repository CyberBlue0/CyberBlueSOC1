...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705223");
  ...
  script_tag(name:"creation_date", value:"2022-09-03 01:00:19 +0000 (Sat, 03 Sep 2022)");
  ...
  script_name("Debian: Security Advisory (DSA-5223)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5223");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5223");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/chromium");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium' package(s) announced via the DSA-5223 advisory.");
