...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.893161");
  ...
  script_name("Debian: Security Advisory (DLA-3161)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-3161");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-3161");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/tzdata");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tzdata' package(s) announced via the DLA-3161 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This update includes the changes in tzdata 2022e. Notable changes are:
