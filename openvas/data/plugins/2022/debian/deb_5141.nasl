...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705141");
  ...
  script_tag(name:"creation_date", value:"2022-05-21 01:00:09 +0000 (Sat, 21 May 2022)");
  ...
  script_name("Debian: Security Advisory (DSA-5141)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5141");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5141");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/thunderbird");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'thunderbird' package(s) announced via the DSA-5141 advisory.");
