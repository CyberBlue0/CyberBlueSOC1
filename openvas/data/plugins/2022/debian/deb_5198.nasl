...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705198");
  script_cve_id("CVE-2022-2047", "CVE-2022-2048");
  script_tag(name:"creation_date", value:"2022-08-03 01:00:09 +0000 (Wed, 03 Aug 2022)");
  ...
  script_name("Debian: Security Advisory (DSA-5198)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5198");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5198");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/jetty9");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'jetty9' package(s) announced via the DSA-5198 advisory.");
...
For the detailed security status of jetty9 please refer to its security tracker page at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'jetty9' package(s) on Debian 11.");
