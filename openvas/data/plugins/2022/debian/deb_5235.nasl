...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5235)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5235");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5235");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/bind9");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'bind9' package(s) announced via the DSA-5235 advisory.");
