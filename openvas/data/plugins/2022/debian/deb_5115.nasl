...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705115");
  script_cve_id("CVE-2022-22624", "CVE-2022-22628", "CVE-2022-22629", "CVE-2022-22662");
  script_tag(name:"creation_date", value:"2022-04-20 01:00:42 +0000 (Wed, 20 Apr 2022)");
  ...
  script_tag(name:"severity_date", value:"2022-09-27 04:48:00 +0000 (Tue, 27 Sep 2022)");

  script_name("Debian: Security Advisory (DSA-5115)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5115");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5115");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/webkit2gtk");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'webkit2gtk' package(s) announced via the DSA-5115 advisory.");
...
Kirin discovered that processing maliciously crafted web content may lead to arbitrary code execution.
