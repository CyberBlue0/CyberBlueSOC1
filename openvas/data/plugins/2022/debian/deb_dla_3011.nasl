...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.893011");
  script_cve_id("CVE-2022-0261", "CVE-2022-0351", "CVE-2022-0413", "CVE-2022-0443", "CVE-2022-0572", "CVE-2022-1154", "CVE-2022-1616", "CVE-2022-1619", "CVE-2022-1621");
  script_tag(name:"creation_date", value:"2022-05-18 05:50:19 +0000 (Wed, 18 May 2022)");
  ...
  script_name("Debian: Security Advisory (DLA-3011)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-3011");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'vim' package(s) announced via the DLA-3011 advisory.");
...
For Debian 9 stretch, these problems have been fixed in version 2:8.0.0197-4+deb9u6.
