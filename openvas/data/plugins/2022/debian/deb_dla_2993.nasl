...
if(description)
{
  ...
  script_tag(name:"insight", value:"One security issue has been found in a compression library libz-mingw-w64.

Danilo Ramos discovered that incorrect memory handling in libz-mingw-w64's deflate handling could result in denial of service or potentially the execution of arbitrary code if specially crafted input is processed.

For Debian 9 stretch, this problem has been fixed in version 1.2.11+dfsg-1+deb9u1.

We recommend that you upgrade your libz-mingw-w64 packages.

For the detailed security status of libz-mingw-w64 please refer to its security tracker page at: [link moved to references]

Further information about Debian LTS security advisories, how to apply these updates to your system and frequently asked questions can be found at: [link moved to references]");

  script_tag(name:"affected", value:"'libz-mingw-w64' package(s) on Debian 9.");
