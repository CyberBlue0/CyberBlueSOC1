...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705182");
  script_cve_id("CVE-2022-22677", "CVE-2022-26710");
  script_tag(name:"creation_date", value:"2022-07-16 01:00:08 +0000 (Sat, 16 Jul 2022)");
  ...
  script_tag(name:"severity_date", value:"2022-11-03 13:48:00 +0000 (Thu, 03 Nov 2022)");

  script_name("Debian: Security Advisory (DSA-5182)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5182");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5182");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/webkit2gtk");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'webkit2gtk' package(s) announced via the DSA-5182 advisory.");
...
An anonymous researcher discovered that the video in a webRTC call may be interrupted if the audio capture gets interrupted.
