...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705035");
  script_cve_id("CVE-2021-44224", "CVE-2021-44790");
  script_tag(name:"creation_date", value:"2022-01-06 02:00:07 +0000 (Thu, 06 Jan 2022)");
  ...
  script_name("Debian: Security Advisory (DSA-5035)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5035");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5035");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/apache2");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'apache2' package(s) announced via the DSA-5035 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Two vulnerabilities have been discovered in the Apache HTTP server:
