...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-3250)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-3250");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-3250");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/multipath-tools");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'multipath-tools' package(s) announced via the DLA-3250 advisory.");
...
Please note that the fix for CVE-2022-41973 involves switching from /dev/shm to systemd-tmpfiles (/run/multipath-tools). If you have previously accessed /dev/shm directly, please update your setup to the new path to facilitate this change.
