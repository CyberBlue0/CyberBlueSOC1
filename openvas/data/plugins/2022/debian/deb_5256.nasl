...
if(description)
{
  ...
  # nb: https://security-tracker.debian.org/tracker/CVE-2022-42920 currently has the following
  # note so we're currently having both added here until this has been sorted out:
  #
  # Duplicate of CVE-2022-34169. But CVE-2022-34169 was assigned for Apache Xalan Java XSLT library,
  # whereas CVE-2022-42920 is associated with bcel itself.
  # check with the assigning CNAs which one to retain if confirmed to be handled as duplicate and
  # move CVE-2022-34169 to Apache Xalan Java XSLT use of BCEL only.
