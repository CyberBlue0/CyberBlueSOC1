...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705220");
  script_xref(name:"CISA", value:"Known Exploited Vulnerability (KEV) catalog");
  script_xref(name:"URL", value:"https://www.cisa.gov/known-exploited-vulnerabilities-catalog");
  script_cve_id("CVE-2022-32893");
  script_tag(name:"creation_date", value:"2022-08-28 01:00:12 +0000 (Sun, 28 Aug 2022)");
  ...
  script_name("Debian: Security Advisory (DSA-5220)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5220");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5220");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/wpewebkit");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wpewebkit' package(s) announced via the DSA-5220 advisory.");
