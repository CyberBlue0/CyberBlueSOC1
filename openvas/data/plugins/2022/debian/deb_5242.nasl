...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5242)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5242");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5242");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/maven-shared-utils");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'maven-shared-utils' package(s) announced via the DSA-5242 advisory.");
