...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705154");
  script_cve_id("CVE-2022-26700", "CVE-2022-26709", "CVE-2022-26716", "CVE-2022-26717", "CVE-2022-26719", "CVE-2022-30293");
  script_tag(name:"creation_date", value:"2022-06-01 13:28:28 +0000 (Wed, 01 Jun 2022)");
  ...
  script_name("Debian: Security Advisory (DSA-5154)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5154");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5154");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/webkit2gtk");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'webkit2gtk' package(s) announced via the DSA-5154 advisory.");
