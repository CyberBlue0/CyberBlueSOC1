...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.892943");
  script_cve_id("CVE-2021-30151", "CVE-2022-23837");
  script_tag(name:"creation_date", value:"2022-03-11 02:00:15 +0000 (Fri, 11 Mar 2022)");
  ...
  script_name("Debian: Security Advisory (DLA-2943)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-2943");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-2943");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/ruby-sidekiq");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ruby-sidekiq' package(s) announced via the DLA-2943 advisory.");
...
Further information about Debian LTS security advisories, how to apply these updates to your system and frequently asked questions can be found at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'ruby-sidekiq' package(s) on Debian 9.");
