...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705221");
  script_cve_id("CVE-2022-38472", "CVE-2022-38473", "CVE-2022-38478");
  script_tag(name:"creation_date", value:"2022-08-31 01:00:05 +0000 (Wed, 31 Aug 2022)");
  ...
  script_name("Debian: Security Advisory (DSA-5221)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5221");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5221");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/thunderbird");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'thunderbird' package(s) announced via the DSA-5221 advisory.");
...
For the stable distribution (bullseye), these problems have been fixed in version 1:91.13.0-1~deb11u1.
