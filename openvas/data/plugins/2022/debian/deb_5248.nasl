...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705248");
  script_cve_id("CVE-2022-39261");
  script_tag(name:"creation_date", value:"2022-10-06 01:00:05 +0000 (Thu, 06 Oct 2022)");
  ...
  script_tag(name:"severity_date", value:"2022-09-30 19:58:00 +0000 (Fri, 30 Sep 2022)");

  script_name("Debian: Security Advisory (DSA-5248)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5248");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5248");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/php-twig");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'php-twig' package(s) announced via the DSA-5248 advisory.");
