...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.893095");
  script_cve_id("CVE-2022-30122", "CVE-2022-30123");
  script_tag(name:"creation_date", value:"2022-09-04 01:00:12 +0000 (Sun, 04 Sep 2022)");
  ...
  script_name("Debian: Security Advisory (DLA-3095)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-3095");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-3095");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/ruby-rack");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ruby-rack' package(s) announced via the DLA-3095 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Two vulnerabilities were discovered in `ruby-rack`, a popular Ruby webserver:
