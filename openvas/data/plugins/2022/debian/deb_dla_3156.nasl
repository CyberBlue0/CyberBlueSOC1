...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.893156");
  script_cve_id("CVE-2022-42927", "CVE-2022-42928", "CVE-2022-42929", "CVE-2022-42932");
  script_tag(name:"creation_date", value:"2022-10-21 01:00:09 +0000 (Fri, 21 Oct 2022)");
  ...
  script_name("Debian: Security Advisory (DLA-3156)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DLA-3156");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/dla-3156");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/firefox-esr");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'firefox-esr' package(s) announced via the DLA-3156 advisory.");
...
In addition, this update brings back support for the armhf architecture.

For Debian 10 buster, these problems have been fixed in version 102.4.0esr-1~deb10u1.
