...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.705188");
  script_cve_id("CVE-2022-21540", "CVE-2022-21541", "CVE-2022-34169");
  script_tag(name:"creation_date", value:"2022-07-24 01:00:10 +0000 (Sun, 24 Jul 2022)");
  ...
  script_name("Debian: Security Advisory (DSA-5188)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-5188");
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/dsa-5188");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/openjdk-11");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openjdk-11' package(s) announced via the DSA-5188 advisory.");
