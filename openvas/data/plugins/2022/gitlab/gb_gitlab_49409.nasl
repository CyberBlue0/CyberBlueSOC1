...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170065");
  ...
  script_cve_id("CVE-2018-14601");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("GitLab 11.1.0, 11.1.1 DoS Vulnerability");
  ...
  script_tag(name:"insight", value:"Slow rendering of markdown files and issue descriptions with
  lots of Markdown references.");

  script_tag(name:"affected", value:"GitLab version 11.1.0 and 11.1.1.");

  script_tag(name:"solution", value:"Update to version 11.1.2 or later.");

  script_xref(name:"URL", value:"https://gitlab.com/gitlab-org/gitlab-foss/-/issues/49409");
