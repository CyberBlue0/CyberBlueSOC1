...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821201");
  ...
  script_cve_id("CVE-2022-28250", "CVE-2022-28251", "CVE-2022-28252", "CVE-2022-28253",
                ...
                "CVE-2022-35672", "CVE-2022-44512", "CVE-2022-44513", "CVE-2022-44514",
                "CVE-2022-44515", "CVE-2022-44516", "CVE-2022-44517", "CVE-2022-44518",
                "CVE-2022-44519", "CVE-2022-44520");
  ...
  script_name("Adobe Acrobat Classic 2020 Security Update (APSB22-16) - Windows");
  ...
  script_tag(name:"affected", value:"Adobe Acrobat Classic 2020 20.005.30314
  and earlier versions on Windows.");

  script_tag(name:"solution", value:"Update Adobe Acrobat Classic 2020 to
  version 2020.005.30334 or later.");
...
if(version_in_range(version:vers, test_version:"20.0", test_version2:"20.005.30314"))
{
  report = report_fixed_ver(installed_version:vers, fixed_version:"20.005.30334(2020.005.30334)", install_path:path);
