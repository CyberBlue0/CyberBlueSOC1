...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.821200");
  ...
  script_name("Adobe Acrobat 2017 Security Update (APSB22-16) - Windows");
  ...
  script_tag(name:"affected", value:"Adobe Acrobat 2017 17.012.30205 and earlier
  versions on Windows.");

  script_tag(name:"solution", value:"Update Adobe Acrobat 2017 to version
  2017.012.30229 or later.");
...
{
  report = report_fixed_ver(installed_version:vers, fixed_version:"17.012.30229(2017.012.30229)", install_path:path);
