...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.819938");
  ...
  script_tag(name:"creation_date", value:"2022-01-13 18:47:36 +0530 (Thu, 13 Jan 2022)");
  script_name("Adobe Acrobat Classic 2020 Security Update (APSB22-01) - Mac OS X");
...
if(version_in_range(version:vers, test_version:"20.0", test_version2:"20.004.30017"))
{
  report = report_fixed_ver(installed_version:vers, fixed_version:"20.004.30020(2020.004.30020)", install_path:path);
