...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.820096");
  ...
  script_tag(name:"creation_date", value:"2022-04-29 17:36:52 +0530 (Fri, 29 Apr 2022)");
  script_name("Adobe Acrobat Classic 2020 Security Update (APSB22-16) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Adobe Acrobat Classic 2020 20.005.30311
  and earlier versions on Mac OS X.");

  script_tag(name:"solution", value:"Update Adobe Acrobat Classic 2020 to
  version 2020.005.30331 or later.");
