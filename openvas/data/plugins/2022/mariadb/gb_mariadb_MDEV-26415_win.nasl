...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.104578");
  ...
  script_tag(name:"creation_date", value:"2022-04-13 07:16:46 +0000 (Wed, 13 Apr 2022)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_tag(name:"severity_vector", value:"CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_tag(name:"severity_origin", value:"NVD");
  script_tag(name:"severity_date", value:"2022-04-19 20:00:00 +0000 (Tue, 19 Apr 2022)");

  script_cve_id("CVE-2022-27385");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("MariaDB DoS Vulnerability (MDEV-26415) - Windows");
  ...
  script_tag(name:"affected", value:"MariaDB versions prior to 10.3.32, 10.4.x prior to 10.4.22,
  10.5.x prior to 10.5.13 and 10.6.x prior to 10.6.5.");

  script_tag(name:"solution", value:"Update to version 10.3.32, 10.4.22, 10.5.13, 10.6.5 or
  later.");
...
if (version_is_less(version: version, test_version: "10.3.32")) {
