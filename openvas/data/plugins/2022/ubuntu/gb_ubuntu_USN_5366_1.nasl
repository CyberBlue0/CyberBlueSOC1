...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845316");
  script_cve_id("CVE-2022-25308", "CVE-2022-25309", "CVE-2022-25310");
  script_tag(name:"creation_date", value:"2022-04-08 01:00:43 +0000 (Fri, 08 Apr 2022)");
  script_version("2024-01-19T05:06:18+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:18 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");

  script_name("Ubuntu: Security Advisory (USN-5366-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5366-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5366-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'fribidi' package(s) announced via the USN-5366-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that FriBidi incorrectly handled processing of input strings
...
(CVE-2022-25310)");
  ...
  script_tag(name:"affected", value:"'fribidi' package(s) on Ubuntu 18.04, Ubuntu 20.04, Ubuntu 21.10.");
