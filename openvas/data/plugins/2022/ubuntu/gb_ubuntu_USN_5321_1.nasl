...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845275");
  script_cve_id("CVE-2022-0843", "CVE-2022-26381", "CVE-2022-26382", "CVE-2022-26383", "CVE-2022-26384", "CVE-2022-26385", "CVE-2022-26387");
  script_tag(name:"creation_date", value:"2022-03-11 02:00:38 +0000 (Fri, 11 Mar 2022)");
  script_version("2024-01-19T05:06:18+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:18 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");

  script_name("Ubuntu: Security Advisory (USN-5321-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5321-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5321-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox' package(s) announced via the USN-5321-1 advisory.");
