...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845229");
  script_cve_id("CVE-2021-43566", "CVE-2021-44142", "CVE-2022-0336");
  script_tag(name:"creation_date", value:"2022-02-02 02:00:30 +0000 (Wed, 02 Feb 2022)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5260-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5260-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5260-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'samba' package(s) announced via the USN-5260-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Orange Tsai discovered that the Samba vfs_fruit module incorrectly handled
...
services. (CVE-2022-0336)");
  ...
  script_tag(name:"affected", value:"'samba' package(s) on Ubuntu 20.04, Ubuntu 21.10.");
