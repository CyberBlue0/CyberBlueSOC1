...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845317");
  script_cve_id("CVE-2022-26280");
  script_tag(name:"creation_date", value:"2022-04-12 01:00:31 +0000 (Tue, 12 Apr 2022)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5374-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5374-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5374-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libarchive' package(s) announced via the USN-5374-1 advisory.");
