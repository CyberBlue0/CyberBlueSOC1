...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-5493-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5493-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5493-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-hwe, linux-meta, linux-signed' package(s) announced via the USN-5493-1 advisory.");
...
denial of service (system crash).");
  ...
  script_tag(name:"affected", value:"'linux, linux-hwe, linux-meta, linux-signed' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 21.10.");
