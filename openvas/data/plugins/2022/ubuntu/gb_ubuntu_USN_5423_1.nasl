...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845374");
  script_cve_id("CVE-2022-20770", "CVE-2022-20771", "CVE-2022-20785", "CVE-2022-20792", "CVE-2022-20796");
  script_tag(name:"creation_date", value:"2022-05-18 01:00:35 +0000 (Wed, 18 May 2022)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5423-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5423-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5423-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'clamav' package(s) announced via the USN-5423-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Michal Dardas discovered that ClamAV incorrectly handled parsing CHM files.
...
possibly execute arbitrary code.(CVE-2022-20796)");
  ...
  script_tag(name:"affected", value:"'clamav' package(s) on Ubuntu 18.04, Ubuntu 20.04, Ubuntu 21.10, Ubuntu 22.04.");
