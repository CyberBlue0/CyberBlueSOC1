...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-intel-iotg, linux-meta-intel-iotg, linux-signed-intel-iotg' package(s) announced via the USN-5564-1 advisory.");
...
Felix Fu discovered that the Sun RPC ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-intel-iotg, linux-meta-intel-iotg, linux-signed-intel-iotg' package(s) on Ubuntu 22.04.");
