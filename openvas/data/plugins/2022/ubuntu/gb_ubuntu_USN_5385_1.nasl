...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845332");
  script_cve_id("CVE-2021-43975", "CVE-2022-0617", "CVE-2022-24448", "CVE-2022-24959");
  script_tag(name:"creation_date", value:"2022-04-22 01:00:22 +0000 (Fri, 22 Apr 2022)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5385-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5385-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5385-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-aws, linux-aws-hwe, linux-azure, linux-azure-4.15, linux-dell300x, linux-gcp, linux-gcp-4.15, linux-hwe, linux-kvm, linux-meta, linux-meta-aws, linux-meta-azure-4.15, linux-meta-dell300x, linux-meta-gcp-4.15, linux-meta-kvm, linux-meta-oracle, linux-meta-snapdragon, linux-oracle, linux-signed, linux-signed-aws, linux-signed-azure-4.15, linux-signed-dell300x, linux-signed-gcp-4.15, linux-signed-oracle, linux-snapdragon' package(s) announced via the USN-5385-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Brendan Dolan-Gavitt discovered that the aQuantia AQtion Ethernet device
...
exhaustion). (CVE-2022-24959)");
  ...
  script_tag(name:"affected", value:"'linux, linux-aws, linux-aws-hwe, linux-azure, linux-azure-4.15, linux-dell300x, linux-gcp, linux-gcp-4.15, linux-hwe, linux-kvm, linux-meta, linux-meta-aws, linux-meta-azure-4.15, linux-meta-dell300x, linux-meta-gcp-4.15, linux-meta-kvm, linux-meta-oracle, linux-meta-snapdragon, linux-oracle, linux-signed, linux-signed-aws, linux-signed-azure-4.15, linux-signed-dell300x, linux-signed-gcp-4.15, linux-signed-oracle, linux-snapdragon' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 18.04.");
