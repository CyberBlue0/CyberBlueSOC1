...
if(description)
{
  ...
  script_cve_id("CVE-2021-28711", "CVE-2021-28712", "CVE-2021-28713", "CVE-2021-28714", "CVE-2021-28715", "CVE-2021-4135", "CVE-2021-43976", "CVE-2021-44733", "CVE-2021-45095", "CVE-2021-45469", "CVE-2021-45480", "CVE-2022-0435", "CVE-2022-0492", "CVE-2022-1055", "CVE-2022-27666");
  ...
  script_name("Ubuntu: Security Advisory (USN-5377-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5377-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5377-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-bluefield, linux-meta-bluefield, linux-signed-bluefield' package(s) announced via the USN-5377-1 advisory.");
...
(TIPC) protocol ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'linux-bluefield, linux-meta-bluefield, linux-signed-bluefield' package(s) on Ubuntu 20.04.");
