...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845466");
  script_cve_id("CVE-2021-4209", "CVE-2022-2509");
  script_tag(name:"creation_date", value:"2022-08-05 01:00:41 +0000 (Fri, 05 Aug 2022)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5550-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5550-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5550-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gnutls28' package(s) announced via the USN-5550-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that GnuTLS incorrectly handled certain memory
...
arbitrary code. (CVE-2022-2509)");
  ...
  script_tag(name:"affected", value:"'gnutls28' package(s) on Ubuntu 18.04, Ubuntu 20.04, Ubuntu 22.04.");
