...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-5241-1)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'qtsvg-opensource-src' package(s) announced via the USN-5241-1 advisory.");
...
code.");
  ...
  script_tag(name:"affected", value:"'qtsvg-opensource-src' package(s) on Ubuntu 18.04.");
