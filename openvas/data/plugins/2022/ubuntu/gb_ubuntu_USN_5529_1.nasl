...
if(description)
{
  ...
  script_cve_id("CVE-2022-1652", "CVE-2022-1679", "CVE-2022-1789", "CVE-2022-1852", "CVE-2022-1973", "CVE-2022-2078", "CVE-2022-21123", "CVE-2022-21125", "CVE-2022-21166", "CVE-2022-34494", "CVE-2022-34495");
  ...
  script_name("Ubuntu: Security Advisory (USN-5529-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5529-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5529-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-meta-oem-5.17, linux-oem-5.17, linux-signed-oem-5.17' package(s) announced via the USN-5529-1 advisory.");
