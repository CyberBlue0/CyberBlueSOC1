...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845208");
  script_cve_id("CVE-2021-3973", "CVE-2021-3974", "CVE-2021-3984", "CVE-2021-4019", "CVE-2021-4069");
  script_tag(name:"creation_date", value:"2022-01-28 02:00:40 +0000 (Fri, 28 Jan 2022)");
  ...
  script_tag(name:"severity_date", value:"2021-12-07 14:02:00 +0000 (Tue, 07 Dec 2021)");

  script_name("Ubuntu: Security Advisory (USN-5247-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5247-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5247-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'vim' package(s) announced via the USN-5247-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that vim incorrectly handled parsing of filenames in its
...
possibly achieve code execution with user privileges.(CVE-2021-4069)");
  ...
  script_tag(name:"affected", value:"'vim' package(s) on Ubuntu 18.04, Ubuntu 20.04, Ubuntu 21.10.");
