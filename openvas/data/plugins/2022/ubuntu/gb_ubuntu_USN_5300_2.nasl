...
if(description)
{
  ...
  script_cve_id("CVE-2015-9253", "CVE-2017-8923", "CVE-2017-9118", "CVE-2017-9119", "CVE-2017-9120", "CVE-2021-21707");
  ...
  script_name("Ubuntu: Security Advisory (USN-5300-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5300-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5300-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php7.2, php7.4' package(s) announced via the USN-5300-2 advisory.");
...
Original advisory details:
 ...
 (CVE-2021-21707)");
  ...
  script_tag(name:"affected", value:"'php7.2, php7.4' package(s) on Ubuntu 18.04, Ubuntu 20.04.");
