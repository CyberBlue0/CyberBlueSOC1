...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-5368-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5368-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5368-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure-5.13, linux-meta-azure-5.13, linux-meta-oracle-5.13, linux-oracle-5.13, linux-signed-azure-5.13, linux-signed-oracle-5.13' package(s) announced via the USN-5368-1 advisory.");
...
It was discovered that the ARM Trusted Execution Environment ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'linux-azure-5.13, linux-meta-azure-5.13, linux-meta-oracle-5.13, linux-oracle-5.13, linux-signed-azure-5.13, linux-signed-oracle-5.13' package(s) on Ubuntu 20.04.");
