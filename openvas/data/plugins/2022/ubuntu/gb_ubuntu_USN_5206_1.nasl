...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845182");
  ...
  script_tag(name:"severity_date", value:"2022-03-16 16:16:00 +0000 (Wed, 16 Mar 2022)");

  script_name("Ubuntu: Security Advisory (USN-5206-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5206-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5206-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-meta-oem-5.14, linux-oem-5.14, linux-signed-oem-5.14' package(s) announced via the USN-5206-1 advisory.");
