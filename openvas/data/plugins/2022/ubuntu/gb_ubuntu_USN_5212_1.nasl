...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-5212-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5212-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5212-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apache2' package(s) announced via the USN-5212-1 advisory.");
...
possibly execute arbitrary code. (CVE-2021-44790)");
  ...
  script_tag(name:"affected", value:"'apache2' package(s) on Ubuntu 18.04, Ubuntu 20.04, Ubuntu 21.04, Ubuntu 21.10.");
