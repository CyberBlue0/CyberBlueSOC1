...
if(description)
{
  ...
  script_cve_id("CVE-2021-4083", "CVE-2021-4090", "CVE-2021-4155", "CVE-2021-42327", "CVE-2022-0001", "CVE-2022-0185", "CVE-2022-0330", "CVE-2022-0435", "CVE-2022-0492", "CVE-2022-0516", "CVE-2022-0742", "CVE-2022-0847", "CVE-2022-22942", "CVE-2022-23222", "CVE-2022-23960", "CVE-2022-25636");
  ...
  script_name("Ubuntu: Security Advisory (USN-5362-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5362-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5362-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-intel-5.13, linux-meta-intel-5.13, linux-signed-intel-5.13' package(s) announced via the USN-5362-1 advisory.");
...
the Linux kernel did not ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'linux-intel-5.13, linux-meta-intel-5.13, linux-signed-intel-5.13' package(s) on Ubuntu 20.04.");
