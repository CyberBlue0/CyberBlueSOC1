...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845351");
  script_cve_id("CVE-2022-1015", "CVE-2022-1016", "CVE-2022-26490");
  script_tag(name:"creation_date", value:"2022-05-04 01:00:46 +0000 (Wed, 04 May 2022)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5390-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5390-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5390-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-meta-raspi, linux-raspi' package(s) announced via the USN-5390-2 advisory.");
...
(system crash) or possibly execute arbitrary code. (CVE-2022-26490)");
  ...
  script_tag(name:"affected", value:"'linux-meta-raspi, linux-raspi' package(s) on Ubuntu 22.04.");
