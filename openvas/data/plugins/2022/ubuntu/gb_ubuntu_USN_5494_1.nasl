...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-5494-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5494-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5494-1");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/1978961");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/1976260");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mozjs91' package(s) announced via the USN-5494-1 advisory.");
...
possibly use this issue to cause a crash. (CVE-2022-31740)");
  ...
  script_tag(name:"affected", value:"'mozjs91' package(s) on Ubuntu 22.04.");
