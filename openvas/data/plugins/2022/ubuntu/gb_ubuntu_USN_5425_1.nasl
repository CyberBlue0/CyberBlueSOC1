...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845375");
  ...
  script_name("Ubuntu: Security Advisory (USN-5425-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5425-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5425-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pcre3' package(s) announced via the USN-5425-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Yunho Kim discovered that PCRE incorrectly handled memory when
...
Ubuntu 18.04 LTS and Ubuntu 20.04 LTS. (CVE-2020-14155)");
  ...
  script_tag(name:"affected", value:"'pcre3' package(s) on Ubuntu 14.04, Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 21.10, Ubuntu 22.04.");
