...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-5518-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5518-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5518-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-aws, linux-azure, linux-gcp, linux-gke, linux-ibm, linux-kvm, linux-lowlatency, linux-meta, linux-meta-aws, linux-meta-azure, linux-meta-gcp, linux-meta-gke, linux-meta-ibm, linux-meta-kvm, linux-meta-lowlatency, linux-meta-oracle, linux-meta-raspi, linux-oracle, linux-raspi, linux-signed, linux-signed-aws, linux-signed-azure, linux-signed-gcp, linux-signed-gke, linux-signed-ibm, linux-signed-kvm, linux-signed-lowlatency, linux-signed-oracle' package(s) announced via the USN-5518-1 advisory.");
...
(system crash) or possibly execute arbitrary code. (CVE-2022-33981)");
  ...
  script_tag(name:"affected", value:"'linux, linux-aws, linux-azure, linux-gcp, linux-gke, linux-ibm, linux-kvm, linux-lowlatency, linux-meta, linux-meta-aws, linux-meta-azure, linux-meta-gcp, linux-meta-gke, linux-meta-ibm, linux-meta-kvm, linux-meta-lowlatency, linux-meta-oracle, linux-meta-raspi, linux-oracle, linux-raspi, linux-signed, linux-signed-aws, linux-signed-azure, linux-signed-gcp, linux-signed-gke, linux-signed-ibm, linux-signed-kvm, linux-signed-lowlatency, linux-signed-oracle' package(s) on Ubuntu 22.04.");
