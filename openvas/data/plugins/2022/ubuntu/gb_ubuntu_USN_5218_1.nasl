...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845189");
  script_cve_id("CVE-2021-20321", "CVE-2021-3760", "CVE-2021-4002", "CVE-2021-41864", "CVE-2021-4204", "CVE-2021-43056", "CVE-2021-43267", "CVE-2021-43389");
  script_tag(name:"creation_date", value:"2022-01-12 02:00:26 +0000 (Wed, 12 Jan 2022)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5218-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5218-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5218-1");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/1956585");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-meta-oem-5.13, linux-oem-5.13, linux-signed-oem-5.13' package(s) announced via the USN-5218-1 advisory.");
