...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845264");
  script_cve_id("CVE-2016-10228", "CVE-2019-25013", "CVE-2020-27618", "CVE-2020-29562", "CVE-2020-6096", "CVE-2021-27645", "CVE-2021-3326", "CVE-2021-35942", "CVE-2021-3998", "CVE-2021-3999", "CVE-2022-23218", "CVE-2022-23219");
  script_tag(name:"creation_date", value:"2022-03-02 02:00:25 +0000 (Wed, 02 Mar 2022)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5310-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5310-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5310-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'glibc' package(s) announced via the USN-5310-1 advisory.");
...
CVE-2022-23219)");
  ...
  script_tag(name:"affected", value:"'glibc' package(s) on Ubuntu 18.04, Ubuntu 20.04, Ubuntu 21.10.");
