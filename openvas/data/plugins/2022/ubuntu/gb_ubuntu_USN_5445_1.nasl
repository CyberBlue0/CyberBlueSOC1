...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845387");
  ...
  script_name("Ubuntu: Security Advisory (USN-5445-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5445-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5445-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'subversion' package(s) announced via the USN-5445-1 advisory.");
...
service. (CVE-2020-17525)");
  ...
  script_tag(name:"affected", value:"'subversion' package(s) on Ubuntu 18.04, Ubuntu 20.04.");
