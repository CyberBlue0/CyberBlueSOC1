...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845180");
  script_cve_id("CVE-2021-4001", "CVE-2021-4002", "CVE-2021-42739", "CVE-2021-43267");
  script_tag(name:"creation_date", value:"2022-01-07 13:02:55 +0000 (Fri, 07 Jan 2022)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5207-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5207-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5207-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-meta-oem-5.10, linux-oem-5.10, linux-signed-oem-5.10' package(s) announced via the USN-5207-1 advisory.");
