...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-hwe-5.13, linux-meta-hwe-5.13, linux-signed-hwe-5.13' package(s) announced via the USN-5295-1 advisory.");
...
(CVE-2022-22942)");
  ...
  script_tag(name:"affected", value:"'linux-hwe-5.13, linux-meta-hwe-5.13, linux-signed-hwe-5.13' package(s) on Ubuntu 20.04.");
