...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845323");
  script_cve_id("CVE-2020-11724", "CVE-2020-36309", "CVE-2021-3618");
  script_tag(name:"creation_date", value:"2022-04-14 01:00:40 +0000 (Thu, 14 Apr 2022)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5371-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5371-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5371-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nginx' package(s) announced via the USN-5371-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that nginx Lua module mishandled certain inputs.
...
(CVE-2021-3618)");
  ...
  script_tag(name:"affected", value:"'nginx' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 21.10.");
