...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-5397-1)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'curl' package(s) announced via the USN-5397-1 advisory.");
