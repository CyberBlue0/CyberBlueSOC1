...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845337");
  script_cve_id("CVE-2022-21426", "CVE-2022-21434", "CVE-2022-21443", "CVE-2022-21476", "CVE-2022-21496");
  script_tag(name:"creation_date", value:"2022-04-27 01:00:24 +0000 (Wed, 27 Apr 2022)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5388-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5388-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5388-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openjdk-lts' package(s) announced via the USN-5388-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that OpenJDK incorrectly limited memory when compiling a
...
invalid of malformed URI strings. (CVE-2022-21496)");
  ...
  script_tag(name:"affected", value:"'openjdk-lts' package(s) on Ubuntu 18.04, Ubuntu 20.04, Ubuntu 21.10, Ubuntu 22.04.");
