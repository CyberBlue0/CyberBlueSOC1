...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.845453");
  script_cve_id("CVE-2022-33070");
  script_tag(name:"creation_date", value:"2022-07-27 01:00:30 +0000 (Wed, 27 Jul 2022)");
  ...
  script_name("Ubuntu: Security Advisory (USN-5531-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2022 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-5531-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-5531-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'protobuf-c' package(s) announced via the USN-5531-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Pietro Borrello discovered that protobuf-c contained an invalid
...
cause a denial of service (system crash) via unspecified vectors.");
  ...
  script_tag(name:"affected", value:"'protobuf-c' package(s) on Ubuntu 20.04, Ubuntu 22.04.");
