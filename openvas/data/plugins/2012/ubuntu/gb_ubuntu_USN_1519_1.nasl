...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2012-07-30 05:48:54 +0000 (Mon, 30 Jul 2012)");
  script_version("2024-01-19T05:06:16+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:16 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"6.1");
  script_tag(name:"cvss_base_vector", value:"AV:A/AC:L/Au:N/C:N/I:N/A:C");

  script_name("Ubuntu: Security Advisory (USN-1519-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2012 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1519-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1519-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'isc-dhcp' package(s) announced via the USN-1519-1 advisory.");
...
denial of service. (CVE-2012-3954)");
  ...
  script_tag(name:"affected", value:"'isc-dhcp' package(s) on Ubuntu 11.04, Ubuntu 11.10, Ubuntu 12.04.");
