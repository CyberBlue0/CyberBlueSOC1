...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.841224");
  ...
  script_tag(name:"creation_date", value:"2012-11-23 06:23:46 +0000 (Fri, 23 Nov 2012)");
  ...
  script_name("Ubuntu: Security Advisory (USN-1638-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2012 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1638-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1638-1");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/1080211");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox' package(s) announced via the USN-1638-1 advisory.");
...
allowed. This ... [Please see the references for more information on the vulnerabilities]");
