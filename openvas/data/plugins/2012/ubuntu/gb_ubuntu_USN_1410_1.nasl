...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2012-03-29 04:35:23 +0000 (Thu, 29 Mar 2012)");
  ...
  script_name("Ubuntu: Security Advisory (USN-1410-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2012 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1410-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1410-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-ec2' package(s) announced via the USN-1410-1 advisory.");
