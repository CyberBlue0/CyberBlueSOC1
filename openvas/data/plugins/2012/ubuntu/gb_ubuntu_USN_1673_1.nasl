...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.841261");
  script_cve_id("CVE-2012-4508", "CVE-2012-5517", "CVE-2013-1928");
  script_tag(name:"creation_date", value:"2012-12-26 06:38:21 +0000 (Wed, 26 Dec 2012)");
  script_version("2024-01-19T05:06:16+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:16 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"4.7");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:M/Au:N/C:C/I:N/A:N");

  script_name("Ubuntu: Security Advisory (USN-1673-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2012 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1673-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1673-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-ti-omap4' package(s) announced via the USN-1673-1 advisory.");
