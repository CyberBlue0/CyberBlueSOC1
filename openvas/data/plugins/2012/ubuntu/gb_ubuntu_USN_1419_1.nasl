...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2012-04-13 05:03:28 +0000 (Fri, 13 Apr 2012)");
  script_version("2024-01-19T05:06:16+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:16 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"6.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:S/C:P/I:P/A:P");

  script_name("Ubuntu: Security Advisory (USN-1419-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2012 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1419-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1419-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'puppet' package(s) announced via the USN-1419-1 advisory.");
...
files. This issue only affected Ubuntu 11.10. (CVE-2012-1989)");
  ...
  script_tag(name:"affected", value:"'puppet' package(s) on Ubuntu 10.04, Ubuntu 11.04, Ubuntu 11.10.");
