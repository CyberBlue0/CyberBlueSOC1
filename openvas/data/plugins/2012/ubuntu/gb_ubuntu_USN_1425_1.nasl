...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2012-04-26 05:06:22 +0000 (Thu, 26 Apr 2012)");
  ...
  script_name("Ubuntu: Security Advisory (USN-1425-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2012 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1425-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1425-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux' package(s) announced via the USN-1425-1 advisory.");
