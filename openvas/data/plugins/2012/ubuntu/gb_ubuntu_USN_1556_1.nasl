...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2012-09-07 05:56:41 +0000 (Fri, 07 Sep 2012)");
  ...
  script_name("Ubuntu: Security Advisory (USN-1556-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2012 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1556-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1556-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-ec2' package(s) announced via the USN-1556-1 advisory.");
