...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.841180");
  ...
  script_tag(name:"creation_date", value:"2012-10-11 04:34:20 +0000 (Thu, 11 Oct 2012)");
  ...
  script_name("Ubuntu: Security Advisory (USN-1599-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2012 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1599-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1599-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-ti-omap4' package(s) announced via the USN-1599-1 advisory.");
