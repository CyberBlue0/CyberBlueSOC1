...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2012-02-21 13:29:05 +0000 (Tue, 21 Feb 2012)");
  script_version("2024-01-19T05:06:16+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:16 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");

  script_name("Ubuntu: Security Advisory (USN-1358-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2012 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1358-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1358-2");
  script_xref(name:"URL", value:"http://www.php.net/manual/en/info.configuration.php#ini.max-input-vars");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/930115");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php5' package(s) announced via the USN-1358-2 advisory.");
