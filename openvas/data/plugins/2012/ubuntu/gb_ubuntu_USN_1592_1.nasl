...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2012-10-03 03:54:32 +0000 (Wed, 03 Oct 2012)");
  script_version("2024-01-19T05:06:16+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:16 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"6.4");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:P");

  script_name("Ubuntu: Security Advisory (USN-1592-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2012 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1592-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1592-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python2.7' package(s) announced via the USN-1592-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Niels Heinen discovered that the urllib and urllib2 modules would process
...
objects with an unpredictable value. (CVE-2012-1150)");
  ...
  script_tag(name:"affected", value:"'python2.7' package(s) on Ubuntu 11.04, Ubuntu 11.10.");
