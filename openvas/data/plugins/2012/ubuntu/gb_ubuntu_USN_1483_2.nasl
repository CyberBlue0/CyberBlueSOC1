...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-1483-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2012 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1483-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1483-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'network-manager-applet' package(s) announced via the USN-1483-2 advisory.");
...
Original advisory details:
 ...
 removes WPA as a security choice for AdHoc connections in NetworkManager.");
  ...
  script_tag(name:"affected", value:"'network-manager-applet' package(s) on Ubuntu 10.04, Ubuntu 11.04, Ubuntu 11.10.");
