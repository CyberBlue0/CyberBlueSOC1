...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2012-05-11 05:32:36 +0000 (Fri, 11 May 2012)");
  ...
  script_name("Ubuntu: Security Advisory (USN-1440-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2012 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1440-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1440-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-lts-backport-natty' package(s) announced via the USN-1440-1 advisory.");
