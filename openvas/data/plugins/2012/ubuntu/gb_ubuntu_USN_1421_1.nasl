...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.840983");
  script_cve_id("CVE-2011-4347", "CVE-2012-0045", "CVE-2012-1097", "CVE-2012-1146");
  script_tag(name:"creation_date", value:"2012-04-13 05:03:35 +0000 (Fri, 13 Apr 2012)");
  ...
  script_name("Ubuntu: Security Advisory (USN-1421-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2012 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1421-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1421-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-lts-backport-maverick' package(s) announced via the USN-1421-1 advisory.");
