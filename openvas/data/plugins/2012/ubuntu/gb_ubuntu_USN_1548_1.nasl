...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2012-09-06 05:19:31 +0000 (Thu, 06 Sep 2012)");
  script_version("2024-01-19T05:06:16+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:16 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");

  script_name("Ubuntu: Security Advisory (USN-1548-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2012 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1548-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1548-1");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/1041620");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox' package(s) announced via the USN-1548-1 advisory.");
...
crafted page, an attacker could exploit these to cause a denial of ... [Please see the references for more information on the vulnerabilities]");
