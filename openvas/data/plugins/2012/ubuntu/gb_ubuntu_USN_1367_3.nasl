...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.840896");
  script_cve_id("CVE-2011-3026");
  script_tag(name:"creation_date", value:"2012-02-21 13:29:17 +0000 (Tue, 21 Feb 2012)");
  script_version("2024-01-19T05:06:16+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:16 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");

  script_name("Ubuntu: Security Advisory (USN-1367-3)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2012 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1367-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1367-3");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/933399");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird' package(s) announced via the USN-1367-3 advisory.");
