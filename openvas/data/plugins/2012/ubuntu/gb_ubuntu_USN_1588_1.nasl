...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-1588-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2012 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1588-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1588-1");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/1016643");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'software-properties' package(s) announced via the USN-1588-1 advisory.");
...
install altered package repository GPG keys.");
  ...
  script_tag(name:"affected", value:"'software-properties' package(s) on Ubuntu 10.04, Ubuntu 11.04, Ubuntu 11.10, Ubuntu 12.04.");
