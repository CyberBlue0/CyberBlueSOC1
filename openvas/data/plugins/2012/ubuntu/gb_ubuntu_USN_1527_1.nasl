...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2012-08-14 05:10:01 +0000 (Tue, 14 Aug 2012)");
  script_version("2024-01-19T05:06:16+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:16 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");

  script_name("Ubuntu: Security Advisory (USN-1527-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2012 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1527-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1527-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'expat' package(s) announced via the USN-1527-1 advisory.");
...
Tim Body discovered that Expat did not properly handle memory reallocation
...
Ubuntu 8.04 LTS, 10.04 LTS, 11.04 and 11.10. (CVE-2012-1148)");
  ...
  script_tag(name:"affected", value:"'expat' package(s) on Ubuntu 8.04, Ubuntu 10.04, Ubuntu 11.04, Ubuntu 11.10, Ubuntu 12.04.");
