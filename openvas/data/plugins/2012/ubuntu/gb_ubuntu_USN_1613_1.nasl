...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2012-10-19 04:23:57 +0000 (Fri, 19 Oct 2012)");
  script_version("2024-01-19T05:06:16+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:16 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"6.9");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:M/Au:N/C:C/I:C/A:C");

  script_name("Ubuntu: Security Advisory (USN-1613-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2012 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1613-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1613-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python2.5' package(s) announced via the USN-1613-1 advisory.");
...
resources. (CVE-2012-1148)");
  ...
  script_tag(name:"affected", value:"'python2.5' package(s) on Ubuntu 8.04.");
