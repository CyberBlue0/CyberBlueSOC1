...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2012-07-03 04:56:01 +0000 (Tue, 03 Jul 2012)");
  script_version("2024-01-19T05:06:16+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:16 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");

  script_name("Ubuntu: Security Advisory (USN-1495-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2012 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1495-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1495-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libreoffice, libreoffice-l10n' package(s) announced via the USN-1495-1 advisory.");
...
(CVE-2012-2334)");
  ...
  script_tag(name:"affected", value:"'libreoffice, libreoffice-l10n' package(s) on Ubuntu 11.04, Ubuntu 11.10.");
