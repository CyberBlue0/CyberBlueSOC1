...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2012-03-16 05:22:51 +0000 (Fri, 16 Mar 2012)");
  ...
  script_name("Ubuntu: Security Advisory (USN-1322-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2012 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1322-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1322-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux' package(s) announced via the USN-1322-1 advisory.");
