...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.840914");
  script_cve_id("CVE-2011-4127", "CVE-2011-4622", "CVE-2012-0038", "CVE-2012-2100");
  script_tag(name:"creation_date", value:"2012-03-07 05:49:24 +0000 (Wed, 07 Mar 2012)");
  ...
  script_name("Ubuntu: Security Advisory (USN-1388-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2012 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1388-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1388-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-ec2' package(s) announced via the USN-1388-1 advisory.");
