...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2012-06-25 04:23:43 +0000 (Mon, 25 Jun 2012)");
  script_version("2024-01-19T05:06:16+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:16 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");

  script_name("Ubuntu: Security Advisory (USN-1463-4)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2012 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1463-4");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1463-4");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/1007556");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird' package(s) announced via the USN-1463-4 advisory.");
...
Original advisory details:
 ...
 the user invoking Firefox. (CVE-2012-1940, CVE-2012-1941, CVE-2012-1947)");
  ...
  script_tag(name:"affected", value:"'thunderbird' package(s) on Ubuntu 10.04, Ubuntu 11.10, Ubuntu 12.04.");
