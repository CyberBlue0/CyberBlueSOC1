...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2012-10-03 03:54:29 +0000 (Wed, 03 Oct 2012)");
  script_version("2024-01-19T05:06:16+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:16 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"9.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:C/I:C/A:C");

  script_name("Ubuntu: Security Advisory (USN-1586-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2012 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-1586-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-1586-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'emacs23' package(s) announced via the USN-1586-1 advisory.");
...
code with the privileges of the user invoking the program. (CVE-2012-3479)");
  ...
  script_tag(name:"affected", value:"'emacs23' package(s) on Ubuntu 11.10, Ubuntu 12.04.");
