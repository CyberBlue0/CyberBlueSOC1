...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2487)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2012 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-2487");
  script_xref(name:"URL", value:"https://www.debian.org/security/2012/dsa-2487");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openoffice.org' package(s) announced via the DSA-2487 advisory.");
