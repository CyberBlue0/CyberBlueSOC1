...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2012-03-12 15:31:30 +0000 (Mon, 12 Mar 2012)");
  script_version("2024-01-19T05:06:16+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:16 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"6.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:P");

  script_name("Debian: Security Advisory (DSA-2415)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2012 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-2415");
  script_xref(name:"URL", value:"https://www.debian.org/security/2012/dsa-2415");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libmodplug' package(s) announced via the DSA-2415 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several vulnerabilities that can lead to the execution of arbitrary code have been discovered in libmodplug, a library for MOD music based on ModPlug. The Common Vulnerabilities and Exposures project identifies the following issues:
...
We recommend that you upgrade your libmodplug packages.");
  ...
  script_tag(name:"affected", value:"'libmodplug' package(s) on Debian 6.");
