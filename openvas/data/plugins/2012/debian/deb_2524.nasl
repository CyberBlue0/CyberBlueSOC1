...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-11-09 22:15:00 +0000 (Sat, 09 Nov 2019)");

  script_name("Debian: Security Advisory (DSA-2524)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2012 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-2524");
  script_xref(name:"URL", value:"https://www.debian.org/security/2012/dsa-2524");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openttd' package(s) announced via the DSA-2524 advisory.");
