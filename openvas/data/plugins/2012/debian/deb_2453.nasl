...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2012-04-30 11:57:45 +0000 (Mon, 30 Apr 2012)");
  script_version("2024-01-19T05:06:16+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:16 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");

  script_name("Debian: Security Advisory (DSA-2453)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2012 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-2453");
  script_xref(name:"URL", value:"https://www.debian.org/security/2012/dsa-2453");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gajim' package(s) announced via the DSA-2453 advisory.");
