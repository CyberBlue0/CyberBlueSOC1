...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2366");
  script_xref(name:"URL", value:"https://www.debian.org/security/2011/dsa-2366");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mediawiki' package(s) announced via the DSA-2366 advisory.");
