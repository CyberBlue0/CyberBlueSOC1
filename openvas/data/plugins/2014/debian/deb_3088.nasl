...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3088)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2014 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3088");
  script_xref(name:"URL", value:"https://www.debian.org/security/2014/dsa-3088");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'qemu-kvm' package(s) announced via the DSA-3088 advisory.");
...
For the stable distribution (wheezy), this problem has been fixed in version 1.1.2+dfsg-6+deb7u6.
