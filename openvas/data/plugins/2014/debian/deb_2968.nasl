...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2968)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2014 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-2968");
  script_xref(name:"URL", value:"https://www.debian.org/security/2014/dsa-2968");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gnupg2' package(s) announced via the DSA-2968 advisory.");
...
We recommend that you upgrade your gnupg2 packages.");
  ...
  script_tag(name:"affected", value:"'gnupg2' package(s) on Debian 7.");
