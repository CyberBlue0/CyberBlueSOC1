...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.703106");
  ...
  script_name("Debian: Security Advisory (DSA-3106)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2014 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3106");
  script_xref(name:"URL", value:"https://www.debian.org/security/2014/dsa-3106");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'jasper' package(s) announced via the DSA-3106 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Jose Duart of the Google Security Team discovered a double free flaw (CVE-2014-8137) and a heap-based buffer overflow flaw (CVE-2014-8138) in JasPer, a library for manipulating JPEG-2000 files. A specially crafted file could cause an application using JasPer to crash or, possibly, execute arbitrary code.

For the stable distribution (wheezy), these problems have been fixed in version 1.900.1-13+deb7u2.
