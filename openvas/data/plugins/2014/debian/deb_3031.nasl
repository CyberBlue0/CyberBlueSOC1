...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3031)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2014 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3031");
  script_xref(name:"URL", value:"https://www.debian.org/security/2014/dsa-3031");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'apt' package(s) announced via the DSA-3031 advisory.");
