...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3090)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2014 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3090");
  script_xref(name:"URL", value:"https://www.debian.org/security/2014/dsa-3090");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'iceweasel' package(s) announced via the DSA-3090 advisory.");
...
For the stable distribution (wheezy), these problems have been fixed in version 31.3.0esr-1~deb7u1.

For the upcoming stable distribution (jessie), these problems will be fixed soon.

For the unstable distribution (sid), these problems have been fixed in version 31.3.0esr-1.
