...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.703033");
  script_cve_id("CVE-2014-1568");
  script_tag(name:"creation_date", value:"2014-10-01 11:28:51 +0000 (Wed, 01 Oct 2014)");
  script_version("2024-01-19T05:06:16+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:16 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");

  script_name("Debian: Security Advisory (DSA-3033)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2014 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-3033");
  script_xref(name:"URL", value:"https://www.debian.org/security/2014/dsa-3033");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'nss' package(s) announced via the DSA-3033 advisory.");
