...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2835)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2014 Greenbone AG");
  script_family("Debian Local Security Checks");

  script_xref(name:"Advisory-ID", value:"DSA-2835");
  script_xref(name:"URL", value:"https://www.debian.org/security/2014/dsa-2835");
  script_xref(name:"URL", value:"http://downloads.asterisk.org/pub/security/AST-2013-007.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'asterisk' package(s) announced via the DSA-2835 advisory.");
