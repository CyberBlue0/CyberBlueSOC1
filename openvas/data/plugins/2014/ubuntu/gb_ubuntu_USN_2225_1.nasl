...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.841834");
  script_cve_id("CVE-2014-0055", "CVE-2014-0077", "CVE-2014-0100", "CVE-2014-0101", "CVE-2014-1737", "CVE-2014-1738", "CVE-2014-2309", "CVE-2014-2523", "CVE-2014-2672", "CVE-2014-2673", "CVE-2014-2678", "CVE-2014-2706", "CVE-2014-2851", "CVE-2014-9715");
  script_tag(name:"creation_date", value:"2014-06-02 09:36:29 +0000 (Mon, 02 Jun 2014)");
  script_version("2024-01-19T05:06:16+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:16 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");

  script_name("Ubuntu: Security Advisory (USN-2225-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2014 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2225-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2225-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-lts-saucy' package(s) announced via the USN-2225-1 advisory.");
...
crash) or possibly gain privileges via a crafted ... [Please see the references for more information on the vulnerabilities]");
