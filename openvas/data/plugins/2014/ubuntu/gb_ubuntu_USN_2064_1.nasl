...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.841676");
  script_cve_id("CVE-2013-4345", "CVE-2013-4588", "CVE-2013-6378", "CVE-2013-6763");
  script_tag(name:"creation_date", value:"2014-01-06 10:33:47 +0000 (Mon, 06 Jan 2014)");
  ...
  script_name("Ubuntu: Security Advisory (USN-2064-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2014 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2064-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2064-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux' package(s) announced via the USN-2064-1 advisory.");
