...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-2245-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2014 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2245-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2245-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'json-c' package(s) announced via the USN-2245-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Florian Weimer discovered that json-c incorrectly handled buffer lengths.
...
(CVE-2013-6371)");
  ...
  script_tag(name:"affected", value:"'json-c' package(s) on Ubuntu 12.04, Ubuntu 13.10, Ubuntu 14.04.");
