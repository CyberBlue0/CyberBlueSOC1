...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2014-01-20 04:37:30 +0000 (Mon, 20 Jan 2014)");
  script_version("2024-01-19T05:06:16+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:16 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");

  script_name("Ubuntu: Security Advisory (USN-2080-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2014 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2080-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2080-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'memcached' package(s) announced via the USN-2080-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Stefan Bucur discovered that Memcached incorrectly handled certain large
...
13.10. (CVE-2013-7239)");
  ...
  script_tag(name:"affected", value:"'memcached' package(s) on Ubuntu 12.04, Ubuntu 12.10, Ubuntu 13.04, Ubuntu 13.10.");
