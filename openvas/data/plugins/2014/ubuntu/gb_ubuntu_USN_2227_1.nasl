...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-2227-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2014 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2227-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2227-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-ti-omap4' package(s) announced via the USN-2227-1 advisory.");
...
crash) or possibly gain ... [Please see the references for more information on the vulnerabilities]");
