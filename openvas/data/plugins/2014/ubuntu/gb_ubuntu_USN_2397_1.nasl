...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2014-11-05 05:22:31 +0000 (Wed, 05 Nov 2014)");
  script_version("2024-01-19T05:06:16+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:16 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");

  script_name("Ubuntu: Security Advisory (USN-2397-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2014 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2397-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2397-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ruby1.8, ruby1.9.1, ruby2.0, ruby2.1' package(s) announced via the USN-2397-1 advisory.");
...
amounts of resources, resulting in a denial of service. (CVE-2014-8080)");
  ...
  script_tag(name:"affected", value:"'ruby1.8, ruby1.9.1, ruby2.0, ruby2.1' package(s) on Ubuntu 12.04, Ubuntu 14.04, Ubuntu 14.10.");
