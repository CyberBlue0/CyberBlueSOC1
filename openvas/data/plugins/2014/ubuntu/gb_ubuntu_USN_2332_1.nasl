...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2014-09-03 03:54:56 +0000 (Wed, 03 Sep 2014)");
  ...
  script_name("Ubuntu: Security Advisory (USN-2332-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2014 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2332-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2332-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux' package(s) announced via the USN-2332-1 advisory.");
