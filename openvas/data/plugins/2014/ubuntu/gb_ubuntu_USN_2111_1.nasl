...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.841717");
  script_cve_id("CVE-2013-2929", "CVE-2013-4592", "CVE-2013-6378", "CVE-2013-6380");
  script_tag(name:"creation_date", value:"2014-02-20 09:46:37 +0000 (Thu, 20 Feb 2014)");
  script_version("2024-01-19T05:06:16+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:16 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"4.7");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:M/Au:N/C:N/I:N/A:C");

  script_name("Ubuntu: Security Advisory (USN-2111-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2014 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2111-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2111-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-lts-quantal' package(s) announced via the USN-2111-1 advisory.");
