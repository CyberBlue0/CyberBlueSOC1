...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-2078-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2014 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2078-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2078-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libxfont' package(s) announced via the USN-2078-1 advisory.");
...
reduce the vulnerability to a denial of service.");
  ...
  script_tag(name:"affected", value:"'libxfont' package(s) on Ubuntu 10.04, Ubuntu 12.04, Ubuntu 12.10, Ubuntu 13.04, Ubuntu 13.10.");
