...
if(description)
{
  ...
  script_cve_id("CVE-2013-4579", "CVE-2013-6368", "CVE-2013-7339", "CVE-2014-1438", "CVE-2014-1446", "CVE-2014-1874");
  script_tag(name:"creation_date", value:"2014-03-12 04:01:51 +0000 (Wed, 12 Mar 2014)");
  script_version("2024-01-19T05:06:16+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:16 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"6.2");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:H/Au:N/C:C/I:C/A:C");

  script_name("Ubuntu: Security Advisory (USN-2134-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2014 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2134-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2134-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-ti-omap4' package(s) announced via the USN-2134-1 advisory.");
