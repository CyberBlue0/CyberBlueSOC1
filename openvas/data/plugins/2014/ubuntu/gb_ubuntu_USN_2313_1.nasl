...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2014-08-14 03:55:13 +0000 (Thu, 14 Aug 2014)");
  script_version("2024-01-19T05:06:16+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:16 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"3.3");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:M/Au:N/C:P/I:N/A:P");

  script_name("Ubuntu: Security Advisory (USN-2313-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2014 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2313-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2313-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-lts-trusty' package(s) announced via the USN-2313-1 advisory.");
