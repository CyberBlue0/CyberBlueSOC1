...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2014-01-27 05:51:43 +0000 (Mon, 27 Jan 2014)");
  script_version("2024-01-19T05:06:16+0000");
  script_tag(name:"last_modification", value:"2024-01-19 05:06:16 +0000 (Fri, 19 Jan 2024)");
  script_tag(name:"cvss_base", value:"4.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:S/C:N/I:N/A:P");

  script_name("Ubuntu: Security Advisory (USN-2086-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2014 Greenbone AG");
  script_family("Ubuntu Local Security Checks");

  script_xref(name:"Advisory-ID", value:"USN-2086-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-2086-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mysql-5.5, mysql-dfsg-5.1' package(s) announced via the USN-2086-1 advisory.");
...
[link moved to references]");
  ...
  script_tag(name:"affected", value:"'mysql-5.5, mysql-dfsg-5.1' package(s) on Ubuntu 10.04, Ubuntu 12.04, Ubuntu 12.10, Ubuntu 13.10.");
