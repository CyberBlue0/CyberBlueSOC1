...
if(description)
{
  ...
  script_name("Fedora: Security Advisory for libgit2_1.6 (FEDORA-2024-605004a28e)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-605004a28e");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/S635BGHHZUMRPI7QOXOJ45QHDD5FFZ3S");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libgit2_1.6'
  package(s) announced via the FEDORA-2024-605004a28e advisory.
