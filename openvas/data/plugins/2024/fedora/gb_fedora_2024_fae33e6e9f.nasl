...
if(description)
{
  ...
  script_name("Fedora: Security Advisory for gdcm (FEDORA-2024-fae33e6e9f)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-fae33e6e9f");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/BZJ4IG7EXMSMPHTK5ZFASCW6MHSOVZOE");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gdcm'
  package(s) announced via the FEDORA-2024-fae33e6e9f advisory.
