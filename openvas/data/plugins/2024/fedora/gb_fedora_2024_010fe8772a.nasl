...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886638");
  ...
  script_tag(name:"creation_date", value:"2024-05-27 10:43:48 +0000 (Mon, 27 May 2024)");
  script_name("Fedora: Security Advisory for kernel (FEDORA-2024-010fe8772a)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-010fe8772a");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/GCBZZEC7L7KTWWAS2NLJK6SO3IZIL4WW");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kernel'
  package(s) announced via the FEDORA-2024-010fe8772a advisory.
