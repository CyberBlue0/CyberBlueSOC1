...
if(description)
{
  ...
  script_cve_id("CVE-2023-36617", "CVE-2023-28755", "CVE-2024-27281", "CVE-2024-27280", "CVE-2024-27282");
  ...
  script_name("Fedora: Security Advisory for ruby (FEDORA-2024-31cac8b8ec)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-31cac8b8ec");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/QA6XUKUY7B5OLNQBLHOT43UW7C5NIOQQ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ruby'
  package(s) announced via the FEDORA-2024-31cac8b8ec advisory.
