...
if(description)
{
  ...
  script_name("Fedora: Security Advisory for composer (FEDORA-2024-bb55f8476a)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-bb55f8476a");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/PO4MU2BC7VR6LMHEX4X7DKGHVFXZV2MC");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'composer'
  package(s) announced via the FEDORA-2024-bb55f8476a advisory.
