...
if(description)
{
  ...
  script_name("Fedora: Security Advisory for emacs (FEDORA-2024-f9ce536a3e)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-f9ce536a3e");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XTM7CMGBJH4HQBRSOAOEQM4GSZUEACF5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'emacs'
  package(s) announced via the FEDORA-2024-f9ce536a3e advisory.
