...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885523");
  ...
  script_tag(name:"creation_date", value:"2024-01-01 02:20:17 +0000 (Mon, 01 Jan 2024)");
  script_name("Fedora: Security Advisory for xerces-c (FEDORA-2023-817ecc703f)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2023-817ecc703f");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/AJYZUBGPVWJ7LEHRCMB5XVADQBNGURXD");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xerces-c'
  package(s) announced via the FEDORA-2023-817ecc703f advisory.
...
Namespaces in XML 1.1, XML Schema, XML Inclusions).");
  ...
  script_tag(name:"affected", value:"'xerces-c' package(s) on Fedora 39.");
