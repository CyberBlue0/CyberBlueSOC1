...
if(description)
{
  ...
  script_name("Fedora: Security Advisory for mingw-qt6-qtbase (FEDORA-2024-81c4b76a71)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-81c4b76a71");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/2U35G2E7ZXVHVXGKZKNECRJXTWOXEZHF");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mingw-qt6-qtbase'
  package(s) announced via the FEDORA-2024-81c4b76a71 advisory.
