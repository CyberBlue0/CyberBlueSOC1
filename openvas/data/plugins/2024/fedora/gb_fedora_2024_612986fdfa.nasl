...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886571");
  ...
  script_tag(name:"creation_date", value:"2024-05-27 10:43:17 +0000 (Mon, 27 May 2024)");
  script_name("Fedora: Security Advisory for pypy (FEDORA-2024-612986fdfa)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-612986fdfa");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/622OZXWG72ISQPLM5Y57YCVIMWHD4C3U");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pypy'
  package(s) announced via the FEDORA-2024-612986fdfa advisory.
