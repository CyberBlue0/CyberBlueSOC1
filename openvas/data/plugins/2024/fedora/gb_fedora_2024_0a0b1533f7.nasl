...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886325");
  ...
  script_name("Fedora: Security Advisory for liblas (FEDORA-2024-0a0b1533f7)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-0a0b1533f7");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/6T2B6GZQ3WUVFNAAWFQJAQY7UM4OH5TA");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'liblas'
  package(s) announced via the FEDORA-2024-0a0b1533f7 advisory.
...
interchange and archival.");
  ...
  script_tag(name:"affected", value:"'liblas' package(s) on Fedora 40.");
