...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2024-03-27 02:16:19 +0000 (Wed, 27 Mar 2024)");
  script_name("Fedora: Security Advisory for containers-common (FEDORA-2024-a267e93f8c)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-a267e93f8c");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/NPFYLVSR2JULYWXEYEBX5L2AFFVFOK5R");
...
separately.");
  ...
  script_tag(name:"affected", value:"'containers-common' package(s) on Fedora 40.");
