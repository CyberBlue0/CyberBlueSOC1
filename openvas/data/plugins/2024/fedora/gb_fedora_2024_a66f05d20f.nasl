...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885831");
  ...
  script_name("Fedora: Security Advisory for dotnet7.0 (FEDORA-2024-a66f05d20f)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-a66f05d20f");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/PX6N6UKNHACRV4HNGCFMMLGTDZX5SV66");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dotnet7.0'
  package(s) announced via the FEDORA-2024-a66f05d20f advisory.
