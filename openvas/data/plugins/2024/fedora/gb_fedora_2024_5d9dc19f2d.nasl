...
if(description)
{
  ...
  script_name("Fedora: Security Advisory for mysql8.0 (FEDORA-2024-5d9dc19f2d)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-5d9dc19f2d");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/WV57BDHII4SG2QZ4RWJFUCEH5YNGSDFQ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mysql8.0'
  package(s) announced via the FEDORA-2024-5d9dc19f2d advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"MySQL is a multi-user, multi-threaded SQL database server");
