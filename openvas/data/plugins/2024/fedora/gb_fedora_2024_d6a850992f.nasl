...
if(description)
{
  ...
  script_name("Fedora: Security Advisory for libuev (FEDORA-2024-d6a850992f)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-d6a850992f");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/P2XZESYGE6XDWAPFUOX26ZWJV2JWMMM5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libuev'
  package(s) announced via the FEDORA-2024-d6a850992f advisory.
