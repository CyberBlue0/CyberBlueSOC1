...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886300");
  ...
  script_name("Fedora: Security Advisory for amavis (FEDORA-2024-8bbcae6af2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-8bbcae6af2");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XQQQQPTZ5JHXTUCYUXZHY6RZJ6VOGOAJ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'amavis'
  package(s) announced via the FEDORA-2024-8bbcae6af2 advisory.
...
which could cause a mail loss.");
  ...
  script_tag(name:"affected", value:"'amavis' package(s) on Fedora 40.");
