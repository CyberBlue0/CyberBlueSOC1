...
if(description)
{
  ...
  script_name("Fedora: Security Advisory for perl-Spreadsheet-ParseXLSX (FEDORA-2024-5f136f5d10)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-5f136f5d10");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/WNJVC4C5C5V44DNOZ5BHVU53CDXPB2OJ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'perl-Spreadsheet-ParseXLSX'
  package(s) announced via the FEDORA-2024-5f136f5d10 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This module is an adaptor for <Spreadsheet::ParseExcel> that reads XLSX files.
