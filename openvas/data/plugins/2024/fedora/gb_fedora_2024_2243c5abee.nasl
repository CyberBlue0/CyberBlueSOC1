...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.887313");
  ...
  script_tag(name:"creation_date", value:"2024-08-06 07:33:33 +0000 (Tue, 06 Aug 2024)");
  script_name("Fedora: Security Advisory for trafficserver (FEDORA-2024-2243c5abee)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-2243c5abee");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/NMVRFLLNYZA5W4A52FGYMR7Z5VOISC2P");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'trafficserver'
  package(s) announced via the FEDORA-2024-2243c5abee advisory.
