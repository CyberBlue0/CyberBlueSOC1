...
if(description)
{
  ...
  script_name("Fedora: Security Advisory for baresip (FEDORA-2024-a63e807450)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-a63e807450");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XHRGYVUUASVG5RGHCEEP3LORP7RCTHIS");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'baresip'
  package(s) announced via the FEDORA-2024-a63e807450 advisory.
...
with HTTP interface, command-line console and interface, and MQTT.");
  ...
  script_tag(name:"affected", value:"'baresip' package(s) on Fedora 40.");
