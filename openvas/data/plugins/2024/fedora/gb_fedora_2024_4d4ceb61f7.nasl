...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2024-05-27 10:42:54 +0000 (Mon, 27 May 2024)");
  script_name("Fedora: Security Advisory for pgadmin4 (FEDORA-2024-4d4ceb61f7)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-4d4ceb61f7");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/T2YFVCB4HCXU3FQBZ5XTWJZWSZUDNCXE");
