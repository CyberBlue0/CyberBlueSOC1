...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.887237");
  ...
  script_tag(name:"creation_date", value:"2024-06-15 04:07:59 +0000 (Sat, 15 Jun 2024)");
  script_name("Fedora: Security Advisory for cyrus-imapd (FEDORA-2024-123f2b3666)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-123f2b3666");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/WVZHUZDU4MGTTZJRNACTMSKXLNMMRLJ6");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cyrus-imapd'
  package(s) announced via the FEDORA-2024-123f2b3666 advisory.
...
hierarchies.");
  ...
  script_tag(name:"affected", value:"'cyrus-imapd' package(s) on Fedora 39.");
