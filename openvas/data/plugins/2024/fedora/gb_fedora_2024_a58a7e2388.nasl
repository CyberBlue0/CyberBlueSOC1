...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886334");
  ...
  script_tag(name:"creation_date", value:"2024-03-28 02:11:14 +0000 (Thu, 28 Mar 2024)");
  script_name("Fedora: Security Advisory for perl-Data-UUID (FEDORA-2024-a58a7e2388)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-a58a7e2388");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/DTKH3TWUOXBAAZST7364UVZ4UPH4CEO7");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'perl-Data-UUID'
  package(s) announced via the FEDORA-2024-a58a7e2388 advisory.
...
<namespace> is a UUID and <name> is a free form string.");
  ...
  script_tag(name:"affected", value:"'perl-Data-UUID' package(s) on Fedora 39.");
