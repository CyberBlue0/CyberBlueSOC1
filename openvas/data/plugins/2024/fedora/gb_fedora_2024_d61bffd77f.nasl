...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.887243");
  ...
  script_tag(name:"creation_date", value:"2024-06-18 04:08:16 +0000 (Tue, 18 Jun 2024)");
  script_name("Fedora: Security Advisory for galera (FEDORA-2024-d61bffd77f)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-d61bffd77f");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/CKWVBZ6DBRFMLDXTHJUZ6LU7MJ5RTNA7");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'galera'
  package(s) announced via the FEDORA-2024-d61bffd77f advisory.
