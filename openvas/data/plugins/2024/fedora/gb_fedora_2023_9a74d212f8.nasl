...
if(description)
{
  ...
  script_cve_id("CVE-2023-49933", "CVE-2023-49938", "CVE-2023-49937", "CVE-2023-49936", "CVE-2023-49935", "CVE-2023-49934");
  ...
  script_tag(name:"severity_date", value:"2023-12-21 17:17:00 +0000 (Thu, 21 Dec 2023)");
  script_tag(name:"creation_date", value:"2024-01-18 09:13:58 +0000 (Thu, 18 Jan 2024)");
  script_name("Fedora: Security Advisory for slurm (FEDORA-2023-9a74d212f8)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2023-9a74d212f8");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/63FEDDYEE2WK7FHWBHKON3OZVQI56WSQ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'slurm'
  package(s) announced via the FEDORA-2023-9a74d212f8 advisory.
