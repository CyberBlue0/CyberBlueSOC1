...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886737");
  ...
  script_tag(name:"creation_date", value:"2024-05-27 10:45:48 +0000 (Mon, 27 May 2024)");
  script_name("Fedora: Security Advisory for golang-gvisor (FEDORA-2024-9cc0e0c63e)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-9cc0e0c63e");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/3WJ4QVX2AMUJ2F2S27POOAHRC4K3CHU4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'golang-gvisor'
  package(s) announced via the FEDORA-2024-9cc0e0c63e advisory.
...
machines.");
  ...
  script_tag(name:"affected", value:"'golang-gvisor' package(s) on Fedora 39.");
