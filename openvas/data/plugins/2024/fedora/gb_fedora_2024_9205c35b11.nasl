...
if(description)
{
  ...
  script_name("Fedora: Security Advisory for stalld (FEDORA-2024-9205c35b11)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-9205c35b11");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/FYM3GTD77AK2OO3EIY6KDZ7LU3PWNNK3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'stalld'
  package(s) announced via the FEDORA-2024-9205c35b11 advisory.
