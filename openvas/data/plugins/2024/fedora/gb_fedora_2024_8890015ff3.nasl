...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886395");
  ...
  script_name("Fedora: Security Advisory for seamonkey (FEDORA-2024-8890015ff3)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-8890015ff3");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/POUCTUBB5IPXEOVRLGDERDTRXJSTDSRI");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'seamonkey'
  package(s) announced via the FEDORA-2024-8890015ff3 advisory.
