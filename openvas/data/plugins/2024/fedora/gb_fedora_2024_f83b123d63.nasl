...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2024-05-27 10:42:47 +0000 (Mon, 27 May 2024)");
  script_name("Fedora: Security Advisory for llhttp (FEDORA-2024-f83b123d63)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-f83b123d63");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/L64SJBAHQLI7UGKHOE5G7FEMSETPKNMA");
