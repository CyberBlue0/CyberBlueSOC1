...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2024-04-03 01:16:17 +0000 (Wed, 03 Apr 2024)");
  script_name("Fedora: Security Advisory for ghc-hakyll (FEDORA-2024-b458482d48)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-b458482d48");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JGRJHU2FTSGTHHRTNDF7STEKLKKA25JN");
...
as markdown or RST.");
  ...
  script_tag(name:"affected", value:"'ghc-hakyll' package(s) on Fedora 39.");
