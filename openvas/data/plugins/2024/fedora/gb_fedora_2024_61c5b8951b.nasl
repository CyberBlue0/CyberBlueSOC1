...
if(description)
{
  ...
  script_name("Fedora: Security Advisory for xdg-desktop-portal-hyprland (FEDORA-2024-61c5b8951b)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-61c5b8951b");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/3ZKX4RUXEGLPNNGSZMQ2JLMT5XDLMUGY");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xdg-desktop-portal-hyprland'
  package(s) announced via the FEDORA-2024-61c5b8951b advisory.
