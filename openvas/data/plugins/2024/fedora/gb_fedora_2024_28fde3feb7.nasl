...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886793");
  ...
  script_name("Fedora: Security Advisory for opensmtpd (FEDORA-2024-28fde3feb7)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-28fde3feb7");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/GZBNQBHCM6PIOUR6I5GEQS35XYT2NX6T");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'opensmtpd'
  package(s) announced via the FEDORA-2024-28fde3feb7 advisory.
...
back to Sendmail as a default mail daemon.");
  ...
  script_tag(name:"affected", value:"'opensmtpd' package(s) on Fedora 40.");
