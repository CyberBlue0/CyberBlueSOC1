...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-12-22 21:11:00 +0000 (Fri, 22 Dec 2023)");
  script_tag(name:"creation_date", value:"2024-01-18 09:15:25 +0000 (Thu, 18 Jan 2024)");
  script_name("Fedora: Security Advisory for zabbix (FEDORA-2024-359d7180b3)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-359d7180b3");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/UMFKNV5E4LG2DIZNPRWQ2ENH75H6UEQT");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'zabbix'
  package(s) announced via the FEDORA-2024-359d7180b3 advisory.
