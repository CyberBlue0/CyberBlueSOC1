...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886874");
  ...
  script_tag(name:"creation_date", value:"2024-05-27 10:50:41 +0000 (Mon, 27 May 2024)");
  script_name("Fedora: Security Advisory for djvulibre (FEDORA-2024-d20163632f)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-d20163632f");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/4APFAWR7QE27GXQMRKR6XKNZWWUJ5YMH");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'djvulibre'
  package(s) announced via the FEDORA-2024-d20163632f advisory.
...
separate sub-package.");
  ...
  script_tag(name:"affected", value:"'djvulibre' package(s) on Fedora 40.");
