...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885650");
  ...
  script_tag(name:"creation_date", value:"2024-02-05 02:03:16 +0000 (Mon, 05 Feb 2024)");
  script_name("Fedora: Security Advisory for python-aiohttp (FEDORA-2024-f249b74f03)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-f249b74f03");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/XXWVZIVAYWEBHNRIILZVB3R3SDQNNAA7");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-aiohttp'
  package(s) announced via the FEDORA-2024-f249b74f03 advisory.
