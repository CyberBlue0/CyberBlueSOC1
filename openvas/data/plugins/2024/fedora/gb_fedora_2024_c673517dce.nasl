...
if(description)
{
  ...
  script_name("Fedora: Security Advisory for apache-commons-configuration (FEDORA-2024-c673517dce)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-c673517dce");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/YD4AFTIIQW662LUAQRMWS6BBKYSZG3YS");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'apache-commons-configuration'
  package(s) announced via the FEDORA-2024-c673517dce advisory.
