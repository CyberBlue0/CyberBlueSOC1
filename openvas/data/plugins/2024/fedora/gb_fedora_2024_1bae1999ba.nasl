...
if(description)
{
  ...
  script_name("Fedora: Security Advisory for prometheus-podman-exporter (FEDORA-2024-1bae1999ba)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-1bae1999ba");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/FBZQ2ZRMFEUQ35235B2HWPSXGDCBZHFV");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'prometheus-podman-exporter'
  package(s) announced via the FEDORA-2024-1bae1999ba advisory.
