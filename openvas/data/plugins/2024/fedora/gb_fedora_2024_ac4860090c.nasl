...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.887262");
  ...
  script_tag(name:"creation_date", value:"2024-06-26 04:08:22 +0000 (Wed, 26 Jun 2024)");
  script_name("Fedora: Security Advisory for libopenmpt (FEDORA-2024-ac4860090c)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-ac4860090c");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/D7YJFV5SVNC56UHJSF56PLZQRD3BMTIO");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libopenmpt'
  package(s) announced via the FEDORA-2024-ac4860090c advisory.
