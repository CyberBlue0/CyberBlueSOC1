...
if(description)
{
  ...
  script_name("Fedora: Security Advisory for systemd (FEDORA-2024-b8312ca5b3)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-b8312ca5b3");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/QHNBXGKJWISJETTTDTZKTBFIBJUOSLKL");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'systemd'
  package(s) announced via the FEDORA-2024-b8312ca5b3 advisory.
...
This package was built from the v254-stable branch of systemd.");
