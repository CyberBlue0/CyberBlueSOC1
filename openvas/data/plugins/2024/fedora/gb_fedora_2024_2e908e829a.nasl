...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.887387");
  script_version("2025-08-07T05:44:51+0000");
  script_xref(name:"CISA", value:"Known Exploited Vulnerability (KEV) catalog");
  script_xref(name:"URL", value:"https://www.cisa.gov/known-exploited-vulnerabilities-catalog");
  script_cve_id("CVE-2024-42009", "CVE-2024-42008", "CVE-2024-42010");
  ...
  script_tag(name:"creation_date", value:"2024-08-15 04:04:33 +0000 (Thu, 15 Aug 2024)");
  script_name("Fedora: Security Advisory for roundcubemail (FEDORA-2024-2e908e829a)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-2e908e829a");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/K33HRCOP4HUWZDOXC272GDCRM22ZIYKQ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'roundcubemail'
  package(s) announced via the FEDORA-2024-2e908e829a advisory.
