...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886327");
  ...
  script_tag(name:"creation_date", value:"2024-03-27 02:16:10 +0000 (Wed, 27 Mar 2024)");
  script_name("Fedora: Security Advisory for w3m (FEDORA-2024-3fc66f8bf3)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-3fc66f8bf3");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/TODROGVCWZ435HQIZE6ARQC5LPQLIA5C");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'w3m'
  package(s) announced via the FEDORA-2024-3fc66f8bf3 advisory.
...
w3m-img package as well.");
  ...
  script_tag(name:"affected", value:"'w3m' package(s) on Fedora 39.");
