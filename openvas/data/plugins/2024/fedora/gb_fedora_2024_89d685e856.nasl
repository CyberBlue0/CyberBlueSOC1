...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.887300");
  ...
  script_name("Fedora: Security Advisory for wordpress (FEDORA-2024-89d685e856)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-89d685e856");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/4EG47FCNCYN7MIKNW6VS55DKS7FMBVOX");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'wordpress'
  package(s) announced via the FEDORA-2024-89d685e856 advisory.
