...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.887228");
  script_version("2024-09-11T05:05:55+0000");
  script_cve_id("CVE-2024-1298");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2024-09-11 05:05:55 +0000 (Wed, 11 Sep 2024)");
  script_tag(name:"creation_date", value:"2024-06-11 04:08:10 +0000 (Tue, 11 Jun 2024)");
  script_name("Fedora: Security Advisory for efifs (FEDORA-2024-07342adb87)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("Fedora Local Security Checks");

  script_xref(name:"Advisory-ID", value:"FEDORA-2024-07342adb87");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/VIMEZWDKEIQKU7NMHKL57DOCITPGEXYN");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'efifs'
  package(s) announced via the FEDORA-2024-07342adb87 advisory.
...
UFS/FFS, UFS2/FFS2, XFS, ZFS and more.");
  ...
  script_tag(name:"affected", value:"'efifs' package(s) on Fedora 40.");
