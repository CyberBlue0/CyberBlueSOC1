...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834704");
  ...
  script_name("Mozilla Thunderbird ESR Security Update (MFSA2024-52) - Windows");
  ...
  115.16.0 and 128.0 before 128.3.1 on Windows.");
