...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.153671");
  script_version("2025-04-11T15:45:04+0000");
  script_tag(name:"last_modification", value:"2025-04-11 15:45:04 +0000 (Fri, 11 Apr 2025)");
  script_tag(name:"creation_date", value:"2024-12-20 04:10:01 +0000 (Fri, 20 Dec 2024)");
  script_tag(name:"cvss_base", value:"7.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:N/A:N");

  script_cve_id("CVE-2024-49765", "CVE-2024-52589", "CVE-2024-52794", "CVE-2024-53991",
                "CVE-2024-53266", "CVE-2024-53851", "CVE-2024-53994");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Discourse < 3.3.3 Multiple Vulnerabilities");
  ...
  script_tag(name:"affected", value:"Discourse prior to version 3.3.3.");
