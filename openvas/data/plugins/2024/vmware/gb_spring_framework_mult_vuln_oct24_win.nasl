...
if(description)
{
  ...
  script_name("VMware Spring Framework 5.3.0 < 5.3.41, 6.0.x < 6.0.25, 6.1.x < 6.1.14 Multiple Vulnerabilities - Windows");
  ...
  script_xref(name:"URL", value:"https://github.com/masa42/CVE-2024-38819-POC");
