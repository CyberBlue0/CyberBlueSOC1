...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856852");
  ...
  script_tag(name:"creation_date", value:"2024-12-17 05:00:24 +0000 (Tue, 17 Dec 2024)");
  script_name("openSUSE: Security Advisory for libaom, libyuv (SUSE-SU-2024:4333-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:4333-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/VWCVTCUTH7YEPH2I6QKPFFMN3HLL77MT");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libaom, libyuv'
  package(s) announced via the SUSE-SU-2024:4333-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This update for libaom, libyuv fixes the following issues:
  ...
  * 2-5% for encoding  ...
  ...
  script_tag(name:"affected", value:"'libaom, libyuv' package(s) on openSUSE Leap 15.4, openSUSE Leap 15.5.");
