...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856508");
  ...
  script_tag(name:"creation_date", value:"2024-09-26 04:01:44 +0000 (Thu, 26 Sep 2024)");
  script_name("openSUSE: Security Advisory for python311 (SUSE-SU-2024:3427-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:3427-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/CRJ2U3MV4VOQ6KW7VRBW3S3FLOUPQD57");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python311'
  package(s) announced via the SUSE-SU-2024:3427-1 advisory.
