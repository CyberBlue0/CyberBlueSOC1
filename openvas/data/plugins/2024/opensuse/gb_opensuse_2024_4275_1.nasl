...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856831");
  script_version("2025-02-26T05:38:41+0000");
  script_cve_id("CVE-2021-47598", "CVE-2023-52752", "CVE-2023-52846", "CVE-2024-26923", "CVE-2024-35861", "CVE-2024-35862", "CVE-2024-35864", "CVE-2024-35950", "CVE-2024-36899", "CVE-2024-36904", "CVE-2024-36964", "CVE-2024-40954", "CVE-2024-41059", "CVE-2024-43861");
  ...
  script_tag(name:"creation_date", value:"2024-12-11 05:00:23 +0000 (Wed, 11 Dec 2024)");
  script_name("openSUSE: Security Advisory for the Linux Kernel (Live Patch 27 for SLE 15 SP4) (SUSE-SU-2024:4275-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:4275-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/YTZ2WGLML4Q6E3IG32UCJ6NFIDUTWN22");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'the Linux Kernel (Live Patch 27 for SLE 15 SP4)'
  package(s) announced via the SUSE-SU-2024:4275-1 advisory.
