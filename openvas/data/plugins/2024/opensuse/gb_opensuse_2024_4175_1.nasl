...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856786");
  script_version("2025-02-26T05:38:41+0000");
  script_cve_id("CVE-2024-10976", "CVE-2024-10977", "CVE-2024-10978", "CVE-2024-10979");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2025-02-26 05:38:41 +0000 (Wed, 26 Feb 2025)");
  script_tag(name:"creation_date", value:"2024-12-05 05:00:20 +0000 (Thu, 05 Dec 2024)");
  script_name("openSUSE: Security Advisory for postgresql13 (SUSE-SU-2024:4175-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:4175-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/LS2XLEBNB7SJ2N2QEBUANUTS7ORDE6SO");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'postgresql13'
  package(s) announced via the SUSE-SU-2024:4175-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  * CVE-2024-10979: Prevent trusted PL/Perl code from changing environment
  ...
  script_tag(name:"affected", value:"'postgresql13' package(s) on openSUSE Leap 15.5, openSUSE Leap 15.6.");
