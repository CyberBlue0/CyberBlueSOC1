...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856684");
  script_version("2025-02-26T05:38:41+0000");
  script_cve_id("CVE-2023-52752", "CVE-2024-36899", "CVE-2024-40954", "CVE-2024-42133");
  ...
  script_tag(name:"creation_date", value:"2024-11-05 05:00:27 +0000 (Tue, 05 Nov 2024)");
  script_name("openSUSE: Security Advisory for the Linux Kernel (Live Patch 1 for SLE 15 SP6) (SUSE-SU-2024:3881-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:3881-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/ZOOTWA362J2SG2EX2CE3LPBWPJ7GVK2B");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'the Linux Kernel (Live Patch 1 for SLE 15 SP6)'
  package(s) announced via the SUSE-SU-2024:3881-1 advisory.
