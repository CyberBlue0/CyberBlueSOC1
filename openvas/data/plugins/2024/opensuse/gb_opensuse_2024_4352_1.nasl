...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856862");
  script_version("2025-02-26T05:38:41+0000");
  script_cve_id("CVE-2024-52530", "CVE-2024-52531", "CVE-2024-52532");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2025-02-26 05:38:41 +0000 (Wed, 26 Feb 2025)");
  script_tag(name:"creation_date", value:"2024-12-18 05:00:43 +0000 (Wed, 18 Dec 2024)");
  script_name("openSUSE: Security Advisory for libsoup (SUSE-SU-2024:4352-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:4352-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/OST3UM36TBIBUKKWN4W3HCA3OMKWOHFT");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libsoup'
  package(s) announced via the SUSE-SU-2024:4352-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  * Increase test timeout on s390x. The http2-body-stream test can be slow and
  ...
  script_tag(name:"affected", value:"'libsoup' package(s) on openSUSE Leap 15.4, openSUSE Leap 15.5.");
