...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856260");
  ...
  script_name("openSUSE: Security Advisory for gdk (SUSE-SU-2024:2076-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:2076-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/KLGHZ7ICMF7B5KMFIDQ27Y6FUJ7F3SJ5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gdk'
  package(s) announced via the SUSE-SU-2024:2076-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  * Avoid Bash specific syntax in baselibs postscript (bsc#1195391)
  ...
  script_tag(name:"affected", value:"'gdk' package(s) on openSUSE Leap 15.6.");
