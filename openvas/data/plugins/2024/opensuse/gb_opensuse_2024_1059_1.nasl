...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856042");
  ...
  script_tag(name:"creation_date", value:"2024-04-06 01:04:10 +0000 (Sat, 06 Apr 2024)");
  script_name("openSUSE: Security Advisory for podman (SUSE-SU-2024:1059-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:1059-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/GZKDNT7DNZ6TMGXXEWSNABYBXKVJHCQG");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'podman'
  package(s) announced via the SUSE-SU-2024:1059-1 advisory.
