...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856322");
  script_version("2025-02-26T05:38:41+0000");
  script_cve_id("CVE-2023-23969", "CVE-2024-38875", "CVE-2024-39329", "CVE-2024-39330", "CVE-2024-39614");
  ...
  script_tag(name:"creation_date", value:"2024-07-24 04:00:41 +0000 (Wed, 24 Jul 2024)");
  script_name("openSUSE: Security Advisory for python (SUSE-SU-2024:2545-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:2545-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/ZRIJHDUR5S7TM7HPZSGPUHL6LRLOFNBX");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python'
  package(s) announced via the SUSE-SU-2024:2545-1 advisory.
