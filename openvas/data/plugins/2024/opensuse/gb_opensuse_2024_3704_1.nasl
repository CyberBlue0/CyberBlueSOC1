...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856607");
  script_version("2025-02-26T05:38:41+0000");
  script_cve_id("CVE-2021-47291", "CVE-2024-41059");
  ...
  script_tag(name:"creation_date", value:"2024-10-18 04:00:43 +0000 (Fri, 18 Oct 2024)");
  script_name("openSUSE: Security Advisory for the Linux Kernel (Live Patch 46 for SLE 15 SP3) (SUSE-SU-2024:3704-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:3704-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/5ESWDH77MSPQVMPKEX33DCOZ5ZWWTEUO");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'the Linux Kernel (Live Patch 46 for SLE 15 SP3)'
  package(s) announced via the SUSE-SU-2024:3704-1 advisory.
