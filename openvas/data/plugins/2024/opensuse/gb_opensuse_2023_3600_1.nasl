...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833831");
  ...
  script_name("openSUSE: Security Advisory for the Linux Kernel (SUSE-SU-2023:3600-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2023:3600-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/KL6U7FN5O2QHPGO4NS7BQXK4FW2KHJR3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'the Linux Kernel'
  package(s) announced via the SUSE-SU-2023:3600-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  * CVE-2023-4569: Fixed information leak in nft_set_catchall_flush in
      net/netfilter/nf_tables_api.c (bsc ...
