...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833196");
  script_version("2025-02-26T05:38:41+0000");
  script_cve_id("CVE-2023-0667", "CVE-2023-0668", "CVE-2023-2855", "CVE-2023-2856", "CVE-2023-2857", "CVE-2023-2858", "CVE-2023-2879", "CVE-2023-2952", "CVE-2023-3648");
  ...
  script_tag(name:"creation_date", value:"2024-03-04 07:11:13 +0000 (Mon, 04 Mar 2024)");
  script_name("openSUSE: Security Advisory for wireshark (SUSE-SU-2023:3252-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2023:3252-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/KYZDFHR64O3IGA4NDBGILIJPAIHWAZDO");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'wireshark'
  package(s) announced via the SUSE-SU-2023:3252-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  script_tag(name:"affected", value:"'wireshark' package(s) on openSUSE Leap 15.4, openSUSE Leap 15.5.");
