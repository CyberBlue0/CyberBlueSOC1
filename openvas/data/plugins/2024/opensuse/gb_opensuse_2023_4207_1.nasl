...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833201");
  ...
  script_name("openSUSE: Security Advisory for nodejs18 (SUSE-SU-2023:4207-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2023:4207-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/5Y6VDB6HR32PUNLGOUKO3D4DXJOKRJ42");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nodejs18'
  package(s) announced via the SUSE-SU-2023:4207-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  * CVE-2023-39333: Fixed a code injection via WebAssembly export names.
  ...
  script_tag(name:"affected", value:"'nodejs18' package(s) on openSUSE Leap 15.3.");
