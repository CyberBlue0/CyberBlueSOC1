...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833091");
  ...
  script_tag(name:"creation_date", value:"2024-03-08 02:00:45 +0000 (Fri, 08 Mar 2024)");
  script_name("openSUSE: Security Advisory for nodejs16 (SUSE-SU-2024:0729-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:0729-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/HSF64FYIRHFXF5QU6VQ4AYTKLQXDFEP2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nodejs16'
  package(s) announced via the SUSE-SU-2024:0729-1 advisory.
