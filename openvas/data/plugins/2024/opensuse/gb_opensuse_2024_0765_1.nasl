...
if(description)
{
  ...
  script_cve_id("CVE-2024-2512", "CVE-2024-25126", "CVE-2024-26141", "CVE-2024-26146");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2025-02-26 05:38:41 +0000 (Wed, 26 Feb 2025)");
  script_tag(name:"creation_date", value:"2024-03-08 02:01:02 +0000 (Fri, 08 Mar 2024)");
  script_name("openSUSE: Security Advisory for rubygem (SUSE-SU-2024:0765-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:0765-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/UYWZYVLI6MW3754MGQX5ORVOUUA34XUQ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rubygem'
  package(s) announced via the SUSE-SU-2024:0765-1 advisory.
