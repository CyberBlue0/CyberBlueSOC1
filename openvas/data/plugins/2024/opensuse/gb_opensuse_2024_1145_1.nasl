...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856048");
  ...
  script_name("openSUSE: Security Advisory for buildah (SUSE-SU-2024:1145-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:1145-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/WPNGTMXYQHTVREWMXNZ4RPNL6GPG6LGJ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'buildah'
  package(s) announced via the SUSE-SU-2024:1145-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  * Update to version 1.34.1 for compatibility with Docker 25.0 (which is not in
      SLES yet, but will eventually be) (bsc#1219563).");
