...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856495");
  ...
  script_name("openSUSE: Security Advisory for kubernetes1.24 (SUSE-SU-2024:3343-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:3343-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/F2L5AQWXHVCDG7BNPKNR6UAVJQH7QD77");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'kubernetes1.24'
  package(s) announced via the SUSE-SU-2024:3343-1 advisory.
