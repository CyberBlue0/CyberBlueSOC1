...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856568");
  ...
  script_tag(name:"creation_date", value:"2024-10-16 04:02:06 +0000 (Wed, 16 Oct 2024)");
  script_name("openSUSE: Security Advisory for the Linux Kernel RT (Live Patch 9 for SLE 15 SP5) (SUSE-SU-2024:3635-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:3635-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/BL3RXEW5VDVX6HS5GR4KUH6GDRT5OFQF");
  ...
  package(s) announced via the SUSE-SU-2024:3635-1 advisory.
