...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856787");
  ...
  script_tag(name:"creation_date", value:"2024-12-05 05:00:23 +0000 (Thu, 05 Dec 2024)");
  script_name("openSUSE: Security Advisory for the Linux Kernel (Live Patch 38 for SLE 15 SP3) (SUSE-SU-2024:4177-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:4177-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/EXGR6SY2Q2Z3TLER4MUKW35TYBEOJEMH");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'the Linux Kernel (Live Patch 38 for SLE 15 SP3)'
  package(s) announced via the SUSE-SU-2024:4177-1 advisory.
