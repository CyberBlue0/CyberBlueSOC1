...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833603");
  ...
  script_name("openSUSE: Security Advisory for postgresql14 (SUSE-SU-2023:4479-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2023:4479-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/7A5QIOUDEDA6HZDAIBTO22TAUSCBNHCB");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'postgresql14'
  package(s) announced via the SUSE-SU-2023:4479-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  * Change the unix domain socket location from /var/run to /run.");
  ...
  script_tag(name:"affected", value:"'postgresql14' package(s) on openSUSE Leap 15.4, openSUSE Leap 15.5.");
