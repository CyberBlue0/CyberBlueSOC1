...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for subversion (SUSE-SU-2024:4366-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:4366-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/NW55B2XEWVYIEUT7P5DCODITXC5RDVJP");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'subversion'
  package(s) announced via the SUSE-SU-2024:4366-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  * CVE-2024-46901: Fixed denial-of-service via control characters in paths in
  ...
  script_tag(name:"affected", value:"'subversion' package(s) on openSUSE Leap 15.4, openSUSE Leap 15.5, openSUSE Leap 15.6.");
