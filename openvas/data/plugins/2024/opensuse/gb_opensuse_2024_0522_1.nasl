...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833181");
  ...
  script_tag(name:"creation_date", value:"2024-03-04 12:52:24 +0000 (Mon, 04 Mar 2024)");
  script_name("openSUSE: Security Advisory for postgresql13 (SUSE-SU-2024:0522-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:0522-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/2SMRATK3VM4TD4UFVR4V4DXRQUSQRMJH");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'postgresql13'
  package(s) announced via the SUSE-SU-2024:0522-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  * CVE-2024-0985: Tighten security restrictions within REFRESH MATERIALIZED
  ...
  script_tag(name:"affected", value:"'postgresql13' package(s) on openSUSE Leap 15.5.");
