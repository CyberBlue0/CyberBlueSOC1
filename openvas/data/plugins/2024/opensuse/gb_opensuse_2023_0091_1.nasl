...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833053");
  ...
  script_tag(name:"creation_date", value:"2024-03-04 07:23:45 +0000 (Mon, 04 Mar 2024)");
  script_name("openSUSE: Security Advisory for python310 (SUSE-SU-2023:0091-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2023:0091-1");
  ...
  package(s) announced via the SUSE-SU-2023:0091-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This update for python310-setuptools fixes the following issues:
