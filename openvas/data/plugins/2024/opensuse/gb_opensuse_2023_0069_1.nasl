...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833161");
  ...
  script_tag(name:"creation_date", value:"2024-03-04 07:22:35 +0000 (Mon, 04 Mar 2024)");
  script_name("openSUSE: Security Advisory for SDL2 (SUSE-SU-2023:0069-1)");
  ...
  package(s) announced via the SUSE-SU-2023:0069-1 advisory.
