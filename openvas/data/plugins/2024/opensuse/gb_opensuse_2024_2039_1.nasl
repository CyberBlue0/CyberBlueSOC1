...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856240");
  ...
  script_tag(name:"creation_date", value:"2024-06-19 04:00:40 +0000 (Wed, 19 Jun 2024)");
  script_name("openSUSE: Security Advisory for php8 (SUSE-SU-2024:2039-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:2039-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/NJ6PYKOK5PUHJ7CJXV7RB4HDRKAMWLPO");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php8'
  package(s) announced via the SUSE-SU-2024:2039-1 advisory.
