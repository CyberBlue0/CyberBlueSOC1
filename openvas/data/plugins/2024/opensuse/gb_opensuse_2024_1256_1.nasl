...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for perl (SUSE-SU-2024:1256-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:1256-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/5YKBTNEKHKGMR7G4XO537TFRQNJMRXUA");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'perl'
  package(s) announced via the SUSE-SU-2024:1256-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  * CVE-2021-47154: Fixed leading zeroes in IPv4 octets may allow attackers to
  ...
  script_tag(name:"affected", value:"'perl' package(s) on openSUSE Leap 15.5.");
