...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856573");
  script_version("2025-02-26T05:38:41+0000");
  script_cve_id("CVE-2024-40909", "CVE-2024-40954", "CVE-2024-41059");
  ...
  script_tag(name:"creation_date", value:"2024-10-16 04:02:43 +0000 (Wed, 16 Oct 2024)");
  script_name("openSUSE: Security Advisory for the Linux Kernel RT (Live Patch 17 for SLE 15 SP5) (SUSE-SU-2024:3627-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:3627-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/EDC3MOOYJCFLEYCPOKSPUCADNYIO3EGI");
  ...
  package(s) announced via the SUSE-SU-2024:3627-1 advisory.
