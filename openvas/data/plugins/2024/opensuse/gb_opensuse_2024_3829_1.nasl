...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856656");
  ...
  script_tag(name:"creation_date", value:"2024-10-31 05:03:33 +0000 (Thu, 31 Oct 2024)");
  script_name("openSUSE: Security Advisory for the Linux Kernel RT (Live Patch 10 for SLE 15 SP5) (SUSE-SU-2024:3829-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:3829-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/RMOWLUMWUZKBWNWZRVPCJY43YUOMCMJ7");
  ...
  package(s) announced via the SUSE-SU-2024:3829-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  * CVE-2023-52502: Fixed a race condition in nfc_llcp_sock_ ...
