...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856463");
  ...
  script_tag(name:"creation_date", value:"2024-09-12 04:00:25 +0000 (Thu, 12 Sep 2024)");
  script_name("openSUSE: Security Advisory for python (SUSE-SU-2024:3187-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:3187-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/RLVLO5KASLQGAKGAI3BZYQHVL5B6Z3A4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python'
  package(s) announced via the SUSE-SU-2024:3187-1 advisory.
