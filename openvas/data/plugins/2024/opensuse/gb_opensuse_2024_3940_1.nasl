...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856699");
  ...
  script_tag(name:"creation_date", value:"2024-11-08 05:00:36 +0000 (Fri, 08 Nov 2024)");
  script_name("openSUSE: Security Advisory for libarchive (SUSE-SU-2024:3940-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:3940-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/T52X7E57LHYSHFIOUR75MGSIL4OEOTYD");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libarchive'
  package(s) announced via the SUSE-SU-2024:3940-1 advisory.
