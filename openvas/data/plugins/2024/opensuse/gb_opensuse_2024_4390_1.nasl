...
if(description)
{
  ...
  script_name("openSUSE: Security Advisory for haproxy (SUSE-SU-2024:4390-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:4390-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/YYMU6HIOATWS24SM3Y4PCD66O3QKGYCQ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'haproxy'
  package(s) announced via the SUSE-SU-2024:4390-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  * CVE-2024-53008: Fixed HTTP/3 request smuggling via malformed HTTP headers
      forwarded to a HTTP/1.1 non-compliant back-end server (bsc#1233973)
