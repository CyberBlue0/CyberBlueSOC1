...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856539");
  script_version("2025-02-26T05:38:41+0000");
  script_cve_id("CVE-2024-6104", "CVE-2024-9341");
  ...
  script_tag(name:"creation_date", value:"2024-10-09 04:00:29 +0000 (Wed, 09 Oct 2024)");
  script_name("openSUSE: Security Advisory for podman (SUSE-SU-2024:3546-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:3546-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/MYMA7BZJZTURAPGKHV2ACU3HBJTKVYMK");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'podman'
  package(s) announced via the SUSE-SU-2024:3546-1 advisory.
