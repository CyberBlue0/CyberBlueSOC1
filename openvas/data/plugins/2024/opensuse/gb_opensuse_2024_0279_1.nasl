...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833547");
  ...
  script_tag(name:"creation_date", value:"2024-03-04 12:51:34 +0000 (Mon, 04 Mar 2024)");
  script_name("openSUSE: Security Advisory for slurm (SUSE-SU-2024:0279-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:0279-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/CFD26TC2JH5AEUXQ7HLCDX4D7XEXTQBT");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'slurm'
  package(s) announced via the SUSE-SU-2024:0279-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  * Fix slurm upgrading to incompatible versions (bsc#1216869).
  ...
  script_tag(name:"affected", value:"'slurm' package(s) on openSUSE Leap 15.3.");
