...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856685");
  script_version("2025-02-26T05:38:41+0000");
  script_cve_id("CVE-2023-52752", "CVE-2024-40909", "CVE-2024-40954", "CVE-2024-42133");
  ...
  script_tag(name:"creation_date", value:"2024-11-05 05:00:30 +0000 (Tue, 05 Nov 2024)");
  script_name("openSUSE: Security Advisory for the Linux Kernel (Live Patch 2 for SLE 15 SP6) (SUSE-SU-2024:3882-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:3882-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/GBH24SQSCU7UKVSH3JGQ4YLAU2LAG7KC");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'the Linux Kernel (Live Patch 2 for SLE 15 SP6)'
  package(s) announced via the SUSE-SU-2024:3882-1 advisory.
