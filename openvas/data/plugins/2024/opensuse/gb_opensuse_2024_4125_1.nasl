...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856766");
  ...
  script_tag(name:"creation_date", value:"2024-12-03 05:00:57 +0000 (Tue, 03 Dec 2024)");
  script_name("openSUSE: Security Advisory for the Linux Kernel RT (Live Patch 15 for SLE 15 SP5) (SUSE-SU-2024:4125-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:4125-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/WE2XM6TRRQ46BOJXGVEANLBXNRZ7EEFB");
  ...
  package(s) announced via the SUSE-SU-2024:4125-1 advisory.
