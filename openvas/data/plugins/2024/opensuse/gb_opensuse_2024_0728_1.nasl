...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833606");
  script_version("2025-02-26T05:38:41+0000");
  script_cve_id("CVE-2023-46809", "CVE-2024-22019", "CVE-2024-22025", "CVE-2024-24758", "CVE-2024-24806");
  ...
  script_tag(name:"creation_date", value:"2024-03-08 02:00:40 +0000 (Fri, 08 Mar 2024)");
  script_name("openSUSE: Security Advisory for nodejs16 (SUSE-SU-2024:0728-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:0728-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/QZ5LGLKDQEMAVM3EPQQ3MUJPAHSG43UT");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nodejs16'
  package(s) announced via the SUSE-SU-2024:0728-1 advisory.
