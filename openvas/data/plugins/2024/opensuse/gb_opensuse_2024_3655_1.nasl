...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856588");
  ...
  script_tag(name:"creation_date", value:"2024-10-17 04:01:36 +0000 (Thu, 17 Oct 2024)");
  script_name("openSUSE: Security Advisory for the Linux Kernel (Live Patch 6 for SLE 15 SP5) (SUSE-SU-2024:3655-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:3655-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/P4LIA2SNUYEEYDFH7Q72CHUMA7X4NIY3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'the Linux Kernel (Live Patch 6 for SLE 15 SP5)'
  package(s) announced via the SUSE-SU-2024:3655-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  * CVE-2024-36964: fs/9p: only translate RWX permissions for plain 9P2000
  ...
  script_tag(name:"affected", value:"'the Linux Kernel (Live Patch 6 for SLE 15 SP5)' package(s) on openSUSE Leap 15.5.");
