...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856569");
  script_version("2025-02-26T05:38:41+0000");
  script_cve_id("CVE-2022-48651", "CVE-2022-48662", "CVE-2023-52846", "CVE-2024-26610", "CVE-2024-26828", "CVE-2024-26852", "CVE-2024-26923", "CVE-2024-27398", "CVE-2024-35861", "CVE-2024-35950", "CVE-2024-36899", "CVE-2024-36964", "CVE-2024-40954", "CVE-2024-41059");
  ...
  script_tag(name:"creation_date", value:"2024-10-16 04:02:16 +0000 (Wed, 16 Oct 2024)");
  script_name("openSUSE: Security Advisory for the Linux Kernel RT (Live Patch 13 for SLE 15 SP5) (SUSE-SU-2024:3639-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:3639-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/QREDIZHMC5MCDU7XHJHAPFFVPPIKTHWD");
  ...
  package(s) announced via the SUSE-SU-2024:3639-1 advisory.
