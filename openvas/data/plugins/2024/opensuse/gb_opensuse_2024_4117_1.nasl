...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856758");
  script_version("2025-02-26T05:38:41+0000");
  script_xref(name:"CISA", value:"Known Exploited Vulnerability (KEV) catalog");
  script_xref(name:"URL", value:"https://www.cisa.gov/known-exploited-vulnerabilities-catalog");
  script_cve_id("CVE-2024-44185", "CVE-2024-44296", "CVE-2024-44308", "CVE-2024-44309", "CVE-2024-44244");
  ...
  script_tag(name:"creation_date", value:"2024-11-30 05:00:20 +0000 (Sat, 30 Nov 2024)");
  script_name("openSUSE: Security Advisory for webkit2gtk3 (SUSE-SU-2024:4117-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:4117-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/VNZ5RBT5KWCT3G7Z5PC3JUAOA7LNJT6Y");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'webkit2gtk3'
  package(s) announced via the SUSE-SU-2024:4117-1 advisory.
