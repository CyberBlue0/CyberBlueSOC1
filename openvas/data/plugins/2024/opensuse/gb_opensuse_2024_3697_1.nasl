...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856590");
  ...
  script_tag(name:"creation_date", value:"2024-10-17 04:01:46 +0000 (Thu, 17 Oct 2024)");
  script_name("openSUSE: Security Advisory for the Linux Kernel (Live Patch 11 for SLE 15 SP5) (SUSE-SU-2024:3697-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:3697-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/A6BRGXRVSUAODD2ZZSX5GJCV46W4N5YB");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'the Linux Kernel (Live Patch 11 for SLE 15 SP5)'
  package(s) announced via the SUSE-SU-2024:3697-1 advisory.
