...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856468");
  script_version("2025-02-26T05:38:41+0000");
  script_cve_id("CVE-2024-6923");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");
  script_tag(name:"last_modification", value:"2025-02-26 05:38:41 +0000 (Wed, 26 Feb 2025)");
  script_tag(name:"creation_date", value:"2024-09-12 04:09:33 +0000 (Thu, 12 Sep 2024)");
  script_name("openSUSE: Security Advisory for python311 (SUSE-SU-2024:3200-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:3200-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/PTLRQHMZ2AHOYSLFSCO2VW4EMTY7TZPP");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python311'
  package(s) announced via the SUSE-SU-2024:3200-1 advisory.
