...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833718");
  ...
  script_tag(name:"creation_date", value:"2024-03-04 07:37:19 +0000 (Mon, 04 Mar 2024)");
  script_name("openSUSE: Security Advisory for the Linux Kernel (Live Patch 16 for SLE 15 SP4) (SUSE-SU-2023:4872-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2023:4872-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/KUUTKSWQUU22QEBVDIYXBW7QELZE5U5X");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'the Linux Kernel (Live Patch 16 for SLE 15 SP4)'
  package(s) announced via the SUSE-SU-2023:4872-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This update for the Linux Kernel 5.14.21-150400_24_81 fixes several issues.
  ...
  * CVE-2023-2163: Fixed an incorrect verifier pruning in BPF that could lead to
  ...
  script_tag(name:"affected", value:"'the Linux Kernel (Live Patch 16 for SLE 15 SP4)' package(s) on openSUSE Leap 15.4.");
