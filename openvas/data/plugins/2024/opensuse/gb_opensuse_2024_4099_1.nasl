...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856748");
  ...
  script_name("openSUSE: Security Advisory for postgresql12 (SUSE-SU-2024:4099-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:4099-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/ZBUKF6XXKZFPRDHGO67WLKAPTNBLL7G7");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'postgresql12'
  package(s) announced via the SUSE-SU-2024:4099-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  * CVE-2024-10979: Prevent trusted PL/Perl code from changing environment
  ...
  script_tag(name:"affected", value:"'postgresql12' package(s) on openSUSE Leap 15.5, openSUSE Leap 15.6.");
