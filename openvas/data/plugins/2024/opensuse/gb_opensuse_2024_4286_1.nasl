...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856833");
  ...
  script_tag(name:"creation_date", value:"2024-12-12 05:00:23 +0000 (Thu, 12 Dec 2024)");
  script_name("openSUSE: Security Advisory for nodejs20 (SUSE-SU-2024:4286-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:4286-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/XKQMWK22BODXSXLPXX4S5RBUTOKNNJN3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nodejs20'
  package(s) announced via the SUSE-SU-2024:4286-1 advisory.
