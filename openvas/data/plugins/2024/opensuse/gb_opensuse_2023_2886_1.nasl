...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833684");
  ...
  script_name("openSUSE: Security Advisory for MozillaFirefox, MozillaFirefox (SUSE-SU-2023:2886-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2023:2886-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/2HTSEB6MFCVTXXFIMHLPTEEYP7BU222O");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'MozillaFirefox, MozillaFirefox'
  package(s) announced via the SUSE-SU-2023:2886-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This update for MozillaFirefox, MozillaFirefox-branding-SLE fixes the following
  issues:
  ...
  * Non-breaking spaces are now preservedpreventing automatic line breakswhen
  ...
  * Removed a configuration option to allow SHA-1 signatures in certificates:
      SHA-1 signatures in certificateslong since determined to no longer be
      secure enoughare now not supported.
  ...
  * Setting Firefox as your default browser now also makes it the default PDF
  ...
  script_tag(name:"affected", value:"'MozillaFirefox, MozillaFirefox' package(s) on openSUSE Leap 15.4, openSUSE Leap 15.5.");
