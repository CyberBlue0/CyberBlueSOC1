...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856409");
  ...
  script_tag(name:"creation_date", value:"2024-09-04 04:00:31 +0000 (Wed, 04 Sep 2024)");
  script_name("openSUSE: Security Advisory for libqt5 (SUSE-SU-2024:3079-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:3079-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/5VWNRBCK2NBMLVAH4IEMLDVRK6Y7VUYC");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libqt5'
  package(s) announced via the SUSE-SU-2024:3079-1 advisory.
