...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856517");
  ...
  script_tag(name:"creation_date", value:"2024-09-27 04:00:29 +0000 (Fri, 27 Sep 2024)");
  script_name("openSUSE: Security Advisory for opensc (SUSE-SU-2024:3445-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:3445-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/EVGKEI3HMNYCWVHWWNIEP23IOFALGMOW");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'opensc'
  package(s) announced via the SUSE-SU-2024:3445-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  * CVE-2024-8443: Heap buffer overflow in OpenPGP driver when generating key.
  ...
  script_tag(name:"affected", value:"'opensc' package(s) on openSUSE Leap 15.4, openSUSE Leap 15.5.");
