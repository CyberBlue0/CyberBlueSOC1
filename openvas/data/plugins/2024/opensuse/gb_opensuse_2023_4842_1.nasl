...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833278");
  ...
  script_name("openSUSE: Security Advisory for python (SUSE-SU-2023:4842-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2023:4842-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/SP6SKXBC4HCOTA3DLZQUPPTV24WYMHIC");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python'
  package(s) announced via the SUSE-SU-2023:4842-1 advisory.
