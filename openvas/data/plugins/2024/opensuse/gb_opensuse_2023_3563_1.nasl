...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833590");
  ...
  script_tag(name:"creation_date", value:"2024-03-04 07:35:27 +0000 (Mon, 04 Mar 2024)");
  script_name("openSUSE: Security Advisory for icu73_2 (SUSE-SU-2023:3563-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2023:3563-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/3C6DI5WWT3BYHXXVLC2OCHSDMMI3JMZK");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'icu73_2'
  package(s) announced via the SUSE-SU-2023:3563-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  * Time zone offsets from local time: New APIs
  ...
  script_tag(name:"affected", value:"'icu73_2' package(s) on openSUSE Leap 15.4, openSUSE Leap 15.5.");
