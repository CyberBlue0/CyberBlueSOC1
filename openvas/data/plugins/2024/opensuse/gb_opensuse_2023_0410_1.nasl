...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833185");
  ...
  script_tag(name:"creation_date", value:"2024-03-04 07:24:30 +0000 (Mon, 04 Mar 2024)");
  script_name("openSUSE: Security Advisory for the Linux Kernel (SUSE-SU-2023:0410-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2023:0410-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/XR44XS7DVZSW4GXVNADJL7MXEH3TMBBG");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'the Linux Kernel'
  package(s) announced via the SUSE-SU-2023:0410-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"The SUSE Linux Enterprise 15 SP1 kernel was updated receive various
  ...
  - net: sched: atm: dont interpret cls results when asked to drop
       (bsc#1207036).

  - net: sched: cbq: dont interpret cls results when asked to drop
       (bsc#1207036).
