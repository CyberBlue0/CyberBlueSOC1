...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856709");
  ...
  script_tag(name:"creation_date", value:"2024-11-09 05:00:37 +0000 (Sat, 09 Nov 2024)");
  script_name("openSUSE: Security Advisory for qemu (SUSE-SU-2024:3948-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:3948-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/IER2U2X3OYNSHEJMM6WROZLOEX44GOPH");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'qemu'
  package(s) announced via the SUSE-SU-2024:3948-1 advisory.
