...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856108");
  ...
  script_tag(name:"creation_date", value:"2024-04-27 01:00:30 +0000 (Sat, 27 Apr 2024)");
  script_name("openSUSE: Security Advisory for php7 (SUSE-SU-2024:1444-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:1444-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/BASFW3ZS5T33OQ6TWU672VCOJR5SSESM");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php7'
  package(s) announced via the SUSE-SU-2024:1444-1 advisory.
