...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833732");
  ...
  script_tag(name:"creation_date", value:"2024-03-04 07:25:15 +0000 (Mon, 04 Mar 2024)");
  script_name("openSUSE: Security Advisory for systemd (SUSE-SU-2022:2866-2)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2022:2866-2");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/O56FCF35VAQGGGCPKDTM4YOXVOQP2ZMK");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'systemd'
  package(s) announced via the SUSE-SU-2022:2866-2 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  script_tag(name:"affected", value:"'systemd' package(s) on openSUSE Leap Micro 5.2.");
