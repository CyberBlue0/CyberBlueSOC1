...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833801");
  ...
  script_name("openSUSE: Security Advisory for mutt (SUSE-SU-2023:3826-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2023:3826-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/TEYVJKZD64BEF44DYUNQ6K3CAOGGVLV4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mutt'
  package(s) announced via the SUSE-SU-2023:3826-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  * CVE-2023-4875: Fixed NULL pointer dereference when receiving an email
  ...
  script_tag(name:"affected", value:"'mutt' package(s) on openSUSE Leap 15.4, openSUSE Leap 15.5.");
