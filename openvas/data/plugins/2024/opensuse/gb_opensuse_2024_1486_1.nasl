...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.856354");
  ...
  script_tag(name:"creation_date", value:"2024-08-20 04:00:47 +0000 (Tue, 20 Aug 2024)");
  script_name("openSUSE: Security Advisory for cosign (SUSE-SU-2024:1486-1)");
  script_category(ACT_GATHER_INFO);
  script_copyright("Copyright (C) 2024 Greenbone AG");
  script_family("SuSE Local Security Checks");

  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:1486-1");
  script_xref(name:"URL", value:"https://lists.opensuse.org/archives/list/security-announce@lists.opensuse.org/thread/DKGS2VOUUB6KAXHPQO4DWZXXGVHJBP6S");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cosign'
  package(s) announced via the SUSE-SU-2024:1486-1 advisory.
Note: This VT has been deprecated and replaced by a Notus scanner based one.");
  ...
  * CVE-2024-29903: Fixed denial of service on host machine via malicious
  ...
  script_tag(name:"affected", value:"'cosign' package(s) on openSUSE Leap 15.4, openSUSE Leap 15.5.");
